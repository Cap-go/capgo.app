...
describe('getting started CLI setup panel', () => {
  ...
  it.concurrent('puts CLI, AI, and teammate setup on getting started instead of account onboarding', () => {
    ...
    expect(commandMarkup).toContain('text-pumpkin-orange-700')
    expect(commandMarkup).not.toContain('text-sky-300')
    expect(commandMarkup).not.toContain('text-violet-300')
    expect(commandMarkup).not.toContain('text-emerald-300')
    expect(commandMarkup).not.toContain('text-cyan-300')
