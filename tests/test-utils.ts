...
export const USER_ID_ORGS_API_EMPTY = '22222222-2222-4222-8222-222222222220'
export const USER_EMAIL_ORGS_API_EMPTY = 'orgs-api-empty@capgo.app'
export const USER_PASSWORD_ORGS_API_EMPTY = 'testtest'
