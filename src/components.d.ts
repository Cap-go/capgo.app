...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    PrioritySupportPresentationModal: typeof import('./components/dashboard/PrioritySupportPresentationModal.vue')['default']
    PrioritySupportPromoBanner: typeof import('./components/dashboard/PrioritySupportPromoBanner.vue')['default']
    PrioritySupportStory: typeof import('./components/dashboard/PrioritySupportStory.vue')['default']
