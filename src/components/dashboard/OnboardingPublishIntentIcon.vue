...
<template>
  <svg viewBox="0 0 46.5 24" aria-hidden="true">
    <svg x="0" y="0" width="24" height="24" viewBox="0 0 24 24">
      <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
        <rect width="20" height="16" x="2" y="4" rx="2" />
        <path d="M10 4v4M2 8h20M6 4v4" />
      </g>
      <svg x="7.95" y="10.0125" width="8.1" height="8.1" viewBox="0 0 24 24">
        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
    ...
    <svg x="33" y="0" width="13.5" height="24" viewBox="5.25 0 13.5 24">
      ...
      <svg x="8.25" y="7.875" width="7.5" height="7.5" viewBox="0 0 24 24" overflow="visible">
        <g transform="translate(0.37 -1.30)">
