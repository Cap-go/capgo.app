...
<template>
  ...
  >
    ...
    <aside
      ...
      class="mt-2 w-[min(100vw-2rem,24rem)] rounded-xl border border-azure-200/80 bg-azure-50/95 p-3.5 text-left text-slate-700 shadow-sm dark:border-azure-500/25 dark:bg-slate-900 dark:text-slate-200"
    >
      <div class="flex items-start gap-3">
        ...
        <div class="min-w-0 flex-1 space-y-1.5">
          <div class="flex items-start justify-between gap-2">
            ...
            <button
              type="button"
              class="inline-flex size-9 shrink-0 items-center justify-center rounded-md text-slate-500 transition-colors hover:bg-slate-200/70 hover:text-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-azure-500 dark:hover:bg-slate-700 dark:hover:text-slate-100"
              :aria-label="t('close')"
              @click="open = false"
            >
