...
function activeTabColor(tab: string, level: 'primary' | 'secondary' | 'tertiary' = 'primary') {
  ...
  // Selected tab keeps a 1px bottom border in the panel color so it is the same
  // height as inactive tabs and that pixel covers the separator at the join.
  return isActive
    ? 'text-blue-500 dark:text-blue-300 bg-blue-50 dark:bg-[#151e31] border border-blue-200/60 dark:border-blue-800/70 border-b-blue-50 dark:border-b-[#151e31] hover:bg-blue-100 hover:border-b-blue-100 dark:hover:bg-[#1e3050] dark:hover:border-b-[#1e3050] transition-colors'
...
const ulPrimaryClass = 'relative z-10 flex text-xs md:text-sm font-medium text-center text-gray-500 dark:text-gray-300 gap-1 pt-1 px-1'
...
const buttonPrimaryClass = 'inline-flex items-center gap-2 px-3 py-2 min-w-[42px] min-h-[38px] h-full rounded-t-md cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-900 transition-all group relative'
...
<template>
  <div class="w-full min-w-0 shrink-0">
    <div class="relative z-20 min-w-0 pb-0">
      <div class="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-px bg-blue-200/60 dark:bg-blue-800/70" aria-hidden="true" />
    ...
    <div class="relative bg-blue-50 dark:bg-slate-800/40">
