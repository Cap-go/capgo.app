...
const router = createRouter({
  routes: [
    ...
    { path: '/admin/dashboard/cli', redirect: '/admin/dashboard/product/cli' },
    { path: '/admin/dashboard/builder', redirect: '/admin/dashboard/product/builder' },
    { path: '/admin/dashboard/notifications', redirect: '/admin/dashboard/product/notifications' },
    { path: '/admin/dashboard/organizations', redirect: '/admin/dashboard/customers/organizations' },
