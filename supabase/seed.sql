...
BEGIN
    ...
    ('00000000-0000-0000-0000-000000000000', '22222222-2222-4222-8222-222222222220', 'authenticated', 'authenticated', 'orgs-api-empty@capgo.app', '$2a$10$0CErXxryZPucjJWq3O7qXeTJgN.tnNU5XCZy9pXKDWRi/aS9W7UFi', NOW(), NOW(), 'oljikwwipqrkwilfsytoe', NOW(), '', NULL, '', '', NULL, NOW(), '{"provider": "email", "providers": ["email"]}', '{"test_identifier": "test_orgs_api_empty"}', 'f', NOW(), NOW(), NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL),
    ...
    ('2022-06-03 05:54:15+00', '', 'orgs-api', 'empty', NULL, 'orgs-api-empty@capgo.app', '22222222-2222-4222-8222-222222222220', NOW(), 't', 't'),
