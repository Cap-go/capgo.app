...
-- Authenticated JWT and service_role callers keep access for console, CLI, and edge.

REVOKE ALL ON FUNCTION public.invite_user_to_org_rbac(character varying, uuid, text) FROM anon;
