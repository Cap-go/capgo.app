...
import { registerCapgoHealth, runCapgoWorkerLivenessProbe } from './capgo_health.ts'
...
export function createHono(functionName: string, _version: string) {
  ...
  registerCapgoHealth(appGlobal, { databaseReadOnly: true })
