...
export function countDevices(
  ...
  if (shouldUseAnalyticsEngine(c))
    return countDevicesCF(c, app_id, customIdMode, deviceIds, versionName, trimmedSearch, updatedAt)
  return countDevicesSB(c, app_id, customIdMode, deviceIds, versionName, trimmedSearch, updatedAt)
}
