...
If the app already has a channel, onboarding asks whether to reuse it or create a new channel. Choose **Yes, use it** to continue with that channel, or **No, create a new one** to choose a new name.
