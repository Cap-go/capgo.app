...
Before sending production notifications, configure Android and iOS push credentials in the Capgo app Notifications tab. Upload the APNs `.p8` key and Android service account JSON directly in the console for hosted Capgo.
