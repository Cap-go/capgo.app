...
The OTA checklist supports versions 3 and 4, including live progress checks for each task. Version 4 reads its OTA steps when `setup.ota_todo_list_version` is the string `"1"`.
