...
function buildTerminalImageDataUrl(frame: TerminalReplayFrame) {
  const svg = [
    ...
    '<div xmlns="http://www.w3.org/1999/xhtml" style="box-sizing:border-box;width:100%;height:100%;padding:16px;background:#0d1117;color:#d6deeb;overflow:hidden;font:14px/20px ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;"><style>pre{margin:0;font:inherit}</style>',
    frame.html,
