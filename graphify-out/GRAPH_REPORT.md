# Graph Report - capgo.app  (2026-08-08)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2120 files · ~4,458,725 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13888 nodes · 25542 edges · 954 communities (803 shown, 151 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.8)
...
## Communities (954 total, 151 thin omitted)
...
Cohesion: 0.01
Nodes (196): scripts, admin:backfill-credit-usage-posthog, admin:backfill-github-user-ids, admin:backfill-missing-app-icons, admin:backfill-missing-store-urls, admin:backfill-paid-product-activity, admin:backfill-plugin-version-ladder, api:dev (+188 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (145): Channel, CompatibilityResult, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+137 more)
...
Cohesion: 0.02
Nodes (118): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+110 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (112): get(), getAll(), CreateApp, post(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle() (+104 more)
...
Cohesion: 0.04
Nodes (78): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, appGlobal (+70 more)
...
Cohesion: 0.03
Nodes (98): ExistingOrganizationApp, PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), BuildProjectStepOutcome, CancelablePromptValue (+90 more)
...
Cohesion: 0.06
Nodes (53): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+45 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (65): createRSA(), setSetting(), setSettingInternal(), getReleaseType(), printReleaseType(), ReleaseTypeResult, configWriteTargetStore, getConfigWriteTarget() (+57 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (61): getActiveUploadReporter(), optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema (+53 more)
...
Cohesion: 0.05
Nodes (59): summarizeUploadCompatibility(), handleBundleUploadCommand(), displayCompatibilityTable(), buildBundleUploadPreviewQrOptions(), verifyCompatibility(), assertIntegerInRange(), assertOptionalConfidence(), assertOptionalIntegerInRange() (+51 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (59): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getFirstTierCreditUnitPricing(), sortCreditPricingSteps(), getErrorMessage() (+51 more)
...
Cohesion: 0.04
Nodes (63): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+55 more)
...
Cohesion: 0.08
Nodes (69): completePendingOnboardingApp(), findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), setConfigWriteTarget(), addAppStep(), addChannelStep(), addCodeChangeStep() (+61 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (40): ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, GLOBAL_STATS_TREND_DATES, NOW, ONBOARDING_INVITE_ORG_ID, ONBOARDING_INVITE_USER_ID (+32 more)
...
Cohesion: 0.05
Nodes (44): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+36 more)
...
Cohesion: 0.06
Nodes (51): filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter(), publicDevice, DeviceRow (+43 more)
...
Cohesion: 0.07
Nodes (44): AlertsReporter, checkAlerts(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies() (+36 more)
...
Cohesion: 0.05
Nodes (35): createAuthenticatedSupabaseClient(), describeBackend, id, RBAC_ORG_ID, deleteUserAs(), withAuthClient(), createOrgWithMember(), orgIds (+27 more)
...
Cohesion: 0.12
Nodes (37): checkAppIdsExist(), askForAppId(), askForReplacementAppId(), ensureNativePlatformForBuild(), exitAfterFinishingReplay(), exitCanceledInitOnboarding(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus() (+29 more)
...
Cohesion: 0.09
Nodes (37): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), countDevicesCF(), countInstallSourcesCF() (+29 more)
...
Cohesion: 0.10
Nodes (29): aiBumpLevel, AiBumpLevelBody, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), app (+21 more)
...
Cohesion: 0.08
Nodes (27): AiBinding, jsonCandidates(), LANGUAGE_NAMES, MessageEntry, normalizeTranslationError(), parseJsonCandidate(), parseTranslationObject(), PublicHttpError (+19 more)
...
Cohesion: 0.11
Nodes (23): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+15 more)
...
Cohesion: 0.09
Nodes (22): AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi(), ManifestDiff, ManifestEntry, requestAiBumpLevel(), resolveAutoBumpLevelFromAi() (+14 more)
...
Cohesion: 0.10
Nodes (20): DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS, DateRangePreset, DateRangePresetGroupKey, DateRangeQueryParams, DateRangeValue, getDateRangeForPreset() (+12 more)
...
Cohesion: 0.16
Nodes (23): cacheReadyStoreEntry(), cacheReadyTranslationPayload(), cloudlogErr(), corsHeaders(), currentReadyTranslationResponse(), errorResponse(), fetch(), fetchHandler() (+15 more)
...
Cohesion: 0.14
Nodes (19): buildTerminalImageDataUrl(), CliStream, createTerminalSnapshot(), createTerminalSnapshotNode(), escapeHtml(), findSerializedNodeId(), findSerializedNodeIdByAttribute(), getReplayViewportSize() (+11 more)
...
Cohesion: 0.14
Nodes (16): addFirstSeenByApp(), batchAdminOnboardingTelemetryWindows(), buildAdminOnboardingProductionDeviceQuery(), buildAdminOnboardingUpdateDownloadQuery(), buildBreakdownMetrics(), convertDataToJsTypes(), emptyAdminOnboardingTelemetry(), getAdminOnboardingTelemetry() (+8 more)
...
Cohesion: 0.21
Nodes (16): claimedTranslationBatchIndex(), enqueueTranslationBatch(), fail(), getTranslationQueue(), isPendingTranslationStale(), isReadyTranslationFresh(), isTranslationBatchLeaseExpired(), nextProcessableBatchIndex() (+8 more)
...
Cohesion: 0.22
Nodes (11): creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel(), formatCreditTierAmount(), formatIncludedThenPrice() (+3 more)
...
Cohesion: 0.20
Nodes (11): buildBatches(), buildTranslationCacheRequest(), cloudlog(), currentSourceChecksum(), getTranslationModel(), logStaleQueuedMessage(), normalizeBatchIndex(), processTranslationQueueBatch() (+3 more)
...
Cohesion: 0.52
Nodes (7): extractAiChoiceText(), extractAiFieldText(), extractAiText(), extractContentText(), messageCatalogOf(), parseTranslationStoreEntry(), recordOf()
...
## Knowledge Gaps
- **4635 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4630 more)
...
- **Why does `Database` connect `Community 81` to `Community 129`, `Community 2`, `Community 4`, `Community 7`, `Community 10`, `Community 15`, `Community 17`, `Community 145`, `Community 21`, `Community 22`, `Community 23`, `Community 281`, `Community 36`, `Community 293`, `Community 38`, `Community 43`, `Community 46`, `Community 174`, `Community 51`, `Community 180`, `Community 58`, `Community 65`, `Community 67`, `Community 364`, `Community 241`?**
  _High betweenness centrality (0.235) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 6` to `Community 133`, `Community 5`, `Community 134`, `Community 136`, `Community 9`, `Community 138`, `Community 11`, `Community 270`, `Community 18`, `Community 147`, `Community 536`, `Community 537`, `Community 25`, `Community 539`, `Community 283`, `Community 413`, `Community 29`, `Community 157`, `Community 158`, `Community 545`, `Community 34`, `Community 40`, `Community 169`, `Community 170`, `Community 43`, `Community 48`, `Community 179`, `Community 52`, `Community 311`, `Community 57`, `Community 185`, `Community 61`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 332`, `Community 79`, `Community 87`, `Community 89`, `Community 90`, `Community 92`, `Community 477`, `Community 478`, `Community 479`, `Community 94`, `Community 225`, `Community 481`, `Community 482`, `Community 100`, `Community 121`, `Community 24`, `Community 489`, `Community 106`, `Community 363`, `Community 112`, `Community 114`, `Community 152`, `Community 247`, `Community 249`, `Community 122`, `Community 252`, `Community 125`, `Community 255`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02278576360554893 - nodes in this community are weakly interconnected._
