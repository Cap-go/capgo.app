...
## Corpus Check
- Large corpus: 2739 files · ~5,196,984 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17098 nodes · 31567 edges · 1090 communities (919 shown, 171 thin omitted)
...
## Communities (1090 total, 171 thin omitted)
...
Cohesion: 0.02
Nodes (160): SuperOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+152 more)
...
Cohesion: 0.02
Nodes (119): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+111 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (138): filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter(), publicDevice, respondEvents() (+130 more)
...
Cohesion: 0.03
Nodes (101): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource() (+93 more)
...
Cohesion: 0.04
Nodes (105): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath() (+97 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (113): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, maybePromptBuilderCta(), shouldBlockIncompatibleUpload(), checkIndexPosition(), searchInDirectory() (+105 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (113): checkAppIdsExist(), listPendingOnboardingApps(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), BuildProjectStepOutcome, CancelablePromptValue, cancelBeforeAuthenticatedOnboarding() (+105 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (79): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+71 more)
...
Cohesion: 0.04
Nodes (70): fetchAllIds(), generateInsertQuery(), ids, main(), BrokenDefaultRow, chunkArray(), loadEnv(), main() (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (85): get(), getAll(), app, appGlobal, CreateApp, post(), persistAppOnboarding(), put() (+77 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (82): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+74 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (65): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+57 more)
...
Cohesion: 0.03
Nodes (76): hostOptionsFromSupabase(), getActiveUploadReporter(), OrganizationUpdatePayload, OrganizationUpdateResponse, resolveConfiguredOrganizationUpdateApiHost, resolveOrganizationUpdateApiHost(), setOrganization(), setOrganizationInternal() (+68 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (76): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore (+68 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (78): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), debugApp() (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (75): reportAppOnboardingProgress(), resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep() (+67 more)
...
Cohesion: 0.04
Nodes (62): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, unbindAppReader(), AuditLog, auditLogSchema (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (70): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+62 more)
...
Cohesion: 0.04
Nodes (61): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+53 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (67): streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController (+59 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (65): id, testOrgId, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels() (+57 more)
...
Cohesion: 0.05
Nodes (53): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), hideLoader() (+45 more)
...
Cohesion: 0.10
Nodes (66): completePendingOnboardingApp(), findAppInOrganization(), loginInitInBrowser(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep() (+58 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (36): LogData, App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload, mocks (+28 more)
...
Cohesion: 0.06
Nodes (54): developmentEnvironmentOptions, OnboardingDevelopmentEnvironmentOption, abTestsConfig, onboardingFor(), onboardingWithNewChannel(), getABTestBranch(), hasNewChannelTreatment(), hasWebNativeDevelopmentEnvironmentTreatment() (+46 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (42): CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod(), isPostgresUniqueViolation() (+34 more)
...
Cohesion: 0.07
Nodes (49): globalId, WEBHOOK_TEST_ORG_ID, webhookApiKey, WebhookDelivery, app, DeliveryMessage, app, AuditLogData (+41 more)
...
Cohesion: 0.06
Nodes (49): assertValidAppId(), ChannelDeviceRow, ChannelRow, deleteBodySchema, DeleteChannelDeviceBody, deleteChannelDeviceOverride(), getExistingChannelDeviceOverride(), getWritableChannel() (+41 more)
...
Cohesion: 0.06
Nodes (46): addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, createAppViaApi(), ensureOptions(), isAppInTargetOrganization() (+38 more)
...
Cohesion: 0.06
Nodes (39): useGitHubProfileDialog(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder (+31 more)
...
Cohesion: 0.09
Nodes (43): emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal(), buildCiAppIdMessage(), collectAppIdCandidates(), fetchCapgoApps() (+35 more)
...
Cohesion: 0.08
Nodes (43): nativeObserveActions, readNativeObserveStats(), defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondSampleView(), respondSummaryOrVersions() (+35 more)
...
Cohesion: 0.05
Nodes (37): AcceptInvitation, acquireRbacOrgLockWithRetry(), baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensureOrgMembership(), ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), isPgLockTimeoutError() (+29 more)
...
Cohesion: 0.06
Nodes (37): AnimationTrigger, useOnboardingChannelAnimation(), UseOnboardingChannelAnimationOptions, createTracker(), {
  getLocalConfigMock,
  sendEventMock,
}, trackerIdentity, createTracker(), steps (+29 more)
...
Cohesion: 0.09
Nodes (35): AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId(), hasProcessedCreditTopUp() (+27 more)
...
Cohesion: 0.10
Nodes (29): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+21 more)
...
Cohesion: 0.07
Nodes (21): AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays, StatsPeriodStartReason (+13 more)
...
Cohesion: 0.13
Nodes (32): promptForKey(), ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions() (+24 more)
...
Cohesion: 0.12
Nodes (25): isVersionDeleted(), DataSetManifest, app, app, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest() (+17 more)
...
Cohesion: 0.14
Nodes (18): buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString(), optionalTagString(), ResolvedTrackingId, resolveTrackingUserId() (+10 more)
...
Cohesion: 0.11
Nodes (19): ALLOWED_ATTRIBUTE_KEYS, createBodySchema, requireManageSsoPermission(), updateBodySchema, uuidSchema, getActivePlanNameOrg(), hasFeature(), isActivePlanStatus() (+11 more)
...
Cohesion: 0.15
Nodes (12): ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExistsInTransaction(), extractProviderId(), getAuthenticatedSsoProviders(), mergeSsoIdentityWithExistingAccount(), OrgRoleName (+4 more)
...
## Knowledge Gaps
- **5960 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5955 more)
...
- **Why does `Database` connect `Community 43` to `Community 2`, `Community 134`, `Community 9`, `Community 11`, `Community 12`, `Community 274`, `Community 19`, `Community 18`, `Community 21`, `Community 22`, `Community 20`, `Community 24`, `Community 27`, `Community 31`, `Community 416`, `Community 33`, `Community 162`, `Community 34`, `Community 37`, `Community 39`, `Community 41`, `Community 171`, `Community 48`, `Community 58`, `Community 320`, `Community 66`, `Community 70`, `Community 74`, `Community 96`, `Community 99`, `Community 372`, `Community 122`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 130`, `Community 259`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 135`, `Community 141`, `Community 17`, `Community 147`, `Community 149`, `Community 153`, `Community 154`, `Community 28`, `Community 156`, `Community 415`, `Community 545`, `Community 546`, `Community 290`, `Community 291`, `Community 548`, `Community 36`, `Community 550`, `Community 167`, `Community 293`, `Community 169`, `Community 294`, `Community 295`, `Community 45`, `Community 557`, `Community 302`, `Community 177`, `Community 50`, `Community 35`, `Community 52`, `Community 56`, `Community 185`, `Community 190`, `Community 191`, `Community 64`, `Community 192`, `Community 68`, `Community 326`, `Community 203`, `Community 209`, `Community 82`, `Community 83`, `Community 84`, `Community 81`, `Community 472`, `Community 94`, `Community 95`, `Community 225`, `Community 101`, `Community 102`, `Community 106`, `Community 107`, `Community 108`, `Community 111`, `Community 114`, `Community 118`, `Community 119`, `Community 121`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5963 weakly-connected nodes found - possible documentation gaps or missing edges._
