...
## Corpus Check
- Large corpus: 2311 files · ~4,769,094 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15160 nodes · 27542 edges · 998 communities (834 shown, 164 thin omitted)
...
## Communities (998 total, 164 thin omitted)
...
Cohesion: 0.03
Nodes (127): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+119 more)
...
Cohesion: 0.03
Nodes (134): app, bodySchema, CreateDeviceBody, baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart() (+126 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (102): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+94 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (124): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+116 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (110): assertCanManageApiKeysForOrgs(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+102 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (115): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+107 more)
...
Cohesion: 0.03
Nodes (104): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), PendingOnboardingApp, checkVersionStatus(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), applyInitAutoTestChange() (+96 more)
...
Cohesion: 0.05
Nodes (76): buildCliRequestHeaders(), getInvocationSource(), completePendingOnboardingApp(), reportAppOnboardingProgress(), AlertsReporter, checkAlerts(), VersionCheckResult, addApp() (+68 more)
...
Cohesion: 0.05
Nodes (60): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), createPlansVisitTracker() (+52 more)
...
Cohesion: 0.08
Nodes (76): cancelCommand(), markSnag(), waitLog(), getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+68 more)
...
Cohesion: 0.05
Nodes (56): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData(), buildAdminStackedBarChartOptions(), formatAdminStackedBarTooltip() (+48 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (56): setCurrentCliCommand(), createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite() (+48 more)
...
Cohesion: 0.04
Nodes (51): CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+43 more)
...
Cohesion: 0.05
Nodes (50): initOnboardingSteps, clearInitLogs(), clearPrompt(), ConfirmPrompt, emit(), INIT_CANCEL, InitCodeDiff, InitCodeDiffLine (+42 more)
...
Cohesion: 0.14
Nodes (9): AppOptions, OrganizationInfo, SDKResult, CapgoSDK, createErrorResult(), withCapacitorConfigTarget(), findSavedKey(), getUserId() (+1 more)
...
Cohesion: 0.07
Nodes (30): useGitHubProfileDialog(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder (+22 more)
...
Cohesion: 0.08
Nodes (35): ensureSplashScreenForDirectUpdate(), ensureUpdaterReadyBeforeSync(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getPackageInstallCommand(), getUpdaterInstallBlocker() (+27 more)
...
Cohesion: 0.10
Nodes (36): listPendingOnboardingApps(), askForAppName(), askForWebDir(), cancelBeforeAuthenticatedOnboarding(), completeExistingAppPendingOnboarding(), ensureCapacitorProjectReady(), ensureWorkspaceReadyForInit(), exitBeforeAuthenticatedOnboarding() (+28 more)
...
Cohesion: 0.10
Nodes (23): getInstalledDependencies(), addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getMissingMainFileRecoveryOptions(), getNuxtUpdaterPluginContent() (+15 more)
...
Cohesion: 0.12
Nodes (22): isTelemetryDisabled(), IncompatibleBundleError, capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS, getCommanderCode(), getCommandPath() (+14 more)
...
## Knowledge Gaps
- **5384 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5379 more)
...
- **Why does `Database` connect `Community 68` to `Community 3`, `Community 8`, `Community 9`, `Community 10`, `Community 15`, `Community 16`, `Community 19`, `Community 22`, `Community 25`, `Community 27`, `Community 157`, `Community 30`, `Community 288`, `Community 32`, `Community 47`, `Community 48`, `Community 185`, `Community 60`, `Community 189`, `Community 64`, `Community 66`, `Community 71`, `Community 76`, `Community 93`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 131`, `Community 4`, `Community 261`, `Community 6`, `Community 7`, `Community 263`, `Community 9`, `Community 138`, `Community 266`, `Community 135`, `Community 268`, `Community 136`, `Community 17`, `Community 148`, `Community 21`, `Community 150`, `Community 31`, `Community 161`, `Community 33`, `Community 290`, `Community 292`, `Community 35`, `Community 38`, `Community 423`, `Community 552`, `Community 553`, `Community 170`, `Community 555`, `Community 171`, `Community 44`, `Community 294`, `Community 177`, `Community 53`, `Community 181`, `Community 182`, `Community 57`, `Community 62`, `Community 192`, `Community 70`, `Community 199`, `Community 75`, `Community 77`, `Community 78`, `Community 79`, `Community 336`, `Community 85`, `Community 86`, `Community 90`, `Community 120`, `Community 95`, `Community 98`, `Community 491`, `Community 492`, `Community 493`, `Community 107`, `Community 235`, `Community 495`, `Community 496`, `Community 110`, `Community 115`, `Community 372`, `Community 504`, `Community 125`, `Community 254`, `Community 127`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5387 weakly-connected nodes found - possible documentation gaps or missing edges._
