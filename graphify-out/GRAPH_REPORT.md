...
## Corpus Check
- Large corpus: 2969 files · ~5,540,340 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17954 nodes · 33301 edges · 1139 communities (962 shown, 177 thin omitted)
...
## Communities (1139 total, 177 thin omitted)
...
Cohesion: 0.02
Nodes (205): calcKeyId(), encryptChecksum(), encryptChecksumV3(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision (+197 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (149): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+141 more)
...
Cohesion: 0.02
Nodes (156): Channel, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+148 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (139): app, bodySchema, syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), didCancel(), getBillingPlans(), invoiceUpcoming(), syncBillingBentoTags() (+131 more)
...
Cohesion: 0.02
Nodes (89): fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool, getPublicKeyFingerprint() (+81 more)
...
Cohesion: 0.03
Nodes (77): getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch() (+69 more)
...
Cohesion: 0.05
Nodes (55): STRIPE_EMULATOR_HEADERS, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id (+47 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (67): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+59 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (74): resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+66 more)
...
Cohesion: 0.04
Nodes (77): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays (+69 more)
...
Cohesion: 0.04
Nodes (62): CheckDomainResponse, install(), PUBLIC_ROUTES, SsoEnforcementResponse, CreditMetricType, sortCreditPricingSteps(), getErrorMessage(), logAsUser() (+54 more)
...
Cohesion: 0.06
Nodes (64): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), buildCordovaModeUploadExample(), buildMissingCapacitorConfigUploadMessage(), enhanceMissingCapacitorConfigUploadError(), loadUploadProjectConfig() (+56 more)
...
Cohesion: 0.04
Nodes (53): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), isTelemetryDisabled(), recordSupabaseCall() (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (66): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+58 more)
...
Cohesion: 0.04
Nodes (60): app, bodySchema, CreateDeviceBody, app, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema (+52 more)
...
Cohesion: 0.11
Nodes (62): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+54 more)
...
Cohesion: 0.04
Nodes (37): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, headers, id, orgId (+29 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (48): adminStore, displayStore, isLoading, loadDashboard(), loadError, loadQuestionFlow(), mainStore, questionFlowLoading (+40 more)
...
Cohesion: 0.06
Nodes (49): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES, ChurnReason (+41 more)
...
Cohesion: 0.05
Nodes (33): APP_UUID, createConfirmedAuthUser(), ORG_ID, TEST_ID, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), createUserAppBinding() (+25 more)
...
Cohesion: 0.09
Nodes (40): maybePromptStarCapgoRepo(), formatGithubRepositoryList(), maybeStarCapgoRepo(), additionalDefaultStarRepositories, checkIfStarred(), parseNumber(), StarAllCommandOptions, starAllRepositoriesCommand() (+32 more)
...
Cohesion: 0.08
Nodes (32): app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getValidatedStatsRequestBody(), insightPeriodDays (+24 more)
...
Cohesion: 0.12
Nodes (34): cancelCommand(), sendCliEvent(), ensureNativePlatformForBuild(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions() (+26 more)
...
Cohesion: 0.10
Nodes (29): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+21 more)

### Community 116 - "Community 116"
Cohesion: 0.10
Nodes (11): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), dismissOptionalPrompts(), screenshotDir, STRIPE_EMULATOR_HEADERS, StripePriceResponse (+3 more)
...
Cohesion: 0.11
Nodes (31): developmentEnvironmentOptions, OnboardingDevelopmentEnvironmentOption, OnboardingAnalyticsFlow, OnboardingDevelopmentEnvironment, OnboardingIntent, applyOptionalUserOnboardingFields(), buildUserOnboardingProgress(), clampOnboardingPayload() (+23 more)
...
Cohesion: 0.13
Nodes (16): persistAppOnboarding(), mocks, AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), AppOnboardingPatch, AppOnboardingState, AppOnboardingStepHistoryChange, AppOnboardingMutationResult (+8 more)
...
Cohesion: 0.13
Nodes (18): ProgressResponse, useAppOnboardingCliProgress(), AppOnboardingStepId, AppOnboardingStepStatus, deriveAppOnboardingOutcome(), filterAppOnboardingReportedPatch(), getAppOnboardingStepIds(), hasSupportedOtaTodoList() (+10 more)
...
Cohesion: 0.13
Nodes (18): persistObservedProgress(), mocks, emitCommittedAppOnboardingHistory(), AppOnboardingBuilderStepId, AppOnboardingBuilderStepState, persistAuthorizedOnboardingMutation(), applyBuilderChecklistUpdate(), appStoreUpdate() (+10 more)
...
Cohesion: 0.15
Nodes (14): mockContext, buildBillingBentoTagUpdates(), didStripeCustomerEmailChange(), getBillingBentoEmails(), getStripeCustomerBillingEmail(), lookupOrgCreatorEmail(), requireLiveStripeCustomerBillingEmail(), retrieveStripeCustomerBillingEmail() (+6 more)
...
Cohesion: 0.28
Nodes (9): buildBreakdownMetrics(), convertDataToJsTypes(), getAdminPlatformOverview(), getPublicLiveUpdateMetricsCF(), readLastMonthDevicesByPlatformCF(), roundPublicPercent(), runQueryToCFA(), rateFromOutcomes() (+1 more)
...
## Knowledge Gaps
- **6249 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6244 more)
...
- **Why does `Database` connect `Community 3` to `Community 128`, `Community 2`, `Community 131`, `Community 6`, `Community 136`, `Community 8`, `Community 10`, `Community 17`, `Community 20`, `Community 21`, `Community 23`, `Community 281`, `Community 26`, `Community 28`, `Community 30`, `Community 42`, `Community 171`, `Community 44`, `Community 48`, `Community 49`, `Community 180`, `Community 444`, `Community 67`, `Community 69`, `Community 71`, `Community 72`, `Community 587`, `Community 83`, `Community 339`, `Community 90`, `Community 739`, `Community 228`, `Community 116`?**
  _High betweenness centrality (0.170) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 132`, `Community 645`, `Community 646`, `Community 7`, `Community 8`, `Community 9`, `Community 648`, `Community 11`, `Community 140`, `Community 146`, `Community 18`, `Community 149`, `Community 280`, `Community 153`, `Community 27`, `Community 158`, `Community 159`, `Community 161`, `Community 162`, `Community 35`, `Community 165`, `Community 39`, `Community 40`, `Community 304`, `Community 179`, `Community 51`, `Community 53`, `Community 311`, `Community 312`, `Community 57`, `Community 58`, `Community 186`, `Community 443`, `Community 315`, `Community 316`, `Community 64`, `Community 578`, `Community 579`, `Community 580`, `Community 582`, `Community 584`, `Community 76`, `Community 205`, `Community 206`, `Community 79`, `Community 593`, `Community 81`, `Community 84`, `Community 86`, `Community 342`, `Community 216`, `Community 89`, `Community 217`, `Community 346`, `Community 219`, `Community 120`, `Community 95`, `Community 98`, `Community 99`, `Community 227`, `Community 102`, `Community 231`, `Community 107`, `Community 110`, `Community 114`, `Community 504`, `Community 122`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.019130372595294286 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.03162389548894432 - nodes in this community are weakly interconnected._