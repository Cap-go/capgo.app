...
## Corpus Check
- Large corpus: 2914 files · ~5,475,361 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17687 nodes · 32859 edges · 1113 communities (944 shown, 169 thin omitted)
...
## Communities (1113 total, 169 thin omitted)
...
Cohesion: 0.02
Nodes (169): CLI_PROJECT_MODES, fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort() (+161 more)
...
Cohesion: 0.01
Nodes (187): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+179 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (136): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), CapgoHttpOptions (+128 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (139): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+131 more)
...
Cohesion: 0.03
Nodes (114): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, applyInitAutoTestChange(), askForAppName(), askForWebDir(), buildCodeDiffLines() (+106 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (85): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+77 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (74): decryptChecksum(), decryptChecksumV3(), decryptSource(), assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, decryptZip() (+66 more)
...
Cohesion: 0.04
Nodes (92): hasAppliedBundle(), didCancel(), BillingPlanBentoState, buildBillingPlanBentoTags(), readNativeActiveDevicesSummaryCF(), readNativeDailyPlatformActiveCF(), assertAnalyticsEngineReadConfig(), buildStatsInsightsFromRows() (+84 more)
...
Cohesion: 0.04
Nodes (72): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (78): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+70 more)
...
Cohesion: 0.04
Nodes (85): activeChannelVersionJoin(), AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, adminOnboardingConversionRate() (+77 more)
...
Cohesion: 0.05
Nodes (72): createRSA(), derivePublicKeyFromPrivate(), resolveAppGettingStartedMessage(), setSetting(), setSettingInternal(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport (+64 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (85): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+77 more)
...
Cohesion: 0.05
Nodes (70): resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (59): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+51 more)
...
Cohesion: 0.04
Nodes (62): resolveAppSetIconPath(), isAppListedInOrganization(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec (+54 more)
...
Cohesion: 0.05
Nodes (42): state, supabase, widgets, classes, globals, rootClasses(), availableLocales, ensureLanguageLoaded() (+34 more)
...
Cohesion: 0.06
Nodes (48): useGitHubProfileDialog(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod() (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (47): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), hideLoader() (+39 more)
...
Cohesion: 0.07
Nodes (55): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildNotificationBadgeStateQuery(), createNotificationDeliveryEventProof() (+47 more)
...
Cohesion: 0.08
Nodes (43): AlertsReporter, checkAlerts(), VersionCheckResult, addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations() (+35 more)
...
Cohesion: 0.07
Nodes (43): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), validateCliRequestHeaderValue(), getInvocationSource(), completePendingOnboardingApp() (+35 more)
...
Cohesion: 0.07
Nodes (43): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown() (+35 more)
...
Cohesion: 0.05
Nodes (38): AcceptInvitation, acquireRbacOrgLockWithRetry(), app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensureOrgMembership(), ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError() (+30 more)
...
Cohesion: 0.09
Nodes (45): maybeAutoTopUpCredits(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh(), checkPlanStatusOnly(), CreditApplicationResult (+37 more)
...
Cohesion: 0.08
Nodes (27): findAppInOrganization(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), selectOnboardingChannel(), cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath() (+19 more)
...
Cohesion: 0.11
Nodes (22): createTestFlows(), DialogHarness, dismissDialog(), findDialogButton(), mountedApps, TestChannel, ChannelRolloutConfirmFlowsDeps, ChannelUpdatePackage (+14 more)
...
Cohesion: 0.12
Nodes (23): admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, APP_ONBOARDING_V3_STEP_IDS, AppOnboardingOutcome, AppOnboardingSource, AppOnboardingStepHistory (+15 more)
...
Cohesion: 0.15
Nodes (18): getRedirect(), allowOnboardingDashboardExploration(), canExploreOnboardingDashboard(), DashboardExploration, getOnboardingExploreBannerAppId(), getOnboardingResumeAppId(), getOnboardingResumeRedirect(), isNewOnboardingUser() (+10 more)
...
Cohesion: 0.19
Nodes (12): AdminOnboardingActivationCohort, AdminOnboardingActivationMetrics, getAdminOnboardingActivationMetrics(), isWithinActivationWindow(), toValidDate(), buildAdminOnboardingInstallSourceQuery(), addOrgToDateSet(), ADMIN_ONBOARDING_WIZARD_BUCKETS (+4 more)
...
Cohesion: 0.20
Nodes (12): normalizeTargetLimit(), resolveTargetPlan(), buildNotificationRegistryLookupQuery(), getAllNotificationBuckets(), getEventsDataset(), getRegistryDataset(), normalizeNotificationTag(), readNotificationBadgeStateCF() (+4 more)
...
Cohesion: 0.29
Nodes (8): ProgressResponse, useAppOnboardingCliProgress(), AppOnboardingStepStatus, filterAppOnboardingReportedPatch(), hasSupportedOtaTodoList(), isAppOnboardingOutcome(), parseAppOnboarding(), getAppSetupRedirect()
...
## Knowledge Gaps
- **6148 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6143 more)
...
- **Why does `Database` connect `Community 33` to `Community 2`, `Community 5`, `Community 6`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 24`, `Community 27`, `Community 31`, `Community 32`, `Community 34`, `Community 163`, `Community 36`, `Community 40`, `Community 43`, `Community 173`, `Community 174`, `Community 46`, `Community 50`, `Community 51`, `Community 56`, `Community 185`, `Community 76`, `Community 332`, `Community 96`, `Community 231`, `Community 118`, `Community 126`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 11` to `Community 129`, `Community 130`, `Community 52`, `Community 7`, `Community 135`, `Community 9`, `Community 14`, `Community 16`, `Community 144`, `Community 18`, `Community 149`, `Community 279`, `Community 152`, `Community 155`, `Community 161`, `Community 162`, `Community 164`, `Community 38`, `Community 39`, `Community 167`, `Community 42`, `Community 298`, `Community 179`, `Community 308`, `Community 309`, `Community 435`, `Community 183`, `Community 568`, `Community 569`, `Community 311`, `Community 571`, `Community 312`, `Community 61`, `Community 573`, `Community 58`, `Community 192`, `Community 67`, `Community 580`, `Community 77`, `Community 78`, `Community 207`, `Community 334`, `Community 81`, `Community 208`, `Community 79`, `Community 341`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 219`, `Community 345`, `Community 94`, `Community 226`, `Community 100`, `Community 101`, `Community 104`, `Community 106`, `Community 107`, `Community 495`, `Community 112`, `Community 111`, `Community 114`, `Community 119`, `Community 632`, `Community 127`, `Community 125`, `Community 639`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.020609718459586434 - nodes in this community are weakly interconnected._
