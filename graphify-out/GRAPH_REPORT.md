...
## Corpus Check
- Large corpus: 2758 files · ~5,217,732 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17201 nodes · 31773 edges · 1116 communities (945 shown, 171 thin omitted)
...
## Communities (1116 total, 171 thin omitted)
...
Cohesion: 0.02
Nodes (153): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, buildCacheKeyOptionSchema (+145 more)
...
Cohesion: 0.03
Nodes (150): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+142 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (103): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+95 more)
...
Cohesion: 0.03
Nodes (125): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, setConfigWriteTarget(), applyInitAutoTestChange(), askForAppName() (+117 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (119): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+111 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (76): fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool, fixtureId (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (92): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (98): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions, Channel (+90 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (99): app, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+91 more)
...
Cohesion: 0.03
Nodes (77): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+69 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (69): STRIPE_EMULATOR_HEADERS, StripePriceResponse, id, testOrgId, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError() (+61 more)
...
Cohesion: 0.04
Nodes (75): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+67 more)
...
Cohesion: 0.04
Nodes (72): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+64 more)
...
Cohesion: 0.05
Nodes (70): resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+62 more)
...
Cohesion: 0.05
Nodes (66): waitForCommandResult(), streamCommandInInitPanel(), ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (79): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+71 more)
...
Cohesion: 0.04
Nodes (46): isTelemetryDisabled(), assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, IncompatibleBundleError, CliUserError, trimTrailingSlashes() (+38 more)
...
Cohesion: 0.06
Nodes (61): createRSA(), derivePublicKeyFromPrivate(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport (+53 more)
...
Cohesion: 0.05
Nodes (58): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+50 more)
...
Cohesion: 0.04
Nodes (43): TEST_ORG_ID, TEST_ORG_ID, getUniqueBaseData(), execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, headers (+35 more)
...
Cohesion: 0.04
Nodes (41): AdminStatsTestApp, ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, getBillingSnapshotCountsAt(), getCoreSnapshotCountsAt(), getGlobalStatsTrendDirect() (+33 more)
...
Cohesion: 0.06
Nodes (50): ensureSplashScreenForDirectUpdate(), ensureUpdaterReadyBeforeSync(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getPackageInstallCommand(), getSplashScreenVersionToInstall() (+42 more)
...
Cohesion: 0.06
Nodes (44): getInvocationSource(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, ensureOptions(), isAppInTargetOrganization() (+36 more)
...
Cohesion: 0.11
Nodes (15): deleteOrganization(), deleteOrganizationInternal(), displayMembers(), DisplayOptions, listMembers(), listMembersInternal(), MemberInfo, PasswordPolicyConfig (+7 more)
...
Cohesion: 0.06
Nodes (43): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult (+35 more)
...
Cohesion: 0.06
Nodes (38): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+30 more)
...
Cohesion: 0.05
Nodes (42): AlertsReporter, checkVersionStatus(), VersionCheckResult, author, bin, capgo, bugs, url (+34 more)
...
Cohesion: 0.07
Nodes (35): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), COMPONENT_RESOLUTION_ERROR_PATTERNS, FIRST_PARTY_INLINE_FRAME_FUNCTIONS, isComponentResolutionErrorMessage(), isDocumentUrlFrame() (+27 more)
...
Cohesion: 0.08
Nodes (38): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), formatDoctorInstallHint(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), getPMAndCommandForDir() (+30 more)
...
Cohesion: 0.08
Nodes (30): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+22 more)
...
Cohesion: 0.09
Nodes (26): adminStore, displayStore, isLoading, loadError, mainStore, router, { t }, AdminABTestDistribution (+18 more)
...
Cohesion: 0.09
Nodes (27): cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+19 more)
...
Cohesion: 0.10
Nodes (10): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), STRIPE_EMULATOR_HEADERS, visualDiffRoutes, visualDiffViewport, test (+2 more)
...
Cohesion: 0.14
Nodes (25): loadDashboard(), ADMIN_CHANNEL_ANIMATION_COHORTS, ADMIN_CHANNEL_ANIMATION_STAGES, ADMIN_CHANNEL_RETENTION_PROGRESS, ADMIN_CHANNEL_SKIP_PROGRESS, AdminChannelPosthogFailureReason, count(), isCohort() (+17 more)
...
Cohesion: 0.13
Nodes (14): ADMIN_AB_TEST_DEVELOPMENT_ENVIRONMENT_OUTCOMES, AdminABTestDevelopmentEnvironment, AdminABTestDevelopmentEnvironmentOutcomeName, developmentEnvironmentPercentage(), isCount(), isOutcome(), isRecord(), parseAdminABTestDevelopmentEnvironment() (+6 more)
...
Cohesion: 0.19
Nodes (14): numberLikeSchema, getDeliveryById(), getWebhookById(), getWebhookLogUrlMetadata(), queueWebhookDelivery(), getDeliveries(), getDeliveriesSchema, retryDelivery() (+6 more)
...
Cohesion: 0.12
Nodes (15): captcha_key, development, local, preprod, prod, supa_anon, development, local (+7 more)
...
Cohesion: 0.23
Nodes (14): getWebhookPublicUrlValidationError(), isWebhookEventType(), parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, post(), bodySchema (+6 more)
...
Cohesion: 0.20
Nodes (9): loginInitInBrowser(), promptForKey(), shouldStartInitBrowserLogin(), helperSource, initComponentsSource, initPromptsSource, initRuntimeSource, initSource (+1 more)
...
Cohesion: 0.22
Nodes (5): NO_ERROR, RequestJSON, schemas, channelSelfRequestSchema, statsRequestSchema
...
## Knowledge Gaps
- **5992 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5987 more)
...
- **Why does `Database` connect `Community 122` to `Community 129`, `Community 3`, `Community 5`, `Community 133`, `Community 11`, `Community 12`, `Community 13`, `Community 17`, `Community 18`, `Community 22`, `Community 28`, `Community 29`, `Community 35`, `Community 550`, `Community 41`, `Community 170`, `Community 429`, `Community 47`, `Community 175`, `Community 54`, `Community 59`, `Community 62`, `Community 63`, `Community 68`, `Community 325`, `Community 70`, `Community 73`, `Community 96`, `Community 229`, `Community 124`, `Community 382`, `Community 127`?**
  _High betweenness centrality (0.207) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 6`, `Community 7`, `Community 136`, `Community 265`, `Community 10`, `Community 12`, `Community 145`, `Community 20`, `Community 149`, `Community 155`, `Community 156`, `Community 157`, `Community 159`, `Community 160`, `Community 36`, `Community 293`, `Community 38`, `Community 296`, `Community 297`, `Community 42`, `Community 428`, `Community 45`, `Community 46`, `Community 174`, `Community 48`, `Community 301`, `Community 51`, `Community 309`, `Community 567`, `Community 568`, `Community 569`, `Community 55`, `Community 571`, `Community 315`, `Community 317`, `Community 573`, `Community 190`, `Community 195`, `Community 196`, `Community 580`, `Community 331`, `Community 75`, `Community 78`, `Community 206`, `Community 80`, `Community 81`, `Community 213`, `Community 86`, `Community 85`, `Community 88`, `Community 90`, `Community 220`, `Community 94`, `Community 95`, `Community 105`, `Community 106`, `Community 363`, `Community 491`, `Community 110`, `Community 114`, `Community 116`, `Community 117`, `Community 630`, `Community 631`, `Community 120`, `Community 633`, `Community 125`, `Community 126`, `Community 639`?**
