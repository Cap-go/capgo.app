...
## Corpus Check
- Large corpus: 2555 files · ~5,007,692 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16262 nodes · 29888 edges · 1047 communities (875 shown, 172 thin omitted)
...
## Communities (1047 total, 172 thin omitted)
...
Cohesion: 0.02
Nodes (278): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), waitLog(), promptDoctorUpdateChoice(), setConfigWriteTarget(), buildAppIdConflictSuggestions() (+270 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (164): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase() (+156 more)
...
Cohesion: 0.03
Nodes (131): encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision (+123 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (106): calcKeyId(), createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys (+98 more)
...
Cohesion: 0.04
Nodes (114): BillingPlanBentoState, buildBillingPlanBentoTags(), maybeAutoTopUpCredits(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh() (+106 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (94): get(), getAll(), app, appGlobal, ALLOWED_STORE_HOSTS, AppleLookupResult, assertAllowedStoreUrl(), decodeHtml() (+86 more)
...
Cohesion: 0.03
Nodes (112): OrganizationUpdatePayload, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+104 more)
...
Cohesion: 0.06
Nodes (65): AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady() (+57 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (53): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+45 more)
...
Cohesion: 0.05
Nodes (55): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+47 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (48): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+40 more)
...
Cohesion: 0.05
Nodes (54): getCurrentCliCommand(), app, bodySchema, CreateDeviceBody, app, CliReplayBody, readOptionalString(), readProperties() (+46 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (55): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getInitUpdaterPluginConfig(), getSpawnOutputText(), normalizeRunDevicePlatform(), PlatformChoice, resolveInitTargetPath() (+47 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (56): enableSupabaseInstrumentation(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath() (+48 more)
...
Cohesion: 0.06
Nodes (43): clearInitLogs(), clearPrompt(), ConfirmPrompt, emit(), InitCodeDiff, InitCodeDiffLine, InitEncryptionPhase, InitEncryptionSummary (+35 more)
...
Cohesion: 0.06
Nodes (18): Channel, withConfigWriteTarget(), ParsedSecurityError, StarAllRepositoriesOptions, StarRepoOptions, BundleCompatibilityEntry, CompatibilityReport, DoctorInfo (+10 more)
...
Cohesion: 0.11
Nodes (35): maybePromptStarCapgoRepo(), additionalDefaultStarRepositories, checkIfStarred(), createAbortedError(), createStartRateLimiter(), dedupeRepositories(), ensureGhReady(), executeGhCommand() (+27 more)
...
Cohesion: 0.15
Nodes (5): OrganizationInfo, SDKResult, CapgoSDK, createErrorResult(), withCapacitorConfigTarget()
...
Cohesion: 0.07
Nodes (24): id, testOrgId, orgId, scopeId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath() (+16 more)
...
Cohesion: 0.11
Nodes (25): buildServerInstructions(), installMcpStdoutGuard(), mcpAddAppInputSchema, mcpAddChannelInputSchema, mcpAddOrganizationInputSchema, mcpCheckCompatibilityInputSchema, mcpCleanupBundlesInputSchema, mcpDeleteAppInputSchema (+17 more)
...
Cohesion: 0.09
Nodes (22): BundleCleanupOptions, bundleCleanupOptionsSchema, BundleCompatibilityOptions, bundleCompatibilityOptionsSchema, BundleDecryptOptions, bundleDecryptOptionsSchema, BundleDeleteOptions, bundleDeleteOptionsSchema (+14 more)
...
Cohesion: 0.17
Nodes (16): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, redactSecretContext() (+8 more)
...
Cohesion: 0.28
Nodes (13): decideAdvance(), decideAtStep(), decideStart(), drive(), explainLiveUpdateOnboarding(), gatherFacts(), mergeProgress(), nextAction() (+5 more)
...
## Knowledge Gaps
- **5740 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5735 more)
...
- **Why does `Database` connect `Community 46` to `Community 3`, `Community 6`, `Community 12`, `Community 13`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 27`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 165`, `Community 169`, `Community 44`, `Community 308`, `Community 60`, `Community 64`, `Community 195`, `Community 67`, `Community 201`, `Community 76`, `Community 92`?**
  _High betweenness centrality (0.213) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 18` to `Community 133`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 141`, `Community 268`, `Community 142`, `Community 528`, `Community 529`, `Community 530`, `Community 19`, `Community 276`, `Community 145`, `Community 277`, `Community 532`, `Community 533`, `Community 401`, `Community 281`, `Community 155`, `Community 28`, `Community 540`, `Community 282`, `Community 159`, `Community 33`, `Community 163`, `Community 292`, `Community 37`, `Community 41`, `Community 43`, `Community 47`, `Community 176`, `Community 49`, `Community 182`, `Community 183`, `Community 313`, `Community 57`, `Community 317`, `Community 62`, `Community 192`, `Community 193`, `Community 68`, `Community 71`, `Community 200`, `Community 459`, `Community 587`, `Community 588`, `Community 590`, `Community 79`, `Community 15`, `Community 81`, `Community 77`, `Community 212`, `Community 88`, `Community 89`, `Community 95`, `Community 97`, `Community 99`, `Community 105`, `Community 106`, `Community 21`, `Community 109`, `Community 367`, `Community 114`, `Community 118`, `Community 250`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5743 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.0211864406779661 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.03136896604233288 - nodes in this community are weakly interconnected._