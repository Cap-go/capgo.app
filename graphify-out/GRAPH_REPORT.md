...
## Corpus Check
- Large corpus: 2394 files · ~4,850,628 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15487 nodes · 28171 edges · 1010 communities (847 shown, 163 thin omitted)
...
## Communities (1010 total, 163 thin omitted)
...
Cohesion: 0.02
Nodes (144): setSetting(), setSettingInternal(), AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema (+136 more)
...
Cohesion: 0.03
Nodes (126): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), applyInitAutoTestChange() (+118 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (115): syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), BillingPlanBentoState, buildBillingPlanBentoTags(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+107 more)
...
Cohesion: 0.03
Nodes (74): setCurrentCliCommand(), categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+66 more)
...
Cohesion: 0.04
Nodes (82): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+74 more)
...
Cohesion: 0.05
Nodes (75): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+67 more)
...
Cohesion: 0.06
Nodes (52): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+44 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (68): streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController (+60 more)
...
Cohesion: 0.09
Nodes (73): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+65 more)
...
Cohesion: 0.07
Nodes (58): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildGlobalNotificationStatsQuery(), buildNotificationBadgeStateQuery() (+50 more)
...
Cohesion: 0.05
Nodes (48): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi() (+40 more)
...
Cohesion: 0.05
Nodes (44): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig, ChannelChecksum, checkCompatibilityNativePackages() (+36 more)
...
Cohesion: 0.08
Nodes (47): createNotificationDeliveryEventProofFromSecret(), getAllNotificationBuckets(), NativeNotificationProviderConfig, NativeNotificationQueueMessage, NativeNotificationRegistryRow, aesKeyFromSecret(), AnalyticsApiResponse, canRetry() (+39 more)
...
Cohesion: 0.06
Nodes (39): id, testOrgId, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers (+31 more)
...
Cohesion: 0.10
Nodes (34): buildCliRequestHeaders(), getInvocationSource(), completePendingOnboardingApp(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppCreateSource, createAppViaApi() (+26 more)

### Community 83 - "Community 83"
Cohesion: 0.10
Nodes (34): createRSA(), checkAlerts(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget() (+26 more)
...
Cohesion: 0.09
Nodes (25): AlertsReporter, VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies() (+17 more)
...
Cohesion: 0.09
Nodes (22): { cloudlogErrMock, queryPosthogHogqlMock }, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), FRONTEND_ONBOARDING_PRODUCTION_HOST, FrontendOnboardingInteractionEvent (+14 more)
...
Cohesion: 0.11
Nodes (24): isTelemetryDisabled(), IncompatibleBundleError, CliUserError, trimTrailingSlashes(), capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS (+16 more)
...
Cohesion: 0.09
Nodes (20): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), posthogLoader(), DialogV2, display, route (+12 more)
...
Cohesion: 0.11
Nodes (18): app, AppContext, getInviteNotificationLockKey(), getInviteResendRequiredPermission(), inviteExistingUserSchema, inviteNotificationCooldowns, lockInviteNotification(), unlockInviteNotification() (+10 more)
...
Cohesion: 0.18
Nodes (23): formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handleMissingPhysicalIosRunTargets() (+15 more)
...
## Knowledge Gaps
- **5475 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5470 more)
...
- **Why does `Database` connect `Community 143` to `Community 3`, `Community 6`, `Community 136`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 20`, `Community 23`, `Community 29`, `Community 31`, `Community 167`, `Community 40`, `Community 41`, `Community 298`, `Community 47`, `Community 48`, `Community 57`, `Community 58`, `Community 61`, `Community 194`, `Community 70`, `Community 199`, `Community 71`, `Community 74`, `Community 212`, `Community 345`, `Community 607`, `Community 488`, `Community 511`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 385`, `Community 260`, `Community 133`, `Community 6`, `Community 516`, `Community 5`, `Community 9`, `Community 11`, `Community 268`, `Community 269`, `Community 140`, `Community 271`, `Community 272`, `Community 17`, `Community 146`, `Community 19`, `Community 142`, `Community 153`, `Community 283`, `Community 156`, `Community 158`, `Community 287`, `Community 32`, `Community 35`, `Community 36`, `Community 171`, `Community 44`, `Community 301`, `Community 46`, `Community 175`, `Community 303`, `Community 563`, `Community 436`, `Community 564`, `Community 566`, `Community 180`, `Community 181`, `Community 53`, `Community 191`, `Community 192`, `Community 67`, `Community 69`, `Community 198`, `Community 75`, `Community 461`, `Community 206`, `Community 79`, `Community 80`, `Community 81`, `Community 77`, `Community 211`, `Community 87`, `Community 89`, `Community 90`, `Community 120`, `Community 93`, `Community 96`, `Community 108`, `Community 112`, `Community 241`, `Community 116`, `Community 503`, `Community 504`, `Community 505`, `Community 507`, `Community 508`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.0227258300006348 - nodes in this community are weakly interconnected._