# Graph Report - capgo.app  (2026-09-08)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2617 files · ~5,092,626 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16613 nodes · 30738 edges · 1053 communities (880 shown, 173 thin omitted)
...
## Communities (1053 total, 173 thin omitted)
...
Cohesion: 0.02
Nodes (314): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), promptDoctorUpdateChoice(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError() (+306 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (173): withConfigWriteTarget(), fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort() (+165 more)
...
Cohesion: 0.03
Nodes (156): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase(), PendingOnboardingApp (+148 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (164): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+156 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (175): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+167 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (118): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+110 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (110): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+102 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (106): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, setSetting() (+98 more)
...
Cohesion: 0.03
Nodes (105): get(), getAll(), app, appGlobal, CreateApp, AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement() (+97 more)
...
Cohesion: 0.03
Nodes (67): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, fixtureId, orgId (+59 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (96): syncSubscriptionAndEventsWithRetry(), autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel(), loadCompatibilityBundle() (+88 more)
...
Cohesion: 0.04
Nodes (81): normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource (+73 more)
...
Cohesion: 0.04
Nodes (62): CheckDomainResponse, PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage() (+54 more)
...
Cohesion: 0.07
Nodes (56): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+48 more)
...
Cohesion: 0.03
Nodes (61): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+53 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (46): TEST_ORG_ID, TEST_ORG_ID, headers, testRunId, execFileAsync, AutoTopUpSettings, originalSettings, headers (+38 more)
...
Cohesion: 0.05
Nodes (57): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), cancelCommand() (+49 more)
...
Cohesion: 0.06
Nodes (47): getInvocationSource(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, createAppViaApi() (+39 more)
...
Cohesion: 0.06
Nodes (49): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+41 more)
...
Cohesion: 0.07
Nodes (47): getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout() (+39 more)
...
Cohesion: 0.07
Nodes (48): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint(), formatSpawnOutput() (+40 more)
...
Cohesion: 0.07
Nodes (37): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), JsonPrimitive, posthogLoader(), PostHogProperties, pushEvent() (+29 more)
...
Cohesion: 0.08
Nodes (41): defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), respondSummaryOrVersions(), sampleActionsForView() (+33 more)
...
Cohesion: 0.08
Nodes (40): isDemoApp(), assertAnalyticsEngineReadConfig(), buildStatsInsightsFromRows(), countAllApps(), countInstallSources(), createStatsDevices(), CreateStatsDevicesOptions, createStatsLogs() (+32 more)
...
Cohesion: 0.05
Nodes (22): LogData, STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device (+14 more)
...
Cohesion: 0.10
Nodes (32): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), AppRow, assertAppAllowsPreview(), buildPreviewQrUrl(), BundleRow, CapgoPreviewHttpOptions, ChannelRow (+24 more)
...
Cohesion: 0.09
Nodes (36): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+28 more)

### Community 91 - "Community 91"
Cohesion: 0.09
Nodes (41): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), countDevicesCF() (+33 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (25): APP_UUID, createConfirmedAuthUser(), ORG_ID, TEST_ID, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), bindOrgRole() (+17 more)
...
Cohesion: 0.08
Nodes (34): readInstallTimingEventsCFChunked(), aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+26 more)
...
Cohesion: 0.09
Nodes (33): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays (+25 more)
...
Cohesion: 0.13
Nodes (23): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, lintFailures (+15 more)
...
Cohesion: 0.13
Nodes (24): APP_ONBOARDING_STEP_IDS, AppOnboardingOutcome, AppOnboardingPatch, AppOnboardingSource, AppOnboardingState, AppOnboardingStepId, AppOnboardingStepState, AppOnboardingStepStatus (+16 more)
...
Cohesion: 0.10
Nodes (23): API_CONTENT_SECURITY_POLICY, AuthInfo, BRES, DEFAULT_CORS_ALLOWED_ORIGINS, getAllowedCorsOrigin(), getConfiguredCorsAllowedOrigins(), honoFactory, isLocalHttpOrigin() (+15 more)
...
Cohesion: 0.18
Nodes (20): buildBundlePreviewDeepLink(), buildChannelPreviewDeepLink(), buildChannelPreviewLatestOptions(), buildDeferredPreviewInstallReferrerUrl(), BundlePreviewLink, ChannelPreviewLink, DEFERRED_PREVIEW_REFERRER_KEYS, getHttpUrlParam() (+12 more)
...
Cohesion: 0.25
Nodes (14): getConsumedDeferredPreviewLink(), handleDeepLink(), installDeepLinkHandler(), isCapgoConsoleHost(), routeDeferredPreviewLink(), routePreviewLink(), routeWebLink(), setConsumedDeferredPreviewLink() (+6 more)
...
Cohesion: 0.15
Nodes (13): buildBreakdownMetrics(), buildPluginBreakdownResult(), convertDataToJsTypes(), getLastMonthAnalyticsWindow(), getLastMonthAnalyticsWindowStart(), getPluginBreakdownCF(), getPublicLiveUpdateMetricsCF(), readActiveAppsCF() (+5 more)
...
Cohesion: 0.43
Nodes (6): persistAppOnboarding(), put(), UpdateApp, isDemoAppRow(), lockOnboardingApp(), unlockOnboardingApp()
...
## Knowledge Gaps
- **5804 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5799 more)
...
- **Why does `Database` connect `Community 86` to `Community 3`, `Community 5`, `Community 6`, `Community 13`, `Community 14`, `Community 273`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 27`, `Community 155`, `Community 30`, `Community 31`, `Community 164`, `Community 37`, `Community 47`, `Community 52`, `Community 312`, `Community 62`, `Community 71`, `Community 202`, `Community 85`, `Community 88`, `Community 217`, `Community 92`, `Community 108`, `Community 116`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 9` to `Community 132`, `Community 8`, `Community 12`, `Community 142`, `Community 143`, `Community 15`, `Community 273`, `Community 146`, `Community 276`, `Community 277`, `Community 535`, `Community 536`, `Community 408`, `Community 538`, `Community 539`, `Community 280`, `Community 153`, `Community 281`, `Community 28`, `Community 287`, `Community 33`, `Community 34`, `Community 163`, `Community 547`, `Community 40`, `Community 41`, `Community 42`, `Community 171`, `Community 175`, `Community 48`, `Community 49`, `Community 183`, `Community 57`, `Community 314`, `Community 59`, `Community 317`, `Community 194`, `Community 195`, `Community 196`, `Community 68`, `Community 70`, `Community 455`, `Community 72`, `Community 201`, `Community 78`, `Community 464`, `Community 592`, `Community 594`, `Community 82`, `Community 84`, `Community 81`, `Community 87`, `Community 90`, `Community 95`, `Community 97`, `Community 100`, `Community 101`, `Community 249`, `Community 103`, `Community 106`, `Community 366`, `Community 112`, `Community 113`, `Community 243`, `Community 371`, `Community 115`, `Community 118`, `Community 121`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.01882205737778175 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020441619270659083 - nodes in this community are weakly interconnected._