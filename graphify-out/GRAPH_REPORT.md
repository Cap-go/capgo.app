# Graph Report - capgo.app  (2026-09-13)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2722 files · ~5,184,132 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17022 nodes · 31435 edges · 1099 communities (923 shown, 176 thin omitted)
...
## Communities (1099 total, 176 thin omitted)
...
Cohesion: 0.02
Nodes (329): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), promptDoctorUpdateChoice(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError() (+321 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (162): SuperOptions, fetchObserve(), AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema (+154 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (194): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+186 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (148): isTelemetryDisabled(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, PendingOnboardingApp, resolveAppSetIconPath() (+140 more)
...
Cohesion: 0.03
Nodes (124): syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), invoiceUpcoming(), BillingPlanBentoState, buildBillingPlanBentoTags(), readNativeActiveDevicesSummaryCF(), readNativeDailyPlatformActiveCF(), isDemoApp() (+116 more)
...
Cohesion: 0.03
Nodes (98): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+90 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (95): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (68): useAppPage(), UseAppPageOptions, adminStore, displayStore, isLoading, loadError, mainStore, router (+60 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (67): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, getPublicKeyFingerprint(), testEncryption() (+59 more)
...
Cohesion: 0.05
Nodes (79): getInvocationSource(), getAppIconStoragePath(), hostOptionsFromSupabase(), reportAppOnboardingProgress(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (83): trackMcpServerStarted(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath() (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (57): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+49 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (71): getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl() (+63 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (70): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys (+62 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (73): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+65 more)
...
Cohesion: 0.04
Nodes (53): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId, AuditLog (+45 more)
...
Cohesion: 0.05
Nodes (60): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+52 more)
...
Cohesion: 0.05
Nodes (60): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), cancelCommand() (+52 more)
...
Cohesion: 0.04
Nodes (54): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels(), getUniqueBaseData(), id (+46 more)
...
Cohesion: 0.05
Nodes (50): ABTestsConfig, ABTestsModule, {
  backgroundTaskMock,
  closeClientMock,
  drizzleExecuteMock,
...
}, FIXED_DATE, installIntentTest(), testConfig(), { closeClientMock, getPgClientMock, queryMock }, config (+42 more)
...
Cohesion: 0.04
Nodes (38): TEST_ORG_ID, TEST_ORG_ID, headers, testRunId, execFileAsync, AutoTopUpSettings, originalSettings, headers (+30 more)
...
Cohesion: 0.06
Nodes (50): nativeObserveActions, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), sampleActionsForView() (+42 more)
...
Cohesion: 0.10
Nodes (44): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, setSetting() (+36 more)
...
Cohesion: 0.05
Nodes (32): APP_UUID, createConfirmedAuthUser(), ORG_ID, TEST_ID, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), createUserAppBinding() (+24 more)
...
Cohesion: 0.05
Nodes (23): LogData, STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device (+15 more)
...
Cohesion: 0.11
Nodes (30): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), AppRow, assertAppAllowsPreview(), buildPreviewQrUrl(), BundleRow, ChannelRow, getAppPreviewState() (+22 more)
...
Cohesion: 0.10
Nodes (33): assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions, renderNotificationHelper(), runCommand(), runInstall(), runSync() (+25 more)
...
Cohesion: 0.10
Nodes (28): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts(), FRONTEND_ONBOARDING_TAB_SWITCH_STEPS (+20 more)
...
Cohesion: 0.06
Nodes (29): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey() (+21 more)
...
Cohesion: 0.11
Nodes (31): persistAppOnboarding(), APP_ONBOARDING_STEP_IDS, appendAppOnboardingStepHistory(), appendStepHistory(), applyAppOnboardingPatch(), AppOnboardingOutcome, AppOnboardingPatch, AppOnboardingSource (+23 more)
...
Cohesion: 0.09
Nodes (26): AdminStatsTestApp, ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, getBillingSnapshotCountsAt(), getCoreSnapshotCountsAt(), getGlobalStatsTrendDirect() (+18 more)
...
Cohesion: 0.24
Nodes (10): loadDistribution(), AdminABTestDistribution, AdminABTestDistributionBranch, isNonNegativeInteger(), isPercentage(), isRecord(), parseAdminABTestDistribution(), parseBranch() (+2 more)
...
Cohesion: 0.27
Nodes (9): put(), UpdateApp, AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), AppOnboardingState, AppOnboardingStepHistoryChange, parseAppOnboardingPatch(), lockOnboardingApp() (+1 more)
...
Cohesion: 0.31
Nodes (6): get(), getAll(), app, appGlobal, CreateApp, FetchStoreMetadataBody
...
## Knowledge Gaps
- **5931 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5926 more)
...
- **Why does `Database` connect `Community 89` to `Community 3`, `Community 4`, `Community 5`, `Community 14`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 29`, `Community 159`, `Community 34`, `Community 36`, `Community 38`, `Community 423`, `Community 44`, `Community 52`, `Community 183`, `Community 314`, `Community 63`, `Community 65`, `Community 77`, `Community 92`, `Community 113`, `Community 376`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 256`, `Community 133`, `Community 135`, `Community 8`, `Community 9`, `Community 10`, `Community 138`, `Community 12`, `Community 399`, `Community 145`, `Community 146`, `Community 147`, `Community 149`, `Community 279`, `Community 153`, `Community 31`, `Community 288`, `Community 32`, `Community 290`, `Community 291`, `Community 292`, `Community 421`, `Community 551`, `Community 552`, `Community 41`, `Community 553`, `Community 43`, `Community 555`, `Community 557`, `Community 170`, `Community 42`, `Community 47`, `Community 49`, `Community 178`, `Community 563`, `Community 304`, `Community 439`, `Community 189`, `Community 190`, `Community 322`, `Community 67`, `Community 194`, `Community 69`, `Community 70`, `Community 72`, `Community 202`, `Community 40`, `Community 79`, `Community 80`, `Community 208`, `Community 81`, `Community 84`, `Community 87`, `Community 219`, `Community 91`, `Community 94`, `Community 96`, `Community 481`, `Community 97`, `Community 612`, `Community 613`, `Community 122`, `Community 359`, `Community 103`, `Community 615`, `Community 109`, `Community 621`, `Community 112`, `Community 114`, `Community 118`, `Community 250`, `Community 381`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.017525327699620685 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02134918014746341 - nodes in this community are weakly interconnected._