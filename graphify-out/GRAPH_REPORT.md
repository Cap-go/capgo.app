...
## Corpus Check
- Large corpus: 2696 files · ~5,161,846 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16908 nodes · 31225 edges · 1091 communities (911 shown, 180 thin omitted)
...
## Communities (1091 total, 180 thin omitted)
...
Cohesion: 0.02
Nodes (161): observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort(), parsePositiveInt(), printFindings(), writeJson() (+153 more)
...
Cohesion: 0.03
Nodes (144): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+136 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (122): get(), getAll(), app, appGlobal, FetchStoreMetadataBody, AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement() (+114 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (131): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+123 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (122): app, bodySchema, CreateDeviceBody, OrgToGet, syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), BillingPlanBentoState, buildBillingPlanBentoTags() (+114 more)
...
Cohesion: 0.03
Nodes (116): app, bodySchema, mockContext, mockContext, mockContext, mockContext, plans, mockContext (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (119): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, addCodeStep(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+111 more)
...
Cohesion: 0.03
Nodes (83): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), categorizeCliError() (+75 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (87): OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch(), deriveSupabaseOperation(), enableSupabaseInstrumentation(), getSupabaseSource(), isSupabaseInstrumentationEnabled() (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (86): categorizeHttpStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), AnyAsyncFn, cachedContextByApiKey, CommandContext (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (83): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore (+75 more)
...
Cohesion: 0.03
Nodes (61): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+53 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (81): resolveChannelAddDuplicateOutcome(), resolveCapacitorConfigTargetPath(), throwCapacitorConfigPathError(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), resolveInitDirectoryPath(), resolveInitTargetPath() (+73 more)
...
Cohesion: 0.04
Nodes (57): useAppPage(), UseAppPageOptions, CLIActivityPayload, useRealtimeCLIFeed(), buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds() (+49 more)
...
Cohesion: 0.04
Nodes (80): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getScopedCreditSteps() (+72 more)
...
Cohesion: 0.03
Nodes (74): getActiveUploadReporter(), optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema (+66 more)
...
Cohesion: 0.05
Nodes (58): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), isCliLoginPath(), isNativeAppStoreContext(), createPlansVisitTracker() (+50 more)
...
Cohesion: 0.05
Nodes (55): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+47 more)
...
Cohesion: 0.10
Nodes (64): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+56 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (56): developmentEnvironmentOptions, OnboardingDevelopmentEnvironmentOption, abTestsConfig, onboardingFor(), onboardingWithNewChannel(), getABTestBranch(), hasNewChannelTreatment(), hasWebNativeDevelopmentEnvironmentTreatment() (+48 more)
...
Cohesion: 0.08
Nodes (52): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+44 more)
...
Cohesion: 0.04
Nodes (47): getUniqueBaseData(), createChannel(), seedOptions, versionCache, headers, id, TEST_ORG_ID, describeBackend (+39 more)
...
Cohesion: 0.05
Nodes (49): flushDeferredCommandInvocation(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), SaveKeyOptions, BrowserLoginDependencies, BrowserLoginEvent, BrowserLoginOptions (+41 more)
...
Cohesion: 0.06
Nodes (41): resolveAppSetIconPath(), assertChannelExists(), CapgoSupabaseClient, disableDownloadChannels(), setDefaultDownloadChannel(), AppListOptions, AppRow, displayApps() (+33 more)
...
Cohesion: 0.08
Nodes (37): { cloudlogErrMock, queryPosthogHogqlMock }, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts() (+29 more)
...
Cohesion: 0.07
Nodes (41): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility(), UploadCompatibilityResult, UploadCompatibilitySummary, getReleaseType(), printReleaseType() (+33 more)
...
Cohesion: 0.08
Nodes (42): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+34 more)
...
Cohesion: 0.08
Nodes (35): buildInitReplayBody(), buildTerminalImageDataUrl(), chunkToString(), CliStream, createTerminal(), createTerminalInteractionEvents(), createTerminalSnapshot(), createTerminalSnapshotNode() (+27 more)

### Community 88 - "Community 88"
Cohesion: 0.15
Nodes (7): fetchObserve(), OrganizationInfo, SDKResult, CapgoSDK, createErrorResult(), withCapacitorConfigTarget(), findSavedKey()
...
Cohesion: 0.08
Nodes (38): debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogSpec, Order, QueryStats (+30 more)
...
Cohesion: 0.07
Nodes (24): appGlobal, app, app, app, AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION (+16 more)
...
Cohesion: 0.08
Nodes (30): getCurrentCliCommand(), AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels (+22 more)
...
Cohesion: 0.09
Nodes (32): app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload, validateReplayBody() (+24 more)
...
Cohesion: 0.08
Nodes (30): getPostHogBrowserContext(), OnboardingEventProperties, PostHogBrowserClient, sanitizedUrl(), sendOnboardingEvent(), createTracker(), {
  getLocalConfigMock,
  sendEventMock,
}, trackerIdentity (+22 more)
...
Cohesion: 0.12
Nodes (28): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), handlePut() (+20 more)
...
Cohesion: 0.13
Nodes (27): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+19 more)
...
Cohesion: 0.10
Nodes (23): cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath(), markStepDone(), promoteEncryptionSummaryToEnabled(), readTmpObj(), tryResumeOnboarding(), validateResumedOnboardingAccess() (+15 more)
...
Cohesion: 0.12
Nodes (20): deliverMock, deliverQueuedPluginNotifications(), AdminChannelSurfingStats, appFilterSql(), getAdminChannelSurfing(), getAdminChannelSurfingFromAE(), getAdminChannelSurfingFromPostgres(), usesAppLogAnalytics() (+12 more)
...
Cohesion: 0.16
Nodes (18): appendBulletedSection(), appendMetadataLine(), appendPlainSection(), diagnosticsLines(), nowStamp(), omittedMarker(), OnboardingSupportBundleInput, OnboardingSupportSection (+10 more)
...
## Knowledge Gaps
- **5891 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5886 more)
...
- **Why does `Database` connect `Community 48` to `Community 3`, `Community 5`, `Community 6`, `Community 14`, `Community 15`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 409`, `Community 26`, `Community 27`, `Community 28`, `Community 32`, `Community 34`, `Community 165`, `Community 38`, `Community 46`, `Community 47`, `Community 181`, `Community 54`, `Community 311`, `Community 64`, `Community 72`, `Community 86`, `Community 91`, `Community 93`, `Community 365`, `Community 124`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 257`, `Community 130`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 140`, `Community 12`, `Community 145`, `Community 18`, `Community 147`, `Community 151`, `Community 408`, `Community 152`, `Community 153`, `Community 539`, `Community 156`, `Community 540`, `Community 541`, `Community 285`, `Community 158`, `Community 286`, `Community 543`, `Community 35`, `Community 545`, `Community 289`, `Community 290`, `Community 291`, `Community 552`, `Community 171`, `Community 43`, `Community 45`, `Community 302`, `Community 51`, `Community 52`, `Community 53`, `Community 318`, `Community 191`, `Community 63`, `Community 192`, `Community 68`, `Community 196`, `Community 203`, `Community 204`, `Community 79`, `Community 81`, `Community 82`, `Community 210`, `Community 468`, `Community 89`, `Community 602`, `Community 603`, `Community 92`, `Community 605`, `Community 222`, `Community 95`, `Community 97`, `Community 98`, `Community 99`, `Community 101`, `Community 102`, `Community 103`, `Community 107`, `Community 112`, `Community 114`, `Community 370`, `Community 119`, `Community 123`, `Community 25`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5894 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021115679407136694 - nodes in this community are weakly interconnected._