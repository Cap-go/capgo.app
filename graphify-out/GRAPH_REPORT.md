# Graph Report - capgo.app  (2026-08-03)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2029 files · ~4,393,802 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13530 nodes · 24752 edges · 917 communities (774 shown, 143 thin omitted)
...
## Communities (917 total, 143 thin omitted)
...
Cohesion: 0.02
Nodes (119): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+111 more)
...
Cohesion: 0.04
Nodes (94): app, bodySchema, baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction() (+86 more)
...
Cohesion: 0.03
Nodes (97): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, setConfigWriteTarget(), applyInitAutoTestChange(), buildCodeDiffLines(), BuildProjectStepOutcome, CancelablePromptValue (+89 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (79): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), Channel, checkVersionNotUsedInChannel(), CheckVersionOptions (+71 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (83): mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata() (+75 more)
...
Cohesion: 0.04
Nodes (77): bodySchema, get(), memberSchema, auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema (+69 more)
...
Cohesion: 0.05
Nodes (65): findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP (+57 more)
...
Cohesion: 0.05
Nodes (62): checkCompatibility(), CompatibilityResult, UploadCompatibilityResult, UploadCompatibilitySummary, handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), assertIntegerInRange(), assertOptionalConfidence() (+54 more)
...
Cohesion: 0.05
Nodes (62): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+54 more)
...
Cohesion: 0.05
Nodes (54): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+46 more)
...
Cohesion: 0.04
Nodes (50): AppBuildOnboardingMetricRow, AppBuildOnboardingMetrics, BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, BuildShardStats, BuildStats, calculateAveragePastDueDays() (+42 more)
...
Cohesion: 0.06
Nodes (47): DataDevice, devicesBodySchema, orderItemSchema, platformSchema, app, createUtcDate(), DataStats, defaultInsightActions (+39 more)
...
Cohesion: 0.06
Nodes (52): ensureNativePlatformForBuild(), formatInheritedCommandFailure(), getInitRecoveryCommands(), getNativePlatformAvailability(), getSelectablePlatformOptions(), handleBrokenIosSync(), handleMissingPlatformSelection(), logBrokenIosSync() (+44 more)
...
Cohesion: 0.05
Nodes (41): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled, ComponentCustomProperties, GlobalComponents (+33 more)
...
Cohesion: 0.07
Nodes (32): adminStore, cancelDebouncedSearchReload(), currentPage, displayStore, formatNumber(), formatPercent(), getOrganizationAttentionLabel(), isLoadingOrganizations (+24 more)
...
Cohesion: 0.08
Nodes (25): appIdParamSchema, bindingIdParamSchema, createGroupBodyHook, createGroupBodySchema, createRoleBindingBodyHook, createRoleBindingBodySchema, invalidAppIdHook, invalidBindingIdHook (+17 more)
...
Cohesion: 0.10
Nodes (28): askForAppName(), askForWebDir(), cancelBeforeAuthenticatedOnboarding(), ensureGitRepoCleanBeforeInit(), ensureWorkspaceReadyForInit(), exitBeforeAuthenticatedOnboarding(), findNearestNamedFile(), findNearestPackageJson() (+20 more)
...
Cohesion: 0.09
Nodes (25): API_CONTENT_SECURITY_POLICY, AuthInfo, BRES, DEFAULT_CORS_ALLOWED_ORIGINS, getAllowedCorsOrigin(), getConfiguredCorsAllowedOrigins(), honoFactory, isLocalHttpOrigin() (+17 more)
...
Cohesion: 0.11
Nodes (22): ensureUpdaterReadyBeforeSync(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallCommand(), getUpdaterVersionToInstall(), handleBuildAndSyncFailure(), logUpdaterInstallStateDetails(), runUpdaterInstallCommand() (+14 more)
...
Cohesion: 0.15
Nodes (11): ctxWith(), ctxWith(), baseCtx, certDerFromP12(), certSha1(), MadeChainP12, MadeP12, makeChainP12() (+3 more)
...
Cohesion: 0.13
Nodes (17): canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup() (+9 more)
...
Cohesion: 0.22
Nodes (18): ensureFunctionsEnvFile(), ensureSymlink(), ensureWorktreeSupabaseDir(), getLocalSupabaseCli(), getStatusJson(), getSupabaseCmd(), hasSupabaseCli(), isTransientDockerPortBindFailure() (+10 more)
...
Cohesion: 0.20
Nodes (16): ChannelInsertColumn, channelInsertColumns, ChannelSet, createAndPromoteChannelInTransaction(), CreatedChannel, definedOrAlias(), DrizzleClient, findVersion() (+8 more)
...
Cohesion: 0.23
Nodes (13): assertCanPromoteChannelInTransaction(), ChannelRow, DrizzleClient, fetchTargetChannel(), fetchVersionName(), getEffectiveApikey(), PgQueryClient, setChannel() (+5 more)
...
Cohesion: 0.19
Nodes (6): withManifest(), ctxFor(), plist(), CAP8_PKG, projectWith(), makeProject()
...
Cohesion: 0.21
Nodes (8): aCtx(), aCtx(), androidCtx(), APPLE_KEY_CONTENT, APPLE_TRIPLET, iosCtx(), PLAY_JSON_B64, makeCtx()
...
Cohesion: 0.46
Nodes (7): dismissedKey(), dismissSupportUsernamesPromptForever(), hasSupportUsernames(), isSupportUsernamesPromptDismissedForever(), lastShownKey(), markSupportUsernamesPromptShown(), shouldShowSupportUsernamesPrompt()
...
## Knowledge Gaps
- **4562 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4557 more)
...
- **Why does `Database` connect `Community 105` to `Community 2`, `Community 131`, `Community 6`, `Community 9`, `Community 11`, `Community 525`, `Community 14`, `Community 271`, `Community 18`, `Community 20`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 34`, `Community 35`, `Community 166`, `Community 40`, `Community 170`, `Community 183`, `Community 56`, `Community 448`, `Community 67`, `Community 80`, `Community 482`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 7` to `Community 128`, `Community 513`, `Community 514`, `Community 3`, `Community 516`, `Community 258`, `Community 130`, `Community 263`, `Community 8`, `Community 9`, `Community 522`, `Community 395`, `Community 12`, `Community 141`, `Community 13`, `Community 15`, `Community 273`, `Community 275`, `Community 150`, `Community 23`, `Community 151`, `Community 28`, `Community 33`, `Community 161`, `Community 162`, `Community 38`, `Community 39`, `Community 169`, `Community 44`, `Community 173`, `Community 50`, `Community 178`, `Community 52`, `Community 54`, `Community 55`, `Community 315`, `Community 66`, `Community 73`, `Community 74`, `Community 459`, `Community 460`, `Community 461`, `Community 463`, `Community 464`, `Community 84`, `Community 85`, `Community 470`, `Community 216`, `Community 90`, `Community 92`, `Community 348`, `Community 227`, `Community 232`, `Community 106`, `Community 234`, `Community 111`, `Community 241`, `Community 242`, `Community 115`, `Community 244`, `Community 116`, `Community 114`, `Community 246`, `Community 117`, `Community 121`, `Community 124`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4565 weakly-connected nodes found - possible documentation gaps or missing edges._
