# Graph Report - capgo.app  (2026-09-10)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2673 files · ~5,128,190 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16809 nodes · 31091 edges · 1098 communities (922 shown, 176 thin omitted)
...
## Communities (1098 total, 176 thin omitted)
...
Cohesion: 0.02
Nodes (157): Channel, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+149 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (179): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+171 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (131): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+123 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (114): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+106 more)
...
Cohesion: 0.03
Nodes (127): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+119 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (91): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (113): ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), addCodeStep(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+105 more)
...
Cohesion: 0.02
Nodes (73): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+65 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (90): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+82 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (64): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert (+56 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (63): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+55 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (74): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (78): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+70 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (53): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+45 more)
...
Cohesion: 0.04
Nodes (72): cleanupStepsDone(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), tryResumeOnboarding(), initOnboardingSteps, ConfirmOptions, intro(), log (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (71): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+63 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (65): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (69): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+61 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (55): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+47 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (54): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId (+46 more)
...
Cohesion: 0.05
Nodes (58): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, sortCreditPricingSteps(), getErrorMessage(), logAsUser() (+50 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (63): AuthGuardTestContext, contextStorage, createTestContext(), getGuard(), MockFetchResponse, withTestContext(), getRedirect(), APP_ONBOARDING_FEATURES (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (43): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+35 more)
...
Cohesion: 0.07
Nodes (58): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, AlertsReporter (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (49): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+41 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (47): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+39 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (50): configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget() (+42 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (53): getUniqueBaseData(), id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, headers (+45 more)
...
Cohesion: 0.05
Nodes (51): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+43 more)
...
Cohesion: 0.05
Nodes (45): IncompatibleBundleError, Release, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS, sleep(), throwTwoFactorComplianceRpcError() (+37 more)

### Community 43 - "Community 43"
Cohesion: 0.09
Nodes (22): addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers() (+14 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (61): syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh(), checkPlanStatusOnly() (+53 more)

### Community 45 - "Community 45"
Cohesion: 0.10
Nodes (62): findAppInOrganization(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForExistingDirectoryPath() (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (54): aiBumpLevel, AiBumpLevelBody, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), app (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (49): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (49): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), isNativeAppStoreContext() (+41 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (49): getInvocationSource(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, createAppViaApi() (+41 more)
...
Cohesion: 0.09
Nodes (49): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+41 more)
...
Cohesion: 0.07
Nodes (43): PKG_V6, PKG_V7, PKG_V7_DUP, ChannelRow, COMPATIBILITY_PLATFORMS, CompatibilityAutoResolve, CompatibilityBundle, CompatibilityEventInsert (+35 more)
...
Cohesion: 0.05
Nodes (49): app, DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema (+41 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (51): nativeObserveActions, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), respondSummaryOrVersions() (+43 more)
...
Cohesion: 0.07
Nodes (43): useGitHubProfileDialog(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod() (+35 more)
...
Cohesion: 0.07
Nodes (44): context, startMs, versionsIntersect(), buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), emptyPlansAnalyticsResponse(), exactTrackingStartedAt() (+36 more)
...
Cohesion: 0.04
Nodes (49): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+41 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (38): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, Awaitable, ChannelInfo, ChannelsListResponse (+30 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (45): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+37 more)
...
Cohesion: 0.07
Nodes (45): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+37 more)
...
Cohesion: 0.06
Nodes (42): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+34 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (37): canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema, appIdParamSchema (+29 more)
...
Cohesion: 0.07
Nodes (40): app, bodySchema, CreateDeviceBody, app, app, CliReplayBody, readOptionalString(), readProperties() (+32 more)
...
Cohesion: 0.09
Nodes (40): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+32 more)
...
Cohesion: 0.10
Nodes (44): checkAppIdsExist(), promptDoctorUpdateChoice(), askForAppId(), askForReplacementAppId(), cancelPackageJsonSelection(), ensureNativePlatformForBuild(), exitAfterFinishingReplay(), exitCanceledInitOnboarding() (+36 more)
...
Cohesion: 0.07
Nodes (31): readInitInternalLogLines(), runInitContactSupport(), ClipboardCandidate, copyToClipboard(), revealInFinder(), confirmMessage(), contactSupport(), ContactSupportDeps (+23 more)
...
Cohesion: 0.09
Nodes (34): AppListOptions, handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, AppRow (+26 more)
...
Cohesion: 0.08
Nodes (35): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+27 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (35): appVersion, manifest, getAppOwnerPostgresMock, requestInfosPostgresMock, runUpdate(), sendNotifToOrgMembersCachedMock, sendStatsAndDeviceMock, AutoUpdateBlockReason (+27 more)
...
Cohesion: 0.10
Nodes (33): isChannelSelfRequestBody(), isDevicePlatform(), isOptionalString(), isOptionalStringMaxLength(), isOptionalString(), isOptionalStringMaxLength(), isStatsRequestBody(), isValidStatsMetadata() (+25 more)
...
Cohesion: 0.10
Nodes (30): DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), PackageInstallState, PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson() (+22 more)
...
Cohesion: 0.08
Nodes (30): AppInfos, AppStats, BaseHeaders, Customer, DeviceRes, DeviceWithoutCreatedAt, NativeVersionUsage, Order (+22 more)

### Community 124 - "Community 124"
Cohesion: 0.11
Nodes (24): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts(), FRONTEND_ONBOARDING_TAB_SWITCH_STEPS (+16 more)

### Community 125 - "Community 125"
Cohesion: 0.09
Nodes (26): AI_STEPS, dayKey(), FailedErrorRow, fingerprint(), FIRST_STEPS, getAdminBuilderAnalytics(), Journey, loadAiChoiceCount() (+18 more)
...
Cohesion: 0.07
Nodes (26): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey() (+18 more)
...
Cohesion: 0.11
Nodes (26): INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, APP_ONBOARDING_STEP_IDS, AppOnboardingOutcome, AppOnboardingPatch, AppOnboardingSource, AppOnboardingState (+18 more)
...
Cohesion: 0.11
Nodes (9): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), visualDiffRoutes, visualDiffViewport, test, dismissSupportPrompt() (+1 more)
...
Cohesion: 0.11
Nodes (23): buildFrontendOnboardingDailySetupCliAgentUsage(), buildFrontendOnboardingDailySetupCliAnchors(), buildFrontendOnboardingDailySetupCliOutcomes(), classifyFrontendOnboardingDailySetupCliAgentSignals(), classifyFrontendOnboardingDailySetupCliOutcome(), createFrontendOnboardingDailySetupCliAgentSignals(), createFrontendOnboardingDailySetupCliOutcomeCounts(), createFrontendOnboardingDailySetupCliSignals() (+15 more)
...
Cohesion: 0.10
Nodes (19): analyticsOptOutCommands, applyCommandAnalyticsOptOut(), applyRawCommandAnalyticsOptOut(), baseGate, body, buildEnvTarget, buildOnboardingBody, envTarget (+11 more)
...
Cohesion: 0.18
Nodes (18): apikeyHasOrgRight(), bodySchema, deleteWebhook(), getDeliveries(), bodySchema, get(), apiKeyHasAppScopedBinding(), assertOrgWebhookScope() (+10 more)
...
Cohesion: 0.14
Nodes (20): buildTerminalImageDataUrl(), CliStream, createTerminalSnapshot(), createTerminalSnapshotNode(), defaultReplayTransport(), escapeHtml(), findSerializedNodeId(), findSerializedNodeIdByAttribute() (+12 more)

### Community 217 - "Community 217"
Cohesion: 0.16
Nodes (19): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, redactSecretContext() (+11 more)
...
Cohesion: 0.20
Nodes (14): get(), getAll(), app, appGlobal, CreateApp, post(), FetchStoreMetadataBody, addAppCreatorToOnboarding() (+6 more)
...
Cohesion: 0.16
Nodes (11): appGlobal, app, app, app, app, registerPluginStatsSbFallbacksForDeno(), appGlobal, appGlobal (+3 more)
...
Cohesion: 0.16
Nodes (13): creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel(), formatCreditTierAmount(), getFirstTierCreditUnitPricing() (+5 more)

### Community 259 - "Community 259"
Cohesion: 0.19
Nodes (16): decodePreviewAppId(), parseChannelId(), ParsedBundlePreviewSubdomain, ParsedChannelPreviewSubdomain, ParsedPreviewSubdomain, parseEncodedPreviewSubdomain(), parsePreviewSubdomain(), parseVersionId() (+8 more)
...
Cohesion: 0.17
Nodes (14): chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), DISCORD_IGNORED_ERROR_CODES, FailureDetail, getQueueAckChunkSize(), mapWithConcurrency() (+6 more)

### Community 281 - "Community 281"
Cohesion: 0.29
Nodes (16): assertAllowedImagePath(), createPlatformAdminSignedImageUrl(), createSignedImageUrl(), decodePathnameSegments(), extractStorageImageKey(), getStorageAllowedOrigins(), hasUnsafeImagePathSegments(), isAllowedImagePath() (+8 more)
...
Cohesion: 0.21
Nodes (12): { cloudlogErrMock, queryPosthogHogqlMock }, hogqlOnboardingVersionIn(), assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), FrontendOnboardingDailySetupCliEvent (+4 more)
...
Cohesion: 0.20
Nodes (7): resolveChannelAddDuplicateOutcome(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), duplicateError, functionsHttpError, supabase
...
Cohesion: 0.25
Nodes (13): cleanStoredImageMetadata(), concatUint8Arrays(), isSameBytes(), JPEG_SIGNATURE, mimeFromFileBytes(), mimeFromFilePath(), PNG_SIGNATURE, readUint32() (+5 more)
...
Cohesion: 0.21
Nodes (8): detectProjectFrameworkFromConfig(), detectProjectFrameworkFromDependencies(), detectProjectTypeInDir(), findMainFileForProjectType(), findProjectType(), getProjectTypeWithLanguage(), logFoundProject(), originalCwd
...
Cohesion: 0.25
Nodes (10): numberLikeSchema, allowLocalWebhookUrls(), getDeliveryById(), getWebhookById(), getWebhookPublicUrlValidationError(), getWebhookUrlValidationError(), queueWebhookDelivery(), getDeliveriesSchema (+2 more)
...
Cohesion: 0.22
Nodes (10): archive_queue_messages(), getQueueBatchSize(), getQueueHttpConcurrency(), getQueueVisibilityTimeout(), isVersionQueueFunction(), mass_edit_queue_messages_cf_ids(), persistQueueCfIds(), processQueue() (+2 more)
...
Cohesion: 0.39
Nodes (8): runAutoEffect(), clearSession(), getSession(), LiveUpdateSessionState, mergeDefined(), mergeSession(), registry, sessionKey()
...
Cohesion: 0.46
Nodes (8): decideAdvance(), decideAtStep(), decideStart(), explainLiveUpdateOnboarding(), mergeProgress(), nextAction(), stateForStepNumber(), stepNumberFromProgress()
...
Cohesion: 0.25
Nodes (8): dispatchQueueMessage(), getActionableQueueFailures(), getManifestRecordFromQueueBody(), getQueueHttpTimeoutMs(), getQueueMaxReads(), http_post_helper(), reportQueueFailures(), truncateDiscordField()
...
Cohesion: 0.40
Nodes (5): resolveCapgoReplayUrl(), resolveConfiguredCapgoReplayUrl(), resolveSupabaseReplayUrl(), shouldStartInitReplay(), startInitReplay()
...
Cohesion: 0.50
Nodes (3): explainForState(), EXPLANATIONS, FALLBACK
...
## Knowledge Gaps
- **5857 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5852 more)
...
- **Why does `Database` connect `Community 6` to `Community 258`, `Community 3`, `Community 5`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 27`, `Community 539`, `Community 29`, `Community 669`, `Community 36`, `Community 422`, `Community 167`, `Community 47`, `Community 49`, `Community 52`, `Community 564`, `Community 180`, `Community 56`, `Community 60`, `Community 66`, `Community 325`, `Community 714`, `Community 75`, `Community 85`, `Community 92`, `Community 375`, `Community 122`, `Community 381`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 129`, `Community 257`, `Community 8`, `Community 9`, `Community 137`, `Community 16`, `Community 17`, `Community 146`, `Community 150`, `Community 152`, `Community 280`, `Community 154`, `Community 26`, `Community 157`, `Community 159`, `Community 31`, `Community 289`, `Community 290`, `Community 421`, `Community 293`, `Community 294`, `Community 168`, `Community 295`, `Community 41`, `Community 555`, `Community 556`, `Community 557`, `Community 46`, `Community 559`, `Community 40`, `Community 177`, `Community 561`, `Community 44`, `Community 53`, `Community 54`, `Community 568`, `Community 188`, `Community 67`, `Community 68`, `Community 70`, `Community 72`, `Community 200`, `Community 329`, `Community 77`, `Community 334`, `Community 207`, `Community 80`, `Community 82`, `Community 210`, `Community 84`, `Community 83`, `Community 221`, `Community 93`, `Community 96`, `Community 97`, `Community 483`, `Community 100`, `Community 101`, `Community 103`, `Community 104`, `Community 105`, `Community 618`, `Community 619`, `Community 621`, `Community 109`, `Community 113`, `Community 627`, `Community 118`, `Community 121`, `Community 123`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02131908462867012 - nodes in this community are weakly interconnected._