# Graph Report - capgo.app  (2026-08-27)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2554 files · ~5,006,587 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16259 nodes · 29879 edges · 1047 communities (879 shown, 168 thin omitted)
...
1. `scripts` - 198 edges
2. `supabaseAdmin()` - 174 edges
3. `scripts` - 171 edges
4. `getSupabaseClient()` - 143 edges
5. `Database` - 126 edges
6. `formatError()` - 98 edges
7. `executeSQL()` - 81 edges
...
## Communities (1047 total, 168 thin omitted)
...
Cohesion: 0.02
Nodes (142): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+134 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (171): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+163 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (133): app, bodySchema, CreateDeviceBody, app, bodySchema, syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), didCancel() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (110): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions, Channel (+102 more)
...
Cohesion: 0.03
Nodes (102): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource() (+94 more)
...
Cohesion: 0.04
Nodes (105): AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi(), ManifestDiff, ManifestEntry, requestAiBumpLevel(), resolveAutoBumpLevelFromAi() (+97 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (107): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+99 more)
...
Cohesion: 0.03
Nodes (100): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+92 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (79): get(), getAll(), app, appGlobal, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle() (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (84): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+76 more)
...
Cohesion: 0.03
Nodes (77): app, canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId() (+69 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (56): fixtureId, orgId, orgId, scopeId, pgPool, fixtureId, orgId, QueryFn (+48 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (79): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission() (+71 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (73): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+65 more)
...
Cohesion: 0.04
Nodes (73): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+65 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (64): getActiveUploadReporter(), isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions (+56 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (68): streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+60 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (47): TEST_ORG_ID, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, AutoTopUpSettings, originalSettings (+39 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (80): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+72 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (61): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+53 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (61): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), getPostHogBrowserContext() (+53 more)
...
Cohesion: 0.06
Nodes (64): reportInitOnboarding(), reportInitOnboardingStep(), InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps, ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP (+56 more)
...
Cohesion: 0.04
Nodes (54): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+46 more)
...
Cohesion: 0.06
Nodes (56): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, setSetting(), setSettingInternal() (+48 more)
...
Cohesion: 0.06
Nodes (56): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, sortCreditPricingSteps(), getErrorMessage(), logAsUser(), AppUsageByApp (+48 more)
...
Cohesion: 0.04
Nodes (42): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), Awaitable, ChannelInfo, ChannelsListResponse (+34 more)
...
Cohesion: 0.07
Nodes (44): useGitHubProfileDialog(), createAiApiKey(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost() (+36 more)
...
Cohesion: 0.06
Nodes (35): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString() (+27 more)
...
Cohesion: 0.08
Nodes (46): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint(), formatSpawnOutput() (+38 more)
...
Cohesion: 0.11
Nodes (38): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal() (+30 more)
...
Cohesion: 0.07
Nodes (36): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult (+28 more)
...
Cohesion: 0.09
Nodes (33): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+25 more)
...
Cohesion: 0.10
Nodes (37): aesKeyFromSecret(), buildNotificationBadgeStateQuery(), buildNotificationRegistryLookupQuery(), decryptNotificationToken(), deriveNativeNotificationIdentity(), encryptNotificationToken(), fromBase64Url(), getAllNotificationBuckets() (+29 more)

### Community 101 - "Community 101"
Cohesion: 0.10
Nodes (37): buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution, ensureCustomerMetadata() (+29 more)
...
Cohesion: 0.08
Nodes (32): aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample (+24 more)
...
Cohesion: 0.10
Nodes (29): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+21 more)
...
Cohesion: 0.10
Nodes (26): normalizeTargetLimit(), resolveTargetPlan(), analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), createNotificationDeliveryEventProof() (+18 more)
...
Cohesion: 0.10
Nodes (25): AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders(), getAppListPath() (+17 more)
...
Cohesion: 0.12
Nodes (25): DeliveryMessage, base64Encode(), bytesToArrayBuffer(), decodeSerializedWebhookSecret(), deliverWebhook(), disableWebhook(), generateStandardWebhookSignature(), getWebhookPayloadEvent() (+17 more)
...
Cohesion: 0.13
Nodes (25): applyValidatedSubkeyContext(), assertSubkeyHasPlaintextSecret(), checkKeyByIdPg(), checkKeyPg(), FindApikeyByValueResult, foundAPIKey(), foundJWT(), getSubkeyId() (+17 more)
...
Cohesion: 0.14
Nodes (20): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+12 more)
...
Cohesion: 0.13
Nodes (18): AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason(), formatStoredChurnReason() (+10 more)
...
Cohesion: 0.17
Nodes (17): isWebhookEventType(), parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, deleteWebhook(), getDeliveries(), checkWebhookPermissionV2() (+9 more)
...
Cohesion: 0.14
Nodes (11): AppScopedMembershipFixture, CreateFixtureOptions, MembershipCleanupFixture, RankFixture, SoleSuperAdminFixture, ANON_ALLOWED_PROCS, AUTHENTICATED_ONLY_PROCS, INVOKER_PROCS (+3 more)
...
Cohesion: 0.30
Nodes (13): assertAllowedImagePath(), createSignedImageUrl(), decodePathnameSegments(), extractStorageImageKey(), getStorageAllowedOrigins(), hasUnsafeImagePathSegments(), isAllowedImagePath(), isStorageImagePathname() (+5 more)
...
Cohesion: 0.26
Nodes (11): AuditLogData, buildWebhookDeliveryPayload(), buildWebhookPayload(), createDeliveryRecord(), createTestPayload(), findWebhooksForEvent(), getWebhookLogUrlMetadata(), normalizeWebhookDeliveryVersion() (+3 more)
...
Cohesion: 0.31
Nodes (10): ensureSplashScreenForDirectUpdate(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getPackageInstallCommand(), getUpdaterInstallCommand(), logPackageInstallStateDetails(), runPackageInstallCommand() (+2 more)
...
## Knowledge Gaps
- **5738 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5733 more)
...
- **Why does `Database` connect `Community 6` to `Community 513`, `Community 3`, `Community 8`, `Community 10`, `Community 140`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 24`, `Community 537`, `Community 26`, `Community 28`, `Community 29`, `Community 36`, `Community 167`, `Community 42`, `Community 44`, `Community 45`, `Community 177`, `Community 51`, `Community 54`, `Community 318`, `Community 66`, `Community 202`, `Community 78`, `Community 207`, `Community 83`, `Community 90`, `Community 91`, `Community 364`, `Community 255`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 129`, `Community 5`, `Community 137`, `Community 9`, `Community 14`, `Community 15`, `Community 16`, `Community 529`, `Community 146`, `Community 530`, `Community 531`, `Community 147`, `Community 533`, `Community 534`, `Community 407`, `Community 281`, `Community 282`, `Community 274`, `Community 285`, `Community 542`, `Community 159`, `Community 286`, `Community 34`, `Community 35`, `Community 162`, `Community 37`, `Community 166`, `Community 38`, `Community 173`, `Community 46`, `Community 47`, `Community 304`, `Community 50`, `Community 179`, `Community 52`, `Community 182`, `Community 56`, `Community 186`, `Community 187`, `Community 64`, `Community 321`, `Community 324`, `Community 197`, `Community 198`, `Community 71`, `Community 459`, `Community 588`, `Community 589`, `Community 206`, `Community 591`, `Community 143`, `Community 84`, `Community 597`, `Community 86`, `Community 144`, `Community 93`, `Community 95`, `Community 96`, `Community 225`, `Community 101`, `Community 104`, `Community 106`, `Community 109`, `Community 367`, `Community 114`, `Community 116`, `Community 120`, `Community 254`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5741 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023636363636363636 - nodes in this community are weakly interconnected._