# Graph Report - capgo.app  (2026-09-07)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2616 files · ~5,091,327 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16597 nodes · 30703 edges · 1055 communities (883 shown, 172 thin omitted)
...
## Communities (1055 total, 172 thin omitted)
...
Cohesion: 0.02
Nodes (153): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials (+145 more)
...
Cohesion: 0.02
Nodes (144): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, resolveCapacitorConfigTargetPath(), throwCapacitorConfigPathError(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+136 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (135): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+127 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (136): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+128 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (122): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), CapgoHttpOptions, Channel (+114 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (100): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+92 more)
...
Cohesion: 0.03
Nodes (115): isVersionDeleted(), app, app, DataSetManifest, registerPluginStatsSbFallbacksForDeno(), getRegistrationMetadata(), DeletedVersionAction, deleteIt() (+107 more)
...
Cohesion: 0.04
Nodes (94): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+86 more)
...
Cohesion: 0.03
Nodes (92): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+84 more)
...
Cohesion: 0.04
Nodes (77): useGitHubProfileDialog(), setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+69 more)
...
Cohesion: 0.05
Nodes (71): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, checkAlerts() (+63 more)
...
Cohesion: 0.05
Nodes (63): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+55 more)

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (79): findAppInOrganization(), listPendingOnboardingApps(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep() (+71 more)
...
Cohesion: 0.07
Nodes (59): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, Platform (+51 more)
...
Cohesion: 0.04
Nodes (51): getUniqueBaseData(), id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, headers (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (34): LogData, STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device (+26 more)
...
Cohesion: 0.05
Nodes (37): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+29 more)
...
Cohesion: 0.05
Nodes (40): isTelemetryDisabled(), IncompatibleBundleError, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS, sleep(), throwTwoFactorComplianceRpcError() (+32 more)
...
Cohesion: 0.07
Nodes (55): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent (+47 more)
...
Cohesion: 0.06
Nodes (50): AppChartRefreshState, ChartRefreshRequestResult, isChartDataStale(), isChartRefreshInProgress(), isOrgCacheReadyForRefresh(), OrgChartRefreshState, parseDashboardRefreshTimestamp(), shouldAutoRequestChartRefresh() (+42 more)
...
Cohesion: 0.08
Nodes (47): app, bodySchema, syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), createPortal() (+39 more)
...
Cohesion: 0.07
Nodes (30): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString() (+22 more)
...
Cohesion: 0.06
Nodes (36): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, Awaitable, ChannelInfo, ChannelsListResponse (+28 more)
...
Cohesion: 0.10
Nodes (35): cancelCommand(), sendCliEvent(), promptDoctorUpdateChoice(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions() (+27 more)
...
Cohesion: 0.15
Nodes (20): JsonPrimitive, posthogLoader(), PostHogProperties, pushEvent(), reset(), setUser(), COMPONENT_RESOLUTION_ERROR_PATTERNS, isComponentResolutionErrorMessage() (+12 more)
...
Cohesion: 0.14
Nodes (19): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+11 more)
...
Cohesion: 0.13
Nodes (12): app, app, AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, post() (+4 more)
...
## Knowledge Gaps
- **5800 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5795 more)
...
- **Why does `Database` connect `Community 45` to `Community 3`, `Community 6`, `Community 8`, `Community 12`, `Community 13`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 24`, `Community 25`, `Community 29`, `Community 159`, `Community 33`, `Community 40`, `Community 42`, `Community 44`, `Community 47`, `Community 58`, `Community 317`, `Community 65`, `Community 71`, `Community 206`, `Community 108`, `Community 119`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 256`, `Community 129`, `Community 132`, `Community 7`, `Community 136`, `Community 9`, `Community 11`, `Community 14`, `Community 145`, `Community 19`, `Community 148`, `Community 149`, `Community 534`, `Community 535`, `Community 536`, `Community 152`, `Community 538`, `Community 27`, `Community 283`, `Community 284`, `Community 539`, `Community 406`, `Community 287`, `Community 288`, `Community 546`, `Community 36`, `Community 37`, `Community 165`, `Community 46`, `Community 302`, `Community 48`, `Community 52`, `Community 53`, `Community 54`, `Community 184`, `Community 185`, `Community 186`, `Community 56`, `Community 321`, `Community 68`, `Community 325`, `Community 198`, `Community 199`, `Community 75`, `Community 205`, `Community 78`, `Community 590`, `Community 464`, `Community 591`, `Community 593`, `Community 77`, `Community 599`, `Community 216`, `Community 88`, `Community 89`, `Community 92`, `Community 97`, `Community 98`, `Community 101`, `Community 275`, `Community 104`, `Community 236`, `Community 110`, `Community 114`, `Community 150`, `Community 118`, `Community 121`, `Community 123`, `Community 127`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 11` to `Community 129`, `Community 9`, `Community 139`, `Community 14`, `Community 17`, `Community 145`, `Community 19`, `Community 275`, `Community 27`, `Community 162`, `Community 291`, `Community 36`, `Community 422`, `Community 424`, `Community 48`, `Community 562`, `Community 52`, `Community 54`, `Community 60`, `Community 323`, `Community 68`, `Community 325`, `Community 75`, `Community 78`, `Community 463`, `Community 211`, `Community 213`, `Community 87`, `Community 89`, `Community 92`, `Community 95`, `Community 223`, `Community 101`, `Community 102`, `Community 104`, `Community 105`, `Community 110`, `Community 241`, `Community 115`, `Community 120`, `Community 121`, `Community 123`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5803 weakly-connected nodes found - possible documentation gaps or missing edges._
