# Graph Report - capgo.app  (2026-08-20)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2430 files · ~4,894,282 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15641 nodes · 28465 edges · 1026 communities (864 shown, 162 thin omitted)
...
## Communities (1026 total, 162 thin omitted)
...
Cohesion: 0.04
Nodes (123): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+115 more)
...
Cohesion: 0.03
Nodes (95): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+87 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (120): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), setConfigWriteTarget(), applyInitAutoTestChange(), askForAppName() (+112 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (110): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, shouldBlockIncompatibleUpload(), emitJsonError() (+102 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (76): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, id (+68 more)
...
Cohesion: 0.04
Nodes (87): app, bodySchema, CreateDeviceBody, app, bodySchema, didCancel(), BillingPlanBentoState, buildBillingPlanBentoTags() (+79 more)
...
Cohesion: 0.05
Nodes (59): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), createPlansVisitTracker() (+51 more)
...
Cohesion: 0.04
Nodes (42): pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId, appRbacId (+34 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (49): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig, ChannelChecksum, checkCompatibilityNativePackages() (+41 more)
...
Cohesion: 0.05
Nodes (61): bodySchema, get(), memberSchema, auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema (+53 more)
...
Cohesion: 0.10
Nodes (64): findAppInOrganization(), getInfoInternal(), getInstalledDependencies(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep() (+56 more)
...
Cohesion: 0.06
Nodes (47): trackMcpServerStarted(), loginSuccessMessage(), logoutMessage(), whoamiMessage(), buildServerInstructions(), buildDeps(), registerLiveUpdateTools(), startMcpServerInternal() (+39 more)
...
Cohesion: 0.07
Nodes (51): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, invoiceUpcoming(), buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent (+43 more)
...
Cohesion: 0.06
Nodes (49): assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody, CAMPAIGN_KINDS, CAMPAIGN_STATUSES (+41 more)
...
Cohesion: 0.08
Nodes (41): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), checkAppExists(), completePendingOnboardingApp(), hostOptionsFromSupabase(), reportAppOnboardingProgress() (+33 more)
...
Cohesion: 0.10
Nodes (36): createRSA(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite() (+28 more)
...
Cohesion: 0.09
Nodes (41): handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution (+33 more)
...
Cohesion: 0.07
Nodes (35): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers, id, orgId (+27 more)
...
Cohesion: 0.07
Nodes (33): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility() (+25 more)
...
Cohesion: 0.08
Nodes (26): { cloudlogErrMock, queryPosthogHogqlMock }, AttemptOverrides, START_MS, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), buildFrontendOnboardingWelcomeHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts() (+18 more)
...
Cohesion: 0.10
Nodes (27): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), app (+19 more)
...
Cohesion: 0.11
Nodes (25): decryptChecksum(), decryptChecksumV3(), decryptSource(), AlertsReporter, VersionCheckResult, getLatestDependencies(), checkIndexPosition(), searchInDirectory() (+17 more)
...
Cohesion: 0.11
Nodes (30): areGlobalStatsNumbersDifferent(), dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows(), filterCandidateGlobalStatsShards() (+22 more)
...
Cohesion: 0.12
Nodes (18): mockContext, mockContext, plans, mockContext, stripeEventTestUtils, honoFactory, MiddlewareKeyVariablesStripe, middlewareStripeWebhook() (+10 more)
...
Cohesion: 0.16
Nodes (26): formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets() (+18 more)
...
Cohesion: 0.12
Nodes (20): addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getNuxtUpdaterPluginContent(), injectInitCode(), detectProjectFrameworkFromConfig() (+12 more)
...
Cohesion: 0.14
Nodes (23): countDemoSeededApps(), countNotificationEvent(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getNativeNotificationGlobalStats(), getRegistersToday() (+15 more)
...
Cohesion: 0.15
Nodes (19): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, buildNativeObservePluginTotalDevicesCFQuery() (+11 more)
...
Cohesion: 0.15
Nodes (20): errorHints, extractExtra(), getConfiguredUpdaterVersion(), getProbeDefaultChannel(), getUpdateUrl(), NativeVersionInfo, parseAndroidNativeVersion(), ParsedUpdateResponse (+12 more)
...
Cohesion: 0.11
Nodes (20): aggregateDailyBuildStats(), buildRecentGlobalStatsRepairDateIds(), calculateChurnRevenue(), calculateNrr(), getBuildStats(), getCompletedAppBuildOnboardingWindow(), getCompletedDayWindow(), getCurrentDayWindow() (+12 more)
...
Cohesion: 0.14
Nodes (13): claimGlobalStatsNotificationDelivery(), getGlobalStatsNotificationStepAction(), getNumber(), hasCompletedGlobalStatsNotifications(), logsnagInsightsTestUtils, markGlobalStatsShardComplete(), readGlobalStatsSnapshot(), releaseGlobalStatsNotificationDeliveryClaim() (+5 more)
...
## Knowledge Gaps
- **5534 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5529 more)
...
- **Why does `Database` connect `Community 65` to `Community 3`, `Community 5`, `Community 265`, `Community 9`, `Community 11`, `Community 12`, `Community 10`, `Community 14`, `Community 143`, `Community 17`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 40`, `Community 173`, `Community 50`, `Community 310`, `Community 60`, `Community 62`, `Community 190`, `Community 198`, `Community 71`, `Community 72`, `Community 203`, `Community 217`, `Community 89`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 130`, `Community 518`, `Community 519`, `Community 520`, `Community 135`, `Community 522`, `Community 11`, `Community 523`, `Community 141`, `Community 142`, `Community 7`, `Community 16`, `Community 145`, `Community 401`, `Community 19`, `Community 530`, `Community 13`, `Community 281`, `Community 282`, `Community 283`, `Community 156`, `Community 29`, `Community 285`, `Community 31`, `Community 159`, `Community 286`, `Community 33`, `Community 35`, `Community 166`, `Community 297`, `Community 43`, `Community 45`, `Community 46`, `Community 49`, `Community 181`, `Community 182`, `Community 183`, `Community 57`, `Community 314`, `Community 572`, `Community 573`, `Community 188`, `Community 63`, `Community 575`, `Community 195`, `Community 68`, `Community 453`, `Community 70`, `Community 202`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 214`, `Community 94`, `Community 96`, `Community 97`, `Community 102`, `Community 106`, `Community 107`, `Community 366`, `Community 113`, `Community 114`, `Community 123`, `Community 252`, `Community 126`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5537 weakly-connected nodes found - possible documentation gaps or missing edges._
