...
## Corpus Check
- Large corpus: 2197 files · ~4,636,271 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 14809 nodes · 26878 edges · 957 communities (804 shown, 153 thin omitted)
...
## Communities (957 total, 153 thin omitted)
...
Cohesion: 0.02
Nodes (143): Channel, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials (+135 more)
...
Cohesion: 0.03
Nodes (112): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, setConfigWriteTarget(), addCodeStep(), applyInitAutoTestChange() (+104 more)
...
Cohesion: 0.05
Nodes (100): withSupabaseSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+92 more)
...
Cohesion: 0.04
Nodes (88): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (90): mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata() (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (79): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), base64ToArrayBuffer() (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (76): isTelemetryDisabled(), createRSA(), AlertsReporter, checkAlerts(), VersionCheckResult, displayApps(), getActiveApps(), listApp() (+68 more)
...
Cohesion: 0.03
Nodes (65): getActiveUploadReporter(), configWriteTargetStore, loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), writeConfigTarget() (+57 more)
...
Cohesion: 0.05
Nodes (69): getConfigWriteTarget(), resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), initOnboardingSteps, ChoiceOption, CollectField (+61 more)
...
Cohesion: 0.08
Nodes (77): cancelCommand(), markSnag(), wait(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+69 more)
...
Cohesion: 0.06
Nodes (51): BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart(), useDashboardDailyChartCycle(), useOrgBillingCycleChart(), BUILD_SERIES_KEYS (+43 more)
...
Cohesion: 0.06
Nodes (55): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+47 more)
...
Cohesion: 0.07
Nodes (43): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), completePendingOnboardingApp(), addApp(), addAppInternal(), AppCreateSource (+35 more)
...
Cohesion: 0.07
Nodes (31): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+23 more)
...
Cohesion: 0.09
Nodes (30): CURRENT_START_MS, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), buildDailyAttempts(), buildFrontendOnboardingAnalytics() (+22 more)
...
Cohesion: 0.14
Nodes (21): decryptChecksum(), decryptChecksumV3(), decryptSource(), checkIndexPosition(), searchInDirectory(), searchInFile(), decryptZip(), decryptZipInternal() (+13 more)
...
Cohesion: 0.13
Nodes (21): checkVersionStatus(), computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), runInitDoctorDiagnostics() (+13 more)

### Community 160 - "Community 160"
Cohesion: 0.12
Nodes (21): AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason(), formatStoredChurnReason() (+13 more)
...
Cohesion: 0.15
Nodes (12): AppChartRefreshState, ChartRefreshRequestResult, isChartDataStale(), isChartRefreshInProgress(), isOrgCacheReadyForRefresh(), OrgChartRefreshState, parseDashboardRefreshTimestamp(), shouldAutoRequestChartRefresh() (+4 more)
...
Cohesion: 0.13
Nodes (16): DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS, DateRangePreset, DateRangePresetGroupKey, DateRangeQueryParams, getDateRangeForPreset(), getTableDateRangeSignature() (+8 more)
...
## Knowledge Gaps
- **5276 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5271 more)
...
- **Why does `Database` connect `Community 84` to `Community 3`, `Community 5`, `Community 7`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 280`, `Community 24`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 179`, `Community 53`, `Community 183`, `Community 62`, `Community 194`, `Community 67`, `Community 74`, `Community 81`, `Community 89`, `Community 237`, `Community 114`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 128`, `Community 258`, `Community 260`, `Community 134`, `Community 7`, `Community 135`, `Community 137`, `Community 6`, `Community 13`, `Community 142`, `Community 14`, `Community 528`, `Community 529`, `Community 146`, `Community 531`, `Community 19`, `Community 407`, `Community 23`, `Community 537`, `Community 282`, `Community 283`, `Community 32`, `Community 164`, `Community 165`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 47`, `Community 176`, `Community 177`, `Community 51`, `Community 54`, `Community 182`, `Community 56`, `Community 186`, `Community 65`, `Community 66`, `Community 69`, `Community 327`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 82`, `Community 470`, `Community 471`, `Community 472`, `Community 88`, `Community 474`, `Community 475`, `Community 91`, `Community 93`, `Community 94`, `Community 225`, `Community 482`, `Community 355`, `Community 106`, `Community 117`, `Community 247`, `Community 248`, `Community 122`, `Community 124`, `Community 125`, `Community 255`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5279 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023112480739599383 - nodes in this community are weakly interconnected._