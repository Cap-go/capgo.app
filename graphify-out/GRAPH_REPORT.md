# Graph Report - capgo.app  (2026-09-04)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2611 files · ~5,087,751 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16574 nodes · 30659 edges · 1065 communities (893 shown, 172 thin omitted)
...
## Communities (1065 total, 172 thin omitted)
...
Cohesion: 0.01
Nodes (174): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+166 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (149): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel() (+141 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (105): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+97 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (103): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+95 more)
...
Cohesion: 0.04
Nodes (102): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+94 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (75): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+67 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (112): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), throwCapacitorConfigPathError(), applyInitAutoTestChange(), askForAppName() (+104 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (69): fixtureId, orgId, createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool (+61 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (86): OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch(), deriveSupabaseOperation(), enableSupabaseInstrumentation(), getSupabaseSource(), isSupabaseInstrumentationEnabled() (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (97): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+89 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (90): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+82 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (77): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+69 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (74): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+66 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (63): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert (+55 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (82): globalId, WEBHOOK_TEST_ORG_ID, webhookApiKey, WebhookDelivery, DeliveryMessage, apikeyHasOrgRight(), allowLocalWebhookUrls(), AuditLogData (+74 more)
...
Cohesion: 0.04
Nodes (58): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString() (+50 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (70): cleanupStepsDone(), waitForCommandResult(), streamCommandInInitPanel(), tryResumeOnboarding(), ConfirmOptions, intro(), PromptResult, SelectOption (+62 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (61): createUserOrgBinding(), destinationOrgId, orgId, scopeId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates() (+53 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (65): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps, ChoiceOption, CollectField (+57 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (61): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), createPlansVisitTracker() (+53 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (64): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore (+56 more)
...
Cohesion: 0.08
Nodes (75): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+67 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (48): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser() (+40 more)
...
Cohesion: 0.04
Nodes (58): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+50 more)
...
Cohesion: 0.04
Nodes (54): resolveAppSetIconPath(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec (+46 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (46): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, IncompatibleBundleError, fetchObserve(), ObserveCliOptions, observeCommand() (+38 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (57): app, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+49 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (42): TEST_ORG_ID, id, orgKeyBody(), execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs() (+34 more)
...
Cohesion: 0.07
Nodes (56): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildGlobalNotificationStatsQuery(), buildNotificationBadgeStateQuery() (+48 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (53): calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit(), buildStorageHourlyRows(), calculateStorageHourlyRows(), collectStorageVersionLifetimes() (+45 more)
...
Cohesion: 0.04
Nodes (56): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+48 more)
...
Cohesion: 0.04
Nodes (42): id, testOrgId, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, Awaitable (+34 more)
...
Cohesion: 0.06
Nodes (51): assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody, CAMPAIGN_KINDS, CAMPAIGN_STATUSES (+43 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (42): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+34 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (48): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, unbindAppReader(), APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES (+40 more)
...
Cohesion: 0.07
Nodes (44): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+36 more)
...
Cohesion: 0.08
Nodes (51): buildChannelSelfCacheRequest(), buildChannelSelfStoreKey(), ChannelSelfContext, ChannelSelfDeviceClient, ChannelSelfOverride, ChannelSelfOverridePayload, ChannelSelfOverrideSyncInput, ChannelSelfOverrideWrite (+43 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (44): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+36 more)
...
Cohesion: 0.12
Nodes (12): displayMembers(), DisplayOptions, listMembers(), listMembersInternal(), MemberInfo, PasswordPolicyConfig, OrganizationInfo, SDKResult (+4 more)
...
Cohesion: 0.08
Nodes (44): syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary (+36 more)
...
Cohesion: 0.08
Nodes (41): app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), sampleActionsForView() (+33 more)
...
Cohesion: 0.10
Nodes (32): AppListOptions, handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), AppRow, assertAppAllowsPreview(), buildPreviewQrUrl(), BundleRow, ChannelRow (+24 more)
...
Cohesion: 0.08
Nodes (36): app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload, validateReplayBody() (+28 more)

### Community 91 - "Community 91"
Cohesion: 0.11
Nodes (33): CreateApp, post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), APP_ONBOARDING_STEP_IDS (+25 more)
...
Cohesion: 0.06
Nodes (33): getUniqueBaseData(), headers, id, TEST_ORG_ID, describeBackend, id, UpdateRes, expectNoPrimaryDownloadStatsRows() (+25 more)
...
Cohesion: 0.09
Nodes (25): readInitInternalLogLines(), confirmMessage(), contactSupport(), ContactSupportDeps, ContactSupportResult, fitBodyPrefix(), resetSupportUploadCacheForTests(), runContactSupport() (+17 more)
...
Cohesion: 0.08
Nodes (32): aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+24 more)
...
Cohesion: 0.10
Nodes (30): buildDeletedFileMarkerRequest(), buildFileReadCacheRequestsForPath(), buildWorkersFileCacheKey(), buildWorkersFileCacheRequests(), CacheLike, FILE_READ_CACHE_ORIGINS, FILE_READ_PATH_PREFIXES, FILE_READ_TRACKING_QUERY_PARAMS (+22 more)
...
Cohesion: 0.08
Nodes (23): id, RBAC_ORG_ID, id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache (+15 more)
...
Cohesion: 0.11
Nodes (21): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts(), FRONTEND_ONBOARDING_TAB_SWITCH_STEPS (+13 more)
...
Cohesion: 0.14
Nodes (30): promptDoctorUpdateChoice(), loginInitInBrowser(), promptForKey(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel() (+22 more)
...
Cohesion: 0.13
Nodes (24): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, readInstallTimingEventsCFChunked(), buildNativeObservePluginTotalDevicesCFQuery() (+16 more)
...
Cohesion: 0.14
Nodes (21): app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch() (+13 more)

### Community 171 - "Community 171"
Cohesion: 0.12
Nodes (20): aggregateCliKeyPolicy(), candidatePolicyAllows(), canonicalizeCliBindings(), CliApiKeyMetadata, CliKeyBinding, CliKeyPolicy, CliLoginKeyDependencies, CliLoginKeyPreparation (+12 more)
...
Cohesion: 0.19
Nodes (25): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown() (+17 more)
...
Cohesion: 0.13
Nodes (18): addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getMissingMainFileRecoveryOptions(), getNuxtUpdaterPluginContent(), injectInitCode() (+10 more)
...
Cohesion: 0.15
Nodes (14): DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS, DateRangePreset, DateRangePresetGroupKey, DateRangeQueryParams, getTableDateRangeSignature(), getTimeWindowPageRange(), isRollingDateRangePreset() (+6 more)
...
Cohesion: 0.20
Nodes (13): assertCanManageApiKeysForOrgsPg(), assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest (+5 more)
...
Cohesion: 0.25
Nodes (7): shouldStartInitBrowserLogin(), helperSource, initComponentsSource, initPromptsSource, initRuntimeSource, initSource, loginSource
...
Cohesion: 0.47
Nodes (6): deriveNativeNotificationIdentity(), getNotificationBucket(), getNotificationIndex(), permissionToNumber(), tombstoneNotificationRegistrationCF(), tombstoneDevice()
...
## Knowledge Gaps
- **5795 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5790 more)
...
- **Why does `Database` connect `Community 37` to `Community 130`, `Community 3`, `Community 4`, `Community 10`, `Community 11`, `Community 524`, `Community 13`, `Community 17`, `Community 19`, `Community 21`, `Community 25`, `Community 157`, `Community 32`, `Community 34`, `Community 547`, `Community 40`, `Community 171`, `Community 47`, `Community 51`, `Community 53`, `Community 55`, `Community 314`, `Community 59`, `Community 71`, `Community 202`, `Community 75`, `Community 206`, `Community 80`, `Community 211`, `Community 88`, `Community 93`, `Community 364`, `Community 118`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 8` to `Community 129`, `Community 6`, `Community 7`, `Community 15`, `Community 16`, `Community 17`, `Community 144`, `Community 275`, `Community 20`, `Community 149`, `Community 152`, `Community 281`, `Community 282`, `Community 408`, `Community 540`, `Community 541`, `Community 285`, `Community 543`, `Community 544`, `Community 287`, `Community 162`, `Community 35`, `Community 36`, `Community 551`, `Community 41`, `Community 169`, `Community 170`, `Community 44`, `Community 43`, `Community 46`, `Community 304`, `Community 54`, `Community 184`, `Community 58`, `Community 317`, `Community 63`, `Community 64`, `Community 321`, `Community 195`, `Community 196`, `Community 74`, `Community 205`, `Community 77`, `Community 79`, `Community 78`, `Community 468`, `Community 599`, `Community 600`, `Community 89`, `Community 602`, `Community 91`, `Community 87`, `Community 90`, `Community 95`, `Community 97`, `Community 98`, `Community 107`, `Community 109`, `Community 112`, `Community 117`, `Community 120`, `Community 252`, `Community 126`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.022326674500587545 - nodes in this community are weakly interconnected._