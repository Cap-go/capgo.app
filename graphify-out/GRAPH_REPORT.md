# Graph Report - capgo.app  (2026-08-26)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2540 files · ~4,994,309 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16240 nodes · 29771 edges · 1049 communities (878 shown, 171 thin omitted)
...
1. `scripts` - 198 edges
2. `supabaseAdmin()` - 171 edges
3. `scripts` - 170 edges
4. `getSupabaseClient()` - 142 edges
5. `Database` - 126 edges
6. `formatError()` - 98 edges
7. `executeSQL()` - 80 edges
...
## Communities (1049 total, 171 thin omitted)
...
Cohesion: 0.02
Nodes (143): setSetting(), setSettingInternal(), AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema (+135 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (170): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+162 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (110): app, app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app (+102 more)
...
Cohesion: 0.04
Nodes (107): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+99 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (98): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+90 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (106): AcceptInvitation, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser(), app (+98 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (101): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), PendingOnboardingApp, applyInitAutoTestChange(), askForAppName(), askForWebDir(), BuildProjectStepOutcome (+93 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (86): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+78 more)
...
Cohesion: 0.03
Nodes (59): fixtureId, orgId, orgId, scopeId, pgPool, fixtureId, orgId, QueryFn (+51 more)
...
Cohesion: 0.03
Nodes (77): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission() (+69 more)
...
Cohesion: 0.05
Nodes (68): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+60 more)
...
Cohesion: 0.05
Nodes (64): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates() (+56 more)
...
Cohesion: 0.04
Nodes (58): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+50 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (68): listPendingOnboardingApps(), waitLog(), shouldStartInitBrowserLogin(), addEncryptionStep(), delay(), ensureUpdaterReadyBeforeSync(), getInitConfigLoadDir(), initApp() (+60 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (58): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), hideLoader(), showLoader() (+50 more)
...
Cohesion: 0.05
Nodes (63): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+55 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (56): getActiveUploadReporter(), isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions (+48 more)
...
Cohesion: 0.06
Nodes (49): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+41 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (48): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal() (+40 more)
...
Cohesion: 0.06
Nodes (46): configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget() (+38 more)
...
Cohesion: 0.07
Nodes (55): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent, orgOnboardingIntentTestUtils (+47 more)
...
Cohesion: 0.06
Nodes (45): resolveAppSetIconPath(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec, Order (+37 more)
...
Cohesion: 0.04
Nodes (43): app, bodySchema, bumpRateLimit(), hashRateLimitKey(), isEmailPreferencesRateLimited(), normalizeEmail(), preferenceValueSchema, PublicEmailPreferenceKey (+35 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (48): aiBumpLevel, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), app, buildBatches() (+40 more)
...
Cohesion: 0.07
Nodes (42): useGitHubProfileDialog(), createAiApiKey(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost() (+34 more)
...
Cohesion: 0.06
Nodes (42): TEST_ORG_ID, id, testOrgId, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, id (+34 more)
...
Cohesion: 0.05
Nodes (38): getUniqueBaseData(), headers, id, TEST_ORG_ID, describeBackend, id, UpdateRes, callLogAs() (+30 more)
...
Cohesion: 0.05
Nodes (47): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+39 more)
...
Cohesion: 0.11
Nodes (48): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), askForAppId(), askForExistingDirectoryPath(), askForReplacementAppId(), buildProjectStep() (+40 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (30): ChannelPromotionPermissionChecker, ChannelPromotionTarget, findChannelsWithoutPromotionPermission(), formatChannelPromotionTargets(), aggregateCliKeyPolicy(), candidatePolicyAllows(), canonicalizeCliBindings(), CliApiKeyMetadata (+22 more)
...
Cohesion: 0.07
Nodes (33): { cloudlogErrMock, queryPosthogHogqlMock }, AttemptOverrides, START_MS, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql() (+25 more)
...
Cohesion: 0.08
Nodes (30): getSuggestedCleanupBundleVersion(), maybeOfferAutoTestCleanup(), readInitInternalLogLines(), confirmMessage(), contactSupport(), ContactSupportDeps, ContactSupportResult, fitBodyPrefix() (+22 more)
...
Cohesion: 0.08
Nodes (39): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint(), formatSpawnOutput(), getInfo() (+31 more)
...
Cohesion: 0.09
Nodes (40): handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution (+32 more)
...
Cohesion: 0.06
Nodes (21): UploadResponse, createGroupOrgBinding(), createUserOrgBinding(), fixtureId, getOrgRoleId(), highRankApiKey, lowRankApiKey, orgId (+13 more)
...
Cohesion: 0.08
Nodes (28): AssignablePrincipal, canManageRoleBindingScope(), CreateBindingOptions, CreateBindingResult, createRoleBindingForPrincipal(), DrizzleClient, DrizzleExecutor, getCallerMaxPriorityRank() (+20 more)
...
Cohesion: 0.13
Nodes (29): loadPlansAnalytics(), array(), boolean(), buildPlansAnalyticsPresentationState(), buildPlansAnalyticsSeries(), ChartDataPoint, ChartSeries, count() (+21 more)

### Community 139 - "Community 139"
Cohesion: 0.10
Nodes (30): buildTerminalImageDataUrl(), CliStream, createTerminalSnapshot(), createTerminalSnapshotNode(), defaultReplayTransport(), escapeHtml(), extractHtmlFragment(), findSerializedNodeId() (+22 more)
...
Cohesion: 0.10
Nodes (25): computeDoctorAnalyticsTags(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), listOutdatedDependencies(), logOutdatedDependencyTable(), maybeRecoverOutdatedDependencies(), addCodeStep() (+17 more)
...
Cohesion: 0.10
Nodes (24): cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), tryResumeOnboarding() (+16 more)
...
Cohesion: 0.15
Nodes (24): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+16 more)
...
Cohesion: 0.10
Nodes (19): authCardShellClass, authGhostButtonClass, authInlineLinkClass, authPrimaryButtonClass, authSecondaryButtonClass, clearCaptchaInitTimeout(), emailForLogin, emailValidation (+11 more)
...
Cohesion: 0.19
Nodes (19): addUpdaterStep(), ensureSplashScreenForDirectUpdate(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getPackageInstallCommand(), getUpdaterInstallBlocker() (+11 more)
...
Cohesion: 0.14
Nodes (15): cancelCommand(), sendCliEvent(), getInitRecoveryCommands(), handleBrokenIosSync(), logBrokenIosSync(), maybeWriteBrokenIosSyncSupportBundle(), writeInitSupportBundle(), getNativeProjectResetAdvice() (+7 more)
...
Cohesion: 0.40
Nodes (5): didStripeCustomerEmailChange(), requireLiveStripeCustomerBillingEmail(), retrieveStripeCustomerBillingEmail(), shouldReplaceOrgManagementEmail(), syncOrgManagementEmailFromStripeCustomer()
...
## Knowledge Gaps
- **5747 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5742 more)
...
- **Why does `Database` connect `Community 46` to `Community 514`, `Community 3`, `Community 6`, `Community 8`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 23`, `Community 25`, `Community 539`, `Community 27`, `Community 34`, `Community 36`, `Community 39`, `Community 52`, `Community 56`, `Community 184`, `Community 321`, `Community 65`, `Community 69`, `Community 82`, `Community 85`, `Community 215`, `Community 232`, `Community 104`, `Community 126`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 128`, `Community 133`, `Community 5`, `Community 263`, `Community 137`, `Community 10`, `Community 12`, `Community 141`, `Community 15`, `Community 18`, `Community 531`, `Community 532`, `Community 533`, `Community 535`, `Community 536`, `Community 153`, `Community 407`, `Community 154`, `Community 155`, `Community 159`, `Community 31`, `Community 289`, `Community 290`, `Community 545`, `Community 292`, `Community 293`, `Community 32`, `Community 33`, `Community 170`, `Community 43`, `Community 172`, `Community 44`, `Community 175`, `Community 48`, `Community 49`, `Community 47`, `Community 305`, `Community 58`, `Community 62`, `Community 63`, `Community 191`, `Community 192`, `Community 196`, `Community 325`, `Community 73`, `Community 75`, `Community 460`, `Community 203`, `Community 204`, `Community 79`, `Community 593`, `Community 594`, `Community 596`, `Community 214`, `Community 88`, `Community 89`, `Community 602`, `Community 92`, `Community 94`, `Community 226`, `Community 99`, `Community 100`, `Community 229`, `Community 107`, `Community 108`, `Community 110`, `Community 119`, `Community 121`, `Community 123`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5750 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023170189805116485 - nodes in this community are weakly interconnected._