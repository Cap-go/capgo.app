...
## Corpus Check
- Large corpus: 2351 files · ~4,808,961 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15275 nodes · 27740 edges · 1014 communities (851 shown, 163 thin omitted)
...
## Communities (1014 total, 163 thin omitted)
...
Cohesion: 0.02
Nodes (148): Channel, GateProbe, gateProject(), AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema (+140 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (152): buildCliRequestHeaders(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), completePendingOnboardingApp(), getAppIconStoragePath(), hostOptionsFromSupabase() (+144 more)
...
Cohesion: 0.02
Nodes (126): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+118 more)
...
Cohesion: 0.02
Nodes (100): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+92 more)
...
Cohesion: 0.03
Nodes (111): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), setConfigWriteTarget(), applyInitAutoTestChange() (+103 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (72): setCurrentCliCommand(), categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource() (+64 more)
...
Cohesion: 0.03
Nodes (81): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+73 more)
...
Cohesion: 0.04
Nodes (67): checkCompatibility(), CompatibilityResult, summarizeUploadCompatibility(), UploadCompatibilityResult, UploadCompatibilitySummary, getActiveUploadReporter(), displayCompatibilityTable(), verifyCompatibility() (+59 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (64): createRSA(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget() (+56 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (79): addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath(), askForReplacementAppId() (+71 more)
...
Cohesion: 0.09
Nodes (38): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), buildCacheKey(), chartDataCache, clampToToday(), colorKeys, useChartData() (+30 more)
...
Cohesion: 0.08
Nodes (38): createAiApiKey(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod() (+30 more)
...
Cohesion: 0.08
Nodes (40): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema (+32 more)
...
Cohesion: 0.07
Nodes (36): isTelemetryDisabled(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec (+28 more)

### Community 67 - "Community 67"
Cohesion: 0.10
Nodes (36): asyncPool(), createStripeClient(), createSupabaseServiceClient(), getArgValue(), getRequiredEnv(), getSupabaseServiceRoleKey(), isActionableStripeCustomerId(), parsePositiveInteger() (+28 more)
...
Cohesion: 0.08
Nodes (29): useGitHubProfileDialog(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder (+21 more)
...
Cohesion: 0.10
Nodes (38): buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution, ensureCustomerMetadata() (+30 more)
...
Cohesion: 0.07
Nodes (32): appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+24 more)

### Community 90 - "Community 90"
Cohesion: 0.08
Nodes (34): ensureSplashScreenForDirectUpdate(), ensureUpdaterReadyBeforeSync(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getPackageInstallCommand(), getUpdaterInstallBlocker() (+26 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (34): aggregateInstallTimingsByVersion(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays, BundleInstallStatsItem (+26 more)

### Community 92 - "Community 92"
Cohesion: 0.10
Nodes (36): AppIconRow, AppleLookupResult, applyIcon(), BackfillFailure, BackfillResult, decodeHtml(), DEFAULT_ICON_VALUES, DownloadedIcon (+28 more)
...
Cohesion: 0.07
Nodes (26): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+18 more)
...
Cohesion: 0.10
Nodes (33): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), log, getRunDeviceCommandForPlatform(), assertHelperFileWritable(), getConfigAppId(), notificationPackages (+25 more)
...
Cohesion: 0.09
Nodes (22): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, toIdString(), TrackEventBody, base (+14 more)
...
Cohesion: 0.18
Nodes (16): loadEnv(), BackfillFailure, BackfillNotFound, BackfillResult, CandidateUser, getCandidatePage(), getGitHubToken(), GitHubUser (+8 more)
...
Cohesion: 0.16
Nodes (12): AdminOnboardingActivationCohort, AdminOnboardingActivationMetrics, getAdminOnboardingActivationMetrics(), isWithinActivationWindow(), toValidDate(), adminOnboardingConversionRate(), AdminOnboardingFunnel, getAdminOnboardingFunnel() (+4 more)
...
Cohesion: 0.25
Nodes (7): cancelCommand(), listenForWaitLogContinue(), markSnag(), waitLog(), buildWaitLogQuery(), isWaitLogContinueKey(), WaitLogQuery
...
## Knowledge Gaps
- **5412 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5407 more)
...
- **Why does `Database` connect `Community 4` to `Community 514`, `Community 3`, `Community 6`, `Community 139`, `Community 395`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 659`, `Community 25`, `Community 28`, `Community 29`, `Community 33`, `Community 294`, `Community 50`, `Community 61`, `Community 190`, `Community 63`, `Community 193`, `Community 66`, `Community 79`, `Community 89`, `Community 608`, `Community 97`, `Community 489`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 256`, `Community 134`, `Community 7`, `Community 135`, `Community 136`, `Community 266`, `Community 139`, `Community 268`, `Community 141`, `Community 520`, `Community 15`, `Community 269`, `Community 137`, `Community 9`, `Community 150`, `Community 279`, `Community 152`, `Community 27`, `Community 159`, `Community 32`, `Community 35`, `Community 37`, `Community 167`, `Community 297`, `Community 8`, `Community 43`, `Community 299`, `Community 175`, `Community 176`, `Community 52`, `Community 564`, `Community 438`, `Community 565`, `Community 567`, `Community 186`, `Community 59`, `Community 187`, `Community 573`, `Community 62`, `Community 58`, `Community 64`, `Community 67`, `Community 70`, `Community 72`, `Community 75`, `Community 204`, `Community 76`, `Community 78`, `Community 85`, `Community 86`, `Community 88`, `Community 92`, `Community 120`, `Community 94`, `Community 96`, `Community 107`, `Community 109`, `Community 237`, `Community 111`, `Community 115`, `Community 507`, `Community 380`, `Community 506`, `Community 123`, `Community 508`, `Community 510`, `Community 511`?**
