...
## Corpus Check
- Large corpus: 2085 files · ~4,435,874 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13737 nodes · 25143 edges · 942 communities (789 shown, 153 thin omitted)
...
5. `Database` - 124 edges
6. `formatError()` - 88 edges
7. `findSavedKey()` - 75 edges
8. `checkPermission()` - 75 edges
...
## Communities (942 total, 153 thin omitted)
...
Cohesion: 0.02
Nodes (145): UpdateProbeResult, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+137 more)
...
Cohesion: 0.01
Nodes (154): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+146 more)
...
Cohesion: 0.02
Nodes (99): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+91 more)
...
Cohesion: 0.04
Nodes (111): syncSubscriptionAndEventsWithRetry(), invoiceUpcoming(), BillingPlanBentoState, buildBillingPlanBentoTags(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (104): checkAppIdsExist(), findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), applyInitAutoTestChange(), BuildProjectStepOutcome, CancelablePromptValue, cancelPackageJsonSelection() (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (77): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath(), Channel, checkVersionNotUsedInChannel() (+69 more)
...
Cohesion: 0.03
Nodes (72): getActiveUploadReporter(), configWriteTargetStore, loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), CapacitorConfig (+64 more)
...
Cohesion: 0.04
Nodes (76): cleanupStepsDone(), delay(), promoteEncryptionSummaryToEnabled(), runBuildAndSyncLoop(), runCapacitorPlatformAdd(), runNativeResetCommand(), streamCommandInInitPanel(), tryResumeOnboarding() (+68 more)
...
Cohesion: 0.03
Nodes (48): createAuthenticatedSupabaseClient(), describeBackend, pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId (+40 more)
...
Cohesion: 0.06
Nodes (63): getConfigWriteTarget(), setConfigWriteTarget(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction (+55 more)
...
Cohesion: 0.06
Nodes (51): AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, setSetting(), setSettingInternal(), writeConfigUpdater(), syncPendingAppIdToCapacitorConfig() (+43 more)
...
Cohesion: 0.11
Nodes (61): completePendingOnboardingApp(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+53 more)
...
Cohesion: 0.07
Nodes (37): canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup(), addGroupMemberBodyHook (+29 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (41): bodySchema, getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal() (+33 more)
...
Cohesion: 0.06
Nodes (35): UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled, ComponentCustomProperties, GlobalComponents, BreadcrumbItem, ExtendedOrganizationMember, ExtendedOrganizationMembers (+27 more)
...
Cohesion: 0.09
Nodes (34): CapgoApiInvokeOptions, getCapgoApiErrorCode(), invokeCapgoApi(), isCapgoManagedSupabaseHost(), isPostgresUniqueViolation(), normalizeApiHost(), parseHostname(), serializeBody() (+26 more)
...
Cohesion: 0.08
Nodes (27): useGitHubProfileDialog(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder (+19 more)
...
Cohesion: 0.08
Nodes (31): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult, UploadCompatibilitySummary, getReleaseType(), printReleaseType(), ReleaseTypeResult (+23 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (30): app, DataSetManifest, getManifestSizeWithRetry(), onManifestCreateTestUtils, QueueLogMetadata, runManifestUpdateWithRetry(), shouldRetryManifestSizeLookup(), shouldSkipManifestSizeRetry() (+22 more)
...
Cohesion: 0.08
Nodes (25): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), isKnownCrawlerNoiseErrorMessage(), isStaleAssetErrorMessage(), KNOWN_CRAWLER_ERROR_PATTERNS, PostHogEventLike (+17 more)
...
Cohesion: 0.07
Nodes (18): canNext(), canPrev(), debouncedReload, debouncedSearch, debouncedUpdateUrlParams, displayElemRange, fastBackward(), fastForward() (+10 more)
...
Cohesion: 0.20
Nodes (20): ensureFunctionsEnvFile(), ensureSymlink(), ensureWorktreeSupabaseDir(), freeHostPorts(), getLocalSupabaseCli(), getStatusJson(), getSupabaseCmd(), hasSupabaseCli() (+12 more)
...
Cohesion: 0.14
Nodes (14): DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS, DateRangePreset, DateRangePresetGroupKey, DateRangeValue, getDateRangeForPreset(), RollingDateRangePreset (+6 more)
...
## Knowledge Gaps
- **4596 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4591 more)
...
- **Why does `Database` connect `Community 84` to `Community 1`, `Community 4`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 143`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 281`, `Community 34`, `Community 38`, `Community 170`, `Community 176`, `Community 56`, `Community 61`, `Community 62`, `Community 66`, `Community 70`, `Community 77`, `Community 79`, `Community 86`, `Community 234`, `Community 247`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 129`, `Community 132`, `Community 133`, `Community 6`, `Community 7`, `Community 136`, `Community 9`, `Community 526`, `Community 527`, `Community 16`, `Community 529`, `Community 405`, `Community 535`, `Community 26`, `Community 27`, `Community 28`, `Community 155`, `Community 282`, `Community 156`, `Community 284`, `Community 31`, `Community 29`, `Community 285`, `Community 166`, `Community 167`, `Community 174`, `Community 47`, `Community 51`, `Community 55`, `Community 59`, `Community 65`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 78`, `Community 80`, `Community 82`, `Community 467`, `Community 468`, `Community 469`, `Community 83`, `Community 87`, `Community 471`, `Community 472`, `Community 89`, `Community 222`, `Community 479`, `Community 96`, `Community 100`, `Community 358`, `Community 110`, `Community 240`, `Community 242`, `Community 115`, `Community 252`, `Community 118`, `Community 247`, `Community 120`, `Community 121`, `Community 250`, `Community 124`, `Community 254`?**
