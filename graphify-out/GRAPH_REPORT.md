# Graph Report - capgo.app  (2026-09-03)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2602 files · ~5,076,879 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16492 nodes · 30451 edges · 1057 communities (886 shown, 171 thin omitted)
...
6. `formatError()` - 98 edges
7. `executeSQL()` - 86 edges
8. `findSavedKey()` - 77 edges
9. `checkPermission()` - 76 edges
10. `initApp()` - 67 edges
...
## Communities (1057 total, 171 thin omitted)
...
Cohesion: 0.03
Nodes (161): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+153 more)
...
Cohesion: 0.02
Nodes (149): OrganizationUpdatePayload, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+141 more)
...
Cohesion: 0.03
Nodes (138): filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter(), publicDevice, syncSubscriptionAndEventsWithRetry() (+130 more)
...
Cohesion: 0.03
Nodes (122): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), applyInitAutoTestChange() (+114 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (121): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+113 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (92): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+84 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (68): fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool, fixtureId (+60 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (87): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+79 more)
...
Cohesion: 0.04
Nodes (83): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+75 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (63): categorizeHttpStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId() (+55 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (69): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+61 more)
...
Cohesion: 0.05
Nodes (70): getConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitTargetPath(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition (+62 more)
...
Cohesion: 0.04
Nodes (70): CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions (+62 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (83): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (65): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys (+57 more)
...
Cohesion: 0.04
Nodes (65): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+57 more)
...
Cohesion: 0.04
Nodes (50): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages() (+42 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (44): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, id, testOrgId, appCreationApiKey, id, createAppForTest() (+36 more)
...
Cohesion: 0.04
Nodes (42): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+34 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (62): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+54 more)
...
Cohesion: 0.05
Nodes (52): getInvocationSource(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, ensureOptions(), isAppInTargetOrganization() (+44 more)
...
Cohesion: 0.06
Nodes (40): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString() (+32 more)
...
Cohesion: 0.06
Nodes (44): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+36 more)
...
Cohesion: 0.04
Nodes (43): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+35 more)
...
Cohesion: 0.04
Nodes (30): App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload, mocks, UploadResponse (+22 more)
...
Cohesion: 0.05
Nodes (43): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates() (+35 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (42): addMonthsUtc(), Cycle, daysInMonthUtc(), oracleCompletedCycle(), pad2(), parseUtcDateOnly(), sqlPortCompletedCycle(), utcDateOnly() (+34 more)
...
Cohesion: 0.07
Nodes (49): getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handleMissingSimulatorIosRunTargets(), handlePhysicalIosRunTargets() (+41 more)
...
Cohesion: 0.07
Nodes (42): buildFileReadCacheRequest(), assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred() (+34 more)
...
Cohesion: 0.08
Nodes (42): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, isTypeScriptCompiler(), loadConfig(), loadConfigForWrite() (+34 more)
...
Cohesion: 0.08
Nodes (47): handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary (+39 more)
...
Cohesion: 0.07
Nodes (38): aggregateCliKeyPolicy(), candidatePolicyAllows(), canonicalizeCliBindings(), CliApiKeyMetadata, CliKeyBinding, CliKeyPolicy, CliLoginKeyDependencies, CliLoginKeyPreparation (+30 more)
...
Cohesion: 0.07
Nodes (40): app, bodySchema, CreateDeviceBody, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString() (+32 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (37): accumulateNumbers(), app, appGlobal, AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildNativeVersionCounts(), bundleUsageSchema (+29 more)
...
Cohesion: 0.09
Nodes (36): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnelStages(), buildInteractionGraph(), buildLegacyFunnel(), buildSetupCliOutcomes() (+28 more)
...
Cohesion: 0.08
Nodes (33): aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+25 more)

### Community 104 - "Community 104"
Cohesion: 0.09
Nodes (33): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays, BundleInstallStatsItem (+25 more)
...
Cohesion: 0.11
Nodes (26): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), isRetryableCronSyncError() (+18 more)
...
Cohesion: 0.09
Nodes (22): isRetryableDurableObjectFetchError(), ALLOWED_METHODS, AppScopedAttachmentPath, AsyncLock, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, EXPOSED_HEADERS (+14 more)
...
Cohesion: 0.13
Nodes (19): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts(), FRONTEND_ONBOARDING_TAB_SWITCH_STEPS (+11 more)
...
Cohesion: 0.13
Nodes (24): APP_ONBOARDING_STEP_IDS, applyAppOnboardingPatch(), AppOnboardingOutcome, AppOnboardingPatch, AppOnboardingSource, AppOnboardingState, AppOnboardingStepId, AppOnboardingStepState (+16 more)
...
Cohesion: 0.07
Nodes (18): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), triggerHeaders, defaultEmailPreferences, id (+10 more)
...
Cohesion: 0.14
Nodes (22): app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch() (+14 more)
...
Cohesion: 0.14
Nodes (16): compareNativePackages(), CompatibilitySummary, DeploymentHistoryEntry, DeploymentPair, didPlatformChecksumMetadataChange(), getIncompatibilityReasons(), hasPlatformChecksum(), hasPlatformChecksumMetadataDrift() (+8 more)
...
Cohesion: 0.16
Nodes (14): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, buildPreviewQrUrl(), PreviewQrTarget (+6 more)
...
Cohesion: 0.15
Nodes (15): app, LIVE_UPDATE_METRICS_HEADERS, LiveUpdateMetricsResponse, sanitizeBreakdown(), sanitizePublicLiveUpdateMetrics(), sanitizePublicPercent(), app, adminDeleteIdentity() (+7 more)
...
Cohesion: 0.18
Nodes (16): getCreditTopUpProductIdFromCustomer(), AutoTopUpSettings, chargeOffSessionCredits(), customerHasSavedPaymentMethod(), getAutoTopUpSettings(), getAvailableCredits(), getCreditProductIdForCustomer(), getDefaultPaymentMethodId() (+8 more)

### Community 244 - "Community 244"
Cohesion: 0.11
Nodes (17): AnalyticsPrimitive, AnalyticsProperties, CaptureEvent, captureOnboardingEvent(), createOnboardingDetailsFieldDebouncer(), CreateOnboardingProgressTrackerOptions, CreateOnboardingTelemetryIdentityOptions, OnboardingAnalyticsStep (+9 more)
...
Cohesion: 0.21
Nodes (13): apikeyHasOrgRight(), bodySchema, deleteWebhook(), apiKeyHasAppScopedBinding(), app, appGlobal, assertOrgWebhookScope(), assertWebhookApiKeyChain() (+5 more)
...
Cohesion: 0.22
Nodes (11): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), FrontendOnboardingDailySetupCliEvent, FrontendOnboardingDailySetupCliEventKind (+3 more)
...
Cohesion: 0.26
Nodes (8): getStatsInsightsPeriod(), parsePeriodDays(), PERIOD_DAY_OPTIONS, PeriodDayOption, generateUtcDateLabels(), getRollingStatsPeriod(), RollingStatsPeriod, utcDayStartMs()
...
Cohesion: 0.22
Nodes (9): mockContext, didStripeCustomerEmailChange(), getStripeCustomerBillingEmail(), requireLiveStripeCustomerBillingEmail(), retrieveStripeCustomerBillingEmail(), shouldReplaceOrgManagementEmail(), syncOrgManagementEmailFromStripeCustomer(), getStripeCustomerEmailFromEvent() (+1 more)
...
Cohesion: 0.22
Nodes (8): createTracker(), {
  getLocalConfigMock,
  sendEventMock,
}, trackerIdentity, steps, trackerIdentity, createOnboardingProgressTracker(), createOnboardingTelemetryIdentity(), resolveOnboardingAppIconSource()
...
Cohesion: 0.48
Nodes (5): isOptionalString(), isOptionalStringMaxLength(), isStatsRequestBody(), isValidStatsMetadata(), ALLOWED_STATS_ACTIONS_SET
...
## Knowledge Gaps
- **5773 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5768 more)
...
- **Why does `Database` connect `Community 60` to `Community 2`, `Community 4`, `Community 5`, `Community 12`, `Community 13`, `Community 15`, `Community 22`, `Community 24`, `Community 27`, `Community 31`, `Community 32`, `Community 37`, `Community 167`, `Community 40`, `Community 41`, `Community 45`, `Community 52`, `Community 53`, `Community 181`, `Community 55`, `Community 311`, `Community 64`, `Community 77`, `Community 205`, `Community 119`?**
  _High betweenness centrality (0.213) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 128`, `Community 131`, `Community 134`, `Community 7`, `Community 10`, `Community 11`, `Community 141`, `Community 143`, `Community 16`, `Community 18`, `Community 402`, `Community 148`, `Community 533`, `Community 534`, `Community 279`, `Community 535`, `Community 280`, `Community 150`, `Community 537`, `Community 538`, `Community 29`, `Community 282`, `Community 151`, `Community 283`, `Community 545`, `Community 34`, `Community 284`, `Community 35`, `Community 288`, `Community 38`, `Community 296`, `Community 169`, `Community 42`, `Community 43`, `Community 172`, `Community 182`, `Community 57`, `Community 317`, `Community 191`, `Community 192`, `Community 65`, `Community 68`, `Community 201`, `Community 202`, `Community 74`, `Community 590`, `Community 463`, `Community 591`, `Community 593`, `Community 208`, `Community 80`, `Community 81`, `Community 85`, `Community 87`, `Community 599`, `Community 90`, `Community 91`, `Community 95`, `Community 98`, `Community 99`, `Community 105`, `Community 490`, `Community 365`, `Community 112`, `Community 152`, `Community 118`, `Community 120`, `Community 122`, `Community 253`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 7` to `Community 393`, `Community 138`, `Community 11`, `Community 14`, `Community 143`, `Community 16`, `Community 273`, `Community 18`, `Community 146`, `Community 283`, `Community 29`, `Community 288`, `Community 35`, `Community 420`, `Community 419`, `Community 38`, `Community 168`, `Community 169`, `Community 57`, `Community 63`, `Community 68`, `Community 73`, `Community 74`, `Community 81`, `Community 85`, `Community 220`, `Community 95`, `Community 103`, `Community 104`, `Community 105`, `Community 234`, `Community 107`, `Community 108`, `Community 365`, `Community 238`, `Community 361`, `Community 112`, `Community 115`, `Community 243`, `Community 120`, `Community 122`, `Community 381`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.03060599095993258 - nodes in this community are weakly interconnected._