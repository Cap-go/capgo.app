# Graph Report - capgo.app  (2026-07-30)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 1979 files · ~4,326,569 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13296 nodes · 24385 edges · 896 communities (756 shown, 140 thin omitted)
...
## Communities (896 total, 140 thin omitted)
...
Cohesion: 0.02
Nodes (137): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+129 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (141): appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials, buildCredentialsSchema (+133 more)
...
Cohesion: 0.03
Nodes (104): get(), getAll(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization() (+96 more)
...
Cohesion: 0.04
Nodes (108): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+100 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (94): getInvocationSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), Channel, checkVersionNotUsedInChannel() (+86 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (101): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), buildCodeDiffLines(), BuildProjectStepOutcome, CancelablePromptValue (+93 more)
...
Cohesion: 0.05
Nodes (83): DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch(), handleManifest(), ManifestCleanupEntry (+75 more)
...
Cohesion: 0.04
Nodes (65): configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), startMcpServer() (+57 more)
...
Cohesion: 0.04
Nodes (54): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, clearVersionAudits() (+46 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (71): completePendingOnboardingApp(), cancelCommand(), markSnag(), wait(), waitLog(), setConfigWriteTarget(), addAppStep(), addChannelStep() (+63 more)
...
Cohesion: 0.07
Nodes (48): createRSA(), checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), writeConfigUpdater(), syncPendingAppIdToCapacitorConfig(), deleteOrganization() (+40 more)
...
Cohesion: 0.07
Nodes (53): formatBytes(), formatNumber(), handleBillingPeriodStats(), getErrorCode(), getRetryableStatus(), isMissingOrgError(), OrgToGet, syncSubscriptionAndEventsWithRetry() (+45 more)
...
Cohesion: 0.06
Nodes (38): findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), ensureGitRepoCleanBeforeInit(), getDirtyGitStatusActionOptions() (+30 more)
...
Cohesion: 0.08
Nodes (42): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), assertIntegerInRange(), assertOptionalConfidence(), assertOptionalIntegerInRange(), disableAutoUpdatesPossibleOptions, setChannel(), setChannelInternal() (+34 more)
...
Cohesion: 0.09
Nodes (36): addMonthsUtc(), Cycle, daysInMonthUtc(), oracleCompletedCycle(), pad2(), parseUtcDateOnly(), sqlPortCompletedCycle(), utcDateOnly() (+28 more)
...
Cohesion: 0.09
Nodes (43): handleCheckoutSessionCompleted(), syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary (+35 more)
...
Cohesion: 0.09
Nodes (24): bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder, CreditPricingStep (+16 more)
...
Cohesion: 0.22
Nodes (20): formatDate(), formatDistanceToNow(), formatLocalDate(), formatLocalDateLong(), formatLocalDateShort(), formatLocalDateTime(), formatLocalDateTimeWithSeconds(), formatLocalMonthYear() (+12 more)
...
## Knowledge Gaps
- **4491 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4486 more)
...
- **Why does `Database` connect `Community 61` to `Community 3`, `Community 5`, `Community 263`, `Community 8`, `Community 9`, `Community 11`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 28`, `Community 32`, `Community 38`, `Community 166`, `Community 39`, `Community 172`, `Community 305`, `Community 50`, `Community 51`, `Community 66`, `Community 80`, `Community 107`?**
  _High betweenness centrality (0.247) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 5` to `Community 129`, `Community 2`, `Community 131`, `Community 514`, `Community 389`, `Community 132`, `Community 133`, `Community 7`, `Community 137`, `Community 266`, `Community 12`, `Community 13`, `Community 270`, `Community 17`, `Community 146`, `Community 152`, `Community 153`, `Community 26`, `Community 29`, `Community 30`, `Community 162`, `Community 163`, `Community 164`, `Community 292`, `Community 36`, `Community 44`, `Community 45`, `Community 48`, `Community 49`, `Community 182`, `Community 312`, `Community 63`, `Community 64`, `Community 449`, `Community 450`, `Community 451`, `Community 67`, `Community 453`, `Community 69`, `Community 454`, `Community 72`, `Community 74`, `Community 462`, `Community 85`, `Community 342`, `Community 87`, `Community 89`, `Community 90`, `Community 121`, `Community 98`, `Community 230`, `Community 103`, `Community 122`, `Community 236`, `Community 238`, `Community 111`, `Community 124`, `Community 240`, `Community 242`, `Community 116`, `Community 505`, `Community 506`, `Community 508`, `Community 125`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.018140731906346116 - nodes in this community are weakly interconnected._
