...
## Corpus Check
- Large corpus: 2377 files · ~4,832,806 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15385 nodes · 27942 edges · 1016 communities (849 shown, 167 thin omitted)
...
- `invokeWithRetry()` --calls--> `attempt()`  [INFERRED]
  src/services/capgoApi.ts → tests/frontend-onboarding-analytics-model.unit.test.ts
...
## Communities (1016 total, 167 thin omitted)
...
Cohesion: 0.02
Nodes (127): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+119 more)
...
Cohesion: 0.04
Nodes (111): BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh() (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (88): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (98): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), resolveAppSetIconPath(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel() (+90 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (112): ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, applyInitAutoTestChange(), BuildProjectStepOutcome, CancelablePromptValue, cancelPackageJsonSelection(), capacitorConfigFiles (+104 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (106): BuilderCtaAction, BuilderCtaChoice, BuilderCtaContext, BuilderCtaSurface, BuilderSelect, BuilderSelectOption, BuilderSelectOptions, decideBuilderCtaSurface() (+98 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (75): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, id (+67 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (78): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, DataUpload (+70 more)
...
Cohesion: 0.03
Nodes (50): createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+42 more)
...
Cohesion: 0.04
Nodes (65): canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup() (+57 more)
...
Cohesion: 0.05
Nodes (69): uploadBundleInternal(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps, ChoiceOption (+61 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (67): streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+59 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (79): checkAppIdsExist(), findAppInOrganization(), cancelCommand(), markSnag(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep() (+71 more)
...
Cohesion: 0.05
Nodes (60): useGitHubProfileDialog(), createAiApiKey(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost() (+52 more)
...
Cohesion: 0.04
Nodes (50): CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+42 more)
...
Cohesion: 0.06
Nodes (53): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+45 more)
...
Cohesion: 0.05
Nodes (43): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, clearVersionAudits() (+35 more)
...
Cohesion: 0.07
Nodes (45): app, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload (+37 more)
...
Cohesion: 0.08
Nodes (37): fetchBundlePages(), isEmptyBundleListError(), handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse (+29 more)
...
Cohesion: 0.07
Nodes (29): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+21 more)
...
Cohesion: 0.08
Nodes (34): app, DataSetManifest, executeStatsQueryWithRetry(), hasPendingAppStatsRefresh(), syncSubscriptionAndEventsWithRetry(), getManifestSizeWithRetry(), onManifestCreateTestUtils, QueueLogMetadata (+26 more)
...
Cohesion: 0.07
Nodes (35): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates() (+27 more)
...
Cohesion: 0.06
Nodes (31): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+23 more)
...
Cohesion: 0.09
Nodes (32): addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers() (+24 more)
...
Cohesion: 0.12
Nodes (29): APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, buildGettingStartedSteps(), GETTING_STARTED_STEP_DEFS (+21 more)

### Community 126 - "Community 126"
Cohesion: 0.11
Nodes (29): attempt(), CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildInteractionGraph(), buildV2V3SetupCliOutcomes() (+21 more)
...
Cohesion: 0.09
Nodes (22): checkVersionStatus(), computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), resolveInitDirectoryPath() (+14 more)
...
Cohesion: 0.18
Nodes (17): isRetryableStatsError(), isRetryableStatsResult(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), getErrorCode(), getRetryableStatus(), isMissingOrgError() (+9 more)
...
Cohesion: 0.16
Nodes (8): onboardingWriteChains, replaceUserOnboardingIfUnchanged(), serializeUserOnboardingWrite(), mainStore, mountedApps, preferenceKey, route, supabaseMocks
...
Cohesion: 0.20
Nodes (8): DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, asTimestamp(), getAppOnboardingFeature(), parseAppOnboardingFeature(), parseAppOnboardingLedger()
...
## Knowledge Gaps
- **5464 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5459 more)
...
- **Why does `Database` connect `Community 63` to `Community 2`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 26`, `Community 30`, `Community 159`, `Community 31`, `Community 34`, `Community 291`, `Community 41`, `Community 42`, `Community 60`, `Community 189`, `Community 62`, `Community 68`, `Community 70`, `Community 205`, `Community 345`, `Community 245`, `Community 246`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 512`, `Community 513`, `Community 131`, `Community 4`, `Community 262`, `Community 391`, `Community 136`, `Community 265`, `Community 521`, `Community 139`, `Community 266`, `Community 7`, `Community 14`, `Community 16`, `Community 17`, `Community 149`, `Community 279`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 166`, `Community 295`, `Community 38`, `Community 298`, `Community 172`, `Community 176`, `Community 48`, `Community 50`, `Community 177`, `Community 55`, `Community 56`, `Community 569`, `Community 58`, `Community 442`, `Community 570`, `Community 572`, `Community 186`, `Community 187`, `Community 64`, `Community 578`, `Community 67`, `Community 195`, `Community 72`, `Community 76`, `Community 77`, `Community 78`, `Community 80`, `Community 84`, `Community 88`, `Community 90`, `Community 95`, `Community 96`, `Community 98`, `Community 99`, `Community 105`, `Community 233`, `Community 114`, `Community 119`, `Community 508`, `Community 509`, `Community 510`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.023516136312344844 - nodes in this community are weakly interconnected._
