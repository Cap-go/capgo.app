...
## Corpus Check
- Large corpus: 2126 files · ~4,465,754 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13926 nodes · 25700 edges · 951 communities (798 shown, 153 thin omitted)
...
## Communities (951 total, 153 thin omitted)
...
Cohesion: 0.03
Nodes (135): app, bodySchema, CreateDeviceBody, baseDecision, decideAutoResolves(), buildReason(), evaluateChannel(), getRolloutVersionName() (+127 more)
...
Cohesion: 0.05
Nodes (109): withSupabaseSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+101 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (85): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (101): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), maybePromptBuilderCta(), shouldBlockIncompatibleUpload(), summarizeUploadCompatibility() (+93 more)
...
Cohesion: 0.03
Nodes (94): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), applyInitAutoTestChange(), BuildProjectStepOutcome, CancelablePromptValue (+86 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (60): ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, GLOBAL_STATS_TREND_DATES, NOW, ONBOARDING_INVITE_ORG_ID, ONBOARDING_INVITE_USER_ID (+52 more)
...
Cohesion: 0.04
Nodes (75): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (71): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), RSAKeys, AlertsReporter, checkAlerts(), VersionCheckResult (+63 more)
...
Cohesion: 0.05
Nodes (55): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+47 more)
...
Cohesion: 0.05
Nodes (43): CheckDomainResponse, UpdateDeliveryScope, UpdateDeliveryStatsResponse, DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS, DateRangePreset, DateRangePresetGroupKey (+35 more)
...
Cohesion: 0.05
Nodes (45): CANCEL, ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+37 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (42): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), hideLoader(), showLoader(), isNativeAppStoreContext() (+34 more)
...
Cohesion: 0.07
Nodes (46): buildCliRequestHeaders(), setCurrentCliCommand(), completePendingOnboardingApp(), cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats() (+38 more)
...
Cohesion: 0.05
Nodes (37): id, RBAC_ORG_ID, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id (+29 more)

### Community 60 - "Community 60"
Cohesion: 0.09
Nodes (46): checkVersionStatus(), addEncryptionStep(), cleanupStepsDone(), delay(), ensureUpdaterReadyBeforeSync(), getInitConfigLoadDir(), initApp(), promoteEncryptionSummaryToEnabled() (+38 more)
...
Cohesion: 0.12
Nodes (47): addAppStep(), addChannelStep(), addCodeChangeStep(), askForAppId(), askForAppName(), askForExistingDirectoryPath(), askForReplacementAppId(), askForWebDir() (+39 more)
...
Cohesion: 0.04
Nodes (33): App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload, mocks, CreditMetric (+25 more)
...
Cohesion: 0.08
Nodes (38): addUpdaterStep(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallBlocker(), getUpdaterInstallCommand(), getUpdaterVersionToInstall(), handleBuildAndSyncFailure(), logUpdaterInstallStateDetails() (+30 more)
...
Cohesion: 0.08
Nodes (29): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), checkIndexPosition(), searchInDirectory() (+21 more)
...
Cohesion: 0.08
Nodes (32): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+24 more)
...
Cohesion: 0.08
Nodes (24): findAppInOrganization(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), getResumedOnboardingAccessError(), resolveInitTargetPath(), validateResumedOnboardingAccess(), getRunDeviceCommandForPlatform() (+16 more)
...
Cohesion: 0.09
Nodes (24): accumulateNumbers(), AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, bundleUsageSchema, bundleUsageTestUtils, checkOrganizationAccess(), fetchAppMetricsRows() (+16 more)
...
## Knowledge Gaps
- **4643 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4638 more)
...
- **Why does `Database` connect `Community 65` to `Community 2`, `Community 7`, `Community 9`, `Community 13`, `Community 14`, `Community 146`, `Community 19`, `Community 276`, `Community 24`, `Community 26`, `Community 31`, `Community 39`, `Community 40`, `Community 44`, `Community 47`, `Community 175`, `Community 48`, `Community 52`, `Community 180`, `Community 194`, `Community 71`, `Community 82`, `Community 87`, `Community 92`, `Community 110`, `Community 370`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 10` to `Community 130`, `Community 4`, `Community 134`, `Community 263`, `Community 8`, `Community 137`, `Community 138`, `Community 11`, `Community 140`, `Community 141`, `Community 528`, `Community 529`, `Community 17`, `Community 531`, `Community 21`, `Community 407`, `Community 23`, `Community 537`, `Community 279`, `Community 27`, `Community 156`, `Community 29`, `Community 157`, `Community 32`, `Community 162`, `Community 35`, `Community 36`, `Community 163`, `Community 167`, `Community 171`, `Community 172`, `Community 50`, `Community 311`, `Community 58`, `Community 188`, `Community 63`, `Community 64`, `Community 70`, `Community 72`, `Community 73`, `Community 80`, `Community 81`, `Community 84`, `Community 469`, `Community 470`, `Community 471`, `Community 89`, `Community 473`, `Community 474`, `Community 120`, `Community 94`, `Community 481`, `Community 98`, `Community 226`, `Community 100`, `Community 101`, `Community 357`, `Community 103`, `Community 109`, `Community 110`, `Community 114`, `Community 246`, `Community 118`, `Community 248`, `Community 251`, `Community 253`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4646 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.022922077922077923 - nodes in this community are weakly interconnected._
