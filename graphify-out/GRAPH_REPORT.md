# Graph Report - capgo.app  (2026-09-26)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2991 files · ~5,563,865 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 18050 nodes · 33550 edges · 1135 communities (962 shown, 173 thin omitted)
...
1. `scripts` - 200 edges
2. `scripts` - 196 edges
3. `supabaseAdmin()` - 185 edges
4. `getSupabaseClient()` - 155 edges
5. `Database` - 127 edges
6. `formatError()` - 101 edges
7. `executeSQL()` - 94 edges
...
## Communities (1135 total, 173 thin omitted)
...
Cohesion: 0.02
Nodes (293): checkAppIdsExist(), findAppInOrganization(), listPendingOnboardingApps(), waitLog(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), shouldStartInitBrowserLogin() (+285 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (195): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), validateCliRequestHeaderValue(), withSupabaseSource(), AppOnboardingProgressPatch (+187 more)
...
Cohesion: 0.03
Nodes (112): get(), getAll(), app, appGlobal, CreateApp, FetchStoreMetadataBody, AppWithOrg, checkEncryptedBundleEnforcement() (+104 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (99): TEST_ORG_ID, TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID (+91 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (126): syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+118 more)
...
Cohesion: 0.02
Nodes (82): fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool, deleteUserAs() (+74 more)
...
Cohesion: 0.03
Nodes (101): setCurrentCliCommand(), createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport (+93 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (86): getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId() (+78 more)
...
Cohesion: 0.03
Nodes (84): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, getActiveUploadReporter(), getBundle(), findMonorepoRoot, findNXMonorepoRoot (+76 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (88): addAppInternal(), appGettingStartedUrl(), ensureOptions(), formatAppGettingStartedMessage(), normalizeConsoleHost(), resolveAppGettingStartedMessage(), shouldPrintAppGettingStartedUrl(), checkIndexPosition() (+80 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (88): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+80 more)
...
Cohesion: 0.04
Nodes (92): OrganizationUpdatePayload, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, buildCredentialsSchema (+84 more)
...
Cohesion: 0.04
Nodes (55): STRIPE_EMULATOR_HEADERS, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (71): app, canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup() (+63 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (66): CheckDomainResponse, install(), PUBLIC_ROUTES, SsoEnforcementResponse, CreditMetricType, getFirstTierCreditUnitPricing(), sortCreditPricingSteps(), getErrorMessage() (+58 more)
...
Cohesion: 0.04
Nodes (64): getCallerMaxPriorityRank(), ALLOWED_ATTRIBUTE_KEYS, applyProviderUpdate(), AuthChange, createBodySchema, JSONB_PROVIDER_COLUMNS, requireManageSsoPermission(), requireMappingTargetsInOrg() (+56 more)
...
Cohesion: 0.06
Nodes (76): AdditiveSchemaSyncOptions, AdditiveSchemaSyncPlan, AdditiveSchemaSyncResult, buildAddCheckConstraintStatement(), buildAddColumnStatement(), buildAlterSequenceStatement(), buildAttachConstraintStatement(), buildCreateIndexStatement() (+68 more)
...
Cohesion: 0.05
Nodes (67): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, readKeyFile(), resolveKeyAndSource() (+59 more)
...
Cohesion: 0.04
Nodes (55): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+47 more)
...
Cohesion: 0.06
Nodes (51): assertCloudSqlDataApiResponseSucceeded(), CloudSqlDataApiResponse, MANIFEST_PER_VERSION_TABLE_SQL, ReadReplicaSchemaSyncPlan, assertCheckConstraintStatement(), assertColumnStatement(), assertCompleteDataApiResponse(), assertConstraintStatement() (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (52): ProgressResponse, useAppOnboardingCliProgress(), admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, APP_ONBOARDING_V3_STEP_IDS, appendAppOnboardingStepHistory() (+44 more)
...
Cohesion: 0.05
Nodes (52): app, DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema (+44 more)
...
Cohesion: 0.04
Nodes (32): LogData, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device, useAppDetailStore (+24 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (50): buildFileReadCacheRequest(), assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildInvalidAttachmentRangeResponse(), buildNormalizedUploadMetadataHeader() (+42 more)
...
Cohesion: 0.06
Nodes (39): app, AuthenticatedClient, bodySchema, hasAppliedBundle(), Observations, persistObservedProgress(), auth, dialect (+31 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (42): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+34 more)
...
Cohesion: 0.08
Nodes (22): withConfigWriteTarget(), DecryptResult, ZipResult, Channel, BundleCompatibilityOptions, CurrentBundleOptions, DeleteOldKeyOptions, DoctorOptions (+14 more)
...
Cohesion: 0.07
Nodes (36): buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString(), optionalTagString() (+28 more)
...
Cohesion: 0.05
Nodes (43): displayStore, mainStore, router, { t }, triggerFakeReplicationToast(), activeCount, canaryColor, canaryStatus (+35 more)
...
Cohesion: 0.08
Nodes (32): AppSettings, persistAppOnboarding(), put(), UpdateApp, buildTrackedAppOnboardingReadyBentoEvent(), mocks, org, getOrgAdminMemberEmailsForTagsMock (+24 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (31): useGitHubProfileDialog(), CLIActivityPayload, useRealtimeCLIFeed(), shouldShowCLIActivity(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes() (+23 more)
...
Cohesion: 0.06
Nodes (16): Channel, EncryptResult, ParsedSecurityError, EncryptBundleOptions, BundleCompatibilityEntry, CompatibilityReport, DoctorInfo, getCapacitorConfig() (+8 more)
...
Cohesion: 0.09
Nodes (26): conversion(), count(), formatOnboardingPaymentCohortMonth(), formatOnboardingPaymentCohortTimestamp(), getOnboardingPaymentCohortPeriod(), invalidReport(), OnboardingPaymentCohortReport, OnboardingPaymentCohortRow (+18 more)

### Community 105 - "Community 105"
Cohesion: 0.12
Nodes (34): post(), body, context, mocks, isAppOnboardingSource(), cleanStoredImageMetadata(), concatUint8Arrays(), isSameBytes() (+26 more)

### Community 106 - "Community 106"
Cohesion: 0.09
Nodes (30): pending, dialect, AnalyticsReader, AnalyticsRow, buildTodoDeviceQuery(), buildTodoSetQuery(), collectAnalyticsEvidence(), collectBundleEvidence() (+22 more)
...
Cohesion: 0.11
Nodes (27): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), runSupabaseResultWithRetry(), getErrorCode(), getRetryableStatus(), isMissingOrgError(), isRetryableCronSyncError() (+19 more)
...
Cohesion: 0.08
Nodes (27): createTracker(), {
  getLocalConfigMock,
  sendEventMock,
}, trackerIdentity, steps, trackerIdentity, OnboardingChannelStage, AnalyticsPrimitive, AnalyticsProperties (+19 more)
...
Cohesion: 0.07
Nodes (17): sizeClasses, doneCount, steps, app, assignment, channelEvents, events, organization (+9 more)
...
Cohesion: 0.11
Nodes (25): event(), mocks, profilePreparedEvent(), startSetupEvent(), emitCommittedSystemAppOnboardingHistory(), AppOnboardingBuilderStepId, AppOnboardingBuilderStepState, persistAppOnboardingMutation() (+17 more)
...
Cohesion: 0.11
Nodes (18): readReplicaSchemaCatalogFromMigrations(), readReplicaSchemaCatalog(), REPLICA_EXCLUDED_INDEXES, REPLICA_FUNCTIONS, REPLICA_SEQUENCES, REPLICA_TABLES, REPLICA_TYPES, replicaConfigPattern() (+10 more)
...
Cohesion: 0.08
Nodes (20): GateProbe, gateProject(), AllCredentials, allCredentialsSchema, buildCacheKeyOptionSchema, buildCacheOptionSchema, BuildCredentials, BuildNeededOptions (+12 more)
...
Cohesion: 0.10
Nodes (19): CLI_PROJECT_MODES, BundleCleanupOptions, bundleCleanupOptionsSchema, BundleCompatibilityOptions, bundleCompatibilityOptionsSchema, bundleDecryptOptionsSchema, BundleDeleteOptions, bundleDeleteOptionsSchema (+11 more)
...
Cohesion: 0.15
Nodes (16): cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogSpec, Order (+8 more)
...
Cohesion: 0.20
Nodes (9): ctxWith(), baseCtx, certDerFromP12(), certSha1(), MadeChainP12, MadeP12, makeChainP12(), makeP12() (+1 more)
...
Cohesion: 0.19
Nodes (9): aCtx(), withManifest(), aCtx(), androidCtx(), APPLE_KEY_CONTENT, APPLE_TRIPLET, iosCtx(), PLAY_JSON_B64 (+1 more)
...
Cohesion: 0.32
Nodes (3): onboardingRefreshBody, OnboardingSignals, refreshAppOnboardingBatch()
...
Cohesion: 0.67
Nodes (3): ReadReplicaSchemaReconciliationResult, ReadReplicaSchemaSyncResult, SchemaCompatibilityIssue

## Knowledge Gaps
- **6289 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6284 more)
...
- **Why does `Database` connect `Community 52` to `Community 3`, `Community 132`, `Community 4`, `Community 8`, `Community 9`, `Community 12`, `Community 17`, `Community 18`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 155`, `Community 29`, `Community 38`, `Community 39`, `Community 173`, `Community 46`, `Community 303`, `Community 63`, `Community 64`, `Community 191`, `Community 452`, `Community 69`, `Community 197`, `Community 76`, `Community 344`, `Community 90`, `Community 226`, `Community 99`, `Community 243`, `Community 122`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 641`, `Community 642`, `Community 131`, `Community 644`, `Community 7`, `Community 8`, `Community 137`, `Community 650`, `Community 136`, `Community 10`, `Community 13`, `Community 273`, `Community 19`, `Community 148`, `Community 405`, `Community 150`, `Community 278`, `Community 160`, `Community 161`, `Community 34`, `Community 165`, `Community 37`, `Community 299`, `Community 43`, `Community 49`, `Community 307`, `Community 308`, `Community 53`, `Community 309`, `Community 51`, `Community 311`, `Community 180`, `Community 312`, `Community 314`, `Community 62`, `Community 451`, `Community 581`, `Community 582`, `Community 583`, `Community 71`, `Community 585`, `Community 75`, `Community 587`, `Community 205`, `Community 77`, `Community 206`, `Community 80`, `Community 81`, `Community 595`, `Community 84`, `Community 215`, `Community 89`, `Community 91`, `Community 92`, `Community 93`, `Community 349`, `Community 225`, `Community 98`, `Community 354`, `Community 100`, `Community 105`, `Community 108`, `Community 109`, `Community 112`, `Community 117`, `Community 120`, `Community 121`, `Community 508`, `Community 125`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.019845170803637256 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02739960906690443 - nodes in this community are weakly interconnected._