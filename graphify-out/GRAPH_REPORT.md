...
## Corpus Check
- Large corpus: 2186 files · ~4,626,464 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 14751 nodes · 26776 edges · 950 communities (797 shown, 153 thin omitted)
...
## Communities (950 total, 153 thin omitted)
...
Cohesion: 0.02
Nodes (107): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+99 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (121): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+113 more)
...
Cohesion: 0.05
Nodes (105): withSupabaseSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (110): BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh() (+102 more)
...
Cohesion: 0.03
Nodes (111): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), setConfigWriteTarget(), addCodeStep(), applyInitAutoTestChange() (+103 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (87): assertCanManageApiKeysForOrgs(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (56): AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData(), buildAdminStackedBarChartOptions(), formatAdminStackedBarTooltip(), useAppPage(), UseAppPageOptions, buildPeriodSubtitle() (+48 more)
...
Cohesion: 0.04
Nodes (77): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys (+69 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (81): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+73 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (78): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, createChannel(), seedOptions, versionCache (+70 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (68): decryptChecksum(), decryptChecksumV3(), decryptSource(), checkIndexPosition(), searchInDirectory(), searchInFile(), decryptZip(), decryptZipInternal() (+60 more)
...
Cohesion: 0.03
Nodes (46): describeBackend, pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId, QueryFn (+38 more)
...
Cohesion: 0.03
Nodes (73): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+65 more)
...
Cohesion: 0.06
Nodes (59): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), completePendingOnboardingApp(), AlertsReporter, checkAlerts(), VersionCheckResult (+51 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (55): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), createPlansVisitTracker() (+47 more)
...
Cohesion: 0.10
Nodes (66): findAppInOrganization(), getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+58 more)
...
Cohesion: 0.05
Nodes (54): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+46 more)
...
Cohesion: 0.06
Nodes (49): aggregateNativeObserveSamples(), app, buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, bumpMetricBucket(), createNativeObserveAggregateState(), createSeries() (+41 more)
...
Cohesion: 0.07
Nodes (47): adminStore, authorized, displayStore, hasCheckoutIntent, hasCheckoutVisitors, hasTraffic, hasVisitors, isInitialLoading (+39 more)
...
Cohesion: 0.09
Nodes (40): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes() (+32 more)
...
Cohesion: 0.10
Nodes (38): syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution (+30 more)
...
Cohesion: 0.12
Nodes (29): isChannelSelfRequestBody(), isDevicePlatform(), isOptionalString(), isOptionalStringMaxLength(), isUpdateRequestBody(), DevicePlatform, fieldIssue(), getAllowedStatsActionsList() (+21 more)
...
Cohesion: 0.11
Nodes (25): ensureUpdaterReadyBeforeSync(), DependencySection, getDeclaredDependency(), getUpdaterInstallState(), PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson(), UpdaterInstallState (+17 more)
...
Cohesion: 0.13
Nodes (21): attempt(), CURRENT_START_MS, buildDailyAttempts(), buildFrontendOnboardingAnalytics(), buildFunnel(), comparePeriods(), findLargestDropoff(), FrontendOnboardingAnalytics (+13 more)
...
Cohesion: 0.13
Nodes (16): buildRecentGlobalStatsRepairDateIds(), calculateChurnRevenue(), calculateNrr(), getCompletedAppBuildOnboardingWindow(), getCompletedDayWindow(), getCurrentDayWindow(), getDailyWindow(), getDateId() (+8 more)
...
Cohesion: 0.21
Nodes (10): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), FRONTEND_ONBOARDING_VERSION, parseStrictPosthogDate(), POSTHOG_MAX_DATE_MS (+2 more)
...
- **Why does `Database` connect `Community 89` to `Community 3`, `Community 6`, `Community 9`, `Community 13`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 284`, `Community 30`, `Community 42`, `Community 48`, `Community 182`, `Community 185`, `Community 58`, `Community 61`, `Community 65`, `Community 71`, `Community 92`, `Community 106`, `Community 241`, `Community 247`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 11` to `Community 128`, `Community 257`, `Community 129`, `Community 259`, `Community 132`, `Community 5`, `Community 10`, `Community 139`, `Community 13`, `Community 15`, `Community 16`, `Community 528`, `Community 18`, `Community 529`, `Community 531`, `Community 146`, `Community 148`, `Community 409`, `Community 27`, `Community 156`, `Community 157`, `Community 286`, `Community 288`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 167`, `Community 168`, `Community 41`, `Community 47`, `Community 433`, `Community 178`, `Community 179`, `Community 52`, `Community 54`, `Community 60`, `Community 67`, `Community 70`, `Community 72`, `Community 73`, `Community 78`, `Community 81`, `Community 82`, `Community 84`, `Community 470`, `Community 471`, `Community 472`, `Community 87`, `Community 474`, `Community 475`, `Community 95`, `Community 97`, `Community 482`, `Community 503`, `Community 230`, `Community 361`, `Community 108`, `Community 114`, `Community 119`, `Community 123`, `Community 254`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023735810113519093 - nodes in this community are weakly interconnected._