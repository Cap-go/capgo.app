...
## Corpus Check
- Large corpus: 2921 files · ~5,482,954 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17716 nodes · 32907 edges · 1122 communities (950 shown, 172 thin omitted)
...
Cohesion: 0.01
Nodes (189): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+181 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (152): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+144 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (145): hasAppliedBundle(), app, bodySchema, RateLimitCounter, baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName() (+137 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (141): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+133 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (117): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+109 more)
...
Cohesion: 0.03
Nodes (102): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+94 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (113): buildCliRequestHeaders(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), completePendingOnboardingApp(), getAppIconStoragePath(), hostOptionsFromSupabase() (+105 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (104): AlertsReporter, checkAlerts(), VersionCheckResult, clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource (+96 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (78): fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool, fixtureId (+70 more)
...
Cohesion: 0.03
Nodes (74): AUTH_HEADER_NAMES, invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), validateCliRequestHeaderValue(), decryptChecksum(), decryptChecksumV3(), decryptSource() (+66 more)
...
Cohesion: 0.03
Nodes (68): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId, AuditLog (+60 more)
...
Cohesion: 0.05
Nodes (74): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), buildCordovaModeUploadExample(), buildMissingCapacitorConfigUploadMessage(), enhanceMissingCapacitorConfigUploadError(), loadUploadProjectConfig() (+66 more)
...
Cohesion: 0.04
Nodes (70): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), isNativeAppStoreContext() (+62 more)
...
Cohesion: 0.05
Nodes (74): getConfigWriteTarget(), resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+66 more)
...
Cohesion: 0.05
Nodes (68): waitForCommandResult(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), ConfirmOptions, intro(), log, PromptResult, SelectOption (+60 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (79): cancelCommand(), sendCliEvent(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep() (+71 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (67): getInvocationSource(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, appGettingStartedUrl(), AppListRow, ensureOptions() (+59 more)
...
Cohesion: 0.04
Nodes (50): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+42 more)
...
Cohesion: 0.04
Nodes (56): adminStore, displayStore, isLoading, loadDashboard(), loadError, loadQuestionFlow(), mainStore, questionFlowLoading (+48 more)
...
Cohesion: 0.05
Nodes (59): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+51 more)
...
Cohesion: 0.05
Nodes (49): getUniqueBaseData(), id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, triggerHeaders (+41 more)
...
Cohesion: 0.06
Nodes (48): aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildDeliveryDayChunks(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery() (+40 more)
...
Cohesion: 0.11
Nodes (15): withSupabaseSource(), Channel, currentBundle(), currentBundleInternal(), CurrentBundleRow, ChannelCurrentBundleOptions, OrganizationInfo, SDKResult (+7 more)
...
Cohesion: 0.07
Nodes (45): assertCanManageApiKeysForOrgsPg(), assertCanPromoteChannelInTransaction(), ChannelRow, DrizzleClient, fetchTargetChannel(), fetchVersionName(), getEffectiveApikey(), PgQueryClient (+37 more)
...
Cohesion: 0.10
Nodes (39): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+31 more)
...
Cohesion: 0.06
Nodes (39): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+31 more)
...
Cohesion: 0.10
Nodes (39): ProgressResponse, useAppOnboardingCliProgress(), admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, APP_ONBOARDING_V3_STEP_IDS, appendAppOnboardingStepHistory() (+31 more)
...
Cohesion: 0.08
Nodes (36): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, readInstallTimingEventsCFChunked(), updateDeliveryStatsTestUtils (+28 more)
...
Cohesion: 0.08
Nodes (34): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+26 more)
...
Cohesion: 0.08
Nodes (29): formatChannels(), wrapChannelValue(), checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult, UploadCompatibilitySummary, getReleaseType() (+21 more)
...
Cohesion: 0.08
Nodes (28): findAppInOrganization(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), selectOnboardingChannel(), cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath() (+20 more)
...
## Knowledge Gaps
- **6161 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6156 more)
...
- **Why does `Database` connect `Community 65` to `Community 128`, `Community 4`, `Community 6`, `Community 134`, `Community 11`, `Community 13`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 155`, `Community 28`, `Community 31`, `Community 34`, `Community 36`, `Community 170`, `Community 44`, `Community 45`, `Community 48`, `Community 51`, `Community 52`, `Community 66`, `Community 73`, `Community 331`, `Community 85`, `Community 93`, `Community 225`, `Community 112`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 130`, `Community 5`, `Community 7`, `Community 8`, `Community 137`, `Community 10`, `Community 140`, `Community 143`, `Community 19`, `Community 275`, `Community 152`, `Community 157`, `Community 158`, `Community 161`, `Community 33`, `Community 163`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 298`, `Community 174`, `Community 431`, `Community 305`, `Community 306`, `Community 179`, `Community 309`, `Community 310`, `Community 57`, `Community 188`, `Community 572`, `Community 573`, `Community 574`, `Community 576`, `Community 193`, `Community 578`, `Community 322`, `Community 198`, `Community 584`, `Community 75`, `Community 204`, `Community 205`, `Community 334`, `Community 81`, `Community 83`, `Community 340`, `Community 86`, `Community 87`, `Community 215`, `Community 217`, `Community 88`, `Community 120`, `Community 96`, `Community 224`, `Community 98`, `Community 121`, `Community 228`, `Community 101`, `Community 102`, `Community 104`, `Community 105`, `Community 494`, `Community 111`, `Community 118`, `Community 632`, `Community 633`, `Community 122`, `Community 635`, `Community 127`?**
