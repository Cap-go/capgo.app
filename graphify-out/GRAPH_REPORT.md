# Graph Report - capgo.app  (2026-08-09)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2132 files · ~4,470,260 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13947 nodes · 25727 edges · 960 communities (805 shown, 155 thin omitted)
...
## Communities (960 total, 155 thin omitted)
...
Cohesion: 0.02
Nodes (139): Channel, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+131 more)
...
Cohesion: 0.05
Nodes (104): check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions, ChannelLinkedVersion (+96 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), addCodeStep() (+110 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (113): AppBuildOnboardingMetricRow, AppBuildOnboardingMetrics, BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, buildLogsnagInsightsRetryMessage(), buildLogsnagInsightsShardMessage(), BuildShardStats (+105 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (101): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, maybePromptBuilderCta(), shouldBlockIncompatibleUpload() (+93 more)
...
Cohesion: 0.03
Nodes (78): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+70 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (82): get(), getAll(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization() (+74 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (83): createRSA(), setSetting(), setSettingInternal(), CompatibilityResult, getActiveUploadReporter(), configWriteTargetStore, loadConfig(), loadConfigForWrite() (+75 more)
...
Cohesion: 0.05
Nodes (47): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+39 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (51): createAuthenticatedSupabaseClient(), describeBackend, pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId (+43 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (52): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, semverApiKey (+44 more)
...
Cohesion: 0.05
Nodes (69): app, BillingPlanBentoState, buildBillingPlanBentoTags(), bytesToGb(), bytesToGBText(), bytesToMb(), bytesToMbText(), toFixed() (+61 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (78): findAppInOrganization(), wait(), waitLog(), getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+70 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (66): promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+58 more)
...
Cohesion: 0.03
Nodes (57): id, id, RBAC_ORG_ID, ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep() (+49 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (51): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+43 more)
...
Cohesion: 0.06
Nodes (58): buildCliRequestHeaders(), setCurrentCliCommand(), getInvocationSource(), completePendingOnboardingApp(), AlertsReporter, checkAlerts(), VersionCheckResult, addApp() (+50 more)
...
Cohesion: 0.07
Nodes (60): getConfigWriteTarget(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult (+52 more)
...
Cohesion: 0.05
Nodes (63): plans, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes (+55 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (57): trackMcpServerStarted(), clearSavedKey(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+49 more)
...
Cohesion: 0.11
Nodes (16): debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogSpec, Order, QueryStats (+8 more)
...
Cohesion: 0.10
Nodes (46): getBundleStorageGb(), getRegistersToday(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh(), checkPlanStatusOnly() (+38 more)
...
Cohesion: 0.09
Nodes (40): app, bodySchema, syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails (+32 more)
...
Cohesion: 0.08
Nodes (32): accumulateNumbers(), AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildNativeVersionCounts(), bundleUsageSchema, bundleUsageTestUtils, checkOrganizationAccess() (+24 more)
...
Cohesion: 0.13
Nodes (32): cancelCommand(), markSnag(), ensureNativePlatformForBuild(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions() (+24 more)
...
Cohesion: 0.11
Nodes (30): archive_queue_messages(), chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), DISCORD_IGNORED_ERROR_CODES, FailureDetail, getActionableQueueFailures() (+22 more)
...
Cohesion: 0.11
Nodes (28): countDemoSeededApps(), countNotificationEvent(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getNativeNotificationGlobalStats(), isMissingAppsWithPreviewColumnError(), isMissingBuildMetricColumnError() (+20 more)
...
Cohesion: 0.11
Nodes (17): ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, GLOBAL_STATS_TREND_DATES, NOW, ONBOARDING_INVITE_ORG_ID, ONBOARDING_INVITE_USER_ID (+9 more)
...
Cohesion: 0.18
Nodes (18): areGlobalStatsNumbersDifferent(), dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows(), getEmptyBuildShardStats() (+10 more)
...
Cohesion: 0.60
Nodes (5): createCustomer(), createStripeCustomer(), finalizePendingStripeCustomer(), getDefaultPlan(), getStripeCustomer()
...
## Knowledge Gaps
- **4653 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4648 more)
...
- **Why does `Database` connect `Community 77` to `Community 2`, `Community 5`, `Community 8`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 149`, `Community 22`, `Community 24`, `Community 281`, `Community 25`, `Community 28`, `Community 38`, `Community 46`, `Community 176`, `Community 51`, `Community 179`, `Community 54`, `Community 65`, `Community 69`, `Community 75`, `Community 88`, `Community 225`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 9` to `Community 256`, `Community 132`, `Community 7`, `Community 136`, `Community 137`, `Community 10`, `Community 11`, `Community 140`, `Community 142`, `Community 18`, `Community 19`, `Community 536`, `Community 537`, `Community 539`, `Community 283`, `Community 413`, `Community 160`, `Community 33`, `Community 545`, `Community 161`, `Community 36`, `Community 34`, `Community 166`, `Community 43`, `Community 172`, `Community 173`, `Community 56`, `Community 57`, `Community 187`, `Community 60`, `Community 61`, `Community 189`, `Community 62`, `Community 68`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 80`, `Community 82`, `Community 84`, `Community 89`, `Community 92`, `Community 93`, `Community 478`, `Community 351`, `Community 479`, `Community 480`, `Community 98`, `Community 94`, `Community 224`, `Community 482`, `Community 483`, `Community 359`, `Community 488`, `Community 105`, `Community 250`, `Community 103`, `Community 109`, `Community 117`, `Community 254`, `Community 122`, `Community 123`, `Community 124`, `Community 126`, `Community 511`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4656 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.023663810689514484 - nodes in this community are weakly interconnected._
