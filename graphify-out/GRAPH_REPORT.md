...
## Corpus Check
- Large corpus: 2713 files · ~5,173,570 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16987 nodes · 31374 edges · 1087 communities (914 shown, 173 thin omitted)
...
## Communities (1087 total, 173 thin omitted)
...
Cohesion: 0.04
Nodes (124): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+116 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (136): didCancel(), BillingPlanBentoState, buildBillingPlanBentoTags(), readNativeActiveDevicesSummaryCF(), readNativeDailyPlatformActiveCF(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange (+128 more)
...
Cohesion: 0.03
Nodes (97): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, isVersionDeleted() (+89 more)
...
Cohesion: 0.04
Nodes (65): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+57 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (68): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir() (+60 more)
...
Cohesion: 0.04
Nodes (79): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+71 more)
...
Cohesion: 0.08
Nodes (83): cancelCommand(), sendCliEvent(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep() (+75 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (69): calcKeyId(), createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), encryptChecksum(), encryptChecksumV3() (+61 more)
...
Cohesion: 0.05
Nodes (47): IncompatibleBundleError, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS, sleep(), throwTwoFactorComplianceRpcError(), TwoFactorComplianceNetworkError (+39 more)
...
Cohesion: 0.03
Nodes (36): LogData, STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device (+28 more)
...
Cohesion: 0.06
Nodes (49): createAiApiKey(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod() (+41 more)
...
Cohesion: 0.06
Nodes (46): app, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload (+38 more)
...
Cohesion: 0.08
Nodes (38): { cloudlogErrMock, queryPosthogHogqlMock }, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts() (+30 more)
...
Cohesion: 0.07
Nodes (32): readInitInternalLogLines(), runInitContactSupport(), ClipboardCandidate, copyToClipboard(), revealInFinder(), confirmMessage(), contactSupport(), ContactSupportDeps (+24 more)
...
Cohesion: 0.08
Nodes (44): aesKeyFromSecret(), buildNotificationBadgeStateQuery(), buildNotificationStatsQuery(), decryptNotificationToken(), decryptProviderSecretWithSecretKey(), decryptWithSecretKey(), deriveDeviceKey(), deriveNativeNotificationIdentity() (+36 more)
...
Cohesion: 0.09
Nodes (24): useGitHubProfileDialog(), ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, ApiKeyLoadScope, clearApiKeyScopeFilters(), confirmApiKeyDeletion(), confirmApiKeyRegeneration() (+16 more)
...
Cohesion: 0.10
Nodes (24): isAppListedInOrganization(), AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders() (+16 more)
...
Cohesion: 0.15
Nodes (21): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), getErrorCode() (+13 more)
...
Cohesion: 0.13
Nodes (16): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), createNotificationDeliveryEventProof(), createNotificationEventProof(), createNotificationIdentityProof() (+8 more)
...
## Knowledge Gaps
- **5912 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5907 more)
...
- **Why does `Database` connect `Community 44` to `Community 3`, `Community 6`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 276`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 156`, `Community 412`, `Community 31`, `Community 33`, `Community 166`, `Community 43`, `Community 174`, `Community 53`, `Community 182`, `Community 55`, `Community 320`, `Community 64`, `Community 72`, `Community 90`, `Community 371`, `Community 120`, `Community 123`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 9` to `Community 130`, `Community 5`, `Community 261`, `Community 134`, `Community 8`, `Community 7`, `Community 12`, `Community 140`, `Community 401`, `Community 147`, `Community 22`, `Community 152`, `Community 25`, `Community 153`, `Community 411`, `Community 154`, `Community 287`, `Community 544`, `Community 545`, `Community 546`, `Community 160`, `Community 548`, `Community 37`, `Community 294`, `Community 550`, `Community 296`, `Community 297`, `Community 34`, `Community 173`, `Community 557`, `Community 47`, `Community 48`, `Community 49`, `Community 306`, `Community 179`, `Community 190`, `Community 62`, `Community 191`, `Community 66`, `Community 67`, `Community 323`, `Community 204`, `Community 78`, `Community 209`, `Community 81`, `Community 83`, `Community 85`, `Community 470`, `Community 601`, `Community 602`, `Community 219`, `Community 604`, `Community 93`, `Community 89`, `Community 610`, `Community 99`, `Community 100`, `Community 98`, `Community 105`, `Community 108`, `Community 109`, `Community 113`, `Community 122`, `Community 124`, `Community 127`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5915 weakly-connected nodes found - possible documentation gaps or missing edges._
