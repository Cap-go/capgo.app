...
## Corpus Check
- Large corpus: 2964 files · ~5,538,406 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17915 nodes · 33261 edges · 1139 communities (965 shown, 174 thin omitted)
...
## Communities (1139 total, 174 thin omitted)
...
Cohesion: 0.02
Nodes (162): Channel, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+154 more)
...
Cohesion: 0.04
Nodes (150): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+142 more)
...
Cohesion: 0.03
Nodes (138): bodySchema, CreateDeviceBody, hasAppliedBundle(), syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), BillingPlanBentoState, buildBillingPlanBentoTags(), readNativeActiveDevicesSummaryCF() (+130 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (136): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+128 more)
...
Cohesion: 0.02
Nodes (79): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, getPublicKeyFingerprint(), testEncryption() (+71 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (89): getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch() (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (95): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, CompatibilityResult, getActiveUploadReporter(), optionsUploadSchema, Compatibility (+87 more)
...
Cohesion: 0.04
Nodes (83): flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+75 more)
...
Cohesion: 0.06
Nodes (64): getInitUpdaterPluginConfig(), reportInitOnboarding(), reportInitOnboardingStep(), initOnboardingSteps, ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES (+56 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (59): buildCordovaModeUploadExample(), buildMissingCapacitorConfigUploadMessage(), enhanceMissingCapacitorConfigUploadError(), loadUploadProjectConfig(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile() (+51 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (62): CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel(), formatCreditTierAmount() (+54 more)
...
Cohesion: 0.06
Nodes (55): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+47 more)
...
Cohesion: 0.04
Nodes (35): sizeClasses, doneCount, steps, app, assignment, channelEvents, events, organization (+27 more)
...
Cohesion: 0.05
Nodes (43): app, app, AuthenticatedClient, bodySchema, Observations, app, CliReplayBody, readOptionalString() (+35 more)
...
Cohesion: 0.08
Nodes (48): ProgressResponse, useAppOnboardingCliProgress(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS (+40 more)
...
Cohesion: 0.08
Nodes (45): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), writeConfigUpdater() (+37 more)
...
Cohesion: 0.06
Nodes (38): persistObservedProgress(), auth, dialect, mocks, overrides, pool, tx, mocks (+30 more)
...
Cohesion: 0.11
Nodes (27): isVersionDeleted(), app, DataSetManifest, onManifestCreateTestUtils, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest() (+19 more)
...
Cohesion: 0.11
Nodes (25): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+17 more)
...
Cohesion: 0.09
Nodes (26): resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), resolveInitDirectoryPath(), resolveInitTargetPath() (+18 more)
...
Cohesion: 0.17
Nodes (23): buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), emptyPlansAnalyticsResponse(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult(), getAdminPlansAnalytics() (+15 more)
...
Cohesion: 0.16
Nodes (16): archive_queue_messages(), getActionableQueueFailures(), getQueueBatchSize(), getQueueHttpConcurrency(), getQueueHttpTimeoutMs(), getQueueMaxReads(), getQueueVisibilityTimeout(), http_post_helper() (+8 more)
...
## Knowledge Gaps
- **6226 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6221 more)
...
- **Why does `Database` connect `Community 5` to `Community 2`, `Community 6`, `Community 135`, `Community 9`, `Community 13`, `Community 15`, `Community 274`, `Community 18`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 29`, `Community 31`, `Community 32`, `Community 159`, `Community 42`, `Community 171`, `Community 43`, `Community 50`, `Community 184`, `Community 61`, `Community 447`, `Community 72`, `Community 330`, `Community 591`, `Community 336`, `Community 91`, `Community 740`, `Community 230`, `Community 103`, `Community 109`, `Community 126`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 128`, `Community 132`, `Community 7`, `Community 648`, `Community 9`, `Community 137`, `Community 649`, `Community 12`, `Community 651`, `Community 10`, `Community 140`, `Community 145`, `Community 657`, `Community 280`, `Community 160`, `Community 161`, `Community 162`, `Community 163`, `Community 33`, `Community 165`, `Community 38`, `Community 293`, `Community 40`, `Community 300`, `Community 48`, `Community 177`, `Community 49`, `Community 307`, `Community 52`, `Community 309`, `Community 182`, `Community 55`, `Community 310`, `Community 58`, `Community 446`, `Community 319`, `Community 192`, `Community 66`, `Community 326`, `Community 582`, `Community 583`, `Community 584`, `Community 74`, `Community 586`, `Community 588`, `Community 207`, `Community 79`, `Community 208`, `Community 209`, `Community 210`, `Community 596`, `Community 80`, `Community 83`, `Community 87`, `Community 343`, `Community 90`, `Community 92`, `Community 221`, `Community 229`, `Community 102`, `Community 101`, `Community 106`, `Community 108`, `Community 111`, `Community 112`, `Community 119`, `Community 120`, `Community 506`, `Community 124`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.0206082581027083 - nodes in this community are weakly interconnected._
