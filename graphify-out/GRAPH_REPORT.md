# Graph Report - capgo.app  (2026-08-13)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2280 files · ~4,743,200 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15041 nodes · 27278 edges · 980 communities (821 shown, 159 thin omitted)
...
## Communities (980 total, 159 thin omitted)
...
Cohesion: 0.02
Nodes (255): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError() (+247 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (158): withConfigWriteTarget(), SuperOptions, AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema (+150 more)
...
Cohesion: 0.03
Nodes (158): getInvocationSource(), withSupabaseSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase() (+150 more)
...
Cohesion: 0.02
Nodes (129): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+121 more)
...
Cohesion: 0.04
Nodes (114): getErrorCode(), getRetryableStatus(), isMissingOrgError(), OrgToGet, syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), applyCreditsForMetric() (+106 more)
...
Cohesion: 0.04
Nodes (82): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), ConfirmOptions, intro(), log, PromptResult, SelectOption (+74 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (66): getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions (+58 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (54): createAuthenticatedSupabaseClient(), describeBackend, pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId (+46 more)
...
Cohesion: 0.03
Nodes (76): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+68 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (76): plans, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes (+68 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (66): app, bodySchema, mockContext, getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), mockContext, handleCheckoutSessionCompleted() (+58 more)
...
Cohesion: 0.05
Nodes (49): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+41 more)
...
Cohesion: 0.06
Nodes (48): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level (+40 more)
...
Cohesion: 0.08
Nodes (48): normalizeTargetLimit(), resolveTargetPlan(), aesKeyFromSecret(), buildNotificationBadgeStateQuery(), buildNotificationRegistryLookupQuery(), buildNotificationStatsQuery(), createNotificationDeliveryEventProof(), createNotificationDeliveryEventProofFromSecret() (+40 more)
...
Cohesion: 0.10
Nodes (38): APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, asTimestamp(), buildGettingStartedSteps() (+30 more)
...
Cohesion: 0.08
Nodes (32): aggregateInstallTimingsByVersion(), buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays, BundleInstallStatsItem, BundleInstallStatsRequest (+24 more)
...
Cohesion: 0.10
Nodes (25): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+17 more)
...
Cohesion: 0.13
Nodes (25): countDemoSeededApps(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getRegistersToday(), isMissingAppsWithPreviewColumnError(), isMissingBuildMetricColumnError() (+17 more)
...
Cohesion: 0.09
Nodes (23): AdminStatsTestApp, ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, getCoreSnapshotCountsAt(), getOnboardingFunnelDirect(), GLOBAL_STATS_TREND_DATES (+15 more)
...
Cohesion: 0.11
Nodes (19): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), countNotificationEvent(), getNativeNotificationGlobalStats(), buildGlobalNotificationStatsQuery() (+11 more)
...
Cohesion: 0.17
Nodes (13): calculateConversionRate(), countAppsWithPreview(), countRegisteredUsersForSnapshot(), getAppBuildOnboardingMetrics(), getCoreSnapshotCounts(), getGithubStars(), getPaidPlanTotal(), getPlanConversionRates() (+5 more)
...
## Knowledge Gaps
- **5353 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5348 more)
...
- **Why does `Database` connect `Community 80` to `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 149`, `Community 23`, `Community 25`, `Community 26`, `Community 285`, `Community 31`, `Community 35`, `Community 41`, `Community 42`, `Community 44`, `Community 45`, `Community 179`, `Community 184`, `Community 68`, `Community 196`, `Community 71`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 256`, `Community 129`, `Community 258`, `Community 255`, `Community 260`, `Community 131`, `Community 134`, `Community 11`, `Community 12`, `Community 13`, `Community 146`, `Community 20`, `Community 21`, `Community 22`, `Community 151`, `Community 155`, `Community 540`, `Community 541`, `Community 30`, `Community 543`, `Community 288`, `Community 417`, `Community 289`, `Community 32`, `Community 37`, `Community 549`, `Community 165`, `Community 166`, `Community 43`, `Community 175`, `Community 176`, `Community 50`, `Community 51`, `Community 55`, `Community 183`, `Community 64`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 90`, `Community 93`, `Community 95`, `Community 480`, `Community 481`, `Community 482`, `Community 99`, `Community 228`, `Community 484`, `Community 485`, `Community 103`, `Community 364`, `Community 492`, `Community 111`, `Community 112`, `Community 116`, `Community 248`, `Community 121`, `Community 126`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02350204539985562 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02179252270866633 - nodes in this community are weakly interconnected._