...
## Corpus Check
- Large corpus: 2758 files · ~5,218,009 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17197 nodes · 31766 edges · 1111 communities (941 shown, 170 thin omitted)
...
## Communities (1111 total, 170 thin omitted)
...
Cohesion: 0.02
Nodes (329): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), checkVersionStatus(), cancelCommand(), sendCliEvent(), waitLog() (+321 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (170): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase() (+162 more)
...
Cohesion: 0.02
Nodes (144): get(), getAll(), AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody (+136 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (160): Channel, CompatibilityResult, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+152 more)
...
Cohesion: 0.02
Nodes (120): categorizeHttpStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache (+112 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (131): app, bodySchema, CreateDeviceBody, syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), buildOnboardingIntentBentoEventData(), parseOrgOnboardingIntent() (+123 more)
...
Cohesion: 0.03
Nodes (78): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent() (+70 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (80): fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool, deleteUserAs() (+72 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (71): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, appGlobal (+63 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (81): getActiveUploadReporter(), OrganizationUpdatePayload, OrganizationUpdateResponse, resolveConfiguredOrganizationUpdateApiHost, resolveOrganizationUpdateApiHost(), setOrganization(), setOrganizationInternal(), updateOrganizationViaApi() (+73 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (81): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (73): BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart(), useDashboardDailyChartCycle(), useOrgBillingCycleChart(), BUILD_SERIES_KEYS (+65 more)
...
Cohesion: 0.03
Nodes (87): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (80): flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+72 more)
...
Cohesion: 0.04
Nodes (61): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), describeFetchFailure() (+53 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (52): categorizeCliError(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), isTelemetryDisabled(), IncompatibleBundleError, isTransientNetworkError() (+44 more)
...
Cohesion: 0.04
Nodes (56): headers, testRunId, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels() (+48 more)
...
Cohesion: 0.06
Nodes (52): readNativeObserveStats(), app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, periodForDays(), respondEvents() (+44 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (60): NativeNotificationQueueMessage, NativeNotificationRegistryRow, aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody() (+52 more)
...
Cohesion: 0.05
Nodes (48): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+40 more)
...
Cohesion: 0.06
Nodes (54): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes() (+46 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (15): async, Any, ASCSession, ASCTeam, Bool, Int, Never, NSImage (+7 more)
...
Cohesion: 0.08
Nodes (45): computeBuggyWeeklyInstallStats(), baseDecision, addDaysToDateOnly(), billingPeriodMetricsRange(), billingPeriodStatsTestUtils, formatBytes(), formatNumber(), getOrgIdForApp() (+37 more)
...
Cohesion: 0.07
Nodes (43): buildFileReadCacheRequest(), assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred() (+35 more)
...
Cohesion: 0.06
Nodes (44): app, bodySchema, SUPPORT_CHANNEL_TYPES, app, app, CliReplayBody, readOptionalString(), readProperties() (+36 more)
...
Cohesion: 0.06
Nodes (38): canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema (+30 more)
...
Cohesion: 0.07
Nodes (38): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+30 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (38): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+30 more)
...
Cohesion: 0.08
Nodes (39): buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution, ensureCustomerMetadata() (+31 more)
...
Cohesion: 0.11
Nodes (34): persistAppOnboarding(), getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, appendAppOnboardingStepHistory(), appendStepHistory(), AppOnboardingOutcome (+26 more)
...
Cohesion: 0.10
Nodes (32): assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions, renderNotificationHelper(), runCommand(), runInstall(), runSync() (+24 more)
...
Cohesion: 0.15
Nodes (32): Platform, baseResult(), decideAdvance(), decideAtStep(), decideStart(), drive(), EngineDeps, explainLiveUpdateOnboarding() (+24 more)
...
Cohesion: 0.09
Nodes (31): AxisConfig, colorChannelToLinear(), createChartColorWithOpacity(), createChartScales(), createStackedChartScales(), createXAxisConfig(), createYAxisConfig(), DARK_CHART_BACKGROUND (+23 more)
...
Cohesion: 0.11
Nodes (28): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+20 more)
...
Cohesion: 0.10
Nodes (20): app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getValidatedStatsRequestBody(), insightPeriodDays (+12 more)
...
Cohesion: 0.16
Nodes (21): isVersionDeleted(), DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getDeletedVersionAction(), getManifestEntryCount(), getMetadataBranch() (+13 more)
...
Cohesion: 0.09
Nodes (21): formatDoctorInstallHint(), allOutdated, declaredByPath, empty, extraLatestKeys, fresh, grouped, installCommand (+13 more)

### Community 207 - "Community 207"
Cohesion: 0.15
Nodes (16): Any, Bool, String, Decodable, Equatable, Identifiable, ASCSession, ASCTeam (+8 more)
...
Cohesion: 0.14
Nodes (12): Context, Context, GuidedFlowModel, URL, WKWebView, Coordinator, NSKeyValueObservation, NSViewRepresentable (+4 more)
...
Cohesion: 0.19
Nodes (16): getCurrentCliCommand(), AdminCliUsageStats, AdminCliUsageUser, aggregateTopUsersByEmail(), CliUsageEvent, emptyAdminCliUsageStats(), getAdminCliUsage(), getAdminCliUsageFromAE() (+8 more)
...
Cohesion: 0.14
Nodes (14): Data, Error, String, Void, URLResponse, WebViewContainer.Coordinator, WKDownload, WKDownloadDelegate (+6 more)
...
Cohesion: 0.27
Nodes (11): app, appGlobal, CreateApp, post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord() (+3 more)
...
Cohesion: 0.24
Nodes (12): assertPreviewChannelDeletePermission(), deletePreviewChannelAndBundle(), getEffectiveApikey(), loadPreviewAppForUpdate(), loadPreviewChannelForUpdate(), loadPreviewChannelOwner(), lockPreviewBundleLifecycle(), OwnerOrgRow (+4 more)
...
Cohesion: 0.18
Nodes (11): allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema, normalizeInviteRole(), PgTransactionClient, post() (+3 more)
...
Cohesion: 0.24
Nodes (10): { closeClientMock, getPgClientMock, queryMock }, ADMIN_AB_TEST_DEVELOPMENT_ENVIRONMENT_OUTCOMES, AdminABTestDevelopmentEnvironment, AdminABTestDevelopmentEnvironmentOutcomeName, AdminABTestDevelopmentEnvironmentRow, buildAdminABTestDevelopmentEnvironment(), DEVELOPMENT_ENVIRONMENTS, getAdminABTestDevelopmentEnvironment() (+2 more)
...
Cohesion: 0.24
Nodes (5): resolveChannelAddDuplicateOutcome(), isChannelAlreadyExistsError(), duplicateError, functionsHttpError, supabase
...
Cohesion: 0.33
Nodes (5): FlowStep, StepState, current, done, upcoming
...
- **Why does `Database` connect `Community 62` to `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 15`, `Community 18`, `Community 19`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 284`, `Community 158`, `Community 31`, `Community 35`, `Community 37`, `Community 169`, `Community 42`, `Community 426`, `Community 46`, `Community 180`, `Community 319`, `Community 83`, `Community 110`, `Community 376`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 5` to `Community 129`, `Community 263`, `Community 137`, `Community 10`, `Community 14`, `Community 145`, `Community 146`, `Community 20`, `Community 150`, `Community 153`, `Community 286`, `Community 30`, `Community 288`, `Community 33`, `Community 294`, `Community 295`, `Community 168`, `Community 425`, `Community 170`, `Community 297`, `Community 298`, `Community 45`, `Community 299`, `Community 559`, `Community 560`, `Community 561`, `Community 49`, `Community 563`, `Community 48`, `Community 565`, `Community 183`, `Community 186`, `Community 571`, `Community 189`, `Community 63`, `Community 193`, `Community 66`, `Community 65`, `Community 325`, `Community 199`, `Community 72`, `Community 329`, `Community 40`, `Community 331`, `Community 205`, `Community 335`, `Community 80`, `Community 81`, `Community 82`, `Community 41`, `Community 212`, `Community 79`, `Community 84`, `Community 215`, `Community 87`, `Community 91`, `Community 92`, `Community 96`, `Community 97`, `Community 100`, `Community 101`, `Community 486`, `Community 105`, `Community 109`, `Community 622`, `Community 623`, `Community 112`, `Community 625`, `Community 115`, `Community 631`, `Community 121`, `Community 382`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.017576616018542365 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.028198727189620618 - nodes in this community are weakly interconnected._
