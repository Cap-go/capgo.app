# Graph Report - capgo.app  (2026-08-15)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2332 files · ~4,784,214 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15218 nodes · 27648 edges · 996 communities (835 shown, 161 thin omitted)
...
## Communities (996 total, 161 thin omitted)
...
Cohesion: 0.02
Nodes (152): Channel, setSetting(), setSettingInternal(), withConfigWriteTarget(), SuperOptions, AppDebugOptions, appDebugOptionsSchema, AppOptions (+144 more)
...
Cohesion: 0.03
Nodes (127): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+119 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (88): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+80 more)
...
Cohesion: 0.05
Nodes (105): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase(), PendingOnboardingApp (+97 more)
...
Cohesion: 0.03
Nodes (99): checkAppIdsExist(), listPendingOnboardingApps(), addCodeStep(), applyInitAutoTestChange(), buildCodeDiffLines(), BuildProjectStepOutcome, CancelablePromptValue, capacitorConfigFiles (+91 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (79): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility() (+71 more)
...
Cohesion: 0.03
Nodes (59): appCreationApiKey, id, AppInsert, id, id, id, semverApiKey, id (+51 more)
...
Cohesion: 0.03
Nodes (46): createAuthenticatedSupabaseClient(), describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, pool (+38 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (70): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+62 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (62): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+54 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (68): cleanupStepsDone(), promoteEncryptionSummaryToEnabled(), tryResumeOnboarding(), ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions (+60 more)
...
Cohesion: 0.09
Nodes (78): completePendingOnboardingApp(), findAppInOrganization(), cancelCommand(), markSnag(), waitLog(), deleteAppInternal(), addAppStep(), addChannelStep() (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (55): DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema (+47 more)
...
Cohesion: 0.04
Nodes (57): TEST_ORG_ID, apiFetch(), id, testOrgId, createAppForTest(), isDuplicateAppCreationError(), fetchRest(), getAnonHeaders() (+49 more)
...
Cohesion: 0.05
Nodes (58): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser(), AppUsageByApp (+50 more)
...
Cohesion: 0.06
Nodes (58): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+50 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (53): getInvocationSource(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal(), AppCreateSource (+45 more)
...
Cohesion: 0.06
Nodes (51): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+43 more)
...
Cohesion: 0.05
Nodes (49): app, DataDevice, devicesBodySchema, orderItemSchema, platformSchema, app, createUtcDate(), DataStats (+41 more)
...
Cohesion: 0.08
Nodes (41): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), fileExists(), handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels() (+33 more)
...
Cohesion: 0.05
Nodes (39): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, createChannel(), seedOptions (+31 more)
...
Cohesion: 0.09
Nodes (44): APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, asTimestamp(), buildGettingStartedSteps() (+36 more)
...
Cohesion: 0.07
Nodes (26): ChannelPromotionPermissionChecker, ChannelPromotionTarget, findChannelsWithoutPromotionPermission(), formatChannelPromotionTargets(), checkPermissions(), CheckPermissionsOptions, hasPermission(), Permission (+18 more)
...
Cohesion: 0.08
Nodes (36): steps, AnalyticsPrimitive, AnalyticsProperties, CaptureEvent, createOnboardingDetailsFieldDebouncer(), createOnboardingProgressTracker(), CreateOnboardingProgressTrackerOptions, OnboardingAnalyticsFlow (+28 more)
...
Cohesion: 0.10
Nodes (34): createRSA(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), setConfigWriteTarget(), writeConfig() (+26 more)
...
Cohesion: 0.08
Nodes (25): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), getAssistedDependencies(), rememberPackageJsonPath() (+17 more)
...
Cohesion: 0.09
Nodes (28): adminStore, displayStore, isLoading, isLoadingStats, isReady, loadError, mainStore, router (+20 more)
...
Cohesion: 0.11
Nodes (29): attempt(), CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildV2Graph(), buildV2SetupCliOutcomes() (+21 more)
...
Cohesion: 0.10
Nodes (22): reportAppOnboardingProgress(), getTmpObjectPath(), markStepDone(), readTmpObj(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition (+14 more)
...
Cohesion: 0.10
Nodes (23): analyticsOptOutCommands, applyCommandAnalyticsOptOut(), applyRawCommandAnalyticsOptOut(), resolveCapgoReplayUrl(), resolveSupabaseReplayUrl(), shouldStartInitReplay(), startInitReplay(), baseGate (+15 more)
...
Cohesion: 0.12
Nodes (21): appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id, keyName() (+13 more)
...
Cohesion: 0.12
Nodes (18): AuthGuardTestContext, contextStorage, createTestContext(), getGuard(), MockFetchResponse, withTestContext(), getRedirect(), allowOnboardingDashboardExploration() (+10 more)

### Community 177 - "Community 177"
Cohesion: 0.09
Nodes (20): buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp(), seedReadyBundle(), createUserOrgBinding(), expectCreatedOrganizationPlan(), globalId (+12 more)
...
Cohesion: 0.13
Nodes (12): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), FrontendOnboardingInteractionEvent, FrontendOnboardingVersion, ONBOARDING_INTERACTION_EVENTS (+4 more)
...
Cohesion: 0.18
Nodes (16): clearInviteOrgQuery(), closeDropdown(), createNewOrg(), getLogoRefreshKey(), handleOrganizationInvitation(), isInvitation(), isSelected(), isSelectedApp() (+8 more)
...
Cohesion: 0.13
Nodes (16): DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS, DateRangePresetGroupKey, DateRangeQueryParams, DateRangeValue, getDateRangeForPreset(), getTableDateRangeSignature() (+8 more)
...
Cohesion: 0.17
Nodes (15): attributeCheckoutStarts(), AttributedCheckout, buildLogicalPlansOpenings(), buildPlansChartData(), DailyBillingPoint, DailyCheckoutIntentPoint, incrementCategory(), LogicalPlansOpening (+7 more)
...
Cohesion: 0.20
Nodes (13): numberLikeSchema, getDeliveryById(), getWebhookById(), queueWebhookDelivery(), getDeliveries(), getDeliveriesSchema, retryDelivery(), retryDeliverySchema (+5 more)
...
Cohesion: 0.32
Nodes (12): activeChannelVersionJoin(), getAlias(), getEffectiveDeviceChannelNamePostgres(), getSchemaUpdatesAlias(), getVersionSelect(), requestInfosChannelByIdPostgres(), requestInfosChannelByIdPostgresRollout(), requestInfosChannelDevicePostgres() (+4 more)
...
Cohesion: 0.43
Nodes (5): AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData(), buildAdminStackedBarChartOptions(), formatAdminStackedBarTooltip()
...
## Knowledge Gaps
- **5396 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5391 more)
...
- **Why does `Database` connect `Community 94` to `Community 3`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 26`, `Community 30`, `Community 164`, `Community 296`, `Community 47`, `Community 54`, `Community 57`, `Community 188`, `Community 66`, `Community 81`, `Community 210`, `Community 224`, `Community 251`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 258`, `Community 131`, `Community 132`, `Community 133`, `Community 134`, `Community 7`, `Community 135`, `Community 265`, `Community 138`, `Community 11`, `Community 268`, `Community 5`, `Community 270`, `Community 17`, `Community 274`, `Community 147`, `Community 149`, `Community 282`, `Community 155`, `Community 286`, `Community 161`, `Community 33`, `Community 34`, `Community 37`, `Community 166`, `Community 39`, `Community 552`, `Community 553`, `Community 42`, `Community 555`, `Community 428`, `Community 172`, `Community 173`, `Community 299`, `Community 45`, `Community 561`, `Community 51`, `Community 53`, `Community 183`, `Community 184`, `Community 59`, `Community 68`, `Community 72`, `Community 40`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 83`, `Community 91`, `Community 93`, `Community 99`, `Community 100`, `Community 107`, `Community 492`, `Community 493`, `Community 494`, `Community 108`, `Community 112`, `Community 240`, `Community 496`, `Community 497`, `Community 117`, `Community 504`, `Community 377`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5399 weakly-connected nodes found - possible documentation gaps or missing edges._
