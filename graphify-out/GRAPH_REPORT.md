...
## Corpus Check
- Large corpus: 2597 files · ~5,066,983 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16486 nodes · 30420 edges · 1058 communities (885 shown, 173 thin omitted)
...
Cohesion: 0.03
Nodes (138): app, loadDeployVersionAdoption(), getRegistrationMetadata(), BillingPlanBentoState, buildBillingPlanBentoTags(), bytesToGb(), bytesToGBText(), bytesToMb() (+130 more)
...
Cohesion: 0.03
Nodes (124): checkAppIdsExist(), findAppInOrganization(), listPendingOnboardingApps(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+116 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (88): fixtureId, orgId, AdminStatsTestApp, ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, getBillingSnapshotCountsAt() (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (90): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+82 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (95): OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), withSupabaseSource(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions (+87 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (97): AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi(), ManifestDiff, ManifestEntry, requestAiBumpLevel(), resolveAutoBumpLevelFromAi() (+89 more)
...
Cohesion: 0.04
Nodes (69): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+61 more)
...
Cohesion: 0.04
Nodes (72): AppOnboardingProgressPatch, check2FAComplianceForApp(), completePendingOnboardingApp(), ExistingOrganizationApp, hostOptionsFromSupabase(), PendingOnboardingApp, reportAppOnboardingProgress(), IncompatibleBundleError (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (59): STRIPE_EMULATOR_HEADERS, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert (+51 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (88): cancelCommand(), sendCliEvent(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep() (+80 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (73): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+65 more)
...
Cohesion: 0.05
Nodes (67): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitTargetPath(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId (+59 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (65): getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl() (+57 more)
...
Cohesion: 0.05
Nodes (57): getInvocationSource(), checkAppExists(), AlertsReporter, VersionCheckResult, addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource (+49 more)
...
Cohesion: 0.04
Nodes (43): TEST_ORG_ID, TEST_ORG_ID, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg(), bindOrgRole() (+35 more)
...
Cohesion: 0.04
Nodes (52): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels(), getUniqueBaseData(), id (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (52): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), validateCliRequestHeaderValue(), debugApp(), describeFetchFailure() (+44 more)
...
Cohesion: 0.04
Nodes (34): STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload (+26 more)
...
Cohesion: 0.05
Nodes (42): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg() (+34 more)
...
Cohesion: 0.06
Nodes (42): DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), PackageInstallState, PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson() (+34 more)
...
Cohesion: 0.08
Nodes (46): app, bodySchema, buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails (+38 more)
...
Cohesion: 0.07
Nodes (39): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility() (+31 more)
...
Cohesion: 0.15
Nodes (18): getCurrentCliCommand(), setCurrentCliCommand(), app, AdminCliUsageStats, AdminCliUsageUser, aggregateTopUsersByEmail(), CliUsageEvent, emptyAdminCliUsageStats() (+10 more)
...
- **Why does `Database` connect `Community 48` to `Community 2`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 24`, `Community 27`, `Community 31`, `Community 32`, `Community 163`, `Community 36`, `Community 35`, `Community 39`, `Community 41`, `Community 42`, `Community 52`, `Community 59`, `Community 315`, `Community 317`, `Community 60`, `Community 68`, `Community 76`, `Community 82`, `Community 83`, `Community 84`, `Community 99`, `Community 121`?**
  _High betweenness centrality (0.217) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 129`, `Community 153`, `Community 261`, `Community 133`, `Community 154`, `Community 136`, `Community 9`, `Community 5`, `Community 12`, `Community 13`, `Community 146`, `Community 278`, `Community 152`, `Community 537`, `Community 26`, `Community 538`, `Community 539`, `Community 157`, `Community 541`, `Community 287`, `Community 288`, `Community 542`, `Community 34`, `Community 411`, `Community 548`, `Community 292`, `Community 30`, `Community 168`, `Community 40`, `Community 171`, `Community 428`, `Community 172`, `Community 44`, `Community 182`, `Community 54`, `Community 58`, `Community 61`, `Community 192`, `Community 193`, `Community 194`, `Community 321`, `Community 70`, `Community 327`, `Community 200`, `Community 74`, `Community 205`, `Community 79`, `Community 81`, `Community 466`, `Community 594`, `Community 595`, `Community 597`, `Community 212`, `Community 88`, `Community 91`, `Community 120`, `Community 603`, `Community 94`, `Community 98`, `Community 102`, `Community 103`, `Community 106`, `Community 491`, `Community 109`, `Community 112`, `Community 116`, `Community 117`, `Community 376`, `Community 123`, `Community 125`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02226190476190476 - nodes in this community are weakly interconnected._
