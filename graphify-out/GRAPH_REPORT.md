...
## Corpus Check
- Large corpus: 2834 files · ~5,380,768 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17500 nodes · 32355 edges · 1122 communities (949 shown, 173 thin omitted)
...
## Communities (1122 total, 173 thin omitted)
...
Cohesion: 0.02
Nodes (124): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (131): didCancel(), BillingPlanBentoState, buildBillingPlanBentoTags(), readNativeActiveDevicesSummaryCF(), readNativeDailyPlatformActiveCF(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange (+123 more)
...
Cohesion: 0.03
Nodes (129): encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, maybePromptBuilderCta() (+121 more)
...
Cohesion: 0.03
Nodes (119): ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, addCodeStep(), applyInitAutoTestChange(), askForAppName(), askForExistingDirectoryPath(), askForExistingPackageJsonPath() (+111 more)
...
Cohesion: 0.05
Nodes (97): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions (+89 more)
...
Cohesion: 0.03
Nodes (72): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource() (+64 more)
...
Cohesion: 0.04
Nodes (56): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+48 more)
...
Cohesion: 0.04
Nodes (57): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, IncompatibleBundleError, CliUserError, isTransientNetworkError(), callTwoFactorComplianceRpcWithRetry() (+49 more)
...
Cohesion: 0.04
Nodes (73): defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), respondSummaryOrVersions(), sampleActionsForView() (+65 more)
...
Cohesion: 0.07
Nodes (76): findAppInOrganization(), cancelCommand(), listenForWaitLogContinue(), sendCliEvent(), waitLog(), buildWaitLogQuery(), isWaitLogContinueKey(), WaitLogQuery (+68 more)
...
Cohesion: 0.05
Nodes (68): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint(), formatSpawnOutput() (+60 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (60): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), AppOnboardingProgressPatch (+52 more)
...
Cohesion: 0.05
Nodes (48): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+40 more)
...
Cohesion: 0.08
Nodes (53): calcKeyId(), createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys (+45 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (22): fetchObserve(), addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal() (+14 more)
...
Cohesion: 0.05
Nodes (51): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+43 more)
...
Cohesion: 0.08
Nodes (55): checkAppIdsExist(), promptDoctorUpdateChoice(), askForAppId(), askForReplacementAppId(), ensureNativePlatformForBuild(), exitAfterFinishingReplay(), exitCanceledInitOnboarding(), formatGithubRepositoryList() (+47 more)
...
Cohesion: 0.07
Nodes (39): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig(), loadConfigForWrite() (+31 more)
...
Cohesion: 0.13
Nodes (19): createTestFlows(), DialogHarness, dismissDialog(), findDialogButton(), mountedApps, TestChannel, ChannelRolloutConfirmFlowsDeps, ChannelUpdatePackage (+11 more)
...
Cohesion: 0.14
Nodes (18): handleBuildAndSyncFailure(), waitForReadyConfirmation(), waitForReadyRetry(), DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), getUpdaterInstallState() (+10 more)
...
Cohesion: 0.24
Nodes (19): put(), UpdateApp, parseAppOnboardingPatch(), assertAllowedImagePath(), createPlatformAdminSignedImageUrl(), createSignedImageUrl(), decodePathnameSegments(), extractStorageImageKey() (+11 more)
...
- **Why does `Database` connect `Community 38` to `Community 3`, `Community 131`, `Community 5`, `Community 8`, `Community 13`, `Community 14`, `Community 18`, `Community 19`, `Community 21`, `Community 26`, `Community 29`, `Community 31`, `Community 288`, `Community 32`, `Community 34`, `Community 36`, `Community 167`, `Community 41`, `Community 42`, `Community 43`, `Community 46`, `Community 50`, `Community 60`, `Community 192`, `Community 193`, `Community 76`, `Community 77`, `Community 334`, `Community 220`, `Community 94`, `Community 370`, `Community 125`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 128`, `Community 5`, `Community 133`, `Community 7`, `Community 6`, `Community 9`, `Community 138`, `Community 12`, `Community 274`, `Community 148`, `Community 150`, `Community 157`, `Community 158`, `Community 161`, `Community 35`, `Community 37`, `Community 293`, `Community 172`, `Community 302`, `Community 303`, `Community 304`, `Community 175`, `Community 306`, `Community 51`, `Community 564`, `Community 565`, `Community 566`, `Community 183`, `Community 56`, `Community 568`, `Community 58`, `Community 570`, `Community 435`, `Community 308`, `Community 57`, `Community 55`, `Community 577`, `Community 70`, `Community 199`, `Community 200`, `Community 206`, `Community 78`, `Community 79`, `Community 338`, `Community 212`, `Community 85`, `Community 87`, `Community 343`, `Community 218`, `Community 219`, `Community 91`, `Community 97`, `Community 98`, `Community 228`, `Community 106`, `Community 107`, `Community 236`, `Community 493`, `Community 47`, `Community 109`, `Community 112`, `Community 113`, `Community 114`, `Community 117`, `Community 630`, `Community 631`, `Community 633`, `Community 124`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021211139896373056 - nodes in this community are weakly interconnected._