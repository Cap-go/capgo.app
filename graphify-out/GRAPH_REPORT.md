# Graph Report - capgo.app  (2026-09-24)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2968 files · ~5,541,072 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17948 nodes · 33301 edges · 1140 communities (969 shown, 171 thin omitted)
...
## Communities (1140 total, 171 thin omitted)
...
Cohesion: 0.02
Nodes (163): CLI_PROJECT_MODES, fetchObserve(), observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort(), parsePositiveInt() (+155 more)
...
Cohesion: 0.01
Nodes (195): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+187 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (138): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+130 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (140): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+132 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (137): app, DataUpload, baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction() (+129 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (109): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+101 more)
...
Cohesion: 0.03
Nodes (126): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+118 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (125): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), shouldStartInitBrowserLogin() (+117 more)
...
Cohesion: 0.03
Nodes (97): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+89 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): hostOptionsFromSupabase(), getActiveUploadReporter(), isTrustedOnboardingApiHost(), parseApiUrl(), OnboardingCheckOptions, hasCustomUpdaterEndpoint(), prepareOnboardingCheck(), startOnboardingCheck() (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (80): AppSettings, persistAppOnboarding(), put(), UpdateApp, bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema (+72 more)
...
Cohesion: 0.04
Nodes (85): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getScopedCreditSteps() (+77 more)
...
Cohesion: 0.04
Nodes (69): CheckDomainResponse, CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel() (+61 more)
...
Cohesion: 0.05
Nodes (66): streamCommandInInitPanel(), initOnboardingSteps, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (55): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshOne(), serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId (+47 more)
...
Cohesion: 0.04
Nodes (53): TEST_ORG_ID, createAuthenticatedSupabaseClient(), describeBackend, execFileAsync, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), deleteUserAs() (+45 more)
...
Cohesion: 0.05
Nodes (61): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+53 more)
...
Cohesion: 0.08
Nodes (27): addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), OrganizationUpdatePayload (+19 more)
...
Cohesion: 0.05
Nodes (45): TEST_ORG_ID, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg(), bindOrgRole(), fixtureId (+37 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (50): TableColumn, setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+42 more)
...
Cohesion: 0.07
Nodes (52): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult (+44 more)
...
Cohesion: 0.06
Nodes (51): buildCordovaModeUploadExample(), buildMissingCapacitorConfigUploadMessage(), enhanceMissingCapacitorConfigUploadError(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget() (+43 more)
...
Cohesion: 0.04
Nodes (27): sizeClasses, refreshOnboarding(), doneCount, steps, closeChannelFlow(), app, assignment, channelEvents (+19 more)
...
Cohesion: 0.08
Nodes (51): ProgressResponse, useAppOnboardingCliProgress(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS (+43 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (51): buildFileReadCacheRequest(), assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildInvalidAttachmentRangeResponse(), buildNormalizedUploadMetadataHeader() (+43 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (46): getAppIconStoragePath(), resolveAppSetIconPath(), isAppListedInOrganization(), assertChannelExists(), CapgoSupabaseClient, disableDownloadChannels(), setDefaultDownloadChannel(), AppListOptions (+38 more)
...
Cohesion: 0.06
Nodes (49): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), PackageInstallState (+41 more)
...
Cohesion: 0.08
Nodes (44): assertCanPromoteChannelInTransaction(), ChannelRow, DrizzleClient, fetchTargetChannel(), fetchVersionName(), getEffectiveApikey(), PgQueryClient, setChannel() (+36 more)
...
Cohesion: 0.06
Nodes (43): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildSubscriptionEventMetadata(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES, ChurnReason, compactMetadata() (+35 more)
...
Cohesion: 0.09
Nodes (36): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, lintFailures (+28 more)
...
Cohesion: 0.11
Nodes (35): APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, asTimestamp(), buildGettingStartedSteps() (+27 more)
...
Cohesion: 0.09
Nodes (29): pending, candidate(), dialect, AnalyticsReader, AnalyticsRow, buildTodoDeviceQuery(), buildTodoSetQuery(), collectAnalyticsEvidence() (+21 more)
...
Cohesion: 0.09
Nodes (27): Part, AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+19 more)
...
Cohesion: 0.12
Nodes (21): IncompatibleBundleError, trimTrailingSlashes(), capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS, getCommanderCode(), getCommandPath() (+13 more)
...
Cohesion: 0.13
Nodes (17): event(), mocks, startSetupEvent(), AppOnboardingBuilderStepId, AppOnboardingBuilderStepState, applyBuilderChecklistUpdate(), appStoreUpdate(), buildBuilderChecklistPatch() (+9 more)

### Community 233 - "Community 233"
Cohesion: 0.16
Nodes (19): mockContext, mockContext, invoiceCreatedOrUpdated(), buildTransferInvoiceFooter(), extractDataEvent(), getLicensedSubscriptionItem(), getStripeCustomerId(), getSubscriptionEndDate() (+11 more)
...
Cohesion: 0.18
Nodes (12): archive_queue_messages(), chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), getQueueAckChunkSize(), mapWithConcurrency(), mass_edit_queue_messages_cf_ids() (+4 more)
...
Cohesion: 0.22
Nodes (9): createdOrUpdated(), getPaidAtUpdate(), getPlanChangeTrackingEventName(), getRevenuePlans(), getSubscriptionTrackingState(), shouldTrackOrganizationUpgrade(), toStripeInfoUpdate(), updateStripeInfo() (+1 more)
...
Cohesion: 0.29
Nodes (8): getQueueBatchSize(), getQueueHttpConcurrency(), getQueueHttpTimeoutMs(), getQueueVisibilityTimeout(), isOnboardingQueue(), isVersionQueueFunction(), readQueue(), shouldRunQueueSyncInBackground()
...
Cohesion: 0.50
Nodes (3): mockContext, getStripeCustomerEmailFromEvent(), normalizeBillingEmail()

### Community 703 - "Community 703"
Cohesion: 0.40
Nodes (5): getActionableQueueFailures(), getQueueMaxReads(), http_post_helper(), reportQueueFailures(), truncateDiscordField()
...
## Knowledge Gaps
- **6247 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6242 more)
...
- **Why does `Database` connect `Community 52` to `Community 2`, `Community 5`, `Community 6`, `Community 12`, `Community 13`, `Community 16`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 156`, `Community 39`, `Community 40`, `Community 169`, `Community 45`, `Community 51`, `Community 60`, `Community 192`, `Community 450`, `Community 68`, `Community 75`, `Community 342`, `Community 220`, `Community 227`, `Community 101`, `Community 108`, `Community 124`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 512`, `Community 7`, `Community 8`, `Community 649`, `Community 650`, `Community 10`, `Community 140`, `Community 13`, `Community 652`, `Community 272`, `Community 17`, `Community 145`, `Community 20`, `Community 23`, `Community 154`, `Community 155`, `Community 158`, `Community 161`, `Community 34`, `Community 35`, `Community 42`, `Community 175`, `Community 47`, `Community 50`, `Community 310`, `Community 55`, `Community 313`, `Community 314`, `Community 59`, `Community 187`, `Community 188`, `Community 449`, `Community 322`, `Community 65`, `Community 194`, `Community 71`, `Community 328`, `Community 201`, `Community 588`, `Community 589`, `Community 590`, `Community 79`, `Community 592`, `Community 208`, `Community 594`, `Community 77`, `Community 84`, `Community 209`, `Community 82`, `Community 87`, `Community 217`, `Community 601`, `Community 91`, `Community 92`, `Community 348`, `Community 94`, `Community 218`, `Community 96`, `Community 100`, `Community 102`, `Community 104`, `Community 115`, `Community 123`, `Community 126`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.021131963942662924 - nodes in this community are weakly interconnected._
