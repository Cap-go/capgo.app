...
## Corpus Check
- Large corpus: 2947 files · ~5,525,481 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17807 nodes · 33059 edges · 1137 communities (963 shown, 174 thin omitted)
...
Cohesion: 0.02
Nodes (329): checkAppIdsExist(), findAppInOrganization(), listPendingOnboardingApps(), setConfigWriteTarget(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), shouldStartInitBrowserLogin(), addAppStep() (+321 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (217): buildCliRequestHeaders(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), completePendingOnboardingApp(), ExistingOrganizationApp, getAppIconStoragePath() (+209 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (175): Channel, SuperOptions, fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit() (+167 more)
...
Cohesion: 0.02
Nodes (135): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource() (+127 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (147): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+139 more)
...
Cohesion: 0.03
Nodes (89): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (107): isVersionDeleted(), hasAppliedBundle(), app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest() (+99 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (94): getActiveUploadReporter(), optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema (+86 more)
...
Cohesion: 0.03
Nodes (89): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+81 more)
...
Cohesion: 0.03
Nodes (78): useGitHubProfileDialog(), setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+70 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (63): buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds(), getBuildCount(), getBuildTotalSeconds() (+55 more)
...
Cohesion: 0.04
Nodes (78): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile() (+70 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (77): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), buildCordovaModeUploadExample(), buildMissingCapacitorConfigUploadMessage(), enhanceMissingCapacitorConfigUploadError(), loadUploadProjectConfig() (+69 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (64): fixtureId, orgId, AdminStatsTestApp, ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, getBillingSnapshotCountsAt() (+56 more)
...
Cohesion: 0.04
Nodes (59): CheckDomainResponse, install(), PUBLIC_ROUTES, SsoEnforcementResponse, CreditMetricType, getErrorMessage(), logAsUser(), AppUsageGlobalByApp (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (70): normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource (+62 more)
...
Cohesion: 0.04
Nodes (51): TEST_ORG_ID, getUniqueBaseData(), AutoTopUpSettings, originalSettings, CreditStep, headers, id, TEST_ORG_ID (+43 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (55): useAppPage(), UseAppPageOptions, buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), buildDemoUpdateDeliveryStats() (+47 more)
...
Cohesion: 0.05
Nodes (64): assertSyncResult(), parseSchema(), parseSchemaAsync(), safeParseSchema(), safeParseSchemaAsync(), SafeParseSchemaResult, SchemaError, StandardSchema (+56 more)
...
Cohesion: 0.06
Nodes (45): buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString(), optionalTagString() (+37 more)
...
Cohesion: 0.04
Nodes (46): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, Awaitable, ChannelInfo, ChannelsListResponse (+38 more)
...
Cohesion: 0.05
Nodes (33): STRIPE_EMULATOR_HEADERS, StripePriceResponse, TEST_ORG_ID, describeBackend, execFileAsync, query(), pool, ApiKeyBinding (+25 more)
...
Cohesion: 0.08
Nodes (39): isChannelSelfRequestBody(), isDevicePlatform(), isOptionalString(), isOptionalStringMaxLength(), isOptionalString(), isOptionalStringMaxLength(), isStatsRequestBody(), isValidStatsMetadata() (+31 more)
...
Cohesion: 0.11
Nodes (32): ProgressResponse, useAppOnboardingCliProgress(), admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, APP_ONBOARDING_V3_STEP_IDS, AppOnboardingOutcome (+24 more)
...
Cohesion: 0.09
Nodes (27): AUTH_HEADER_NAMES, invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), validateCliRequestHeaderValue(), cancelCommand(), debugApp(), describeFetchFailure() (+19 more)

### Community 114 - "Community 114"
Cohesion: 0.06
Nodes (16): sizeClasses, doneCount, steps, app, assignment, channelEvents, events, organization (+8 more)
...
Cohesion: 0.15
Nodes (30): baseResult(), decideAdvance(), decideAtStep(), decideStart(), drive(), explainLiveUpdateOnboarding(), gatherFacts(), GitRepoStatus (+22 more)
...
Cohesion: 0.09
Nodes (26): sendOnboardingEvent(), createTracker(), {
  getLocalConfigMock,
  sendEventMock,
}, trackerIdentity, steps, trackerIdentity, AnalyticsPrimitive, AnalyticsProperties (+18 more)
...
Cohesion: 0.11
Nodes (6): dismissOptionalPrompts(), screenshotDir, STRIPE_EMULATOR_HEADERS, test, dismissSupportPrompt(), isTimeoutError()
...
Cohesion: 0.10
Nodes (20): pending, AuthenticatedClient, bodySchema, Observations, AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), getTodoEvidenceNeeds(), loadTodoEvidenceCandidates() (+12 more)
...
Cohesion: 0.15
Nodes (25): buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult(), getAdminPlansAnalytics(), isOptionalString() (+17 more)
...
Cohesion: 0.14
Nodes (22): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), app (+14 more)
...
Cohesion: 0.14
Nodes (18): dialect, AnalyticsReader, AnalyticsRow, buildTodoDeviceQuery(), buildTodoSetQuery(), collectAnalyticsEvidence(), collectBundleEvidence(), collectChannelEvidence() (+10 more)
...
Cohesion: 0.10
Nodes (19): browserInvocationIndex, browserLoginIndex, builderAuthCallback, builderSource, indexSource, initActionSource, initActionStart, initCommandSource (+11 more)
...
Cohesion: 0.28
Nodes (10): BUILDER_STEP_IDS, BuilderOnboardingChecklist, BuilderPlatform, BuilderStepId, hasSupportedBuilderTodoList(), isBuilderTodoListSelected(), isRecord(), parseBuilderOnboardingChecklist() (+2 more)
...
Cohesion: 0.30
Nodes (11): getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), appendAppOnboardingStepHistory(), appendStepHistory(), applyAppOnboardingPatch(), getAppOnboardingStepHistoryChanges(), getRawStepRecords(), isRecord() (+3 more)
...
Cohesion: 0.18
Nodes (5): mountPreview(), createRouter(), mocks, createNavigation(), storage
...
Cohesion: 0.33
Nodes (9): appGettingStartedUrl(), formatAppGettingStartedMessage(), normalizeConsoleHost(), resolveAppGettingStartedMessage(), shouldPrintAppGettingStartedUrl(), makeTempDir(), tempDirs, withTempProject() (+1 more)
...
Cohesion: 0.80
Nodes (4): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow()
...
## Knowledge Gaps
- **6198 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6193 more)
...
- **Why does `Database` connect `Community 3` to `Community 4`, `Community 8`, `Community 11`, `Community 14`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 152`, `Community 24`, `Community 26`, `Community 29`, `Community 31`, `Community 32`, `Community 295`, `Community 167`, `Community 43`, `Community 45`, `Community 562`, `Community 56`, `Community 59`, `Community 443`, `Community 63`, `Community 327`, `Community 588`, `Community 80`, `Community 216`, `Community 93`, `Community 737`, `Community 233`, `Community 361`, `Community 113`, `Community 123`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 55` to `Community 645`, `Community 134`, `Community 9`, `Community 12`, `Community 13`, `Community 269`, `Community 15`, `Community 16`, `Community 17`, `Community 146`, `Community 153`, `Community 154`, `Community 28`, `Community 159`, `Community 162`, `Community 35`, `Community 36`, `Community 34`, `Community 300`, `Community 301`, `Community 44`, `Community 303`, `Community 48`, `Community 304`, `Community 306`, `Community 309`, `Community 442`, `Community 189`, `Community 62`, `Community 64`, `Community 65`, `Community 579`, `Community 68`, `Community 580`, `Community 582`, `Community 71`, `Community 584`, `Community 198`, `Community 72`, `Community 199`, `Community 74`, `Community 77`, `Community 334`, `Community 76`, `Community 75`, `Community 210`, `Community 594`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 215`, `Community 90`, `Community 92`, `Community 96`, `Community 99`, `Community 105`, `Community 107`, `Community 111`, `Community 116`, `Community 503`, `Community 122`, `Community 124`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.017557337430578895 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023074678458395996 - nodes in this community are weakly interconnected._