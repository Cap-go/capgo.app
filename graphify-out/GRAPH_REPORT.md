...
## Corpus Check
- Large corpus: 2550 files · ~5,003,042 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16245 nodes · 29860 edges · 1045 communities (875 shown, 170 thin omitted)
...
Cohesion: 0.02
Nodes (145): UpdateProbeResult, AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema (+137 more)
...
Cohesion: 0.03
Nodes (133): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+125 more)
...
Cohesion: 0.03
Nodes (112): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+104 more)
...
Cohesion: 0.03
Nodes (96): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+88 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (100): bodySchema, CreateDeviceBody, app, DataSetManifest, getRegistrationMetadata(), DeletedVersionAction, deleteIt(), deleteManifest() (+92 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (70): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+62 more)
...
Cohesion: 0.03
Nodes (102): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+94 more)
...
Cohesion: 0.03
Nodes (91): flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+83 more)
...
Cohesion: 0.03
Nodes (68): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, id, testOrgId (+60 more)
...
Cohesion: 0.05
Nodes (67): initOnboardingSteps, CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+59 more)
...
Cohesion: 0.04
Nodes (63): resolveAppSetIconPath(), cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue() (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (64): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), getInitUpdaterPluginConfig(), resolveInitTargetPath(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES (+56 more)
...
Cohesion: 0.04
Nodes (55): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+47 more)
...
Cohesion: 0.05
Nodes (56): isTelemetryDisabled(), decryptChecksum(), decryptChecksumV3(), decryptSource(), decryptZip(), decryptZipInternal(), resolvePublicKey(), toIvSessionKeyDecryptError() (+48 more)
...
Cohesion: 0.07
Nodes (31): addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers() (+23 more)
...
Cohesion: 0.10
Nodes (71): findAppInOrganization(), waitLog(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep() (+63 more)
...
Cohesion: 0.06
Nodes (53): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+45 more)
...
Cohesion: 0.06
Nodes (52): calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit(), buildStorageHourlyRows(), calculateStorageHourlyRows(), collectStorageVersionLifetimes() (+44 more)
...
Cohesion: 0.05
Nodes (35): TEST_ORG_ID, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createUserOrgBinding(), expectCreatedOrganizationPlan() (+27 more)
...
Cohesion: 0.07
Nodes (47): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+39 more)
...
Cohesion: 0.06
Nodes (48): app, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload (+40 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (39): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+31 more)
...
Cohesion: 0.06
Nodes (35): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, id, orgId, createUserAppBinding(), createUserOrgBinding() (+27 more)
...
Cohesion: 0.06
Nodes (27): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), Awaitable, ChannelInfo, ChannelsListResponse (+19 more)
...
Cohesion: 0.09
Nodes (36): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), getRunDeviceCommandForPlatform(), assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions (+28 more)
...
Cohesion: 0.08
Nodes (32): readInstallTimingEventsCFChunked(), aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample (+24 more)
...
## Knowledge Gaps
- **5733 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5728 more)
...
- **Why does `Database` connect `Community 26` to `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 530`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 25`, `Community 164`, `Community 37`, `Community 169`, `Community 42`, `Community 45`, `Community 49`, `Community 55`, `Community 311`, `Community 67`, `Community 196`, `Community 202`, `Community 76`, `Community 77`, `Community 80`, `Community 83`, `Community 359`, `Community 507`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 18` to `Community 6`, `Community 7`, `Community 135`, `Community 10`, `Community 11`, `Community 522`, `Community 523`, `Community 524`, `Community 138`, `Community 16`, `Community 526`, `Community 527`, `Community 147`, `Community 401`, `Community 144`, `Community 278`, `Community 279`, `Community 143`, `Community 534`, `Community 282`, `Community 283`, `Community 157`, `Community 285`, `Community 33`, `Community 162`, `Community 290`, `Community 38`, `Community 44`, `Community 47`, `Community 48`, `Community 51`, `Community 180`, `Community 53`, `Community 181`, `Community 60`, `Community 189`, `Community 317`, `Community 62`, `Community 192`, `Community 193`, `Community 63`, `Community 581`, `Community 454`, `Community 582`, `Community 72`, `Community 584`, `Community 201`, `Community 75`, `Community 590`, `Community 81`, `Community 211`, `Community 213`, `Community 85`, `Community 89`, `Community 145`, `Community 90`, `Community 272`, `Community 95`, `Community 96`, `Community 100`, `Community 104`, `Community 233`, `Community 109`, `Community 114`, `Community 115`, `Community 116`, `Community 118`, `Community 249`, `Community 124`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 11` to `Community 129`, `Community 132`, `Community 7`, `Community 10`, `Community 143`, `Community 16`, `Community 18`, `Community 150`, `Community 413`, `Community 416`, `Community 33`, `Community 290`, `Community 47`, `Community 48`, `Community 51`, `Community 60`, `Community 189`, `Community 318`, `Community 63`, `Community 320`, `Community 62`, `Community 452`, `Community 69`, `Community 72`, `Community 208`, `Community 81`, `Community 84`, `Community 88`, `Community 90`, `Community 91`, `Community 99`, `Community 100`, `Community 103`, `Community 104`, `Community 109`, `Community 237`, `Community 116`, `Community 118`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5736 weakly-connected nodes found - possible documentation gaps or missing edges._
