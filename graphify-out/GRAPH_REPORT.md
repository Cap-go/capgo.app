...
## Corpus Check
- Large corpus: 2989 files · ~5,562,222 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 18058 nodes · 33549 edges · 1125 communities (954 shown, 171 thin omitted)
...
Cohesion: 0.02
Nodes (312): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), cancelCommand() (+304 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (221): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+213 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (166): Channel, OrganizationUpdatePayload, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema (+158 more)
...
Cohesion: 0.03
Nodes (134): respondEvents(), hasAppliedBundle(), syncSubscriptionAndEventsWithRetry(), didCancel(), BillingPlanBentoState, buildBillingPlanBentoTags(), maybeAutoTopUpCredits(), applyCreditsForMetric() (+126 more)
...
Cohesion: 0.03
Nodes (93): TEST_ORG_ID, TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID (+85 more)
...
Cohesion: 0.03
Nodes (90): getActiveUploadReporter(), optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema (+82 more)
...
Cohesion: 0.04
Nodes (82): get(), getAll(), app, appGlobal, CreateApp, FetchStoreMetadataBody, AppWithOrg, checkEncryptedBundleEnforcement() (+74 more)
...
Cohesion: 0.04
Nodes (71): CheckDomainResponse, CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel() (+63 more)
...
Cohesion: 0.04
Nodes (57): buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), buildTrackedAppOnboardingReadyBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+49 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (59): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshOne(), serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (68): getInvocationSource(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, appGettingStartedUrl(), AppListRow (+60 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (51): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers (+43 more)
...
Cohesion: 0.05
Nodes (68): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile() (+60 more)
...
Cohesion: 0.05
Nodes (57): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), isNativeAppStoreContext() (+49 more)
...
Cohesion: 0.04
Nodes (28): sizeClasses, refreshOnboarding(), doneCount, steps, closeChannelFlow(), app, assignment, channelEvents (+20 more)
...
Cohesion: 0.06
Nodes (45): clearInitLogs(), clearPrompt(), ConfirmPrompt, emit(), INIT_CANCEL, InitCodeDiff, InitCodeDiffLine, InitEncryptionPhase (+37 more)
...
Cohesion: 0.05
Nodes (40): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), getUniqueBaseData(), id, insertDelta() (+32 more)
...
Cohesion: 0.08
Nodes (36): isTrustedOnboardingApiHost(), parseApiUrl(), BackgroundOnboardingCheck, PreparedOnboardingCheck, OnboardingCheckOptions, hasCustomUpdaterEndpoint(), prepareOnboardingCheck(), startOnboardingCheck() (+28 more)
...
Cohesion: 0.08
Nodes (43): nativeObserveActions, readNativeObserveStats(), app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondSampleView() (+35 more)
...
Cohesion: 0.08
Nodes (42): buildDeletedFileMarkerRequest(), buildFileReadCacheRequestsForPath(), buildWorkersFileCacheKey(), buildWorkersFileCacheRequests(), CacheLike, FILE_READ_CACHE_ORIGINS, FILE_READ_PATH_PREFIXES, fileReadCacheTestUtils (+34 more)
...
Cohesion: 0.08
Nodes (39): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+31 more)
...
Cohesion: 0.08
Nodes (40): buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution, ensureCustomerMetadata() (+32 more)
...
Cohesion: 0.08
Nodes (32): pending, dialect, AnalyticsReader, AnalyticsRow, buildTodoDeviceQuery(), buildTodoSetQuery(), collectAnalyticsEvidence(), collectBundleEvidence() (+24 more)
...
Cohesion: 0.08
Nodes (28): isRetryableDurableObjectFetchError(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env, normalizeContentType(), StoredR2Part (+20 more)
...
Cohesion: 0.10
Nodes (36): APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, asTimestamp(), buildGettingStartedSteps() (+28 more)
...
Cohesion: 0.08
Nodes (24): conversion(), count(), formatOnboardingPaymentCohortMonth(), formatOnboardingPaymentCohortTimestamp(), getOnboardingPaymentCohortPeriod(), invalidReport(), OnboardingPaymentCohortReport, OnboardingPaymentCohortRow (+16 more)
...
Cohesion: 0.11
Nodes (26): event(), mocks, profilePreparedEvent(), startSetupEvent(), emitCommittedSystemAppOnboardingHistory(), AppOnboardingBuilderStepId, AppOnboardingBuilderStepState, persistAppOnboardingMutation() (+18 more)
...
Cohesion: 0.12
Nodes (21): auth, dialect, mocks, overrides, pool, tx, getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking() (+13 more)
...
Cohesion: 0.10
Nodes (21): AuthGuardTestContext, contextStorage, createTestContext(), getGuard(), MockFetchResponse, withTestContext(), getRedirect(), allowOnboardingDashboardExploration() (+13 more)
...
Cohesion: 0.17
Nodes (16): FILE_READ_TRACKING_QUERY_PARAMS, getAttachmentFileIdFromReadPath(), app, buildWorkersCacheKey(), CachedFiles, CachedFilesLoopback, fetch(), FilesExecutionContext (+8 more)
...
Cohesion: 0.18
Nodes (6): app, AuthenticatedClient, bodySchema, Observations, persistObservedProgress(), mocks
...
## Knowledge Gaps
- **6287 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6282 more)
...
- **Why does `Database` connect `Community 68` to `Community 130`, `Community 3`, `Community 4`, `Community 7`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 21`, `Community 22`, `Community 26`, `Community 27`, `Community 28`, `Community 159`, `Community 32`, `Community 169`, `Community 47`, `Community 48`, `Community 52`, `Community 438`, `Community 311`, `Community 62`, `Community 70`, `Community 77`, `Community 333`, `Community 221`, `Community 102`, `Community 103`, `Community 124`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 132`, `Community 8`, `Community 9`, `Community 10`, `Community 138`, `Community 17`, `Community 277`, `Community 150`, `Community 23`, `Community 25`, `Community 155`, `Community 156`, `Community 29`, `Community 157`, `Community 162`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 46`, `Community 303`, `Community 304`, `Community 49`, `Community 306`, `Community 176`, `Community 307`, `Community 53`, `Community 566`, `Community 567`, `Community 568`, `Community 437`, `Community 570`, `Community 308`, `Community 60`, `Community 572`, `Community 55`, `Community 65`, `Community 580`, `Community 197`, `Community 198`, `Community 204`, `Community 78`, `Community 338`, `Community 83`, `Community 84`, `Community 85`, `Community 211`, `Community 214`, `Community 91`, `Community 220`, `Community 92`, `Community 93`, `Community 95`, `Community 100`, `Community 105`, `Community 107`, `Community 235`, `Community 495`, `Community 113`, `Community 116`, `Community 630`, `Community 631`, `Community 118`, `Community 633`, `Community 123`, `Community 126`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.018418083208968806 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02386827000493468 - nodes in this community are weakly interconnected._