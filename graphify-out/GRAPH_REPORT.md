...
## Corpus Check
- Large corpus: 2618 files · ~5,092,892 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16618 nodes · 30745 edges · 1066 communities (894 shown, 172 thin omitted)
...
## Communities (1066 total, 172 thin omitted)
...
Cohesion: 0.02
Nodes (148): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+140 more)
...
Cohesion: 0.03
Nodes (138): app, bodySchema, RateLimitCounter, syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), didCancel(), getBillingPlans(), invoiceUpcoming() (+130 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (132): calcKeyId(), encryptChecksum(), encryptChecksumV3(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, maybePromptBuilderCta() (+124 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (98): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+90 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (112): check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+104 more)
...
Cohesion: 0.03
Nodes (94): app, bodySchema, SUPPORT_CHANNEL_TYPES, app, bodySchema, CreateDeviceBody, app, AppContext (+86 more)
...
Cohesion: 0.03
Nodes (102): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+94 more)
...
Cohesion: 0.04
Nodes (79): TableColumn, useGitHubProfileDialog(), setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess() (+71 more)
...
Cohesion: 0.03
Nodes (61): fixtureId, orgId, orgId, scopeId, pgPool, fixtureId, orgId, QueryFn (+53 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (69): decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptSource(), generateSessionKey(), RSAKeys, assertMinCliVersion(), formatMinCliVersionMessage() (+61 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (76): flushDeferredCommandInvocation(), AlertsReporter, checkAlerts(), VersionCheckResult, AppListOptions, AppRow, displayApps(), formatAppListText() (+68 more)
...
Cohesion: 0.04
Nodes (70): waitForCommandResult(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), log, PromptResult (+62 more)
...
Cohesion: 0.03
Nodes (54): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, headers, id, orgId (+46 more)
...
Cohesion: 0.04
Nodes (64): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+56 more)
...
Cohesion: 0.04
Nodes (67): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+59 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (71): findAppInOrganization(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+63 more)
...
Cohesion: 0.05
Nodes (53): trackMcpServerStarted(), clearSavedKey(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage(), readKeyFile() (+45 more)
...
Cohesion: 0.05
Nodes (55): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, devicesBodySchema (+47 more)
...
Cohesion: 0.07
Nodes (53): ensureGitignored(), maybePromptStarCapgoRepo(), formatGithubRepositoryList(), maybeStarCapgoRepo(), additionalDefaultStarRepositories, checkIfStarred(), createAbortedError(), createStartRateLimiter() (+45 more)
...
Cohesion: 0.05
Nodes (44): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg() (+36 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (44): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+36 more)
...
Cohesion: 0.08
Nodes (43): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig() (+35 more)
...
Cohesion: 0.05
Nodes (35): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+27 more)
...
Cohesion: 0.07
Nodes (46): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes() (+38 more)
...
Cohesion: 0.08
Nodes (40): ensureNativePlatformForBuild(), getNativePlatformAvailability(), getSelectablePlatformOptions(), handleMissingPlatformSelection(), normalizeRunDevicePlatform(), PlatformChoice, runCapacitorPlatformAdd(), runInitDoctorDiagnostics() (+32 more)
...
Cohesion: 0.08
Nodes (33): app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getValidatedStatsRequestBody(), insightPeriodDays (+25 more)
...
Cohesion: 0.08
Nodes (29): resolveCapacitorConfigTargetPath(), throwCapacitorConfigPathError(), cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath(), markStepDone(), readTmpObj(), resolveInitDirectoryPath() (+21 more)
...
Cohesion: 0.14
Nodes (4): UploadHandler, buildFileHttpMetadata(), toBase64(), WritableStreamBuffer
...
Cohesion: 0.14
Nodes (27): cancelCommand(), sendCliEvent(), promptDoctorUpdateChoice(), getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets() (+19 more)
...
## Knowledge Gaps
- **5805 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5800 more)
...
- **Why does `Database` connect `Community 8` to `Community 3`, `Community 6`, `Community 7`, `Community 11`, `Community 525`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 27`, `Community 29`, `Community 31`, `Community 548`, `Community 164`, `Community 42`, `Community 49`, `Community 53`, `Community 55`, `Community 56`, `Community 60`, `Community 318`, `Community 66`, `Community 68`, `Community 209`, `Community 83`, `Community 368`, `Community 119`, `Community 254`?**
  _High betweenness centrality (0.203) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 260`, `Community 132`, `Community 5`, `Community 138`, `Community 139`, `Community 10`, `Community 140`, `Community 142`, `Community 411`, `Community 150`, `Community 279`, `Community 152`, `Community 23`, `Community 151`, `Community 27`, `Community 28`, `Community 540`, `Community 541`, `Community 542`, `Community 287`, `Community 33`, `Community 155`, `Community 288`, `Community 544`, `Community 37`, `Community 545`, `Community 158`, `Community 290`, `Community 553`, `Community 170`, `Community 291`, `Community 44`, `Community 43`, `Community 38`, `Community 45`, `Community 50`, `Community 51`, `Community 187`, `Community 188`, `Community 62`, `Community 319`, `Community 323`, `Community 69`, `Community 327`, `Community 201`, `Community 202`, `Community 76`, `Community 78`, `Community 208`, `Community 81`, `Community 469`, `Community 597`, `Community 87`, `Community 598`, `Community 600`, `Community 90`, `Community 88`, `Community 92`, `Community 606`, `Community 223`, `Community 96`, `Community 97`, `Community 100`, `Community 101`, `Community 107`, `Community 109`, `Community 112`, `Community 118`, `Community 125`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5808 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.022403011353287598 - nodes in this community are weakly interconnected._