...
## Corpus Check
- Large corpus: 2602 files · ~5,077,555 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16500 nodes · 30461 edges · 1052 communities (884 shown, 168 thin omitted)
...
## Communities (1052 total, 168 thin omitted)
...
Cohesion: 0.02
Nodes (146): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials (+138 more)
...
Cohesion: 0.02
Nodes (116): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+108 more)
...
Cohesion: 0.03
Nodes (117): get(), getAll(), CreateApp, AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle() (+109 more)
...
Cohesion: 0.04
Nodes (104): DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch(), handleManifest(), ManifestCleanupEntry (+96 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (113): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+105 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (63): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+55 more)
...
Cohesion: 0.03
Nodes (73): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir() (+65 more)
...
Cohesion: 0.04
Nodes (69): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), OrgResolverDeps, ownerOrgCache (+61 more)
...
Cohesion: 0.04
Nodes (70): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+62 more)
...
Cohesion: 0.10
Nodes (69): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+61 more)
...
Cohesion: 0.05
Nodes (50): isTelemetryDisabled(), IncompatibleBundleError, displayMembers(), DisplayOptions, listMembers(), listMembersInternal(), MemberInfo, PasswordPolicyConfig (+42 more)
...
Cohesion: 0.06
Nodes (51): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getGlobalAnalyticsProps() (+43 more)
...
Cohesion: 0.04
Nodes (31): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device, useAppDetailStore (+23 more)
...
Cohesion: 0.06
Nodes (53): checkVersionStatus(), buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint() (+45 more)
...
Cohesion: 0.09
Nodes (36): isAppInTargetOrganization(), handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, AppRow (+28 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (39): ensureUpdaterReadyBeforeSync(), handleBuildAndSyncFailure(), waitForVerifiedUpdaterInstall(), DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), getUpdaterInstallState() (+31 more)
...
Cohesion: 0.08
Nodes (38): app, bodySchema, CreateDeviceBody, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString() (+30 more)
...
Cohesion: 0.06
Nodes (32): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey() (+24 more)
...
Cohesion: 0.08
Nodes (34): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays (+26 more)
...
Cohesion: 0.08
Nodes (27): isAppListedInOrganization(), AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders() (+19 more)
...
Cohesion: 0.15
Nodes (26): promptDoctorUpdateChoice(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets() (+18 more)
...
Cohesion: 0.13
Nodes (19): SaveKeyOptions, BrowserLoginDependencies, BrowserLoginEvent, BrowserLoginOptions, defaults, listOrganizationIds(), loginInitInBrowser(), promptForKey() (+11 more)
...
Cohesion: 0.11
Nodes (17): app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getValidatedStatsRequestBody(), insightPeriodDays (+9 more)
...
Cohesion: 0.15
Nodes (18): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+10 more)
...
Cohesion: 0.35
Nodes (10): post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), applyAppOnboardingPatch(), isAppOnboardingSource() (+2 more)
...
Cohesion: 0.21
Nodes (11): cursorSchema, hasControlChars(), hasUnsafeDevicesQueryText(), hasUnsafeQueryText(), hasUnsafeStatsQueryText(), queryLimitNumberSchema, queryLimitSchema, queryLimitStringSchema (+3 more)
...
Cohesion: 0.48
Nodes (6): persistAppOnboarding(), put(), UpdateApp, parseAppOnboardingPatch(), lockOnboardingApp(), unlockOnboardingApp()
...
## Knowledge Gaps
- **5780 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5775 more)
...
- **Why does `Database` connect `Community 55` to `Community 3`, `Community 6`, `Community 8`, `Community 14`, `Community 16`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 29`, `Community 157`, `Community 30`, `Community 37`, `Community 40`, `Community 42`, `Community 46`, `Community 174`, `Community 48`, `Community 178`, `Community 316`, `Community 75`, `Community 206`, `Community 80`, `Community 208`, `Community 212`, `Community 109`, `Community 114`?**
  _High betweenness centrality (0.212) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 7` to `Community 130`, `Community 258`, `Community 5`, `Community 134`, `Community 135`, `Community 10`, `Community 11`, `Community 140`, `Community 12`, `Community 15`, `Community 144`, `Community 145`, `Community 146`, `Community 17`, `Community 534`, `Community 535`, `Community 536`, `Community 150`, `Community 538`, `Community 283`, `Community 284`, `Community 539`, `Community 408`, `Community 287`, `Community 288`, `Community 546`, `Community 35`, `Community 165`, `Community 170`, `Community 43`, `Community 300`, `Community 45`, `Community 173`, `Community 53`, `Community 56`, `Community 57`, `Community 58`, `Community 187`, `Community 188`, `Community 189`, `Community 321`, `Community 68`, `Community 327`, `Community 200`, `Community 201`, `Community 74`, `Community 202`, `Community 204`, `Community 589`, `Community 590`, `Community 79`, `Community 592`, `Community 465`, `Community 211`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 222`, `Community 478`, `Community 94`, `Community 95`, `Community 100`, `Community 102`, `Community 124`, `Community 113`, `Community 117`, `Community 120`, `Community 252`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02271880819366853 - nodes in this community are weakly interconnected._