# Graph Report - capgo-new  (2026-09-16)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2785 files · ~5,217,495 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17347 nodes · 31889 edges · 1127 communities (953 shown, 174 thin omitted)
...
Cohesion: 0.02
Nodes (125): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+117 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (144): app, syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), didCancel(), invoiceUpcoming(), BillingPlanBentoState, buildBillingPlanBentoTags(), readNativeActiveDevicesSummaryCF() (+136 more)
...
Cohesion: 0.03
Nodes (128): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+120 more)
...
Cohesion: 0.03
Nodes (104): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), OrgResolverDeps (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (129): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+121 more)
...
Cohesion: 0.05
Nodes (106): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+98 more)
...
Cohesion: 0.04
Nodes (100): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+92 more)
...
Cohesion: 0.04
Nodes (79): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes() (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (70): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser() (+62 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (83): globalId, WEBHOOK_TEST_ORG_ID, webhookApiKey, WebhookDelivery, DeliveryMessage, numberLikeSchema, apikeyHasOrgRight(), allowLocalWebhookUrls() (+75 more)
...
Cohesion: 0.04
Nodes (66): canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema, appIdParamSchema (+58 more)
...
Cohesion: 0.07
Nodes (38): completePendingOnboardingApp(), hostOptionsFromSupabase(), addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayMembers(), DisplayOptions (+30 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (80): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+72 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (64): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitTargetPath(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase (+56 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (65): promoteEncryptionSummaryToEnabled(), initOnboardingSteps, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+57 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (63): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, AlertsReporter (+55 more)
...
Cohesion: 0.05
Nodes (58): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), isNativeAppStoreContext() (+50 more)
...
Cohesion: 0.04
Nodes (56): resolveAppSetIconPath(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec (+48 more)
...
Cohesion: 0.04
Nodes (45): TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg(), bindOrgRole() (+37 more)
...
Cohesion: 0.06
Nodes (53): billingPaidAtCache, resolveBillingPaidAt(), shouldShowExpiredTrialCopy(), shouldShowExpiredTrialPlansState(), shouldShowPlanFailureBanner(), bindAppReader(), DEVICE_STORE, DEVICE_TF (+45 more)
...
Cohesion: 0.05
Nodes (48): BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart(), useDashboardDailyChartCycle(), useOrgBillingCycleChart(), BUILD_SERIES_KEYS (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (49): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+41 more)
...
Cohesion: 0.05
Nodes (41): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+33 more)
...
Cohesion: 0.09
Nodes (46): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+38 more)
...
Cohesion: 0.08
Nodes (41): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), buildCacheKey(), chartDataCache, clampToToday(), clearChartDataCache(), colorKeys (+33 more)
...
Cohesion: 0.06
Nodes (40): app, periodForDays(), app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema (+32 more)
...
Cohesion: 0.07
Nodes (41): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+33 more)
...
Cohesion: 0.06
Nodes (42): app, bodySchema, CreateDeviceBody, app, app, CliReplayBody, readOptionalString(), readProperties() (+34 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (20): Digester, noopDigester(), sha256Digester(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env (+12 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (38): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), getUniqueBaseData(), headers, id (+30 more)
...
Cohesion: 0.08
Nodes (35): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+27 more)
...
Cohesion: 0.08
Nodes (34): ensureSplashScreenForDirectUpdate(), ensureUpdaterReadyBeforeSync(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getPackageInstallCommand(), getSplashScreenVersionToInstall() (+26 more)
...
Cohesion: 0.11
Nodes (29): INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, AppOnboardingOutcome, AppOnboardingPatch, AppOnboardingSource (+21 more)
...
Cohesion: 0.13
Nodes (25): getInvocationSource(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppAddDuplicateOutcome (+17 more)
...
Cohesion: 0.13
Nodes (16): ALLOWED_HEADERS, AppScopedAttachmentPath, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, FinalPart, getAttachmentReadCandidateKeys(), getSafeAttachmentReadCandidateKeys() (+8 more)
...
Cohesion: 0.33
Nodes (10): CreateApp, post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), applyAppOnboardingPatch() (+2 more)
...
Cohesion: 0.36
Nodes (9): persistAppOnboarding(), put(), UpdateApp, appendAppOnboardingStepHistory(), appendStepHistory(), getAppOnboardingStepHistoryChanges(), isRecord(), parseSetupRecord() (+1 more)
...
## Knowledge Gaps
- **6095 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6090 more)
...
- **Why does `Database` connect `Community 36` to `Community 4`, `Community 133`, `Community 7`, `Community 8`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 539`, `Community 33`, `Community 162`, `Community 421`, `Community 38`, `Community 40`, `Community 41`, `Community 47`, `Community 177`, `Community 52`, `Community 59`, `Community 574`, `Community 62`, `Community 320`, `Community 69`, `Community 79`, `Community 82`, `Community 86`, `Community 97`, `Community 373`, `Community 121`, `Community 378`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 640`, `Community 5`, `Community 261`, `Community 7`, `Community 6`, `Community 9`, `Community 139`, `Community 399`, `Community 15`, `Community 146`, `Community 20`, `Community 151`, `Community 152`, `Community 154`, `Community 283`, `Community 156`, `Community 289`, `Community 291`, `Community 292`, `Community 37`, `Community 420`, `Community 294`, `Community 168`, `Community 295`, `Community 297`, `Community 35`, `Community 44`, `Community 45`, `Community 46`, `Community 174`, `Community 564`, `Community 565`, `Community 566`, `Community 55`, `Community 568`, `Community 57`, `Community 54`, `Community 571`, `Community 190`, `Community 191`, `Community 67`, `Community 196`, `Community 579`, `Community 326`, `Community 202`, `Community 74`, `Community 333`, `Community 80`, `Community 209`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 220`, `Community 479`, `Community 95`, `Community 99`, `Community 104`, `Community 105`, `Community 109`, `Community 111`, `Community 114`, `Community 120`, `Community 124`, `Community 637`, `Community 638`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 6` to `Community 5`, `Community 7`, `Community 141`, `Community 14`, `Community 399`, `Community 15`, `Community 20`, `Community 154`, `Community 35`, `Community 165`, `Community 44`, `Community 45`, `Community 435`, `Community 54`, `Community 311`, `Community 313`, `Community 64`, `Community 67`, `Community 196`, `Community 325`, `Community 199`, `Community 328`, `Community 330`, `Community 331`, `Community 80`, `Community 214`, `Community 215`, `Community 88`, `Community 89`, `Community 90`, `Community 98`, `Community 99`, `Community 109`, `Community 114`, `Community 245`, `Community 124`?**
