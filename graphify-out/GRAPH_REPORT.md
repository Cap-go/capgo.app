...
## Corpus Check
- Large corpus: 2948 files · ~5,526,740 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17821 nodes · 33080 edges · 1115 communities (943 shown, 172 thin omitted)
...
## Communities (1115 total, 172 thin omitted)
...
Cohesion: 0.03
Nodes (152): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), CapgoHttpOptions, Channel (+144 more)
...
Cohesion: 0.02
Nodes (142): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+134 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (122): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+114 more)
...
Cohesion: 0.02
Nodes (122): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+114 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (117): get(), getAll(), app, appGlobal, CreateApp, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists() (+109 more)
...
Cohesion: 0.02
Nodes (85): TEST_ORG_ID, fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, execFileAsync (+77 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (87): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+79 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+110 more)
...
Cohesion: 0.05
Nodes (79): DeliveryMessage, numberLikeSchema, apikeyHasOrgRight(), allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload() (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (87): app, bodySchema, autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel() (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (75): filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter(), publicDevice, BillingPlanBentoState (+67 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (62): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+54 more)
...
Cohesion: 0.08
Nodes (86): findAppInOrganization(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep() (+78 more)
...
Cohesion: 0.05
Nodes (65): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+57 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (64): getInvocationSource(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, appGettingStartedUrl(), AppListRow, ensureOptions() (+56 more)
...
Cohesion: 0.04
Nodes (51): resolveAppSetIconPath(), cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+43 more)
...
Cohesion: 0.04
Nodes (25): sizeClasses, doneCount, steps, app, assignment, channelEvents, events, organization (+17 more)
...
Cohesion: 0.06
Nodes (42): ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, ApiKeyLoadScope, clearApiKeyScopeFilters(), confirmApiKeyDeletion(), confirmApiKeyRegeneration(), createDialogButton() (+34 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (48): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshOne(), serviceRoleSupabase, unbindAppReader(), APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES (+40 more)
...
Cohesion: 0.10
Nodes (42): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), encryptSource(), generateSessionKey(), RSAKeys (+34 more)
...
Cohesion: 0.11
Nodes (32): admin, APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, APP_ONBOARDING_V3_STEP_IDS, appendAppOnboardingStepHistory(), appendStepHistory(), applyAppOnboardingPatch() (+24 more)
...
Cohesion: 0.10
Nodes (26): Part, AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+18 more)
...
Cohesion: 0.13
Nodes (24): isVersionDeleted(), onManifestCreateTestUtils, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getDeletedVersionAction(), getManifestEntryCount() (+16 more)
...
Cohesion: 0.15
Nodes (15): ProgressResponse, useAppOnboardingCliProgress(), AppOnboardingStepId, AppOnboardingStepStatus, deriveAppOnboardingOutcome(), getAppOnboardingStepIds(), mergeAppOnboarding(), parseAppOnboarding() (+7 more)
...
Cohesion: 0.14
Nodes (15): pending, AppOnboardingStepPosthogInput, getTodoEvidenceNeeds(), loadTodoEvidenceCandidates(), TodoEvidenceResult, Body, Database, LockedApp (+7 more)
...
## Knowledge Gaps
- **6199 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6194 more)
...
- **Why does `Database` connect `Community 46` to `Community 2`, `Community 3`, `Community 8`, `Community 13`, `Community 16`, `Community 19`, `Community 148`, `Community 24`, `Community 27`, `Community 28`, `Community 33`, `Community 162`, `Community 547`, `Community 36`, `Community 40`, `Community 47`, `Community 50`, `Community 434`, `Community 54`, `Community 67`, `Community 68`, `Community 71`, `Community 332`, `Community 78`, `Community 80`, `Community 218`, `Community 104`, `Community 119`, `Community 123`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 139`, `Community 270`, `Community 144`, `Community 21`, `Community 22`, `Community 23`, `Community 152`, `Community 153`, `Community 154`, `Community 156`, `Community 285`, `Community 34`, `Community 38`, `Community 170`, `Community 43`, `Community 44`, `Community 301`, `Community 174`, `Community 302`, `Community 303`, `Community 177`, `Community 433`, `Community 306`, `Community 307`, `Community 53`, `Community 566`, `Community 567`, `Community 568`, `Community 57`, `Community 570`, `Community 315`, `Community 572`, `Community 188`, `Community 62`, `Community 63`, `Community 320`, `Community 194`, `Community 195`, `Community 579`, `Community 196`, `Community 206`, `Community 207`, `Community 79`, `Community 337`, `Community 82`, `Community 49`, `Community 85`, `Community 86`, `Community 87`, `Community 217`, `Community 93`, `Community 94`, `Community 99`, `Community 228`, `Community 102`, `Community 106`, `Community 107`, `Community 492`, `Community 112`, `Community 628`, `Community 629`, `Community 118`, `Community 631`, `Community 126`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 22` to `Community 6`, `Community 135`, `Community 9`, `Community 10`, `Community 397`, `Community 14`, `Community 142`, `Community 21`, `Community 23`, `Community 154`, `Community 34`, `Community 44`, `Community 174`, `Community 49`, `Community 53`, `Community 57`, `Community 60`, `Community 188`, `Community 62`, `Community 449`, `Community 460`, `Community 206`, `Community 209`, `Community 210`, `Community 339`, `Community 86`, `Community 87`, `Community 88`, `Community 92`, `Community 223`, `Community 100`, `Community 106`, `Community 107`, `Community 112`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.03242717625671162 - nodes in this community are weakly interconnected._