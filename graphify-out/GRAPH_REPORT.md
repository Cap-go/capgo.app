# Graph Report - capgo.app  (2026-08-31)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2567 files · ~5,030,275 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16304 nodes · 29989 edges · 1040 communities (870 shown, 170 thin omitted)
...
1. `scripts` - 198 edges
2. `supabaseAdmin()` - 175 edges
3. `scripts` - 173 edges
4. `getSupabaseClient()` - 145 edges
5. `Database` - 126 edges
6. `formatError()` - 98 edges
7. `executeSQL()` - 82 edges
...
## Communities (1040 total, 170 thin omitted)
...
Cohesion: 0.02
Nodes (144): get(), getAll(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization() (+136 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (173): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+165 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (116): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+108 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (97): buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds(), getBuildCount(), getBuildTotalSeconds() (+89 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (122): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), buildAppIdConflictSuggestions() (+114 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (99): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, AlertsReporter, checkAlerts(), VersionCheckResult, deleteAppInternal() (+91 more)
...
Cohesion: 0.04
Nodes (103): app, autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel(), loadCompatibilityBundle() (+95 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (105): mockContext, mockContext, mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates() (+97 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (105): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi() (+97 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (89): getActiveUploadReporter(), configWriteTargetStore, isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), throwCapacitorConfigPathError(), withConfigWriteTarget() (+81 more)
...
Cohesion: 0.04
Nodes (72): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, appGlobal (+64 more)
...
Cohesion: 0.06
Nodes (87): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+79 more)
...
Cohesion: 0.04
Nodes (70): CheckDomainResponse, PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder (+62 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (89): cancelCommand(), sendCliEvent(), waitLog(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep() (+81 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (74): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getScopedCreditSteps() (+66 more)
...
Cohesion: 0.04
Nodes (70): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+62 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (69): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+61 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (65): getAppIconStoragePath(), resolveAppSetIconPath(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (68): getConfigWriteTarget(), getInitUpdaterPluginConfig(), resolveInitTargetPath(), reportInitOnboarding(), reportInitOnboardingStep(), InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps (+60 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (66): promoteEncryptionSummaryToEnabled(), ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions, SpinnerController (+58 more)
...
Cohesion: 0.04
Nodes (59): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+51 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (61): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+53 more)
...
Cohesion: 0.04
Nodes (43): TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createUserOrgBinding() (+35 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (61): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent (+53 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (48): useAppPage(), UseAppPageOptions, buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow (+40 more)
...
Cohesion: 0.05
Nodes (47): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+39 more)
...
Cohesion: 0.06
Nodes (46): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), hideLoader(), showLoader() (+38 more)
...
Cohesion: 0.04
Nodes (51): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+43 more)

### Community 59 - "Community 59"
Cohesion: 0.09
Nodes (45): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal() (+37 more)
...
Cohesion: 0.07
Nodes (49): getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handleMissingPhysicalIosRunTargets(), handleMissingSimulatorIosRunTargets() (+41 more)
...
Cohesion: 0.08
Nodes (40): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), emptyPlansAnalyticsResponse(), exactTrackingStartedAt(), explicitTransitionKind() (+32 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (42): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+34 more)
...
Cohesion: 0.07
Nodes (44): DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey (+36 more)
...
Cohesion: 0.05
Nodes (34): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+26 more)
...
Cohesion: 0.08
Nodes (39): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes(), countInstallSourcesCF() (+31 more)
...
Cohesion: 0.08
Nodes (29): createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash(), withAdminDashboardMinimize() (+21 more)
...
Cohesion: 0.09
Nodes (30): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, lintFailures (+22 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (32): readInstallTimingEventsCFChunked(), aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+24 more)
...
Cohesion: 0.09
Nodes (31): OnboardingAnalyticsFlow, OnboardingIntent, createOnboardingProgressPersistence(), CreateOnboardingProgressPersistenceOptions, OnboardingPersistOptions, OnboardingPersistResult, OnboardingProgressTrackingInitializationState, shouldInitializeOnboardingProgressTracking() (+23 more)
...
Cohesion: 0.06
Nodes (27): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), id, testOrgApiKey, testOrgId (+19 more)
...
Cohesion: 0.11
Nodes (27): buildTerminalImageDataUrl(), CliStream, createTerminalSnapshot(), createTerminalSnapshotNode(), defaultReplayTransport(), escapeHtml(), extractHtmlFragment(), findSerializedNodeId() (+19 more)
...
Cohesion: 0.14
Nodes (28): array(), boolean(), buildPlansAnalyticsPresentationState(), buildPlansAnalyticsSeries(), ChartDataPoint, ChartSeries, count(), counts() (+20 more)

### Community 139 - "Community 139"
Cohesion: 0.13
Nodes (30): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown() (+22 more)
...
Cohesion: 0.12
Nodes (20): AuthGuardTestContext, contextStorage, createTestContext(), getGuard(), MockFetchResponse, withTestContext(), getRedirect(), allowOnboardingDashboardExploration() (+12 more)
...
Cohesion: 0.10
Nodes (21): adminStore, cancelDebouncedSearchReload(), currentPage, displayStore, formatNumber(), formatPercent(), getOrganizationAttentionLabel(), isLoadingOrganizations (+13 more)
...
Cohesion: 0.11
Nodes (17): app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, insightPeriodDays, ORDER_KEYS (+9 more)
...
Cohesion: 0.15
Nodes (10): appGlobal, app, app, app, app, registerPluginStatsSbFallbacksForDeno(), appGlobal, consoleHeaders (+2 more)
...
Cohesion: 0.15
Nodes (16): getValidatedStatsRequestBody(), normalizeRangeDate(), appIdSchema, cursorSchema, deviceIdSchema, hasControlChars(), hasInvalidQueryLimitInput(), hasUnsafeDevicesQueryText() (+8 more)
...
Cohesion: 0.19
Nodes (15): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+7 more)
...
Cohesion: 0.21
Nodes (10): getActiveCliReplaySessionId(), isCliTelemetryDisabled(), createInitTelemetry(), InitProgressTelemetry, InitTelemetryOptions, ResumeCandidate, TelemetryProperties, TelemetryValue (+2 more)
...
Cohesion: 0.29
Nodes (8): app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload, validateReplayBody()
...
## Knowledge Gaps
- **5746 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5741 more)
...
- **Why does `Database` connect `Community 27` to `Community 2`, `Community 4`, `Community 7`, `Community 11`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 33`, `Community 165`, `Community 40`, `Community 170`, `Community 42`, `Community 43`, `Community 303`, `Community 47`, `Community 55`, `Community 59`, `Community 60`, `Community 196`, `Community 70`, `Community 199`, `Community 89`, `Community 351`, `Community 503`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 4` to `Community 129`, `Community 6`, `Community 520`, `Community 521`, `Community 522`, `Community 136`, `Community 524`, `Community 525`, `Community 393`, `Community 12`, `Community 272`, `Community 144`, `Community 145`, `Community 275`, `Community 148`, `Community 18`, `Community 532`, `Community 277`, `Community 146`, `Community 17`, `Community 23`, `Community 158`, `Community 288`, `Community 34`, `Community 164`, `Community 37`, `Community 39`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 264`, `Community 308`, `Community 181`, `Community 182`, `Community 265`, `Community 192`, `Community 193`, `Community 450`, `Community 13`, `Community 68`, `Community 580`, `Community 581`, `Community 583`, `Community 198`, `Community 202`, `Community 74`, `Community 76`, `Community 589`, `Community 78`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 92`, `Community 93`, `Community 96`, `Community 97`, `Community 109`, `Community 112`, `Community 115`, `Community 243`, `Community 116`, `Community 120`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 12` to `Community 131`, `Community 4`, `Community 133`, `Community 6`, `Community 265`, `Community 13`, `Community 17`, `Community 148`, `Community 23`, `Community 409`, `Community 34`, `Community 39`, `Community 44`, `Community 49`, `Community 54`, `Community 310`, `Community 448`, `Community 194`, `Community 68`, `Community 72`, `Community 202`, `Community 76`, `Community 205`, `Community 82`, `Community 84`, `Community 101`, `Community 231`, `Community 105`, `Community 108`, `Community 109`, `Community 112`, `Community 120`, `Community 506`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5749 weakly-connected nodes found - possible documentation gaps or missing edges._
