...
## Corpus Check
- Large corpus: 2521 files · ~4,978,559 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16109 nodes · 29404 edges · 1042 communities (876 shown, 166 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.8)
...
6. `formatError()` - 94 edges
7. `executeSQL()` - 77 edges
8. `findSavedKey()` - 76 edges
...
## Communities (1042 total, 166 thin omitted)
...
Cohesion: 0.02
Nodes (154): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+146 more)
...
Cohesion: 0.01
Nodes (169): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+161 more)
...
Cohesion: 0.04
Nodes (122): didCancel(), invoiceUpcoming(), BillingPlanBentoState, buildBillingPlanBentoTags(), buildOnboardingIntentBentoEventData(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange (+114 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (104): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+96 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (118): calcKeyId(), encryptChecksum(), encryptChecksumV3(), BuilderCtaAction, BuilderCtaChoice, BuilderCtaContext, BuilderCtaSurface, BuilderSelect (+110 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (70): createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+62 more)
...
Cohesion: 0.04
Nodes (82): aiBumpLevel, AiBumpLevelBody, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, AppWithOrg, checkEncryptedBundleEnforcement() (+74 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (92): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (62): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, describeBackend, id, testOrgId, appCreationApiKey, id (+54 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (78): enableSupabaseInstrumentation(), flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource (+70 more)
...
Cohesion: 0.05
Nodes (69): createRSA(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget() (+61 more)
...
Cohesion: 0.04
Nodes (62): CheckDomainResponse, PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, sortCreditPricingSteps() (+54 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (69): streamCommandInInitPanel(), initOnboardingSteps, CANCEL, ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions (+61 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (66): checkIndexPosition(), searchInDirectory(), searchInFile(), getActiveUploadReporter(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal() (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (56): isTelemetryDisabled(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptSource(), generateSessionKey(), RSAKeys, decryptZip() (+48 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (63): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitTargetPath(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase (+55 more)
...
Cohesion: 0.05
Nodes (58): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), createPlansVisitTracker() (+50 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (75): cancelCommand(), sendCliEvent(), waitLog(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), askForAppId() (+67 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (51): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+43 more)
...
Cohesion: 0.04
Nodes (62): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+54 more)
...
Cohesion: 0.05
Nodes (45): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, clearVersionAudits() (+37 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (60): AdditiveSchemaSyncOptions, AdditiveSchemaSyncPlan, AdditiveSchemaSyncResult, applyReadReplicaSchemaSync(), assertAppliedStatementsVisible(), assertCatalogObject(), assertSchemaCatalog(), assertSchemaColumn() (+52 more)
...
Cohesion: 0.06
Nodes (38): buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, toIdString(), TrackEventBody, base (+30 more)
...
Cohesion: 0.05
Nodes (36): TEST_ORG_ID, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createUserOrgBinding(), expectCreatedOrganizationPlan(), globalId, globalIdRbac (+28 more)
...
Cohesion: 0.06
Nodes (42): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates() (+34 more)
...
Cohesion: 0.07
Nodes (40): addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog(), stepToName(), ApiKeyListFilterOptions (+32 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (40): accumulateNumbers(), app, appGlobal, AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildNativeVersionCounts(), bundleUsageSchema (+32 more)
...
Cohesion: 0.07
Nodes (41): debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogSpec, Order (+33 more)
...
Cohesion: 0.08
Nodes (35): DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), PackageInstallState, PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson() (+27 more)
...
Cohesion: 0.08
Nodes (34): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult, UploadCompatibilitySummary, getReleaseType(), printReleaseType(), ReleaseTypeResult (+26 more)
...
Cohesion: 0.09
Nodes (31): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, lintFailures (+23 more)
...
Cohesion: 0.09
Nodes (30): parseBumpDecision(), app, buildBatches(), getTargetLanguageName(), keepTranslation(), LANGUAGE_NAMES, MessageEntry, parseTranslationObject() (+22 more)
...
Cohesion: 0.09
Nodes (26): AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders(), getAppListPath() (+18 more)
...
Cohesion: 0.11
Nodes (22): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts(), FRONTEND_ONBOARDING_TAB_SWITCH_STEPS (+14 more)
...
Cohesion: 0.08
Nodes (22): orgId, scopeId, buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp(), seedReadyBundle(), createDirectApiKeyWithBindings() (+14 more)
...
Cohesion: 0.11
Nodes (19): setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), AppScopedAttachmentPath, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, FinalPart (+11 more)
...
Cohesion: 0.13
Nodes (16): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), posthogBoolean(), sqlStr() (+8 more)
...
## Knowledge Gaps
- **5708 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5703 more)
...
- **Why does `Database` connect `Community 9` to `Community 129`, `Community 2`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 20`, `Community 22`, `Community 30`, `Community 36`, `Community 40`, `Community 169`, `Community 175`, `Community 49`, `Community 179`, `Community 312`, `Community 185`, `Community 58`, `Community 62`, `Community 67`, `Community 74`, `Community 76`, `Community 210`, `Community 213`, `Community 88`, `Community 100`, `Community 255`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 132`, `Community 5`, `Community 136`, `Community 8`, `Community 524`, `Community 13`, `Community 525`, `Community 526`, `Community 141`, `Community 528`, `Community 529`, `Community 400`, `Community 274`, `Community 14`, `Community 152`, `Community 153`, `Community 154`, `Community 283`, `Community 284`, `Community 29`, `Community 158`, `Community 31`, `Community 287`, `Community 537`, `Community 288`, `Community 155`, `Community 34`, `Community 165`, `Community 38`, `Community 168`, `Community 42`, `Community 299`, `Community 44`, `Community 174`, `Community 52`, `Community 53`, `Community 60`, `Community 317`, `Community 64`, `Community 193`, `Community 194`, `Community 195`, `Community 321`, `Community 581`, `Community 582`, `Community 72`, `Community 584`, `Community 73`, `Community 460`, `Community 77`, `Community 590`, `Community 206`, `Community 207`, `Community 83`, `Community 212`, `Community 85`, `Community 87`, `Community 89`, `Community 93`, `Community 95`, `Community 97`, `Community 98`, `Community 102`, `Community 106`, `Community 107`, `Community 120`, `Community 123`, `Community 254`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5711 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.022381486226777707 - nodes in this community are weakly interconnected._
