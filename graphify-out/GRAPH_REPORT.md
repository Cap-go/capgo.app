# Graph Report - capgo.app  (2026-08-22)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2437 files · ~4,903,055 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15707 nodes · 28580 edges · 1036 communities (871 shown, 165 thin omitted)
...
## Communities (1036 total, 165 thin omitted)
...
Cohesion: 0.02
Nodes (144): Channel, checkIndexPosition(), searchInDirectory(), searchInFile(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal() (+136 more)
...
Cohesion: 0.01
Nodes (163): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+155 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (103): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+95 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (110): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+102 more)
...
Cohesion: 0.05
Nodes (103): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+95 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (111): ExistingOrganizationApp, PendingOnboardingApp, applyInitAutoTestChange(), askForAppName(), askForWebDir(), BuildProjectStepOutcome, CancelablePromptValue, cancelBeforeAuthenticatedOnboarding() (+103 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (100): app, DataSetManifest, getRegistrationMetadata(), DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount() (+92 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (78): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+70 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (73): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, testOrgId (+65 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (63): STRIPE_EMULATOR_HEADERS, describeBackend, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id (+55 more)
...
Cohesion: 0.04
Nodes (67): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), OrgResolverDeps, ownerOrgCache (+59 more)
...
Cohesion: 0.04
Nodes (62): getActiveUploadReporter(), CapacitorConfig, ExtConfigPairs, CapacitorCliConfig, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions (+54 more)
...
Cohesion: 0.05
Nodes (60): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, AppChartRefreshState, ChartRefreshRequestResult, isChartDataStale(), isChartRefreshInProgress() (+52 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (60): ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+52 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (72): checkAppIdsExist(), findAppInOrganization(), listPendingOnboardingApps(), setConfigWriteTarget(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+64 more)
...
Cohesion: 0.06
Nodes (64): normalizeTargetLimit(), resolveTargetPlan(), analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret() (+56 more)
...
Cohesion: 0.05
Nodes (53): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (54): AppBuildOnboardingMetricRow, AppBuildOnboardingMetrics, applySubscriptionRevenue(), BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, BuildShardStats, BuildStats (+46 more)
...
Cohesion: 0.03
Nodes (36): pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId, appRbacId (+28 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (41): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, toIdString(), TrackEventBody (+33 more)
...
Cohesion: 0.07
Nodes (44): createRSA(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, addOrganization(), addOrganizationInternal(), deleteOrganization() (+36 more)
...
Cohesion: 0.07
Nodes (45): getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), getCreditTopUpProductIdFromCustomer(), handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout() (+37 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (45): aggregateNativeObserveSamples(), buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, bumpMetricBucket(), createNativeObserveAggregateState(), createSeries(), durationExpression (+37 more)
...
Cohesion: 0.07
Nodes (45): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit() (+37 more)
...
Cohesion: 0.08
Nodes (49): getErrorCode(), getRetryableStatus(), isMissingOrgError(), OrgToGet, syncSubscriptionAndEventsWithRetry(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange (+41 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (43): getInfoInternal(), getInstalledDependencies(), addUpdaterStep(), ensureSplashScreenForDirectUpdate(), ensureUpdaterReadyBeforeSync(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput() (+35 more)
...
Cohesion: 0.06
Nodes (41): AdminLegendDataChart, AdminLegendToggleChart, AdminStackedBarChartData, AdminStackedBarChartDataset, AdminStackedBarCompatibleDataset, AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData() (+33 more)
...
Cohesion: 0.06
Nodes (45): apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow, buildCompatibilityResult(), buildUploadPayload(), buildZipBuffer(), CAPACITOR_CONFIG_PATH, ChannelVersionRow (+37 more)
...
Cohesion: 0.05
Nodes (28): STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload (+20 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (35): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+27 more)
...
Cohesion: 0.07
Nodes (36): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers, id, orgId (+28 more)
...
Cohesion: 0.06
Nodes (30): app, bodySchema, bumpRateLimit(), hashRateLimitKey(), isEmailPreferencesRateLimited(), preferenceValueSchema, PublicEmailPreferenceKey, app (+22 more)
...
Cohesion: 0.08
Nodes (33): buildFrontendOnboardingDailySeries(), buildFrontendOnboardingDailySetupCliSeries(), buildFrontendOnboardingDailyTabSwitchSeries(), buildFrontendOnboardingDailyWelcomeOutcomeSeries(), buildFrontendOnboardingFunnelStages(), buildFrontendOnboardingFunnelSummaries(), buildFrontendOnboardingGraphMetrics(), createFrontendOnboardingAnalyticsLoader() (+25 more)
...
Cohesion: 0.10
Nodes (30): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), completePendingOnboardingApp() (+22 more)

### Community 98 - "Community 98"
Cohesion: 0.09
Nodes (33): setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+25 more)
...
Cohesion: 0.08
Nodes (28): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+20 more)
...
Cohesion: 0.11
Nodes (23): IncompatibleBundleError, CliUserError, trimTrailingSlashes(), capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS, getCommanderCode() (+15 more)
...
Cohesion: 0.11
Nodes (7): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), continueFromAppNameToIcon(), continueFromAppNameToOrganization(), test
...
Cohesion: 0.13
Nodes (18): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts(), FRONTEND_ONBOARDING_TAB_SWITCH_STEPS (+10 more)
...
Cohesion: 0.13
Nodes (17): { cloudlogErrMock, queryPosthogHogqlMock }, FRONTEND_ONBOARDING_PRODUCTION_HOST, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), FrontendOnboardingDailySetupCliEventKind (+9 more)
...
Cohesion: 0.15
Nodes (18): numberLikeSchema, apikeyHasOrgRight(), apikeyHasOrgRightWithPolicy(), checkApikeyMeetsOrgPolicy(), bodySchema, get(), apiKeyHasAppScopedBinding(), app (+10 more)
...
Cohesion: 0.13
Nodes (14): Digester, noopDigester(), sha256Digester(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env (+6 more)
...
Cohesion: 0.10
Nodes (16): clackReplicationReporter, DEPLOYMENT_REGIONS, DeploymentRegion, getClosestRegionFromTimeZone(), getCurrentTimeZone(), getOrderedRegions(), ReplicationProgressOptions, ReplicationProgressReporter (+8 more)
...
Cohesion: 0.16
Nodes (15): buildFrontendOnboardingDailySetupCliOutcomes(), classifyFrontendOnboardingDailySetupCliOutcome(), createFrontendOnboardingDailySetupCliOutcomeCounts(), createFrontendOnboardingDailySetupCliSignals(), findLatestAnchorIndex(), FRONTEND_ONBOARDING_DAILY_SETUP_CLI_OUTCOME_KEYS, FrontendOnboardingDailySetupCliAnchor, FrontendOnboardingDailySetupCliEvent (+7 more)
...
Cohesion: 0.11
Nodes (19): dependencies, happy-dom, ink, ink-spinner, @inkjs/ui, jsonwebtoken, @manypkg/tools, node-forge (+11 more)
...
Cohesion: 0.16
Nodes (12): CompatibilitySummary, DeploymentHistoryEntry, DeploymentPair, didPlatformChecksumMetadataChange(), getIncompatibilityReasons(), hasPlatformChecksum(), hasPlatformChecksumMetadataDrift(), IncompatibilityReason (+4 more)
...
Cohesion: 0.19
Nodes (12): markStepDone(), isCliTelemetryDisabled(), createInitTelemetry(), InitProgressTelemetry, InitTelemetryOptions, mergeInitProgressTelemetry(), parseInitProgressTelemetry(), ResumeCandidate (+4 more)
...
Cohesion: 0.35
Nodes (8): buildVersionCompareSql(), cfPartExpr(), compareVersionPrefix(), parseVersionCompareFilter(), parseVersionParts(), partExpr(), pgPartExpr(), VERSION_COMPARE_OPS
...
## Knowledge Gaps
- **5558 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5553 more)
...
- **Why does `Database` connect `Community 71` to `Community 131`, `Community 4`, `Community 3`, `Community 7`, `Community 9`, `Community 12`, `Community 14`, `Community 20`, `Community 22`, `Community 23`, `Community 26`, `Community 37`, `Community 165`, `Community 304`, `Community 54`, `Community 190`, `Community 65`, `Community 67`, `Community 68`, `Community 199`, `Community 203`, `Community 215`, `Community 100`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 128`, `Community 6`, `Community 7`, `Community 519`, `Community 520`, `Community 521`, `Community 11`, `Community 136`, `Community 523`, `Community 524`, `Community 143`, `Community 397`, `Community 144`, `Community 18`, `Community 275`, `Community 530`, `Community 146`, `Community 278`, `Community 279`, `Community 29`, `Community 158`, `Community 32`, `Community 35`, `Community 36`, `Community 164`, `Community 293`, `Community 41`, `Community 177`, `Community 50`, `Community 308`, `Community 309`, `Community 183`, `Community 184`, `Community 57`, `Community 185`, `Community 55`, `Community 64`, `Community 66`, `Community 579`, `Community 452`, `Community 580`, `Community 582`, `Community 197`, `Community 268`, `Community 202`, `Community 76`, `Community 588`, `Community 206`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 89`, `Community 94`, `Community 95`, `Community 222`, `Community 360`, `Community 107`, `Community 110`, `Community 112`, `Community 114`, `Community 116`, `Community 248`, `Community 121`, `Community 122`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02297974988891005 - nodes in this community are weakly interconnected._