...
## Corpus Check
- Large corpus: 2354 files · ~4,815,762 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15282 nodes · 27754 edges · 1005 communities (841 shown, 164 thin omitted)
...
## Communities (1005 total, 164 thin omitted)
...
Cohesion: 0.02
Nodes (312): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), cancelCommand(), markSnag(), waitLog(), setConfigWriteTarget() (+304 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (153): Channel, UpdateProbeResult, resolveCapacitorConfigTargetPath(), withConfigWriteTarget(), SuperOptions, AppDebugOptions, appDebugOptionsSchema, AppOptions (+145 more)
...
Cohesion: 0.03
Nodes (159): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase() (+151 more)
...
Cohesion: 0.02
Nodes (122): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+114 more)
...
Cohesion: 0.04
Nodes (121): syncSubscriptionAndEventsWithRetry(), didCancel(), getBillingPlans(), invoiceUpcoming(), syncBillingBentoTags(), syncBillingBentoTagsFromStoredStripeInfo(), BillingPlanBentoState, buildBillingPlanBentoTags() (+113 more)
...
Cohesion: 0.03
Nodes (84): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), CompatibilityResult, getActiveUploadReporter() (+76 more)
...
Cohesion: 0.05
Nodes (62): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), id, id, RBAC_ORG_ID, createChannel() (+54 more)
...
Cohesion: 0.05
Nodes (65): getInvocationSource(), reportAppOnboardingProgress(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal() (+57 more)
...
Cohesion: 0.04
Nodes (67): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, insertDelta(), productionChannel() (+59 more)
...
Cohesion: 0.06
Nodes (52): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+44 more)
...
Cohesion: 0.06
Nodes (48): buildCliRequestHeaders(), setCurrentCliCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogSpec (+40 more)
...
Cohesion: 0.07
Nodes (48): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildNotificationBadgeStateQuery(), createNotificationDeliveryEventProof() (+40 more)
...
Cohesion: 0.11
Nodes (29): attempt(), CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildInteractionGraph(), buildV2SetupCliOutcomes() (+21 more)
...
Cohesion: 0.12
Nodes (22): allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer(), createDeliveryRecord(), decodeSerializedWebhookSecret() (+14 more)
...
Cohesion: 0.09
Nodes (18): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), createStatsAppReadKey(), createStatsSiblingApp(), deleteApikeyById() (+10 more)
...
Cohesion: 0.16
Nodes (18): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, buildNativeObservePluginTotalDevicesCFQuery(), buildNativeObservePluginVersionsCFQuery() (+10 more)
...
Cohesion: 0.19
Nodes (16): DeliveryMessage, createTestPayload(), deliverWebhook(), disableWebhook(), getWebhookLogUrlMetadata(), getWebhookPayloadEvent(), getWebhookPayloadEventId(), incrementAttemptCount() (+8 more)
...
Cohesion: 0.18
Nodes (7): longLog, render(), renderReadOnly(), makeStdin(), makeStdout(), renderShellAt(), watchdog
...
Cohesion: 0.26
Nodes (10): getDeliveryById(), getWebhookById(), queueWebhookDelivery(), bodySchema, deleteWebhook(), getDeliveries(), getDeliveriesSchema, retryDelivery() (+2 more)
...
## Knowledge Gaps
- **5413 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5408 more)
...
- **Why does `Database` connect `Community 59` to `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 13`, `Community 14`, `Community 17`, `Community 147`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 29`, `Community 30`, `Community 287`, `Community 34`, `Community 35`, `Community 43`, `Community 178`, `Community 182`, `Community 57`, `Community 195`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 256`, `Community 129`, `Community 257`, `Community 259`, `Community 513`, `Community 260`, `Community 7`, `Community 9`, `Community 265`, `Community 11`, `Community 143`, `Community 15`, `Community 18`, `Community 276`, `Community 153`, `Community 27`, `Community 28`, `Community 158`, `Community 33`, `Community 290`, `Community 164`, `Community 165`, `Community 292`, `Community 39`, `Community 41`, `Community 42`, `Community 175`, `Community 560`, `Community 49`, `Community 434`, `Community 561`, `Community 563`, `Community 181`, `Community 54`, `Community 176`, `Community 60`, `Community 62`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 198`, `Community 73`, `Community 74`, `Community 76`, `Community 80`, `Community 82`, `Community 83`, `Community 89`, `Community 91`, `Community 248`, `Community 97`, `Community 99`, `Community 228`, `Community 101`, `Community 104`, `Community 115`, `Community 500`, `Community 501`, `Community 502`, `Community 504`, `Community 505`, `Community 122`, `Community 127`, `Community 383`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.01847534265931892 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021658078840434 - nodes in this community are weakly interconnected._