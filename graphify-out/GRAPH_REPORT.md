...
## Corpus Check
- Large corpus: 2483 files · ~4,947,443 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15905 nodes · 28927 edges · 1018 communities (851 shown, 167 thin omitted)
...
## Communities (1018 total, 167 thin omitted)
...
Cohesion: 0.02
Nodes (288): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), listPendingOnboardingApps(), checkVersionStatus(), resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError() (+280 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (162): Channel, UpdateProbeResult, withConfigWriteTarget(), addOrganization(), addOrganizationInternal(), GateProbe, gateProject(), AppDebugOptions (+154 more)
...
Cohesion: 0.04
Nodes (147): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase(), PendingOnboardingApp (+139 more)
...
Cohesion: 0.03
Nodes (141): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction() (+133 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (124): get(), getAll(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization() (+116 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (104): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+96 more)
...
Cohesion: 0.03
Nodes (108): getCreditTopUpProductId(), mockContext, mockContext, mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate (+100 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (94): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility() (+86 more)
...
Cohesion: 0.04
Nodes (70): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, appGlobal (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (76): useGitHubProfileDialog(), setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (89): bodySchema, buildExpectedCurrentFields(), buildOrganizationUpdateQuery(), buildRollbackFields(), buildUpdateFields(), enforceSelf2faRequirement(), ensureOrgAccess(), getErrorDetail() (+81 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (83): normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (57): createAuthenticatedSupabaseClient(), describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId (+49 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (63): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+55 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (75): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays (+67 more)
...
Cohesion: 0.04
Nodes (64): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), hideLoader(), showLoader() (+56 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (64): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), cancelCommand() (+56 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (60): CheckDomainResponse, PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage() (+52 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (39): LogData, assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), STRIPE_EMULATOR_HEADERS, AppVersion, filterAppVersions() (+31 more)
...
Cohesion: 0.04
Nodes (65): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+57 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (68): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+60 more)
...
Cohesion: 0.07
Nodes (52): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+44 more)
...
Cohesion: 0.07
Nodes (46): getInvocationSource(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppCreateSource, createAppViaApi(), ensureOptions(), isStorageObjectConflict() (+38 more)
...
Cohesion: 0.06
Nodes (36): AlertsReporter, VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies() (+28 more)
...
Cohesion: 0.11
Nodes (27): countDemoSeededApps(), countNotificationEvent(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getNativeNotificationGlobalStats(), getPaidProductActivityStats(), getRegistersToday() (+19 more)
...
Cohesion: 0.17
Nodes (19): DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch(), handleManifest(), ManifestCleanupEntry (+11 more)
...
Cohesion: 0.12
Nodes (17): aggregateDailyBuildStats(), buildRecentGlobalStatsRepairDateIds(), calculateChurnRevenue(), calculateNrr(), getBuildStats(), getCompletedAppBuildOnboardingWindow(), getCompletedDayWindow(), getCurrentDayWindow() (+9 more)
...
## Knowledge Gaps
- **5636 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5631 more)
...
- **Why does `Database` connect `Community 27` to `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 13`, `Community 14`, `Community 17`, `Community 20`, `Community 149`, `Community 21`, `Community 24`, `Community 25`, `Community 154`, `Community 26`, `Community 30`, `Community 159`, `Community 38`, `Community 43`, `Community 300`, `Community 186`, `Community 63`, `Community 192`, `Community 221`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 9` to `Community 128`, `Community 382`, `Community 130`, `Community 132`, `Community 133`, `Community 520`, `Community 8`, `Community 10`, `Community 266`, `Community 511`, `Community 141`, `Community 268`, `Community 270`, `Community 144`, `Community 16`, `Community 18`, `Community 12`, `Community 148`, `Community 275`, `Community 282`, `Community 31`, `Community 35`, `Community 39`, `Community 169`, `Community 42`, `Community 170`, `Community 171`, `Community 45`, `Community 302`, `Community 49`, `Community 437`, `Community 181`, `Community 567`, `Community 568`, `Community 182`, `Community 570`, `Community 59`, `Community 183`, `Community 55`, `Community 191`, `Community 67`, `Community 70`, `Community 71`, `Community 76`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 86`, `Community 89`, `Community 91`, `Community 92`, `Community 99`, `Community 102`, `Community 108`, `Community 238`, `Community 111`, `Community 115`, `Community 121`, `Community 506`, `Community 507`, `Community 508`, `Community 510`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02026760709469972 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020627479264334656 - nodes in this community are weakly interconnected._