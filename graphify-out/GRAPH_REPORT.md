...
## Corpus Check
- Large corpus: 2348 files · ~4,807,567 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15277 nodes · 27751 edges · 1010 communities (847 shown, 163 thin omitted)
...
Cohesion: 0.02
Nodes (147): setSetting(), setSettingInternal(), AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema (+139 more)
...
Cohesion: 0.03
Nodes (130): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+122 more)
...
Cohesion: 0.03
Nodes (102): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName() (+94 more)
...
Cohesion: 0.03
Nodes (65): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, fetchRest(), getAnonHeaders() (+57 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (75): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+67 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (76): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (57): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, createHashedKeySDK() (+49 more)
...
Cohesion: 0.03
Nodes (62): DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema (+54 more)
...
Cohesion: 0.04
Nodes (68): getActiveUploadReporter(), configWriteTargetStore, loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), writeConfigTarget() (+60 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (68): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), AppOnboardingProgressPatch, checkAppExists(), completePendingOnboardingApp(), getAppIconStoragePath() (+60 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (71): getConfigWriteTarget(), resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+63 more)
...
Cohesion: 0.04
Nodes (42): describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, pool, pool (+34 more)
...
Cohesion: 0.09
Nodes (76): waitLog(), getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep() (+68 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (65): id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission() (+57 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (63): executeStatsQueryWithRetry(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit(), buildStorageHourlyRows(), calculateStorageHourlyRows() (+55 more)
...
Cohesion: 0.05
Nodes (53): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+45 more)
...
Cohesion: 0.05
Nodes (51): app, appGlobal, assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody (+43 more)
...
Cohesion: 0.06
Nodes (36): { cloudlogErrMock, queryPosthogHogqlMock }, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), FrontendOnboardingInteractionEvent, FrontendOnboardingVersion (+28 more)
...
Cohesion: 0.10
Nodes (36): asyncPool(), createStripeClient(), createSupabaseServiceClient(), getArgValue(), getRequiredEnv(), getSupabaseServiceRoleKey(), isActionableStripeCustomerId(), loadEnv() (+28 more)
...
Cohesion: 0.07
Nodes (31): resolveAppSetIconPath(), assertChannelExists(), CapgoSupabaseClient, disableDownloadChannels(), setDefaultDownloadChannel(), setApp(), setAppInternal(), normalizeStoreUrl() (+23 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (38): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getSpawnOutputText(), normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerForTargetList(), runPackageRunnerSync() (+30 more)
...
Cohesion: 0.09
Nodes (35): apiKeyBindingsAllowOrgCreate(), assertApiKeyCanKeepOrgCreateGrant(), parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), validateApiKeyGlobalPermissionsForBindings(), ApiKeyRow, app, assertCanManageApiKeysForOrgs() (+27 more)
...
Cohesion: 0.08
Nodes (33): aggregateInstallTimingsByVersion(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays, BundleInstallStatsItem (+25 more)
...
Cohesion: 0.10
Nodes (37): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes(), countInstallSourcesCF() (+29 more)
...
Cohesion: 0.08
Nodes (32): aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample, durationExpression (+24 more)
...
Cohesion: 0.11
Nodes (26): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), ApiKeyGlobalPermissionBinding, attachApiKeyGlobalPermissions() (+18 more)
...
Cohesion: 0.11
Nodes (16): cancelCommand(), markSnag(), writeConfigUpdater(), syncPendingAppIdToCapacitorConfig(), createKeyInternal(), deleteOldPrivateKeyInternal(), ensureCapacitorUpdaterConfig(), saveKeyInternal() (+8 more)
...
Cohesion: 0.18
Nodes (16): parsePositiveInteger(), BackfillFailure, BackfillNotFound, BackfillResult, CandidateUser, getCandidatePage(), getGitHubToken(), GitHubUser (+8 more)
...
- **Why does `Database` connect `Community 81` to `Community 3`, `Community 5`, `Community 10`, `Community 11`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 28`, `Community 31`, `Community 37`, `Community 295`, `Community 39`, `Community 42`, `Community 48`, `Community 54`, `Community 189`, `Community 62`, `Community 70`, `Community 78`, `Community 84`, `Community 88`, `Community 247`?**
  _High betweenness centrality (0.193) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 256`, `Community 129`, `Community 513`, `Community 133`, `Community 134`, `Community 7`, `Community 264`, `Community 137`, `Community 266`, `Community 11`, `Community 268`, `Community 6`, `Community 14`, `Community 17`, `Community 147`, `Community 149`, `Community 154`, `Community 32`, `Community 161`, `Community 36`, `Community 38`, `Community 40`, `Community 41`, `Community 170`, `Community 298`, `Community 171`, `Community 299`, `Community 558`, `Community 559`, `Community 302`, `Community 561`, `Community 434`, `Community 180`, `Community 181`, `Community 567`, `Community 58`, `Community 63`, `Community 192`, `Community 66`, `Community 69`, `Community 71`, `Community 72`, `Community 75`, `Community 76`, `Community 77`, `Community 86`, `Community 119`, `Community 89`, `Community 346`, `Community 90`, `Community 92`, `Community 93`, `Community 96`, `Community 102`, `Community 106`, `Community 235`, `Community 108`, `Community 114`, `Community 115`, `Community 499`, `Community 500`, `Community 501`, `Community 503`, `Community 504`, `Community 381`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.022406384284837322 - nodes in this community are weakly interconnected._