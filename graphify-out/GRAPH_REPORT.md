# Graph Report - capgo.app  (2026-09-14)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2728 files · ~5,189,406 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17052 nodes · 31488 edges · 1106 communities (928 shown, 178 thin omitted)
...
## Communities (1106 total, 178 thin omitted)
...
Cohesion: 0.02
Nodes (169): fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort(), parsePositiveInt() (+161 more)
...
Cohesion: 0.03
Nodes (135): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+127 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (124): BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), isDemoAppRow(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+116 more)
...
Cohesion: 0.03
Nodes (117): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, addCodeStep(), applyInitAutoTestChange(), askForAppName(), askForExistingDirectoryPath() (+109 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (88): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+80 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (79): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+71 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (65): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+57 more)
...
Cohesion: 0.06
Nodes (84): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (59): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers (+51 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (85): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+77 more)
...
Cohesion: 0.04
Nodes (77): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+69 more)
...
Cohesion: 0.04
Nodes (53): AppOnboardingProgressPatch, assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, IncompatibleBundleError, CliUserError, isTransientNetworkError() (+45 more)
...
Cohesion: 0.04
Nodes (66): getActiveUploadReporter(), isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), appAddHintMessage(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions (+58 more)
...
Cohesion: 0.04
Nodes (64): getAppIconStoragePath(), resolveAppSetIconPath(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+56 more)
...
Cohesion: 0.06
Nodes (66): resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES (+58 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (71): findAppInOrganization(), waitLog(), setConfigWriteTarget(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep() (+63 more)
...
Cohesion: 0.04
Nodes (52): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+44 more)
...
Cohesion: 0.08
Nodes (53): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, AlertsReporter (+45 more)
...
Cohesion: 0.11
Nodes (16): addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), OrganizationInfo (+8 more)
...
Cohesion: 0.05
Nodes (38): fetchAllIds(), generateInsertQuery(), ids, main(), BrokenDefaultRow, chunkArray(), loadEnv(), main() (+30 more)
...
Cohesion: 0.07
Nodes (39): { cloudlogErrMock, queryPosthogHogqlMock }, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts() (+31 more)
...
Cohesion: 0.07
Nodes (46): nativeObserveActions, readNativeObserveStats(), app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents() (+38 more)
...
Cohesion: 0.06
Nodes (39): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+31 more)
...
Cohesion: 0.12
Nodes (34): get(), getAll(), app, appGlobal, CreateApp, post(), put(), UpdateApp (+26 more)
...
Cohesion: 0.08
Nodes (40): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getSpawnOutputText(), normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerForTargetList(), runPackageRunnerSync() (+32 more)
...
Cohesion: 0.10
Nodes (38): app, DeliveryMessage, app, AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer() (+30 more)
...
Cohesion: 0.07
Nodes (33): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+25 more)
...
Cohesion: 0.08
Nodes (35): getAppOwnerPostgresMock, getBundleUrlMock, requestInfosPostgresMock, runUpdate(), sendStatsAndDeviceMock, appVersion, manifest, AutoUpdateBlockReason (+27 more)
...
Cohesion: 0.10
Nodes (31): isUpdateRequestBody(), NO_ERROR, RequestJSON, schemas, channelSelfRequestSchema, DevicePlatform, fieldIssue(), getAllowedStatsActionsList() (+23 more)

### Community 107 - "Community 107"
Cohesion: 0.09
Nodes (33): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), app (+25 more)
...
Cohesion: 0.09
Nodes (26): adminStore, displayStore, isLoading, loadDashboard(), loadError, mainStore, router, { t } (+18 more)
...
Cohesion: 0.07
Nodes (24): id, testOrgId, buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp(), seedReadyBundle(), serviceRoleSupabase (+16 more)
...
Cohesion: 0.11
Nodes (26): AB_TEST_BRANCHES, AB_TEST_INTENTS, ABTestAssignment, ABTestAudience, ABTestBentoSyncState, ABTestIntent, ABTestsConfig, AssignmentAudienceUser (+18 more)
...
Cohesion: 0.14
Nodes (28): cancelCommand(), sendCliEvent(), promptDoctorUpdateChoice(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel() (+20 more)
...
Cohesion: 0.22
Nodes (17): app, assertValidAppId(), ChannelDeviceRow, ChannelRow, deleteBodySchema, DeleteChannelDeviceBody, deleteChannelDeviceOverride(), getExistingChannelDeviceOverride() (+9 more)

### Community 264 - "Community 264"
Cohesion: 0.15
Nodes (13): TrackEventBody, base, buildPlanCheckoutStartedBentoEvent(), normalizeRecurrence(), PlanCheckoutStartedBentoInput, recurrenceToPlanType(), addAuthenticatedApiKeyIdToTrackingPayload(), executeBentoTracking() (+5 more)
...
Cohesion: 0.21
Nodes (14): allowLocalWebhookUrls(), getWebhookPublicUrlValidationError(), isWebhookEventType(), parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, bodySchema (+6 more)
...
Cohesion: 0.33
Nodes (7): eligibleTestNames(), getOrCreateUserABTests(), hasIntentGatedTests(), needsBentoSync(), normalizeEmail(), readAssignmentUser(), readBentoSyncState()
...
## Knowledge Gaps
- **5944 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5939 more)
...
- **Why does `Database` connect `Community 31` to `Community 2`, `Community 5`, `Community 136`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 27`, `Community 28`, `Community 542`, `Community 543`, `Community 32`, `Community 292`, `Community 169`, `Community 426`, `Community 44`, `Community 47`, `Community 178`, `Community 51`, `Community 187`, `Community 325`, `Community 78`, `Community 88`, `Community 93`, `Community 122`, `Community 378`, `Community 382`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 60` to `Community 258`, `Community 386`, `Community 514`, `Community 6`, `Community 263`, `Community 135`, `Community 7`, `Community 9`, `Community 11`, `Community 139`, `Community 267`, `Community 17`, `Community 146`, `Community 18`, `Community 149`, `Community 24`, `Community 152`, `Community 153`, `Community 157`, `Community 158`, `Community 161`, `Community 292`, `Community 36`, `Community 164`, `Community 296`, `Community 297`, `Community 42`, `Community 425`, `Community 300`, `Community 301`, `Community 174`, `Community 45`, `Community 560`, `Community 561`, `Community 48`, `Community 563`, `Community 52`, `Community 565`, `Community 304`, `Community 572`, `Community 62`, `Community 193`, `Community 70`, `Community 199`, `Community 72`, `Community 327`, `Community 200`, `Community 75`, `Community 330`, `Community 77`, `Community 79`, `Community 210`, `Community 82`, `Community 87`, `Community 215`, `Community 218`, `Community 94`, `Community 97`, `Community 99`, `Community 485`, `Community 101`, `Community 103`, `Community 104`, `Community 107`, `Community 109`, `Community 622`, `Community 114`, `Community 121`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02003315178782856 - nodes in this community are weakly interconnected._
