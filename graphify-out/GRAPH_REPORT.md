...
## Corpus Check
- Large corpus: 2423 files · ~4,888,132 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15610 nodes · 28381 edges · 1029 communities (866 shown, 163 thin omitted)
...
## Communities (1029 total, 163 thin omitted)
...
Cohesion: 0.02
Nodes (146): withConfigWriteTarget(), optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials, buildCredentialsSchema, BuildNeededOptions, buildNeededOptionsSchema (+138 more)
...
Cohesion: 0.04
Nodes (125): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), CapgoHttpOptions (+117 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (134): app, DataSetManifest, getRegistrationMetadata(), DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount() (+126 more)
...
Cohesion: 0.03
Nodes (84): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+76 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (115): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, shouldBlockIncompatibleUpload(), summarizeUploadCompatibility() (+107 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (117): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), addCodeStep(), applyInitAutoTestChange() (+109 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (79): isTelemetryDisabled(), getActiveUploadReporter(), IncompatibleBundleError, CapacitorConfig, ExtConfigPairs, CliUserError, trimTrailingSlashes(), CapacitorCliConfig (+71 more)
...
Cohesion: 0.03
Nodes (80): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+72 more)
...
Cohesion: 0.04
Nodes (72): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+64 more)
...
Cohesion: 0.05
Nodes (70): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+62 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (66): streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController (+58 more)
...
Cohesion: 0.06
Nodes (61): buildCliRequestHeaders(), setCurrentCliCommand(), getInvocationSource(), completePendingOnboardingApp(), reportAppOnboardingProgress(), createRSA(), AlertsReporter, checkAlerts() (+53 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (72): getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+64 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (55): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+47 more)
...
Cohesion: 0.06
Nodes (47): app, DataDevice, devicesBodySchema, orderItemSchema, platformSchema, app, DataStats, defaultInsightActions (+39 more)
...
Cohesion: 0.08
Nodes (14): async, Any, ASCSession, Bool, Int, Never, NSImage, String (+6 more)
...
Cohesion: 0.08
Nodes (44): createCapacitorRunTargetListError(), ensureNativePlatformForBuild(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getNativePlatformAvailability(), getSelectablePlatformOptions(), getSpawnOutputText(), handleMissingPlatformSelection() (+36 more)
...
Cohesion: 0.07
Nodes (28): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString() (+20 more)
...
Cohesion: 0.09
Nodes (29): decryptChecksum(), decryptChecksumV3(), decryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkIndexPosition() (+21 more)
...
Cohesion: 0.11
Nodes (28): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+20 more)
...
Cohesion: 0.10
Nodes (24): cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData, LogSpec (+16 more)

### Community 131 - "Community 131"
Cohesion: 0.13
Nodes (25): setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), setConfigWriteTarget() (+17 more)
...
Cohesion: 0.14
Nodes (12): app, appGlobal, ApiKeyRow, app, assertCanManageApiKeysForOrgsPg(), assertExpirationMatchesOrgPoliciesPg(), BindingInput, CreateApiKeyRecordParams (+4 more)
...
## Knowledge Gaps
- **5528 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5523 more)
...
- **Why does `Database` connect `Community 60` to `Community 130`, `Community 2`, `Community 5`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `Community 19`, `Community 20`, `Community 24`, `Community 158`, `Community 35`, `Community 163`, `Community 165`, `Community 38`, `Community 39`, `Community 36`, `Community 48`, `Community 304`, `Community 58`, `Community 190`, `Community 195`, `Community 86`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 132`, `Community 6`, `Community 7`, `Community 136`, `Community 265`, `Community 8`, `Community 518`, `Community 519`, `Community 520`, `Community 138`, `Community 271`, `Community 272`, `Community 522`, `Community 523`, `Community 274`, `Community 18`, `Community 529`, `Community 150`, `Community 275`, `Community 23`, `Community 25`, `Community 154`, `Community 287`, `Community 34`, `Community 134`, `Community 164`, `Community 37`, `Community 293`, `Community 171`, `Community 172`, `Community 45`, `Community 44`, `Community 50`, `Community 309`, `Community 183`, `Community 184`, `Community 393`, `Community 574`, `Community 62`, `Community 575`, `Community 449`, `Community 577`, `Community 194`, `Community 65`, `Community 583`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 89`, `Community 90`, `Community 91`, `Community 93`, `Community 95`, `Community 96`, `Community 105`, `Community 109`, `Community 241`, `Community 113`, `Community 115`, `Community 116`, `Community 118`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5531 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.022489492980416703 - nodes in this community are weakly interconnected._
