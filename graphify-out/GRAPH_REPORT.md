# Graph Report - capgo.app  (2026-09-01)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2580 files · ~5,045,265 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16392 nodes · 30242 edges · 1044 communities (875 shown, 169 thin omitted)
...
## Communities (1044 total, 169 thin omitted)
...
Cohesion: 0.03
Nodes (126): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+118 more)
...
Cohesion: 0.03
Nodes (124): findVersion(), findVersionId(), resolveVersion(), syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata(), BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp() (+116 more)
...
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+110 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (74): fixtureId, orgId, createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool (+66 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (73): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser() (+65 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (80): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+72 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (85): checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+77 more)
...
Cohesion: 0.03
Nodes (91): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+83 more)
...
Cohesion: 0.04
Nodes (67): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), base64ToArrayBuffer() (+59 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (49): flushDeferredCommandInvocation(), AlertsReporter, checkAlerts(), VersionCheckResult, SaveKeyOptions, BrowserLoginDependencies, BrowserLoginEvent, BrowserLoginOptions (+41 more)
...
Cohesion: 0.08
Nodes (85): findAppInOrganization(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep() (+77 more)
...
Cohesion: 0.06
Nodes (67): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, setSetting() (+59 more)
...
Cohesion: 0.04
Nodes (68): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+60 more)
...
Cohesion: 0.06
Nodes (66): getInitUpdaterPluginConfig(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps, ChoiceOption (+58 more)
...
Cohesion: 0.04
Nodes (55): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+47 more)
...
Cohesion: 0.05
Nodes (47): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, toIdString(), TrackEventBody (+39 more)
...
Cohesion: 0.05
Nodes (59): AdminLegendDataChart, AdminLegendToggleChart, AdminStackedBarChartData, AdminStackedBarChartDataset, AdminStackedBarCompatibleDataset, AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData() (+51 more)
...
Cohesion: 0.05
Nodes (53): resolveAppSetIconPath(), isAppListedInOrganization(), cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level (+45 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (59): checkVersionStatus(), buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint() (+51 more)
...
Cohesion: 0.07
Nodes (41): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, CliReplayBody (+33 more)
...
Cohesion: 0.08
Nodes (41): assertCanPromoteChannelInTransaction(), ChannelRow, DrizzleClient, fetchTargetChannel(), fetchVersionName(), getEffectiveApikey(), PgQueryClient, setChannel() (+33 more)
...
Cohesion: 0.08
Nodes (34): aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+26 more)
...
Cohesion: 0.06
Nodes (25): id, testOrgId, orgId, scopeId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath() (+17 more)
...
Cohesion: 0.08
Nodes (28): resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath(), markStepDone(), readTmpObj(), resolveInitDirectoryPath() (+20 more)
...
Cohesion: 0.08
Nodes (25): app, bodySchema, bumpRateLimit(), hashRateLimitKey(), isEmailPreferencesRateLimited(), normalizeEmail(), preferenceValueSchema, PublicEmailPreferenceKey (+17 more)
...
Cohesion: 0.09
Nodes (29): DeliveryMessage, allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookPayload(), bytesToArrayBuffer(), decodeSerializedWebhookSecret(), disableWebhook() (+21 more)
...
Cohesion: 0.13
Nodes (22): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), APIKEY_MANAGER_DENIED_ASSIGNABLE_ROLES (+14 more)

### Community 153 - "Community 153"
Cohesion: 0.11
Nodes (22): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+14 more)
...
Cohesion: 0.16
Nodes (23): buildWebhookDeliveryPayload(), createDeliveryRecord(), createTestPayload(), deliverWebhook(), getWebhookLogUrlMetadata(), getWebhookPublicUrlValidationError(), isWebhookEventType(), normalizeWebhookDeliveryVersion() (+15 more)
...
Cohesion: 0.16
Nodes (19): updateDeliveryStatsTestUtils, buildPlatformUpdateDeliveryDailyCFQuery(), buildPlatformUpdateDeliveryDeliveriesSubquery(), buildPlatformUpdateDeliveryDeviceCountCFQuery(), buildPlatformUpdateDeliveryOverviewCFQuery(), emptyPlatformUpdateDeliveryOverviewRow(), mergePlatformDeliveryDailyRow(), mergePlatformDeliveryPercentile() (+11 more)
...
Cohesion: 0.27
Nodes (11): apikeyHasOrgRight(), apiKeyHasAppScopedBinding(), app, appGlobal, assertOrgWebhookScope(), assertWebhookApiKeyChain(), assertWebhookOrgPolicy(), checkWebhookPermission() (+3 more)
...
Cohesion: 0.22
Nodes (10): getManifestSizeWithRetry(), onManifestCreateTestUtils, QueueLogMetadata, runManifestUpdateWithRetry(), shouldRetryManifestSizeLookup(), shouldSkipManifestSizeRetry(), updateManifestSize(), onVersionUpdateTestUtils (+2 more)
...
Cohesion: 0.29
Nodes (6): createTracker(), steps, trackerIdentity, createOnboardingProgressTracker(), createOnboardingTelemetryIdentity(), resolveOnboardingAppIconSource()
...
## Knowledge Gaps
- **5748 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5743 more)
...
- **Why does `Database` connect `Community 41` to `Community 3`, `Community 5`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 533`, `Community 25`, `Community 32`, `Community 34`, `Community 39`, `Community 170`, `Community 44`, `Community 45`, `Community 175`, `Community 50`, `Community 309`, `Community 311`, `Community 58`, `Community 59`, `Community 71`, `Community 72`, `Community 205`, `Community 81`, `Community 85`, `Community 88`, `Community 360`, `Community 117`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 256`, `Community 130`, `Community 132`, `Community 6`, `Community 7`, `Community 140`, `Community 141`, `Community 525`, `Community 15`, `Community 526`, `Community 527`, `Community 143`, `Community 529`, `Community 530`, `Community 401`, `Community 16`, `Community 151`, `Community 152`, `Community 280`, `Community 281`, `Community 155`, `Community 28`, `Community 156`, `Community 285`, `Community 538`, `Community 287`, `Community 33`, `Community 35`, `Community 165`, `Community 38`, `Community 300`, `Community 46`, `Community 47`, `Community 48`, `Community 181`, `Community 54`, `Community 56`, `Community 312`, `Community 186`, `Community 187`, `Community 188`, `Community 316`, `Community 62`, `Community 65`, `Community 582`, `Community 455`, `Community 583`, `Community 585`, `Community 198`, `Community 199`, `Community 76`, `Community 204`, `Community 78`, `Community 79`, `Community 337`, `Community 84`, `Community 215`, `Community 345`, `Community 92`, `Community 93`, `Community 70`, `Community 99`, `Community 100`, `Community 111`, `Community 112`, `Community 116`, `Community 120`, `Community 125`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5751 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023506493506493507 - nodes in this community are weakly interconnected._