# Graph Report - capgo.app  (2026-09-09)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2670 files · ~5,127,103 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16807 nodes · 31084 edges · 1088 communities (913 shown, 175 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 127 edges (avg confidence: 0.8)
...
1. `scripts` - 200 edges
2. `supabaseAdmin()` - 182 edges
3. `scripts` - 178 edges
4. `getSupabaseClient()` - 147 edges
5. `Database` - 127 edges
6. `formatError()` - 99 edges
7. `executeSQL()` - 88 edges
8. `findSavedKey()` - 78 edges
9. `checkPermission()` - 77 edges
10. `initApp()` - 67 edges
...
- `getCompatibilityDetails()` --calls--> `parseRange()`  [INFERRED]
  cli/src/utils.ts → supabase/functions/_backend/utils/plans_analytics.ts

## Import Cycles
- 1-file cycle: `shared/preview-subdomain.ts -> shared/preview-subdomain.ts`
- 1-file cycle: `supabase/functions/_backend/utils/plugin_compatibility.ts -> supabase/functions/_backend/utils/plugin_compatibility.ts`
- 1-file cycle: `supabase/functions/_backend/utils/ab_tests.ts -> supabase/functions/_backend/utils/ab_tests.ts`
...
## Communities (1088 total, 175 thin omitted)
...
Cohesion: 0.01
Nodes (200): scripts, admin:backfill-credit-usage-posthog, admin:backfill-github-user-ids, admin:backfill-missing-app-icons, admin:backfill-missing-store-urls, admin:backfill-paid-product-activity, admin:backfill-plugin-version-ladder, admin:migrate-legacy-bare-image-paths (+192 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (151): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+143 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (178): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+170 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (112): OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch(), deriveSupabaseOperation(), enableSupabaseInstrumentation(), getSupabaseSource(), isSupabaseInstrumentationEnabled() (+104 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (110): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+102 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (101): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+93 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (97): describeBackend, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id (+89 more)
...
Cohesion: 0.03
Nodes (123): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+115 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (113): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, shouldBlockIncompatibleUpload(), checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult (+105 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (100): app, registerPluginStatsSbFallbacksForDeno(), baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction() (+92 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (110): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+102 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (66): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+58 more)
...
Cohesion: 0.04
Nodes (86): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (79): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+71 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (72): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (78): flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+70 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (65): APP_UUID, createConfirmedAuthUser(), ORG_ID, TEST_ID, createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema (+57 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (56): TEST_ORG_ID, TEST_ORG_ID, id, testOrgId, headers, testRunId, Awaitable, ChannelInfo (+48 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (63): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+55 more)
...
Cohesion: 0.05
Nodes (67): streamCommandInInitPanel(), initOnboardingSteps, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+59 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (71): nativeObserveActions, app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView() (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (45): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+37 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (57): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+49 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (77): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+69 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (61): resolveAppSetIconPath(), isAppListedInOrganization(), cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level (+53 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (66): calcKeyId(), createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), encryptChecksum(), encryptChecksumV3() (+58 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (51): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, IncompatibleBundleError, fetchObserve(), ObserveCliOptions, observeCommand() (+43 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (62): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction (+54 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (63): hostOptionsFromSupabase(), getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions, CapgoConfig (+55 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (32): AlertsReporter, VersionCheckResult, addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations() (+24 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (63): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+55 more)
...
Cohesion: 0.05
Nodes (53): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+45 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (52): AppBuildOnboardingMetricRow, AppBuildOnboardingMetrics, BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, BuildShardStats, BuildStats, calculateAveragePastDueDays() (+44 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (45): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+37 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (65): devDependencies, adm-zip, @antfu/eslint-config, @aws-sdk/client-s3, bun-types, @capacitor/cli, @capacitor/core, @capgo/cli (+57 more)
...
Cohesion: 0.06
Nodes (53): aiBumpLevel, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), app, buildBatches() (+45 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (57): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_DEVELOPMENT_ENVIRONMENTS, ORG_ONBOARDING_INTENTS (+49 more)
...
Cohesion: 0.04
Nodes (55): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+47 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (46): assertCloudSqlDataApiResponseSucceeded(), CloudSqlDataApiResponse, ReadReplicaSchemaSyncPlan, assertCheckConstraintStatement(), assertColumnStatement(), assertCompleteDataApiResponse(), assertConstraintStatement(), assertDataApiRequestFitsLimit() (+38 more)
...
Cohesion: 0.08
Nodes (56): aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody(), canRetry(), chunkDeviceRows() (+48 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (50): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+42 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (52): checkVersionStatus(), buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint() (+44 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (44): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), buildDemoUpdateDeliveryStats(), UpdateDeliveryScope, UpdateDeliveryStatsResponse (+36 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (47): CLIActivityPayload, useRealtimeCLIFeed(), displayStore, mainStore, router, { t }, triggerFakeReplicationToast(), activeCount (+39 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (44): addMonthsUtc(), Cycle, daysInMonthUtc(), oracleCompletedCycle(), pad2(), parseUtcDateOnly(), sqlPortCompletedCycle(), utcDateOnly() (+36 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (49): assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertProviderSecretMaterial(), assertString(), BadgeBody, CAMPAIGN_KINDS (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (51): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES, ChurnReason (+43 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (44): ALLOWED_STORE_HOSTS, AppleLookupResult, assertAllowedStoreUrl(), decodeHtml(), extractAndroidAppId(), extractAppleStoreCountry(), extractAppleStoreId(), extractMetaTag() (+36 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (36): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isCliLoginPath(), isNativeAppStoreContext() (+28 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (25): createInheritedOrgAdminApiKey(), createRbacApiKey(), createSeededAppApiKey(), expectApiKeyRow(), fillApiKeyName(), INHERITED_ORG_ID, openCreateKeyDialog(), RoleBindingWithRole (+17 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (40): app, canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema (+32 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (50): archive_queue_messages(), chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), DISCORD_IGNORED_ERROR_CODES, dispatchQueueMessage(), extractErrorDetails() (+42 more)
...
Cohesion: 0.07
Nodes (42): BuilderStatusResponse, calculateBuildRuntimeSeconds(), calculateRunnerWaitSeconds(), calculateTimeoutCompletedAt(), capBuildRuntimeSeconds(), formatBuildTimeoutError(), hasBuildTimedOut(), isTerminalBuildStatus() (+34 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (42): buildFrontendOnboardingDailySeries(), buildFrontendOnboardingDailySetupCliAgentSeries(), buildFrontendOnboardingDailySetupCliSeries(), buildFrontendOnboardingDailyTabSwitchSeries(), buildFrontendOnboardingDailyWelcomeOutcomeSeries(), buildFrontendOnboardingFunnelStages(), buildFrontendOnboardingFunnelSummaries(), buildFrontendOnboardingGraphMetrics() (+34 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (44): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+36 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (39): useGitHubProfileDialog(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod() (+31 more)
...
Cohesion: 0.07
Nodes (38): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), JsonPrimitive, posthogLoader(), PostHogProperties, pushEvent() (+30 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (39): accumulateNumbers(), app, appGlobal, AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildNativeVersionCounts(), bundleUsageSchema (+31 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (34): { cloudlogErrMock, queryPosthogHogqlMock }, { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql(), emptyTabSwitchCounts() (+26 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (34): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+26 more)
...
Cohesion: 0.09
Nodes (36): AppListOptions, handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, AppRow (+28 more)

### Community 81 - "Community 81"
Cohesion: 0.09
Nodes (41): buildFileReadCacheRequest(), assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred() (+33 more)
...
Cohesion: 0.05
Nodes (41): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOnboardingFunnel, AdminOrganizationInsightRow (+33 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (35): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+27 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (32): isRetryableDurableObjectFetchError(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env, normalizeContentType(), StoredR2Part (+24 more)
...
Cohesion: 0.06
Nodes (33): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+25 more)

### Community 88 - "Community 88"
Cohesion: 0.09
Nodes (38): assertSchemaCatalog(), columnKey(), compareColumns(), compareConstraints(), compareExpectedColumns(), compareExpectedIndexes(), compareFunctions(), compareIndexes() (+30 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (31): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult() (+23 more)
...
Cohesion: 0.07
Nodes (32): ChannelPromotionPermissionChecker, ChannelPromotionTarget, findChannelsWithoutPromotionPermission(), formatChannelPromotionTargets(), aggregateCliKeyPolicy(), candidatePolicyAllows(), canonicalizeCliBindings(), CliApiKeyMetadata (+24 more)
...
Cohesion: 0.08
Nodes (36): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays (+28 more)
...
Cohesion: 0.05
Nodes (39): devDependencies, adm-zip, @antfu/eslint-config, @bradenmacdonald/s3-lite-client, @capacitor/cli, @capgo/find-package-manager, ci-info, @clack/prompts (+31 more)
...
Cohesion: 0.10
Nodes (35): assertCanPromoteChannelInTransaction(), ChannelRow, DrizzleClient, fetchTargetChannel(), fetchVersionName(), getEffectiveApikey(), PgQueryClient, setChannel() (+27 more)

### Community 100 - "Community 100"
Cohesion: 0.09
Nodes (35): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnelStages(), buildInteractionGraph(), buildLegacyFunnel(), buildSetupCliOutcomes() (+27 more)

### Community 101 - "Community 101"
Cohesion: 0.08
Nodes (32): aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample (+24 more)
...
Cohesion: 0.10
Nodes (34): aesKeyFromSecret(), buildGlobalNotificationStatsQuery(), buildNotificationBadgeStateQuery(), buildNotificationStatsQuery(), decryptNotificationToken(), decryptProviderSecretWithSecretKey(), decryptWithSecretKey(), encryptNotificationToken() (+26 more)

### Community 106 - "Community 106"
Cohesion: 0.09
Nodes (33): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions, renderNotificationHelper() (+25 more)

### Community 107 - "Community 107"
Cohesion: 0.10
Nodes (33): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+25 more)

### Community 108 - "Community 108"
Cohesion: 0.08
Nodes (18): adminStore, displayStore, getCountryFlag(), getCountryLabel(), isLoading, { locale, t }, mainStore, normalizeCountryCode() (+10 more)

### Community 109 - "Community 109"
Cohesion: 0.09
Nodes (22): Tab, TableAction, TableColumn, TableRow, TableSort, accountTabs, adminTabs, appSettingsTabs (+14 more)

### Community 110 - "Community 110"
Cohesion: 0.08
Nodes (29): AssignablePrincipal, canManageRoleBindingScope(), CreateBindingOptions, CreateBindingResult, createRoleBindingForPrincipal(), DrizzleClient, DrizzleExecutor, getCallerMaxPriorityRank() (+21 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (25): ALLOWED_ATTRIBUTE_KEYS, app, createBodySchema, requireManageSsoPermission(), updateBodySchema, uuidSchema, app, bodySchema (+17 more)

### Community 112 - "Community 112"
Cohesion: 0.10
Nodes (30): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), getErrorCode() (+22 more)
...
Cohesion: 0.10
Nodes (31): buildDeletedFileMarkerRequest(), buildFileReadCacheRequestsForPath(), buildWorkersFileCacheKey(), buildWorkersFileCacheRequests(), CacheLike, FILE_READ_CACHE_ORIGINS, FILE_READ_PATH_PREFIXES, FILE_READ_TRACKING_QUERY_PARAMS (+23 more)
...
Cohesion: 0.13
Nodes (32): promptDoctorUpdateChoice(), ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions() (+24 more)
...
Cohesion: 0.11
Nodes (28): CommandResult, createMissingExecutableError(), ExecutableProbeOptions, ExecutableProbeResult, getAvailablePackageManagers(), getMissingPackageManagerExecutable(), getPackageManagerInfo(), isPackageManagerAvailable() (+20 more)
...
Cohesion: 0.09
Nodes (23): deliverMock, { closeClientMock, sendNotifOrgMock, sendNotifToOrgMembersOnceMock }, requestPluginNotifications(), deliverQueuedPluginNotifications(), getPluginNotificationItemResult(), PluginNotificationBatchBody, PluginNotificationDeliveryResult, PluginNotificationItemResult (+15 more)

### Community 128 - "Community 128"
Cohesion: 0.10
Nodes (30): appVersion, manifest, AutoUpdateBlockReason, CHANNEL_UPDATE_PACKAGE_VALUES, ChannelUpdatePackage, getInvalidIpInfo(), getProviderInfrastructureInfo(), getResponseFeatureSupport() (+22 more)
...
Cohesion: 0.09
Nodes (19): AnalyzeBehavior, CiFailureActions, CiFailureActionsInput, decideAnalyzeBehavior(), DecideInput, PostAnalyzeInput, PostAnalyzeStreamInput, postAnalyzeStreamRequest() (+11 more)
...
Cohesion: 0.13
Nodes (30): loadPlansAnalytics(), array(), boolean(), buildPlansAnalyticsPresentationState(), buildPlansAnalyticsSeries(), ChartDataPoint, ChartSeries, count() (+22 more)
...
Cohesion: 0.12
Nodes (28): getRequiredEnv(), applyStoredPercents(), assertDateId(), BackfillRow, buildBackfillRow(), buildPluginBreakdownResult(), buildPluginVersionLadderQuery(), fetchGlobalStatsRows() (+20 more)
...
Cohesion: 0.07
Nodes (15): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), UploadResponse, createAuthenticatedClient(), isRetryableRpcTransportError(), requestActorUserId(), SUPABASE_ANON_KEY (+7 more)
...
Cohesion: 0.11
Nodes (18): askUpdateNotificationAfterBundleChange(), closeAutoUpdateDropdown(), disableRollout(), EditableChannelKey(), enableRollout(), getChannel(), handleVersionLink(), isPushUpdateReady() (+10 more)

### Community 143 - "Community 143"
Cohesion: 0.13
Nodes (9): Digester, noopDigester(), sha256Digester(), isR2ChecksumError(), isR2Error(), isR2MultipartDoesNotExistError(), UploadHandler, buildFileHttpMetadata() (+1 more)

### Community 144 - "Community 144"
Cohesion: 0.12
Nodes (21): app, buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString(), optionalTagString(), ResolvedTrackingId (+13 more)
...
Cohesion: 0.07
Nodes (28): bento_tag, bento_tag, A, B, C, D, bento_tag, bento_tag (+20 more)
...
Cohesion: 0.13
Nodes (26): appGlobal, app, AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure() (+18 more)

### Community 155 - "Community 155"
Cohesion: 0.13
Nodes (24): isVersionDeleted(), app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getDeletedVersionAction() (+16 more)
...
Cohesion: 0.12
Nodes (26): APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, buildGettingStartedSteps(), GETTING_STARTED_STEP_DEFS (+18 more)
...
Cohesion: 0.11
Nodes (18): mockContext, mockContext, mockContext, plans, mockContext, stripeEventTestUtils, extractDataEvent(), getLicensedSubscriptionItem() (+10 more)
...
Cohesion: 0.13
Nodes (22): configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), setConfigWriteTarget(), withConfigWriteTarget() (+14 more)

### Community 171 - "Community 171"
Cohesion: 0.13
Nodes (22): app, appGlobal, buildBundleInfoRequest(), buildPreviewAuthRequest(), buildPreviewDownloadPayload(), buildPreviewPayloadResponseHeaders(), buildPreviewResponseHeaders(), BundleInfoCache (+14 more)

### Community 172 - "Community 172"
Cohesion: 0.11
Nodes (17): readReplicaSchemaCatalogFromMigrations(), readReplicaSchemaCatalog(), REPLICA_EXCLUDED_INDEXES, REPLICA_FUNCTIONS, REPLICA_SEQUENCES, REPLICA_TABLES, REPLICA_TYPES, replicaConfigPattern() (+9 more)

### Community 173 - "Community 173"
Cohesion: 0.12
Nodes (27): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), countDevicesCF(), countInstallSourcesCF(), countUpdatesFromLogsCF() (+19 more)
...
Cohesion: 0.09
Nodes (21): adminStore, cancelDebouncedSearchReload(), currentPage, displayStore, famousCount, iconicCount, isLoadingApps, loadApps() (+13 more)
...
Cohesion: 0.18
Nodes (26): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend() (+18 more)
...
Cohesion: 0.14
Nodes (23): applyOptionalUserOnboardingFields(), buildUserOnboardingProgress(), clampOnboardingPayload(), clampResumableOnboardingStep(), fallbackUsersOnboardingProgressForLegacyConstraint(), isOneOf(), isUsersOnboardingCheckConstraintError(), jsonByteLength() (+15 more)
...
Cohesion: 0.14
Nodes (23): applyValidatedSubkeyContext(), assertSubkeyHasPlaintextSecret(), checkKeyByIdPg(), checkKeyPg(), FindApikeyByValueResult, foundAPIKey(), foundJWT(), getSubkeyId() (+15 more)
...
Cohesion: 0.15
Nodes (15): compareNativePackages(), DeploymentHistoryEntry, DeploymentPair, didPlatformChecksumMetadataChange(), getIncompatibilityReasons(), hasPlatformChecksum(), hasPlatformChecksumMetadataDrift(), IncompatibilityReason (+7 more)
...
Cohesion: 0.14
Nodes (19): emptyPlansAnalyticsResponse(), attributeCheckoutStarts(), AttributedCheckout, buildLogicalPlansOpenings(), buildPlansChartData(), CheckoutCompletionOutcome, classifyCheckoutCompletion(), DailyBillingPoint (+11 more)
...
Cohesion: 0.10
Nodes (20): normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), browserInvocationIndex, browserLoginIndex, indexSource, initActionSource, initActionStart (+12 more)
...
Cohesion: 0.13
Nodes (23): areGlobalStatsNumbersDifferent(), dispatchGlobalStatsShards(), dispatchMissingGlobalStatsShards(), dispatchMissingGlobalStatsShardsFor(), dispatchMissingGlobalStatsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows(), getEmptyBuildShardStats() (+15 more)
...
Cohesion: 0.14
Nodes (14): cancelDebouncedSearchReload(), closeChannelEditor(), formatNumber(), formatPercent(), getChannelEditorFocusable(), getOrganizationAttentionLabel(), loadEnterpriseAdoption(), loadOrganizations() (+6 more)
...
Cohesion: 0.13
Nodes (19): AI_STEPS, dayKey(), FailedErrorRow, fingerprint(), FIRST_STEPS, getAdminBuilderAnalytics(), Journey, loadAiChoiceCount() (+11 more)
...
Cohesion: 0.18
Nodes (16): app, AdminCliUsageStats, AdminCliUsageUser, aggregateTopUsersByEmail(), CliUsageEvent, emptyAdminCliUsageStats(), getAdminCliUsage(), getAdminCliUsageFromAE() (+8 more)
...
Cohesion: 0.17
Nodes (17): getRedirect(), allowOnboardingDashboardExploration(), canExploreOnboardingDashboard(), DashboardExploration, getOnboardingExploreBannerAppId(), getOnboardingResumeAppId(), getOnboardingResumeRedirect(), isNewOnboardingUser() (+9 more)
...
Cohesion: 0.17
Nodes (15): AUTHENTICATION_CONTINUATION, AuthenticationDestination, buildAuthenticationSection(), buildCliAiSetupPrompt(), buildOrganizationSection(), CliAiPromptApp, CliAiPromptInput, CliAiPromptOrganization (+7 more)
...
Cohesion: 0.17
Nodes (15): AdminLegendDataChart, AdminLegendToggleChart, AdminStackedBarChartData, AdminStackedBarChartDataset, AdminStackedBarCompatibleDataset, AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData() (+7 more)
...
Cohesion: 0.16
Nodes (14): markStepDone(), reportInitOnboardingStep(), getActiveCliReplaySessionId(), isCliTelemetryDisabled(), createInitTelemetry(), InitProgressTelemetry, InitTelemetryOptions, mergeInitProgressTelemetry() (+6 more)
...
Cohesion: 0.18
Nodes (13): addConnectOrigin(), buildConsoleContentSecurityPolicy(), CONSOLE_CONTENT_SECURITY_POLICY, ConsoleCspOptions, getConfiguredConnectSources(), getDeployTimeConnectOverrides(), joinSources(), PREVIEW_CONNECT_SOURCES (+5 more)
...
Cohesion: 0.19
Nodes (12): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder() (+4 more)

### Community 290 - "Community 290"
Cohesion: 0.12
Nodes (15): api_domain, development, local, preprod, prod, base_domain, development, local (+7 more)
...
Cohesion: 0.30
Nodes (12): buildPluginCompatibilityTrendSeries(), getLatestNonEmptyPluginTrendPoint(), PluginCompatibilityChartSeries, PluginCompatibilityTrendPoint, bucketPluginVersionBreakdown(), estimateKnownPluginVersionDevicesFromLadder(), hasPluginVersionBreakdown(), isLegacyChannelSelfStorePluginVersion() (+4 more)
...
Cohesion: 0.21
Nodes (15): capturePosthogException(), capturePosthogReplaySnapshot(), getPostHogExceptionUrl(), getPostHogSnapshotUrl(), getRequestPath(), groupIdentifyPosthog(), jsonByteLength(), parseExceptionFrames() (+7 more)
...
Cohesion: 0.19
Nodes (15): normalizeTargetLimit(), resolveTargetPlan(), buildNotificationRegistryLookupQuery(), deriveNativeNotificationIdentity(), getAllNotificationBuckets(), getNotificationBucket(), getNotificationIndex(), normalizeNotificationTag() (+7 more)
...
Cohesion: 0.30
Nodes (12): abTestsConfig, getABTestBranch(), hasWebNativeDevelopmentEnvironmentTreatment(), hasWebNativePublishIntentTreatment(), isABTestBranch(), isRecord(), OnboardingABTestAssignment, OnboardingABTestBranch (+4 more)

### Community 315 - "Community 315"
Cohesion: 0.24
Nodes (11): { cloudlogErrMock }, describeThrownValue(), getLogArrayLength(), getObjectType(), readErrorProperty(), redactPostgresLogText(), serializePostgresAggregateErrors(), serializePostgresError() (+3 more)
...
Cohesion: 0.14
Nodes (10): attemptedDestination, captchaKey, currentUserEmail, currentUserId, emailVerificationBlockingReason, otpVerificationCode, otpVerificationLoading, rawReturnToQuery (+2 more)
...
Cohesion: 0.20
Nodes (11): actionToFilter, failureActionFilterKeys, failureActions, filterToAction, observeActionFilterKeys, observeActions, statsActionFilters, updateActionFilterKeys (+3 more)
...
Cohesion: 0.30
Nodes (12): AUTH_EMAIL_EVENTS, AuthEmailBentoDetails, authEmailDeliveriesFromGoTrueEvent(), AuthEmailDelivery, AuthEmailPayload, buildAuthConfirmationUrl(), buildAuthEmailBentoDetails(), delivery() (+4 more)
...
Cohesion: 0.19
Nodes (6): renderFrameText(), longLog, render(), renderReadOnly(), assertContains(), RECOVERY_OPTIONS
...
Cohesion: 0.21
Nodes (9): buildAppTooLargeTrackedBentoEvent(), base, AppTooLargeBentoInput, buildAppTooLargeBentoEvent(), toSizeMb(), AiInstructionsCopiedInput, buildAiInstructionsCopiedBentoEvent(), isAiInstructionsCopiedEvent() (+1 more)
...
Cohesion: 0.21
Nodes (12): AdminOnboardingActivationCohort, AdminOnboardingActivationMetrics, getAdminOnboardingActivationMetrics(), isWithinActivationWindow(), toValidDate(), AdminOnboardingFunnel, addOrgToDateSet(), ADMIN_ONBOARDING_WIZARD_BUCKETS (+4 more)
...
Cohesion: 0.15
Nodes (9): globalId, WEBHOOK_TEST_ORG_ID, webhookApiKey, WebhookDelivery, base64Encode(), bytesToArrayBuffer(), decodeSerializedWebhookSecret(), generateStandardWebhookSignature() (+1 more)

### Community 361 - "Community 361"
Cohesion: 0.19
Nodes (13): buildGlobalStatsRetryMessage(), buildGlobalStatsShardMessage(), getGlobalStatsShardDelaySeconds(), getGlobalStatsShardFunctionName(), getGlobalStatsShardQueueKey(), queueGlobalStatsMessage(), queueGlobalStatsShard(), queueGlobalStatsShards() (+5 more)
...
Cohesion: 0.21
Nodes (12): emptyPlatformUpdateDeliveryOverviewRow(), mergePlatformDeliveryDailyRow(), mergePlatformDeliveryPercentile(), mergePlatformUpdateDeliveryDailyRows(), mergePlatformUpdateDeliveryOverviewRows(), normalizePlatformUpdateDeliveryDailyRow(), normalizePlatformUpdateDeliveryOverviewRow(), queryPlatformUpdateDeliveryDeviceCount() (+4 more)

### Community 377 - "Community 377"
Cohesion: 0.27
Nodes (10): AppRow, buildAlternativeAppIds(), createOnboardingAppWithFallbackIds(), isAppIdConflict(), OnboardingAppCreateInput, OnboardingAppCreateResult, OnboardingAppFunctionErrorMessages, readOnboardingAppFunctionError() (+2 more)
...
Cohesion: 0.20
Nodes (9): AdminOnboardingJourneyEdge, AdminOnboardingJourneyEdgeStyle, AdminOnboardingJourneyGraphConfig, AdminOnboardingJourneyIcon, AdminOnboardingJourneyLevel, AdminOnboardingJourneyNode, AdminOnboardingJourneyNodeKind, AdminOnboardingJourneyNodeTone (+1 more)
...
Cohesion: 0.31
Nodes (7): authStorageKey(), buildSession(), dismissSupportPrompt(), fakeJwt(), installAuthenticatedAdminSession(), main(), outputPath
...
Cohesion: 0.29
Nodes (8): AppRow, createOnboardingAppFromDraft(), CreateOnboardingAppResult, uploadIconFromDraft(), clearOnboardingAppDraft(), getDraftStorageKey(), loadOnboardingAppDraft(), OnboardingAppDraft
...
Cohesion: 0.20
Nodes (10): buildDeviceIdsByInstallSourcesQuery(), buildInstallSourceList(), buildReadDevicesCFQuery(), buildReadDevicesCFVersionNameCondition(), getAdminOrgMetrics(), getReadDevicesCFOrder(), normalizeAnalyticsLimit(), readDeviceIdsByInstallSourcesCF() (+2 more)
...
Cohesion: 0.29
Nodes (9): allowLocalWebhookUrls(), getDeliveryById(), getWebhookById(), getWebhookPublicUrlValidationError(), getWebhookUrlValidationError(), queueWebhookDelivery(), getDeliveriesSchema, retryDelivery() (+1 more)
...
Cohesion: 0.25
Nodes (8): resolveCapacitorConfigTargetPath(), throwCapacitorConfigPathError(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), resolveLiveUpdateProjectTarget(), outsideRoot, root
...
Cohesion: 0.33
Nodes (6): execFile, getLinkedProjectRef(), getTypeGenTarget(), main(), supa_anon, supa_url
...
Cohesion: 0.28
Nodes (9): addFirstSeenByApp(), batchAdminOnboardingTelemetryWindows(), buildAdminOnboardingProductionDeviceQuery(), buildAdminOnboardingUpdateDownloadQuery(), emptyAdminOnboardingTelemetry(), getAdminOnboardingTelemetry(), getAdminOnboardingTelemetryWindowFilter(), isAdminOnboardingTelemetryWithinRetention() (+1 more)
...
Cohesion: 0.22
Nodes (5): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader()

### Community 462 - "Community 462"
Cohesion: 0.28
Nodes (9): refreshUntil(), asTimestamp(), getAppOnboardingFeature(), isRecord(), parseAppOnboardingFeature(), parseAppOnboardingLedger(), setupOutcome(), withGettingStartedDismissed() (+1 more)
...
Cohesion: 0.32
Nodes (6): app, LIVE_UPDATE_METRICS_HEADERS, LiveUpdateMetricsResponse, sanitizeBreakdown(), sanitizePublicLiveUpdateMetrics(), sanitizePublicPercent()
...
Cohesion: 0.46
Nodes (6): addConfiguredHost(), getAllowedConfirmationHosts(), hasControlCharacters(), isAllowedConfirmationUrl(), normalizeRedirectPath(), validateRedirectPath()

### Community 490 - "Community 490"
Cohesion: 0.46
Nodes (7): isStoreReleaseValidated(), markStoreReleaseValidated(), readStorage(), storeReleaseSessionKey(), storeReleaseValidatedKey(), storeReleaseValidatedKeys, writeStorage()
...
Cohesion: 0.48
Nodes (5): LogMetadata, logRowDisplayMetadata(), normalizeLogMetadata(), ParsedLogVersionName, parseLogVersionName()
...
Cohesion: 0.43
Nodes (7): fixSupabaseHost(), getDatabaseURL(), getLocalReadOnlyDatabaseURL(), getReadOnlyDatabaseURL(), isLocalWorkerEnv(), safeSetResponseHeader(), setDatabaseSource()

### Community 517 - "Community 517"
Cohesion: 0.38
Nodes (7): getCachedReplicaLag(), getFreshReplicationLagMemoryEntry(), getReplicationLagCacheKey(), queryReplicaLag(), setReplicationLagHeader(), setReplicationLagMemoryEntry(), toReplicationLagSeconds()
...
Cohesion: 0.40
Nodes (3): isTerminal, refreshOnboarding(), stopPolling()
...
Cohesion: 0.47
Nodes (5): AppScopedMembershipFixture, CreateFixtureOptions, MembershipCleanupFixture, RankFixture, SoleSuperAdminFixture
...
Cohesion: 0.40
Nodes (5): honoFactory, MiddlewareKeyVariablesStripe, middlewareStripeWebhook(), parseStripeEvent(), StripeData
...
Cohesion: 0.60
Nodes (5): getAdminPluginBreakdown(), getLatestNonEmptyPluginTrendRowDate(), parseBreakdownJson(), parsePluginVersionLadderJson(), pickPluginBreakdownSnapshotRow()
...
## Knowledge Gaps
- **5853 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5848 more)
...
- **Why does `Database` connect `Community 29` to `Community 256`, `Community 3`, `Community 5`, `Community 8`, `Community 11`, `Community 140`, `Community 14`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 533`, `Community 26`, `Community 289`, `Community 33`, `Community 419`, `Community 165`, `Community 41`, `Community 559`, `Community 50`, `Community 55`, `Community 62`, `Community 324`, `Community 71`, `Community 461`, `Community 80`, `Community 82`, `Community 91`, `Community 117`, `Community 377`, `Community 126`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 128`, `Community 6`, `Community 7`, `Community 263`, `Community 136`, `Community 138`, `Community 10`, `Community 12`, `Community 16`, `Community 148`, `Community 150`, `Community 154`, `Community 155`, `Community 284`, `Community 157`, `Community 289`, `Community 417`, `Community 35`, `Community 37`, `Community 550`, `Community 551`, `Community 552`, `Community 294`, `Community 295`, `Community 554`, `Community 44`, `Community 556`, `Community 174`, `Community 298`, `Community 299`, `Community 40`, `Community 45`, `Community 51`, `Community 563`, `Community 53`, `Community 311`, `Community 59`, `Community 188`, `Community 64`, `Community 193`, `Community 66`, `Community 194`, `Community 329`, `Community 76`, `Community 205`, `Community 78`, `Community 79`, `Community 332`, `Community 81`, `Community 211`, `Community 87`, `Community 90`, `Community 92`, `Community 477`, `Community 94`, `Community 96`, `Community 97`, `Community 99`, `Community 614`, `Community 615`, `Community 102`, `Community 617`, `Community 107`, `Community 623`, `Community 111`, `Community 113`, `Community 112`, `Community 116`, `Community 119`, `Community 123`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.022252889425564946 - nodes in this community are weakly interconnected._