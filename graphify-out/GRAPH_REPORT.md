# Graph Report - capgo.app  (2026-08-18)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2396 files · ~4,852,915 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15506 nodes · 28189 edges · 1019 communities (854 shown, 165 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.8)
...
3. `scripts` - 161 edges
4. `getSupabaseClient()` - 139 edges
5. `Database` - 125 edges
6. `formatError()` - 93 edges
7. `checkPermission()` - 75 edges
8. `findSavedKey()` - 74 edges
9. `executeSQL()` - 66 edges
10. `initApp()` - 65 edges
...
## Communities (1019 total, 165 thin omitted)
...
Cohesion: 0.04
Nodes (117): syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (94): setCurrentCliCommand(), categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+86 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (98): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+90 more)
...
Cohesion: 0.04
Nodes (104): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, maybePromptBuilderCta(), shouldBlockIncompatibleUpload() (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (105): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName() (+97 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (79): useGitHubProfileDialog(), setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+71 more)
...
Cohesion: 0.04
Nodes (58): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+50 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (51): createAuthenticatedSupabaseClient(), describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId (+43 more)
...
Cohesion: 0.08
Nodes (83): getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (73): uploadBundleInternal(), resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+65 more)
...
Cohesion: 0.05
Nodes (64): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), bytesToGb(), ChecksumInfo, ChecksumType, formatBytes() (+56 more)
...
Cohesion: 0.05
Nodes (62): ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (55): buildCliRequestHeaders(), getInvocationSource(), AppOnboardingProgressPatch, checkAppExists(), completePendingOnboardingApp(), getAppIconStoragePath(), hostOptionsFromSupabase(), reportAppOnboardingProgress() (+47 more)
...
Cohesion: 0.05
Nodes (59): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+51 more)
...
Cohesion: 0.06
Nodes (48): app, DataDevice, devicesBodySchema, orderItemSchema, platformSchema, app, DataStats, defaultInsightActions (+40 more)
...
Cohesion: 0.06
Nodes (48): steps, trackerIdentity, AnalyticsPrimitive, AnalyticsProperties, CaptureEvent, createOnboardingDetailsFieldDebouncer(), createOnboardingProgressTracker(), CreateOnboardingProgressTrackerOptions (+40 more)
...
Cohesion: 0.05
Nodes (46): CLIActivityPayload, useRealtimeCLIFeed(), displayStore, mainStore, router, { t }, triggerFakeReplicationToast(), activeCount (+38 more)
...
Cohesion: 0.06
Nodes (35): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+27 more)
...
Cohesion: 0.07
Nodes (43): BuilderStatusResponse, calculateBuildRuntimeSeconds(), calculateRunnerWaitSeconds(), calculateTimeoutCompletedAt(), capBuildRuntimeSeconds(), formatBuildTimeoutError(), hasBuildTimedOut(), isTerminalBuildStatus() (+35 more)
...
Cohesion: 0.08
Nodes (44): getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handleMissingPhysicalIosRunTargets(), handleMissingSimulatorIosRunTargets() (+36 more)
...
Cohesion: 0.09
Nodes (36): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+28 more)
...
Cohesion: 0.10
Nodes (37): buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), emptyPlansAnalyticsResponse(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult(), getAdminPlansAnalytics() (+29 more)
...
Cohesion: 0.10
Nodes (25): buildFrontendOnboardingDailySeries(), buildFrontendOnboardingDailySetupCliSeries(), buildFrontendOnboardingFunnelStages(), buildFrontendOnboardingFunnelSummaries(), buildFrontendOnboardingGraphMetrics(), createFrontendOnboardingAnalyticsLoader(), DAILY_SETUP_CLI_OUTCOME_COLORS, formatFrontendOnboardingDuration() (+17 more)

### Community 117 - "Community 117"
Cohesion: 0.09
Nodes (11): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), AppVersion, filterAppVersions(), FilterValue, getFilterValue() (+3 more)
...
Cohesion: 0.11
Nodes (30): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildInteractionGraph(), buildV2V3SetupCliOutcomes(), comparePeriods() (+22 more)
...
Cohesion: 0.10
Nodes (31): areGlobalStatsNumbersDifferent(), buildRecentGlobalStatsRepairDateIds(), dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows() (+23 more)
...
Cohesion: 0.10
Nodes (23): flushDeferredCommandInvocation(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), doLoginExists(), login(), loginInternal(), Options (+15 more)
...
Cohesion: 0.13
Nodes (13): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), FRONTEND_ONBOARDING_PRODUCTION_HOST, FrontendOnboardingInteractionEvent, FrontendOnboardingVersion (+5 more)
...
Cohesion: 0.17
Nodes (13): calculateChurnRevenue(), calculateNrr(), getCompletedAppBuildOnboardingWindow(), getCompletedDayWindow(), getCurrentDayWindow(), getDailyWindow(), getDateId(), getPaidProductActivityStats() (+5 more)
...
## Knowledge Gaps
- **5492 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5487 more)
...
- **Why does `Database` connect `Community 50` to `Community 3`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 141`, `Community 18`, `Community 19`, `Community 24`, `Community 28`, `Community 31`, `Community 33`, `Community 34`, `Community 37`, `Community 167`, `Community 41`, `Community 172`, `Community 304`, `Community 58`, `Community 193`, `Community 195`, `Community 68`, `Community 202`, `Community 216`, `Community 92`?**
  _High betweenness centrality (0.213) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 513`, `Community 514`, `Community 515`, `Community 132`, `Community 5`, `Community 517`, `Community 518`, `Community 136`, `Community 9`, `Community 138`, `Community 7`, `Community 141`, `Community 525`, `Community 15`, `Community 143`, `Community 399`, `Community 17`, `Community 275`, `Community 276`, `Community 269`, `Community 278`, `Community 279`, `Community 156`, `Community 30`, `Community 159`, `Community 32`, `Community 163`, `Community 36`, `Community 44`, `Community 180`, `Community 181`, `Community 308`, `Community 312`, `Community 571`, `Community 59`, `Community 572`, `Community 574`, `Community 191`, `Community 448`, `Community 65`, `Community 64`, `Community 192`, `Community 580`, `Community 199`, `Community 200`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 206`, `Community 81`, `Community 82`, `Community 80`, `Community 86`, `Community 89`, `Community 90`, `Community 97`, `Community 99`, `Community 101`, `Community 104`, `Community 108`, `Community 115`, `Community 120`, `Community 250`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5495 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023457453958865438 - nodes in this community are weakly interconnected._