# Graph Report - capgo.app  (2026-08-23)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2465 files · ~4,938,060 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15858 nodes · 28833 edges · 1024 communities (860 shown, 164 thin omitted)
...
Cohesion: 0.02
Nodes (137): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+129 more)
...
Cohesion: 0.02
Nodes (104): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+96 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (133): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+125 more)
...
Cohesion: 0.04
Nodes (122): syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+114 more)
...
Cohesion: 0.03
Nodes (93): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), setInvocationSource(), OrgResolverDeps, ownerOrgCache (+85 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (112): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, maybePromptBuilderCta(), shouldBlockIncompatibleUpload() (+104 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (68): createAuthenticatedSupabaseClient(), describeBackend, pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId (+60 more)
...
Cohesion: 0.05
Nodes (85): check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions (+77 more)
...
Cohesion: 0.04
Nodes (75): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getGlobalAnalyticsProps() (+67 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (71): CheckDomainResponse, PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder (+63 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (64): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+56 more)
...
Cohesion: 0.04
Nodes (69): promoteEncryptionSummaryToEnabled(), initOnboardingSteps, CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption (+61 more)
...
Cohesion: 0.05
Nodes (61): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), hideLoader(), showLoader() (+53 more)
...
Cohesion: 0.04
Nodes (60): getAppIconStoragePath(), resolveAppSetIconPath(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+52 more)
...
Cohesion: 0.06
Nodes (62): getInitUpdaterPluginConfig(), resolveInitTargetPath(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction (+54 more)
...
Cohesion: 0.06
Nodes (51): addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags(), trackBentoEvent(), unsubscribeBento(), subscriberUpdate (+43 more)
...
Cohesion: 0.10
Nodes (65): findAppInOrganization(), cancelCommand(), sendCliEvent(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+57 more)
...
Cohesion: 0.11
Nodes (16): deleteOrganization(), deleteOrganizationInternal(), displayMembers(), DisplayOptions, listMembers(), listMembersInternal(), MemberInfo, PasswordPolicyConfig (+8 more)
...
Cohesion: 0.07
Nodes (45): adminStore, authorized, displayStore, hasCheckoutIntent, hasCheckoutVisitors, hasTraffic, hasVisitors, isInitialLoading (+37 more)
...
Cohesion: 0.09
Nodes (39): createRSA(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, setSetting(), setSettingInternal(), configWriteTargetStore (+31 more)
...
Cohesion: 0.10
Nodes (42): ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+34 more)
...
Cohesion: 0.08
Nodes (35): app, bodySchema, CreateDeviceBody, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString() (+27 more)
...
Cohesion: 0.09
Nodes (29): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, lintFailures (+21 more)
...
Cohesion: 0.09
Nodes (24): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult, UploadCompatibilitySummary, getReleaseType(), printReleaseType(), ReleaseTypeResult (+16 more)
...
Cohesion: 0.13
Nodes (16): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), FrontendOnboardingDailySetupCliEventKind, sqlStr() (+8 more)
...
Cohesion: 0.15
Nodes (20): decryptChecksum(), decryptChecksumV3(), decryptSource(), checkIndexPosition(), searchInDirectory(), searchInFile(), decryptZip(), decryptZipInternal() (+12 more)
...
Cohesion: 0.16
Nodes (16): numberLikeSchema, apikeyHasOrgRight(), bodySchema, get(), apiKeyHasAppScopedBinding(), app, appGlobal, assertOrgWebhookScope() (+8 more)
...
## Knowledge Gaps
- **5616 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5611 more)
...
- **Why does `Database` connect `Community 28` to `Community 3`, `Community 520`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 165`, `Community 42`, `Community 171`, `Community 46`, `Community 306`, `Community 58`, `Community 61`, `Community 67`, `Community 71`, `Community 199`, `Community 82`, `Community 351`, `Community 98`, `Community 495`?**
  _High betweenness centrality (0.234) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 16` to `Community 512`, `Community 513`, `Community 514`, `Community 131`, `Community 516`, `Community 5`, `Community 517`, `Community 7`, `Community 392`, `Community 137`, `Community 10`, `Community 266`, `Community 140`, `Community 141`, `Community 526`, `Community 142`, `Community 9`, `Community 273`, `Community 145`, `Community 274`, `Community 276`, `Community 278`, `Community 152`, `Community 155`, `Community 160`, `Community 289`, `Community 34`, `Community 32`, `Community 37`, `Community 293`, `Community 295`, `Community 40`, `Community 45`, `Community 174`, `Community 307`, `Community 51`, `Community 53`, `Community 181`, `Community 182`, `Community 573`, `Community 445`, `Community 574`, `Community 576`, `Community 63`, `Community 194`, `Community 195`, `Community 68`, `Community 198`, `Community 582`, `Community 78`, `Community 207`, `Community 81`, `Community 84`, `Community 85`, `Community 214`, `Community 88`, `Community 89`, `Community 91`, `Community 219`, `Community 94`, `Community 95`, `Community 106`, `Community 107`, `Community 111`, `Community 112`, `Community 113`, `Community 115`, `Community 245`, `Community 121`, `Community 127`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5619 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.024079807361541108 - nodes in this community are weakly interconnected._