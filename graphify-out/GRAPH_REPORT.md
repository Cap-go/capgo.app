...
## Corpus Check
- Large corpus: 2062 files · ~4,413,816 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13688 nodes · 24973 edges · 926 communities (776 shown, 150 thin omitted)
...
## Communities (926 total, 150 thin omitted)
...
Cohesion: 0.03
Nodes (104): app, DataSetManifest, app, bodySchema, baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName() (+96 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (107): ExistingOrganizationApp, PendingOnboardingApp, resolveCapacitorConfigTargetPath(), applyInitAutoTestChange(), askForAppId(), askForAppName(), askForWebDir(), BuildProjectStepOutcome (+99 more)
...
Cohesion: 0.05
Nodes (98): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, shouldBlockIncompatibleUpload(), summarizeUploadCompatibility() (+90 more)
...
Cohesion: 0.03
Nodes (83): getCreditTopUpProductId(), mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement() (+75 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (74): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult (+66 more)
...
Cohesion: 0.05
Nodes (68): runCapacitorPlatformAdd(), streamCommandInInitPanel(), uploadStep(), ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions (+60 more)
...
Cohesion: 0.08
Nodes (66): checkAppIdsExist(), completePendingOnboardingApp(), addAppStep(), addCodeChangeStep(), askForExistingDirectoryPath(), askForReplacementAppId(), buildProjectStep(), cancelCommand() (+58 more)
...
Cohesion: 0.07
Nodes (53): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent, orgOnboardingIntentTestUtils (+45 more)
...
Cohesion: 0.09
Nodes (45): getInvocationSource(), checkAppExists(), AlertsReporter, checkAlerts(), VersionCheckResult, addApp(), addAppInternal(), AppCreateSource (+37 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (45): app, buildReplicationQuery(), CheckStatus, clearDataCanaryCacheForTests(), countAppVersions(), DataCanaryCacheEntry, dataCanaryInflight, dataCanaryMemoryCache (+37 more)
...
Cohesion: 0.09
Nodes (40): checkVersionStatus(), setConfigWriteTarget(), addEncryptionStep(), addUpdaterStep(), cleanupStepsDone(), delay(), ensureUpdaterReadyBeforeSync(), formatSpawnOutput() (+32 more)
...
Cohesion: 0.08
Nodes (24): useGitHubProfileDialog(), ChannelPromotionPermissionChecker, ChannelPromotionTarget, findChannelsWithoutPromotionPermission(), formatChannelPromotionTargets(), getGitHubProfile(), GitHubProfile, GitHubProfileError (+16 more)
...
Cohesion: 0.10
Nodes (32): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+24 more)
...
Cohesion: 0.12
Nodes (25): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), numberLikeSchema, apikeyHasOrgRight(), apikeyHasOrgRightWithPolicy(), checkApikeyMeetsOrgPolicy() (+17 more)
...
Cohesion: 0.10
Nodes (23): addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getNuxtUpdaterPluginContent(), injectInitCode(), findMonorepoRoot (+15 more)

### Community 138 - "Community 138"
Cohesion: 0.12
Nodes (25): buildTerminalImageDataUrl(), CliStream, createTerminal(), createTerminalSnapshot(), createTerminalSnapshotNode(), escapeHtml(), extractHtmlFragment(), findSerializedNodeId() (+17 more)
...
Cohesion: 0.14
Nodes (23): countDemoSeededApps(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getRegistersToday(), isMissingBuildMetricColumnError(), runBuildsGlobalStatsShard() (+15 more)
...
Cohesion: 0.18
Nodes (9): findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), addChannelStep(), getResumedOnboardingAccessError() (+1 more)
...
Cohesion: 0.17
Nodes (13): calculateConversionRate(), countRegisteredUsersForSnapshot(), getAppBuildOnboardingMetrics(), getCoreSnapshotCounts(), getGithubStars(), getPaidPlanTotal(), getPlanConversionRates(), normalizeCoreSnapshotCounts() (+5 more)
...
## Knowledge Gaps
- **4606 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4601 more)
...
- **Why does `Database` connect `Community 11` to `Community 2`, `Community 5`, `Community 9`, `Community 10`, `Community 14`, `Community 526`, `Community 15`, `Community 145`, `Community 16`, `Community 275`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 31`, `Community 43`, `Community 180`, `Community 57`, `Community 60`, `Community 444`, `Community 74`, `Community 464`, `Community 82`, `Community 221`, `Community 483`, `Community 233`?**
  _High betweenness centrality (0.215) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 514`, `Community 3`, `Community 515`, `Community 5`, `Community 517`, `Community 7`, `Community 130`, `Community 133`, `Community 394`, `Community 139`, `Community 140`, `Community 523`, `Community 13`, `Community 143`, `Community 144`, `Community 17`, `Community 141`, `Community 276`, `Community 277`, `Community 279`, `Community 28`, `Community 29`, `Community 162`, `Community 163`, `Community 35`, `Community 38`, `Community 39`, `Community 42`, `Community 173`, `Community 174`, `Community 48`, `Community 50`, `Community 63`, `Community 66`, `Community 68`, `Community 73`, `Community 457`, `Community 458`, `Community 459`, `Community 75`, `Community 461`, `Community 462`, `Community 83`, `Community 470`, `Community 86`, `Community 88`, `Community 91`, `Community 220`, `Community 347`, `Community 94`, `Community 92`, `Community 248`, `Community 100`, `Community 105`, `Community 237`, `Community 112`, `Community 113`, `Community 246`, `Community 118`, `Community 120`, `Community 250`, `Community 123`, `Community 124`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4609 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020177383592017737 - nodes in this community are weakly interconnected._