...
## Corpus Check
- Large corpus: 2883 files · ~5,466,843 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17633 nodes · 32724 edges · 1111 communities (942 shown, 169 thin omitted)
...
## Communities (1111 total, 169 thin omitted)
...
Cohesion: 0.02
Nodes (160): withSupabaseSource(), Channel, currentBundle(), currentBundleInternal(), CurrentBundleRow, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema (+152 more)
...
Cohesion: 0.03
Nodes (141): OrgResolverDeps, ownerOrgCache, AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase() (+133 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (146): hasAppliedBundle(), app, bodySchema, RateLimitCounter, app, bodySchema, didCancel(), getBillingPlans() (+138 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (121): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+113 more)
...
Cohesion: 0.03
Nodes (121): ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), shouldStartInitBrowserLogin(), selectOnboardingChannel() (+113 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (90): useGitHubProfileDialog(), ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, ApiKeyLoadScope, clearApiKeyScopeFilters(), confirmApiKeyDeletion(), confirmApiKeyRegeneration() (+82 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (107): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, shouldBlockIncompatibleUpload(), summarizeUploadCompatibility() (+99 more)
...
Cohesion: 0.04
Nodes (82): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+74 more)
...
Cohesion: 0.03
Nodes (60): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, fixtureId, orgId (+52 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (65): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+57 more)
...
Cohesion: 0.03
Nodes (78): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+70 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (80): cancelCommand(), sendCliEvent(), getConfigWriteTarget(), resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets() (+72 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (57): STRIPE_EMULATOR_HEADERS, id, testOrgId, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers (+49 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (79): flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+71 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (59): decryptChecksum(), decryptChecksumV3(), decryptSource(), assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, decryptZip() (+51 more)
...
Cohesion: 0.03
Nodes (59): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId (+51 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (81): checkAppIdsExist(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+73 more)
...
Cohesion: 0.05
Nodes (63): CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions, SpinnerController (+55 more)
...
Cohesion: 0.04
Nodes (49): sizeClasses, AnimationTrigger, useOnboardingChannelAnimation(), UseOnboardingChannelAnimationOptions, app, channelEvents, events, organization (+41 more)
...
Cohesion: 0.04
Nodes (66): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+58 more)
...
Cohesion: 0.04
Nodes (57): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels(), getUniqueBaseData(), id (+49 more)
...
Cohesion: 0.07
Nodes (50): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), writeConfigUpdater() (+42 more)
...
Cohesion: 0.07
Nodes (48): isVersionDeleted(), app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getDeletedVersionAction() (+40 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (34): install(), PUBLIC_ROUTES, SsoEnforcementResponse, AppContext, UserModule, AuthGuardTestContext, contextStorage, createTestContext() (+26 more)
...
Cohesion: 0.08
Nodes (37): setCurrentCliCommand(), isTrustedOnboardingApiHost(), parseApiUrl(), BackgroundOnboardingCheck, PreparedOnboardingCheck, runOnboardingCheck(), OnboardingCheckOptions, prepareOnboardingCheck() (+29 more)

### Community 69 - "Community 69"
Cohesion: 0.08
Nodes (44): ProgressResponse, useAppOnboardingCliProgress(), admin, getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), APP_ONBOARDING_V1_STEP_IDS (+36 more)
...
Cohesion: 0.08
Nodes (44): buildFileReadCacheRequest(), assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred() (+36 more)
...
Cohesion: 0.08
Nodes (41): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+33 more)
...
Cohesion: 0.06
Nodes (32): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+24 more)
...
Cohesion: 0.08
Nodes (33): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig(), loadConfigForWrite() (+25 more)
...
Cohesion: 0.08
Nodes (32): appTodo(), AppTodoProgress, asRecord(), formatAppTodoList(), getAppTodoSteps(), readAppTodoProgress(), STEP_TITLES, V2_STEP_IDS (+24 more)
...
Cohesion: 0.08
Nodes (30): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi() (+22 more)

### Community 113 - "Community 113"
Cohesion: 0.10
Nodes (35): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions, renderNotificationHelper() (+27 more)
...
Cohesion: 0.15
Nodes (25): processAppFameBatch(), APP_FAME_TIERS, AppFameCandidate, AppFameDecision, AppFameTier, buildFameSystemPrompt(), buildFameUserPrompt(), clampScore() (+17 more)
...
Cohesion: 0.18
Nodes (26): adminOnboardingConversionRate(), closeClient(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend() (+18 more)
...
Cohesion: 0.13
Nodes (16): ALLOWED_ATTRIBUTE_KEYS, app, createBodySchema, requireManageSsoPermission(), updateBodySchema, uuidSchema, callManagementAPI(), createSSOProvider() (+8 more)
...
Cohesion: 0.16
Nodes (18): apikeyHasOrgRight(), bodySchema, deleteWebhook(), bodySchema, get(), apiKeyHasAppScopedBinding(), app, appGlobal (+10 more)
...
Cohesion: 0.12
Nodes (17): ALLOWED_HEADERS, ALLOWED_METHODS, AppScopedAttachmentPath, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, EXPOSED_HEADERS, FinalPart (+9 more)
...
Cohesion: 0.20
Nodes (22): getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets() (+14 more)
...
Cohesion: 0.15
Nodes (19): fetchIconDataUrl(), fetchValidatedUrl(), getWebsitePublicHostnameValidationError(), messages, fetchPublicUrl(), FetchPublicUrlOptions, getPublicHostnameValidationError(), getPublicUrlSyntaxValidationError() (+11 more)
...
Cohesion: 0.23
Nodes (14): aiBumpLevel, AiBumpLevelBody, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), extractAppsArray() (+6 more)
...
Cohesion: 0.42
Nodes (7): context, now, { queryMock, closeMock, clientMock }, buildRegistrationComparisonWindows(), buildRegistrationMonthlyComparisonQuery(), getAdminRegistrationMonthlyComparison(), registrationCount()
...
Cohesion: 0.31
Nodes (8): numberLikeSchema, getDeliveryById(), getWebhookById(), queueWebhookDelivery(), getDeliveries(), getDeliveriesSchema, retryDelivery(), retryDeliverySchema
...
## Knowledge Gaps
- **6135 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6130 more)
...
- **Why does `Database` connect `Community 42` to `Community 128`, `Community 2`, `Community 5`, `Community 139`, `Community 12`, `Community 11`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 27`, `Community 31`, `Community 33`, `Community 34`, `Community 43`, `Community 172`, `Community 47`, `Community 179`, `Community 63`, `Community 73`, `Community 331`, `Community 89`, `Community 90`, `Community 98`, `Community 226`, `Community 104`, `Community 105`, `Community 112`, `Community 127`?**
  _High betweenness centrality (0.174) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 18` to `Community 129`, `Community 132`, `Community 6`, `Community 7`, `Community 8`, `Community 137`, `Community 14`, `Community 144`, `Community 273`, `Community 20`, `Community 154`, `Community 29`, `Community 158`, `Community 159`, `Community 39`, `Community 40`, `Community 295`, `Community 298`, `Community 41`, `Community 428`, `Community 303`, `Community 48`, `Community 178`, `Community 306`, `Community 564`, `Community 565`, `Community 566`, `Community 308`, `Community 568`, `Community 54`, `Community 570`, `Community 187`, `Community 313`, `Community 317`, `Community 64`, `Community 579`, `Community 70`, `Community 203`, `Community 76`, `Community 78`, `Community 335`, `Community 82`, `Community 83`, `Community 85`, `Community 213`, `Community 214`, `Community 215`, `Community 88`, `Community 86`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 225`, `Community 233`, `Community 490`, `Community 108`, `Community 109`, `Community 626`, `Community 627`, `Community 629`, `Community 117`, `Community 121`, `Community 123`, `Community 126`?**
