# Graph Report - capgo.app  (2026-09-15)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2747 files · ~5,205,575 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17166 nodes · 31717 edges · 1114 communities (941 shown, 173 thin omitted)
...
## Communities (1114 total, 173 thin omitted)
...
Cohesion: 0.02
Nodes (162): fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort(), parsePositiveInt() (+154 more)
...
Cohesion: 0.02
Nodes (108): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+100 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (122): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+114 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (133): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+125 more)
...
Cohesion: 0.03
Nodes (82): STRIPE_EMULATOR_HEADERS, describeBackend, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId (+74 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (116): getRegistrationMetadata(), invoiceUpcoming(), BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), isDemoAppRow(), buildOnboardingIntentBentoEventData(), applyCreditsForMetric() (+108 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+110 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (81): get(), getAll(), app, appGlobal, FetchStoreMetadataBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists() (+73 more)
...
Cohesion: 0.04
Nodes (61): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+53 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (76): CheckDomainResponse, PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, creditPricingMetricOrder (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (84): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+76 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (69): getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch() (+61 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (76): getActiveUploadReporter(), optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema (+68 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (77): resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+69 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (77): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+69 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (67): useGitHubProfileDialog(), ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, ApiKeyLoadScope, clearApiKeyScopeFilters(), confirmApiKeyDeletion(), confirmApiKeyRegeneration() (+59 more)
...
Cohesion: 0.03
Nodes (60): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId, AuditLog (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (54): TEST_ORG_ID, TEST_ORG_ID, getUniqueBaseData(), execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, headers (+46 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (66): CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions, SpinnerController (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (54): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), recordSupabaseCall(), IncompatibleBundleError (+46 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (56): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+48 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (43): fixtureId, orgId, orgId, scopeId, pgPool, fixtureId, orgId, QueryFn (+35 more)
...
Cohesion: 0.09
Nodes (71): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+63 more)
...
Cohesion: 0.05
Nodes (58): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit() (+50 more)
...
Cohesion: 0.05
Nodes (52): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+44 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (54): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile() (+46 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (47): updateUser(), base64ToArrayBuffer(), blobToData(), getPhotoErrorMessage(), isPhotoSelectionCancelledError(), pickPhoto(), supabase, takePhoto() (+39 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (49): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), isCliLoginPath(), hideLoader(), showLoader() (+41 more)
...
Cohesion: 0.05
Nodes (53): aggregateNativeObserveSamples(), buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, buildVersionStatsQuery(), bumpMetricBucket(), createNativeObserveAggregateState(), createSeries() (+45 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (50): backgroundTaskMock, baseBuild, emitBuildTransition(), fakeContext(), maybeSingleMock, sendDiscordAlertMock, sendEventToTrackingMock, BuilderStatusResponse (+42 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (42): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+34 more)
...
Cohesion: 0.09
Nodes (48): getAppListPath(), checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError() (+40 more)
...
Cohesion: 0.06
Nodes (50): API_CONTENT_SECURITY_POLICY, AuthInfo, BRES, DEFAULT_CORS_ALLOWED_ORIGINS, getAllowedCorsOrigin(), getConfiguredCorsAllowedOrigins(), honoFactory, isLocalHttpOrigin() (+42 more)
...
Cohesion: 0.05
Nodes (43): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+35 more)
...
Cohesion: 0.07
Nodes (41): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+33 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (26): STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload (+18 more)
...
Cohesion: 0.09
Nodes (39): AlertsReporter, checkAlerts(), VersionCheckResult, addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations() (+31 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (43): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+35 more)
...
Cohesion: 0.08
Nodes (42): readNativeObserveStats(), defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), respondSummaryOrVersions() (+34 more)
...
Cohesion: 0.09
Nodes (43): syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution (+35 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (36): getCurrentCliCommand(), AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.10
Nodes (39): persistAppOnboarding(), put(), UpdateApp, getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, appendAppOnboardingStepHistory() (+31 more)
...
Cohesion: 0.09
Nodes (37): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+29 more)
...
Cohesion: 0.08
Nodes (29): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+21 more)
...
Cohesion: 0.07
Nodes (30): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+22 more)
...
Cohesion: 0.10
Nodes (35): aesKeyFromSecret(), decryptNotificationToken(), decryptProviderSecretWithSecretKey(), decryptWithSecretKey(), deriveNativeNotificationIdentity(), encryptNotificationToken(), encryptProviderSecret(), encryptWithSecretKey() (+27 more)
...
Cohesion: 0.12
Nodes (32): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult (+24 more)
...
Cohesion: 0.07
Nodes (26): id, testOrgId, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp(), seedReadyBundle() (+18 more)
...
Cohesion: 0.11
Nodes (25): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), buildNotificationBadgeStateQuery(), createNotificationDeliveryEventProof(), createNotificationDeliveryEventProofFromSecret() (+17 more)

### Community 159 - "Community 159"
Cohesion: 0.10
Nodes (22): AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders(), getAppListRow() (+14 more)
...
Cohesion: 0.15
Nodes (27): promptDoctorUpdateChoice(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+19 more)
...
Cohesion: 0.18
Nodes (26): closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend() (+18 more)
...
Cohesion: 0.12
Nodes (20): addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getMissingMainFileRecoveryOptions(), getNuxtUpdaterPluginContent(), injectInitCode() (+12 more)
...
Cohesion: 0.16
Nodes (19): apikeyHasOrgRight(), bodySchema, deleteWebhook(), getDeliveries(), bodySchema, get(), apiKeyHasAppScopedBinding(), app (+11 more)
...
Cohesion: 0.15
Nodes (19): chunkArray(), getArgValue(), loadEnv(), loadInput(), main(), getEnv(), initS3(), listAllObjectsInFolder() (+11 more)
...
Cohesion: 0.10
Nodes (16): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+8 more)
...
Cohesion: 0.13
Nodes (15): adminStore, displayStore, isLoading, loadError, mainStore, router, { t }, ADMIN_AB_TEST_PUBLISH_INTENT_OUTCOMES (+7 more)
...
Cohesion: 0.17
Nodes (14): { closeClientMock, getPgClientMock, queryMock }, ADMIN_AB_TEST_PUBLISH_INTENT_OUTCOMES, AdminABTestPublishIntentOutcome, AdminABTestPublishIntentOutcomeCount, AdminABTestPublishIntentOutcomeName, AdminABTestPublishIntentOutcomeRow, buildAdminABTestPublishIntentOutcome(), getAdminABTestPublishIntentOutcome() (+6 more)
...
Cohesion: 0.20
Nodes (12): loadDashboard(), AdminABTestDistribution, AdminABTestDistributionBranch, isNonNegativeInteger(), isPercentage(), isRecord(), parseAdminABTestDistribution(), parseBranch() (+4 more)
...
Cohesion: 0.24
Nodes (13): AuditLogData, buildWebhookDeliveryPayload(), buildWebhookPayload(), createDeliveryRecord(), createTestPayload(), findWebhooksForEvent(), getWebhookLogUrlMetadata(), getWebhookPublicUrlValidationError() (+5 more)

### Community 318 - "Community 318"
Cohesion: 0.33
Nodes (14): assertAllowedImagePath(), createPlatformAdminSignedImageUrl(), createSignedImageUrl(), decodePathnameSegments(), extractStorageImageKey(), hasUnsafeImagePathSegments(), isAllowedImagePath(), isOwnershipBearingImagePath() (+6 more)
...
Cohesion: 0.31
Nodes (11): CreateApp, post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), applyAppOnboardingPatch() (+3 more)
...
Cohesion: 0.40
Nodes (4): adminOnboardingConversionRate(), getAdminOnboardingFunnel(), buildAdminOnboardingInstallSourceQuery(), buildAdminOnboardingWizardDropoff()
...
## Knowledge Gaps
- **5976 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5971 more)
...
- **Why does `Database` connect `Community 69` to `Community 3`, `Community 5`, `Community 7`, `Community 383`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 24`, `Community 25`, `Community 29`, `Community 159`, `Community 41`, `Community 42`, `Community 169`, `Community 428`, `Community 52`, `Community 329`, `Community 211`, `Community 93`, `Community 95`, `Community 99`, `Community 101`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 129`, `Community 261`, `Community 133`, `Community 6`, `Community 8`, `Community 138`, `Community 267`, `Community 11`, `Community 13`, `Community 141`, `Community 150`, `Community 154`, `Community 156`, `Community 161`, `Community 289`, `Community 35`, `Community 164`, `Community 37`, `Community 34`, `Community 296`, `Community 297`, `Community 299`, `Community 44`, `Community 300`, `Community 174`, `Community 301`, `Community 45`, `Community 561`, `Community 562`, `Community 51`, `Community 50`, `Community 565`, `Community 56`, `Community 572`, `Community 319`, `Community 321`, `Community 66`, `Community 70`, `Community 199`, `Community 72`, `Community 200`, `Community 201`, `Community 76`, `Community 77`, `Community 78`, `Community 335`, `Community 80`, `Community 82`, `Community 210`, `Community 340`, `Community 215`, `Community 216`, `Community 90`, `Community 92`, `Community 223`, `Community 121`, `Community 98`, `Community 102`, `Community 487`, `Community 105`, `Community 106`, `Community 624`, `Community 625`, `Community 114`, `Community 627`, `Community 112`, `Community 117`, `Community 119`, `Community 633`, `Community 125`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5979 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02086858432036097 - nodes in this community are weakly interconnected._