...
## Corpus Check
- Large corpus: 2190 files · ~4,627,929 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 14744 nodes · 26766 edges · 956 communities (803 shown, 153 thin omitted)
...
## Communities (956 total, 153 thin omitted)
...
Cohesion: 0.02
Nodes (148): getReleaseType(), printReleaseType(), ReleaseTypeResult, SuperOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions (+140 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (118): check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+110 more)
...
Cohesion: 0.04
Nodes (102): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+94 more)
...
Cohesion: 0.03
Nodes (106): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+98 more)
...
Cohesion: 0.03
Nodes (72): getActiveUploadReporter(), configWriteTargetStore, loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), writeConfigTarget() (+64 more)
...
Cohesion: 0.07
Nodes (89): completePendingOnboardingApp(), getInfoInternal(), getInstalledDependencies(), setConfigWriteTarget(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep() (+81 more)
...
Cohesion: 0.04
Nodes (65): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+57 more)
...
Cohesion: 0.04
Nodes (63): canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup(), addGroupMemberBodyHook (+55 more)
...
Cohesion: 0.06
Nodes (62): getInvocationSource(), createRSA(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal() (+54 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (63): getConfigWriteTarget(), resolveInitTargetPath(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction (+55 more)
...
Cohesion: 0.05
Nodes (57): plans, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+49 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (51): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level (+43 more)
...
Cohesion: 0.04
Nodes (52): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+44 more)
...
Cohesion: 0.05
Nodes (44): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), UpdateDeliveryScope, UpdateDeliveryStatsResponse, DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS, DATE_RANGE_PRESET_LABEL_KEYS (+36 more)
...
Cohesion: 0.07
Nodes (46): CheckoutData, getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), getCreditTopUpProductIdFromCustomer(), handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout() (+38 more)
...
Cohesion: 0.07
Nodes (38): aggregateNativeObserveSamples(), app, buildNativeObserveResponse(), BuildNativeObserveResponseInput, createNativeObserveAggregateState(), createSeries(), durationExpression, finalizeNativeObserveAggregate() (+30 more)
...
Cohesion: 0.10
Nodes (35): getInitRecoveryCommands(), handleMissingPlatformSelection(), normalizeRunDevicePlatform(), PlatformChoice, runCapacitorPlatformAdd(), runPackageRunnerSync(), getRunDeviceCommandForPlatform(), assertHelperFileWritable() (+27 more)
...
Cohesion: 0.11
Nodes (33): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), countInstallSourcesCF(), countUpdatesFromLogsCF() (+25 more)
...
Cohesion: 0.14
Nodes (15): AdminStackedBarDataset, applyAdminStackedBarAccessibleBorders(), buildAdminStackedBarChartData(), buildAdminStackedBarChartOptions(), formatAdminStackedBarTooltip(), creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys (+7 more)
...
Cohesion: 0.14
Nodes (14): buildBreakdownMetrics(), buildPluginBreakdownResult(), convertDataToJsTypes(), getAdminPlatformOverview(), getLastMonthAnalyticsWindow(), getLastMonthAnalyticsWindowStart(), getPluginBreakdownCF(), getPublicLiveUpdateMetricsCF() (+6 more)
...
Cohesion: 0.30
Nodes (12): getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handlePhysicalIosRunTargets(), handleSimulatorIosRunTargets() (+4 more)
...
Cohesion: 0.33
Nodes (7): buildBillingBentoTagUpdates(), didCancel(), getBillingBentoEmails(), getStripeCustomerBillingEmail(), lookupOrgCreatorEmail(), normalizeBillingEmail(), syncBillingBentoTags()
...
Cohesion: 0.47
Nodes (6): bumpMetricBucket(), foldNativeObserveSamples(), foldOverviewCounters(), foldVersionBucket(), pushDurationSample(), pushTimedActionDuration()
...
Cohesion: 0.67
Nodes (4): buildNativeObservePluginResponse(), readNativeObservePluginStats(), readNativeObservePluginStatsCF(), readNativeObservePluginStatsSB()
...
## Knowledge Gaps
- **5253 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5248 more)
...
- **Why does `Database` connect `Community 82` to `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 11`, `Community 15`, `Community 20`, `Community 149`, `Community 278`, `Community 22`, `Community 21`, `Community 24`, `Community 27`, `Community 35`, `Community 167`, `Community 39`, `Community 44`, `Community 176`, `Community 49`, `Community 50`, `Community 179`, `Community 63`, `Community 71`, `Community 199`, `Community 75`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 129`, `Community 257`, `Community 130`, `Community 133`, `Community 7`, `Community 8`, `Community 266`, `Community 10`, `Community 142`, `Community 16`, `Community 144`, `Community 19`, `Community 148`, `Community 531`, `Community 532`, `Community 534`, `Community 412`, `Community 284`, `Community 287`, `Community 160`, `Community 33`, `Community 161`, `Community 36`, `Community 38`, `Community 43`, `Community 172`, `Community 173`, `Community 45`, `Community 46`, `Community 52`, `Community 55`, `Community 59`, `Community 61`, `Community 67`, `Community 68`, `Community 73`, `Community 78`, `Community 79`, `Community 80`, `Community 85`, `Community 87`, `Community 472`, `Community 473`, `Community 474`, `Community 89`, `Community 476`, `Community 477`, `Community 94`, `Community 97`, `Community 227`, `Community 101`, `Community 486`, `Community 360`, `Community 109`, `Community 127`, `Community 112`, `Community 241`, `Community 114`, `Community 116`, `Community 122`, `Community 252`, `Community 125`, `Community 255`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.022154906153480636 - nodes in this community are weakly interconnected._