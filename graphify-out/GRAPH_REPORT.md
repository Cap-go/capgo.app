# Graph Report - capgo.app  (2026-08-16)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2363 files · ~4,821,974 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15315 nodes · 27806 edges · 1021 communities (857 shown, 164 thin omitted)
...
1. `scripts` - 197 edges
2. `supabaseAdmin()` - 166 edges
3. `scripts` - 160 edges
4. `getSupabaseClient()` - 138 edges
5. `Database` - 125 edges
6. `formatError()` - 93 edges
7. `checkPermission()` - 77 edges
...
Cohesion: 0.01
Nodes (197): scripts, admin:backfill-credit-usage-posthog, admin:backfill-github-user-ids, admin:backfill-missing-app-icons, admin:backfill-missing-store-urls, admin:backfill-paid-product-activity, admin:backfill-plugin-version-ladder, api:dev (+189 more)
...
Cohesion: 0.02
Nodes (118): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+110 more)
...
Cohesion: 0.03
Nodes (134): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+126 more)
...
Cohesion: 0.04
Nodes (102): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+94 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (86): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), GlobalAnalyticsProps, InvocationSource, setInvocationSource() (+78 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (110): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, applyInitAutoTestChange(), askForAppName(), askForWebDir() (+102 more)
...
Cohesion: 0.05
Nodes (79): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+71 more)
...
Cohesion: 0.04
Nodes (67): app, canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook (+59 more)
...
Cohesion: 0.04
Nodes (68): hostOptionsFromSupabase(), getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement (+60 more)
...
Cohesion: 0.04
Nodes (70): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+62 more)
...
Cohesion: 0.05
Nodes (69): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), calculate(), COMPATIBILITY_PLATFORMS, CompatibilityEventInsert, CompatibilityPlatform, addStorageIntervalToDailyBuckets() (+61 more)
...
Cohesion: 0.04
Nodes (39): describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, pool, anonSupabase (+31 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (51): TEST_ORG_ID, apiFetch(), fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers (+43 more)

### Community 28 - "Community 28"
Cohesion: 0.10
Nodes (74): addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+66 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (62): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, createChannel(), seedOptions, versionCache (+54 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (58): getGlobalAnalyticsProps(), createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite() (+50 more)
...
Cohesion: 0.07
Nodes (53): flushDeferredCommandInvocation(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, deleteAppInternal(), displayApps(), getActiveApps() (+45 more)
...
Cohesion: 0.07
Nodes (45): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+37 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (42): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+34 more)
...
Cohesion: 0.06
Nodes (47): steps, trackerIdentity, AnalyticsPrimitive, AnalyticsProperties, CaptureEvent, createOnboardingDetailsFieldDebouncer(), createOnboardingProgressTracker(), CreateOnboardingProgressTrackerOptions (+39 more)
...
Cohesion: 0.07
Nodes (49): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), getSpawnOutputText() (+41 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (47): aggregateNativeObserveSamples(), app, buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, bumpMetricBucket(), createNativeObserveAggregateState(), createSeries() (+39 more)
...
Cohesion: 0.07
Nodes (45): DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, Json, APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature (+37 more)
...
Cohesion: 0.13
Nodes (12): withSupabaseSource(), Channel, currentBundle(), currentBundleInternal(), CurrentBundleRow, ChannelCurrentBundleOptions, OrganizationInfo, SDKResult (+4 more)
...
Cohesion: 0.07
Nodes (39): DataDevice, devicesBodySchema, orderItemSchema, platformSchema, app, createUtcDate(), DataStats, defaultInsightActions (+31 more)
...
Cohesion: 0.05
Nodes (34): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+26 more)
...
Cohesion: 0.08
Nodes (28): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, toIdString(), TrackEventBody, base (+20 more)
...
Cohesion: 0.08
Nodes (27): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), FrontendOnboardingInteractionEvent, FrontendOnboardingVersion, ONBOARDING_INTERACTION_EVENTS (+19 more)
...
Cohesion: 0.08
Nodes (33): aggregateInstallTimingsByVersion(), buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays, BundleInstallStatsItem, BundleInstallStatsRequest (+25 more)
...
Cohesion: 0.09
Nodes (31): aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample, durationExpression (+23 more)

### Community 101 - "Community 101"
Cohesion: 0.08
Nodes (30): appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+22 more)
...
Cohesion: 0.11
Nodes (26): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), checkAppExists(), completePendingOnboardingApp(), reportAppOnboardingProgress(), addApp() (+18 more)
...
Cohesion: 0.09
Nodes (10): assertDayWindow(), daySpan(), isUsageWindow(), AppVersion, filterAppVersions(), FilterValue, getFilterValue(), mockVersions (+2 more)
...
Cohesion: 0.11
Nodes (28): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildInteractionGraph(), buildV2SetupCliOutcomes(), comparePeriods() (+20 more)
...
Cohesion: 0.16
Nodes (17): asyncPool(), AuditState, chunkArray(), getPaidOrTrialOrgIds(), listAllKeys(), listAllKeysParallel(), loadEnv(), loadJsonArray() (+9 more)
...
Cohesion: 0.14
Nodes (12): creditPricingDisclaimer, ensureUpdateBillingAccess(), formatMetricAmount(), handleBuyCredits(), handleCreditCheckoutReturn(), loadTransactions(), metricLabel(), paginatedDailyTransactions (+4 more)
...
Cohesion: 0.14
Nodes (17): cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), tryResumeOnboarding(), getActiveCliReplaySessionId(), createInitTelemetry(), InitProgressTelemetry (+9 more)
...
Cohesion: 0.20
Nodes (10): AdminOnboardingActivationCohort, AdminOnboardingActivationMetrics, getAdminOnboardingActivationMetrics(), isWithinActivationWindow(), toValidDate(), AdminOnboardingFunnel, ADMIN_ONBOARDING_WIZARD_BUCKETS, AdminOnboardingWizardBucket (+2 more)
...
Cohesion: 0.26
Nodes (9): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent, orgOnboardingIntentTestUtils, syncOrgOnboardingIntentBentoTags() (+1 more)
...
## Knowledge Gaps
- **5433 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5428 more)
...
- **Why does `Database` connect `Community 10` to `Community 3`, `Community 6`, `Community 390`, `Community 8`, `Community 14`, `Community 19`, `Community 20`, `Community 26`, `Community 29`, `Community 286`, `Community 34`, `Community 35`, `Community 36`, `Community 41`, `Community 175`, `Community 47`, `Community 48`, `Community 55`, `Community 184`, `Community 188`, `Community 62`, `Community 73`, `Community 203`, `Community 228`, `Community 101`, `Community 613`, `Community 487`, `Community 112`, `Community 511`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 132`, `Community 133`, `Community 262`, `Community 7`, `Community 8`, `Community 137`, `Community 516`, `Community 263`, `Community 134`, `Community 4`, `Community 15`, `Community 144`, `Community 272`, `Community 146`, `Community 16`, `Community 24`, `Community 160`, `Community 161`, `Community 33`, `Community 290`, `Community 293`, `Community 38`, `Community 39`, `Community 169`, `Community 170`, `Community 46`, `Community 434`, `Community 179`, `Community 180`, `Community 567`, `Community 568`, `Community 58`, `Community 187`, `Community 570`, `Community 61`, `Community 191`, `Community 576`, `Community 68`, `Community 69`, `Community 71`, `Community 74`, `Community 461`, `Community 78`, `Community 83`, `Community 84`, `Community 341`, `Community 85`, `Community 89`, `Community 91`, `Community 120`, `Community 97`, `Community 98`, `Community 232`, `Community 106`, `Community 109`, `Community 113`, `Community 117`, `Community 375`, `Community 504`, `Community 505`, `Community 506`, `Community 251`, `Community 508`, `Community 127`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5436 weakly-connected nodes found - possible documentation gaps or missing edges._
