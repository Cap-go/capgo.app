...
## Corpus Check
- Large corpus: 2316 files · ~4,772,390 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15187 nodes · 27597 edges · 987 communities (823 shown, 164 thin omitted)
...
## Communities (987 total, 164 thin omitted)
...
Cohesion: 0.02
Nodes (155): SuperOptions, AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema (+147 more)
...
Cohesion: 0.04
Nodes (142): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase(), PendingOnboardingApp (+134 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (142): app, DataSetManifest, syncSubscriptionAndEventsWithRetry(), DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount() (+134 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (158): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+150 more)
...
Cohesion: 0.03
Nodes (117): checkAppIdsExist(), listPendingOnboardingApps(), resolveCapacitorConfigTargetPath(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), BuildProjectStepOutcome, CancelablePromptValue (+109 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (94): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps (+86 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (100): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+92 more)
...
Cohesion: 0.04
Nodes (74): clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage(), readKeyFile() (+66 more)
...
Cohesion: 0.08
Nodes (83): completePendingOnboardingApp(), findAppInOrganization(), cancelCommand(), markSnag(), getInfoInternal(), setConfigWriteTarget(), addAppStep(), addChannelStep() (+75 more)
...
Cohesion: 0.05
Nodes (67): waitForCommandResult(), streamCommandInInitPanel(), ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (63): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser(), createPlansVisitTracker() (+55 more)
...
Cohesion: 0.04
Nodes (43): createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool, pool, pool (+35 more)
...
Cohesion: 0.06
Nodes (66): reportAppOnboardingProgress(), resolveInitTargetPath(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (62): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+54 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (60): useGitHubProfileDialog(), ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, clearApiKeyScopeFilters(), confirmApiKeyDeletion(), confirmApiKeyRegeneration(), createAiApiKey() (+52 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (56): CompatibilityResult, getActiveUploadReporter(), Compatibility, findMonorepoRoot, findNXMonorepoRoot, addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (53): DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema (+45 more)
...
Cohesion: 0.05
Nodes (45): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, id, insertDelta() (+37 more)
...
Cohesion: 0.06
Nodes (46): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData (+38 more)
...
Cohesion: 0.05
Nodes (44): app, buildQueueHealthCriteria(), buildQueueIntervalMap(), cronTaskIntervalSeconds(), evaluateQueueHealth(), fetchQueueMetrics(), isSafeQueueName(), loadQueueIntervals() (+36 more)
...
Cohesion: 0.07
Nodes (40): AlertsReporter, checkVersionStatus(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getLatestDependencies(), deleteOrganization() (+32 more)
...
Cohesion: 0.11
Nodes (27): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult() (+19 more)
...
Cohesion: 0.08
Nodes (23): appIdParamSchema, bindingIdParamSchema, createGroupBodyHook, createGroupBodySchema, createRoleBindingBodyHook, createRoleBindingBodySchema, invalidAppIdHook, invalidBindingIdHook (+15 more)
...
Cohesion: 0.12
Nodes (26): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildV2Graph(), comparePeriods(), eachUtcDate() (+18 more)
...
Cohesion: 0.12
Nodes (19): Digester, noopDigester(), sha256Digester(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, DEFAULT_RETRY_PARAMS (+11 more)
...
Cohesion: 0.13
Nodes (18): getInstalledDependencies(), addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getNuxtUpdaterPluginContent(), injectInitCode() (+10 more)
...
Cohesion: 0.20
Nodes (13): emptyPlansAnalyticsResponse(), attributeCheckoutStarts(), AttributedCheckout, buildLogicalPlansOpenings(), buildPlansChartData(), incrementCategory(), LogicalPlansOpening, PlansBehaviorEvent (+5 more)
...
## Knowledge Gaps
- **5388 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5383 more)
...
- **Why does `Database` connect `Community 79` to `Community 2`, `Community 4`, `Community 8`, `Community 12`, `Community 13`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 156`, `Community 284`, `Community 29`, `Community 30`, `Community 31`, `Community 42`, `Community 49`, `Community 50`, `Community 184`, `Community 188`, `Community 67`, `Community 71`, `Community 199`, `Community 96`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 256`, `Community 130`, `Community 258`, `Community 132`, `Community 5`, `Community 133`, `Community 7`, `Community 136`, `Community 12`, `Community 270`, `Community 15`, `Community 146`, `Community 148`, `Community 151`, `Community 28`, `Community 286`, `Community 32`, `Community 545`, `Community 546`, `Community 35`, `Community 420`, `Community 548`, `Community 38`, `Community 37`, `Community 40`, `Community 169`, `Community 554`, `Community 170`, `Community 171`, `Community 45`, `Community 47`, `Community 179`, `Community 180`, `Community 54`, `Community 61`, `Community 62`, `Community 194`, `Community 69`, `Community 75`, `Community 78`, `Community 82`, `Community 83`, `Community 86`, `Community 91`, `Community 93`, `Community 99`, `Community 100`, `Community 228`, `Community 487`, `Community 488`, `Community 105`, `Community 489`, `Community 106`, `Community 491`, `Community 492`, `Community 365`, `Community 111`, `Community 499`, `Community 116`, `Community 245`, `Community 246`, `Community 120`, `Community 253`, `Community 125`?**
