# Graph Report - capgo.app  (2026-08-19)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2411 files · ~4,876,426 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15569 nodes · 28312 edges · 1033 communities (865 shown, 168 thin omitted)
...
Cohesion: 0.02
Nodes (268): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions() (+260 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (172): buildCliRequestHeaders(), setCurrentCliCommand(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase() (+164 more)
...
Cohesion: 0.03
Nodes (128): app, LIVE_UPDATE_METRICS_HEADERS, LiveUpdateMetricsResponse, sanitizeBreakdown(), sanitizePublicLiveUpdateMetrics(), sanitizePublicPercent(), app, bodySchema (+120 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (101): UpdateMetadataBody, app, bodySchema, CreateDeviceBody, app, AppContext, CompleteTopUpRequest, CostCalculationRequest (+93 more)
...
Cohesion: 0.03
Nodes (90): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), checkIndexPosition(), searchInDirectory() (+82 more)
...
Cohesion: 0.03
Nodes (59): createAuthenticatedSupabaseClient(), describeBackend, pgPool, deleteUserAs(), withAuthClient(), fixtureId, orgId, QueryFn (+51 more)
...
Cohesion: 0.04
Nodes (78): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), ConfirmOptions, intro(), log, PromptResult, SelectOption (+70 more)
...
Cohesion: 0.04
Nodes (70): reportAppOnboardingProgress(), createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite() (+62 more)
...
Cohesion: 0.04
Nodes (55): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (62): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+54 more)
...
Cohesion: 0.04
Nodes (61): AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId, ORG_ID, parseAuditLogsResponse() (+53 more)
...
Cohesion: 0.07
Nodes (43): useGitHubProfileDialog(), createAiApiKey(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost() (+35 more)
...
Cohesion: 0.06
Nodes (29): ChannelPromotionPermissionChecker, ChannelPromotionTarget, findChannelsWithoutPromotionPermission(), formatChannelPromotionTargets(), aggregateCliKeyPolicy(), candidatePolicyAllows(), canonicalizeCliBindings(), CliApiKeyMetadata (+21 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (39): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+31 more)
...
Cohesion: 0.06
Nodes (37): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+29 more)
...
Cohesion: 0.09
Nodes (27): buildFrontendOnboardingDailySeries(), buildFrontendOnboardingDailySetupCliSeries(), buildFrontendOnboardingFunnelStages(), buildFrontendOnboardingFunnelSummaries(), buildFrontendOnboardingGraphMetrics(), createFrontendOnboardingAnalyticsLoader(), DAILY_SETUP_CLI_OUTCOME_COLORS, formatFrontendOnboardingDuration() (+19 more)
...
Cohesion: 0.11
Nodes (28): assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions, renderNotificationHelper(), runCommand(), runInstall(), runSync() (+20 more)
...
Cohesion: 0.11
Nodes (30): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildInteractionGraph(), buildSetupCliOutcomes(), comparePeriods() (+22 more)
...
Cohesion: 0.10
Nodes (31): areGlobalStatsNumbersDifferent(), dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows(), filterCandidateGlobalStatsShards() (+23 more)
...
Cohesion: 0.14
Nodes (22): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, buildNativeObservePluginTotalDevicesCFQuery() (+14 more)
...
Cohesion: 0.20
Nodes (11): buildLogsnagInsightsRetryMessage(), buildLogsnagInsightsShardMessage(), getLogsnagInsightsShardDelaySeconds(), getLogsnagInsightsShardFunctionName(), getLogsnagInsightsShardQueueKey(), queueLogsnagInsightsMessage(), queueLogsnagInsightsShard(), reserveLogsnagInsightsRetry() (+3 more)
...
Cohesion: 0.33
Nodes (5): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), UploadResponse, APIKEY_TEST_ORG_SUPER_ADMIN
...
## Knowledge Gaps
- **5517 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5512 more)
...
- **Why does `Database` connect `Community 47` to `Community 3`, `Community 4`, `Community 6`, `Community 11`, `Community 13`, `Community 16`, `Community 149`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 31`, `Community 36`, `Community 293`, `Community 43`, `Community 45`, `Community 51`, `Community 57`, `Community 187`, `Community 61`, `Community 63`, `Community 193`, `Community 89`?**
  _High betweenness centrality (0.227) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 129`, `Community 257`, `Community 515`, `Community 516`, `Community 517`, `Community 387`, `Community 263`, `Community 135`, `Community 9`, `Community 264`, `Community 519`, `Community 520`, `Community 266`, `Community 267`, `Community 15`, `Community 528`, `Community 12`, `Community 271`, `Community 148`, `Community 24`, `Community 153`, `Community 280`, `Community 132`, `Community 28`, `Community 30`, `Community 133`, `Community 32`, `Community 33`, `Community 295`, `Community 40`, `Community 8`, `Community 42`, `Community 171`, `Community 172`, `Community 173`, `Community 55`, `Community 185`, `Community 58`, `Community 186`, `Community 444`, `Community 60`, `Community 192`, `Community 577`, `Community 578`, `Community 67`, `Community 580`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 586`, `Community 203`, `Community 74`, `Community 77`, `Community 80`, `Community 84`, `Community 86`, `Community 87`, `Community 90`, `Community 91`, `Community 96`, `Community 101`, `Community 103`, `Community 236`, `Community 108`, `Community 118`, `Community 123`, `Community 124`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.021668058704211908 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.029046553464086702 - nodes in this community are weakly interconnected._