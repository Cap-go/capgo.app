...
## Corpus Check
- Large corpus: 2458 files · ~4,934,841 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15834 nodes · 28793 edges · 1027 communities (866 shown, 161 thin omitted)
...
Cohesion: 0.02
Nodes (148): withConfigWriteTarget(), AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema (+140 more)
...
Cohesion: 0.03
Nodes (121): get(), getAll(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization() (+113 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (112): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (114): OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch(), deriveSupabaseOperation(), enableSupabaseInstrumentation(), getSupabaseSource(), isSupabaseInstrumentationEnabled() (+106 more)
...
Cohesion: 0.04
Nodes (111): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), maybePromptBuilderCta(), shouldBlockIncompatibleUpload(), summarizeUploadCompatibility() (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (102): listPendingOnboardingApps(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), BuildProjectStepOutcome (+94 more)
...
Cohesion: 0.03
Nodes (78): useAppPage(), UseAppPageOptions, CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, sortCreditPricingSteps() (+70 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (67): buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds(), getBuildCount(), getBuildTotalSeconds() (+59 more)
...
Cohesion: 0.04
Nodes (75): setCurrentCliCommand(), categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (85): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), didCancel(), getBillingPlans(), syncBillingBentoTags(), syncBillingBentoTagsFromStoredStripeInfo(), BillingPlanBentoState (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (82): configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget() (+74 more)
...
Cohesion: 0.03
Nodes (49): describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+41 more)
...
Cohesion: 0.04
Nodes (63): getActiveUploadReporter(), CapacitorConfig, ExtConfigPairs, CapacitorCliConfig, findMonorepoRoot, findNXMonorepoRoot, addProjectTypeCandidateDir(), ArrayElement (+55 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (69): waitForCommandResult(), streamCommandInInitPanel(), CANCEL, ConfirmOptions, intro(), log, PromptResult, SelectOption (+61 more)
...
Cohesion: 0.05
Nodes (63): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+55 more)

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (70): findAppInOrganization(), sendCliEvent(), waitLog(), getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+62 more)
...
Cohesion: 0.06
Nodes (55): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), RSAKeys, AlertsReporter, checkAlerts(), checkVersionStatus() (+47 more)
...
Cohesion: 0.06
Nodes (42): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi() (+34 more)
...
Cohesion: 0.06
Nodes (42): getAppIconStoragePath(), resolveAppSetIconPath(), assertChannelExists(), CapgoSupabaseClient, disableDownloadChannels(), setDefaultDownloadChannel(), AppListOptions, AppRow (+34 more)
...
Cohesion: 0.10
Nodes (32): buildCliRequestHeaders(), getInvocationSource(), AppOnboardingProgressPatch, completePendingOnboardingApp(), ExistingOrganizationApp, hostOptionsFromSupabase(), PendingOnboardingApp, reportAppOnboardingProgress() (+24 more)
...
Cohesion: 0.10
Nodes (24): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), buildFrontendOnboardingDailySetupCliOutcomes(), classifyFrontendOnboardingDailySetupCliOutcome() (+16 more)
...
Cohesion: 0.15
Nodes (32): checkAppIdsExist(), askForAppId(), askForReplacementAppId(), ensureNativePlatformForBuild(), exitAfterFinishingReplay(), exitCanceledInitOnboarding(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability() (+24 more)
...
Cohesion: 0.12
Nodes (22): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+14 more)
...
Cohesion: 0.14
Nodes (16): cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogSpec (+8 more)
...
- **Why does `Database` connect `Community 74` to `Community 3`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 145`, `Community 19`, `Community 20`, `Community 22`, `Community 26`, `Community 27`, `Community 28`, `Community 158`, `Community 34`, `Community 166`, `Community 43`, `Community 304`, `Community 306`, `Community 52`, `Community 55`, `Community 57`, `Community 59`, `Community 64`, `Community 202`, `Community 80`, `Community 212`, `Community 95`, `Community 246`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 11` to `Community 515`, `Community 516`, `Community 5`, `Community 6`, `Community 517`, `Community 519`, `Community 520`, `Community 265`, `Community 140`, `Community 398`, `Community 143`, `Community 272`, `Community 273`, `Community 146`, `Community 275`, `Community 148`, `Community 18`, `Community 529`, `Community 276`, `Community 144`, `Community 16`, `Community 282`, `Community 157`, `Community 33`, `Community 35`, `Community 164`, `Community 165`, `Community 294`, `Community 39`, `Community 42`, `Community 46`, `Community 47`, `Community 175`, `Community 49`, `Community 308`, `Community 181`, `Community 182`, `Community 183`, `Community 309`, `Community 576`, `Community 65`, `Community 577`, `Community 451`, `Community 579`, `Community 194`, `Community 195`, `Community 14`, `Community 72`, `Community 73`, `Community 201`, `Community 585`, `Community 71`, `Community 205`, `Community 83`, `Community 84`, `Community 86`, `Community 90`, `Community 94`, `Community 99`, `Community 100`, `Community 103`, `Community 107`, `Community 108`, `Community 111`, `Community 113`, `Community 116`, `Community 245`, `Community 125`?**
