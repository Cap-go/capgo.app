...
## Corpus Check
- Large corpus: 2560 files · ~5,008,865 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16273 nodes · 29917 edges · 1031 communities (860 shown, 171 thin omitted)
...
## Communities (1031 total, 171 thin omitted)
...
Cohesion: 0.03
Nodes (155): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, baseDecision, decideAutoResolves(), buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart() (+147 more)
...
Cohesion: 0.03
Nodes (100): replaceApiKeyGlobalPermissionsForExistingBindings(), app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app (+92 more)
...
Cohesion: 0.03
Nodes (112): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (91): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+83 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (81): buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds(), getBuildCount(), getBuildTotalSeconds() (+73 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (107): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+99 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (98): mockContext, mockContext, mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates() (+90 more)
...
Cohesion: 0.04
Nodes (101): BuilderCtaAction, BuilderCtaChoice, BuilderCtaContext, BuilderCtaSurface, BuilderSelect, BuilderSelectOption, BuilderSelectOptions, decideBuilderCtaSurface() (+93 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (81): OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch(), deriveSupabaseOperation(), enableSupabaseInstrumentation(), getSupabaseSource(), isSupabaseInstrumentationEnabled() (+73 more)
...
Cohesion: 0.04
Nodes (70): AppInsert, id, id, id, RBAC_ORG_ID, createHashedKeySDK(), uploadBundleWithHashedKey(), assertCompatibilityTableColumns() (+62 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (76): getActiveUploadReporter(), configWriteTargetStore, isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), throwCapacitorConfigPathError(), withConfigWriteTarget() (+68 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (80): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+72 more)
...
Cohesion: 0.04
Nodes (73): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult (+65 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (68): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+60 more)
...
Cohesion: 0.04
Nodes (63): getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), SupabaseCallInfo, AnyAsyncFn, cachedContextByApiKey (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (70): getConfigWriteTarget(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps, ChoiceOption (+62 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (81): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+73 more)
...
Cohesion: 0.04
Nodes (44): TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, triggerHeaders, callLogAs(), seedStaleCreatedByOrg() (+36 more)
...
Cohesion: 0.05
Nodes (56): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, sortCreditPricingSteps(), getErrorMessage(), logAsUser() (+48 more)
...
Cohesion: 0.05
Nodes (48): useAppPage(), UseAppPageOptions, buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), buildDemoUpdateDeliveryStats() (+40 more)
...
Cohesion: 0.06
Nodes (43): getAppIconStoragePath(), resolveAppSetIconPath(), assertChannelExists(), CapgoSupabaseClient, disableDownloadChannels(), setDefaultDownloadChannel(), AppListOptions, AppRow (+35 more)
...
Cohesion: 0.06
Nodes (39): canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup() (+31 more)
...
Cohesion: 0.07
Nodes (41): aggregateInstallTimingsByVersion(), aggregateSuccessRowsFromVersionUsage(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays (+33 more)
...
Cohesion: 0.08
Nodes (38): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+30 more)
...
Cohesion: 0.07
Nodes (34): readInstallTimingEventsCFChunked(), aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+26 more)
...
Cohesion: 0.06
Nodes (28): id, testOrgId, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), id, semverApiKey (+20 more)
...
Cohesion: 0.12
Nodes (33): ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+25 more)
...
Cohesion: 0.09
Nodes (21): id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, createPendingApp(), RELATIONS (+13 more)
...
Cohesion: 0.15
Nodes (23): executeStatsQueryWithRetry(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), getErrorCode(), getRetryableStatus(), isMissingOrgError(), isRetryableCronSyncError() (+15 more)
...
Cohesion: 0.10
Nodes (22): addCodeStep(), buildCodeDiffLines(), getExistingUpdaterBinding(), getInitCodeCall(), getInitCodeInjection(), getMissingMainFileRecoveryOptions(), getNuxtUpdaterPluginContent(), injectInitCode() (+14 more)
...
Cohesion: 0.11
Nodes (22): setConfigWriteTarget(), cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), tryResumeOnboarding(), getActiveCliReplaySessionId(), isCliTelemetryDisabled() (+14 more)
...
Cohesion: 0.22
Nodes (5): NO_ERROR, RequestJSON, schemas, channelSelfRequestSchema, updateRequestSchema
...
- **Why does `Database` connect `Community 51` to `Community 3`, `Community 10`, `Community 11`, `Community 140`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 22`, `Community 23`, `Community 25`, `Community 29`, `Community 34`, `Community 37`, `Community 43`, `Community 175`, `Community 49`, `Community 305`, `Community 54`, `Community 63`, `Community 65`, `Community 194`, `Community 72`, `Community 76`, `Community 206`, `Community 245`, `Community 252`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 128`, `Community 516`, `Community 517`, `Community 518`, `Community 7`, `Community 520`, `Community 9`, `Community 137`, `Community 521`, `Community 393`, `Community 6`, `Community 270`, `Community 527`, `Community 144`, `Community 145`, `Community 146`, `Community 13`, `Community 20`, `Community 4`, `Community 150`, `Community 23`, `Community 278`, `Community 151`, `Community 279`, `Community 282`, `Community 161`, `Community 163`, `Community 165`, `Community 38`, `Community 42`, `Community 44`, `Community 179`, `Community 52`, `Community 309`, `Community 53`, `Community 313`, `Community 187`, `Community 188`, `Community 573`, `Community 574`, `Community 447`, `Community 320`, `Community 576`, `Community 61`, `Community 66`, `Community 69`, `Community 198`, `Community 205`, `Community 80`, `Community 81`, `Community 89`, `Community 218`, `Community 90`, `Community 93`, `Community 96`, `Community 97`, `Community 102`, `Community 103`, `Community 360`, `Community 106`, `Community 116`, `Community 117`, `Community 119`, `Community 251`, `Community 124`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 4` to `Community 7`, `Community 135`, `Community 9`, `Community 13`, `Community 270`, `Community 17`, `Community 146`, `Community 20`, `Community 405`, `Community 150`, `Community 23`, `Community 407`, `Community 155`, `Community 160`, `Community 161`, `Community 163`, `Community 547`, `Community 42`, `Community 311`, `Community 313`, `Community 59`, `Community 445`, `Community 66`, `Community 69`, `Community 73`, `Community 84`, `Community 214`, `Community 89`, `Community 92`, `Community 93`, `Community 221`, `Community 223`, `Community 102`, `Community 103`, `Community 360`, `Community 105`, `Community 106`, `Community 238`, `Community 111`, `Community 368`?**
