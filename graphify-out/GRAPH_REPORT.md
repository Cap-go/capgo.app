...
## Corpus Check
- Large corpus: 2336 files · ~4,786,937 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15221 nodes · 27647 edges · 1003 communities (839 shown, 164 thin omitted)
...
## Communities (1003 total, 164 thin omitted)
...
Cohesion: 0.02
Nodes (140): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+132 more)
...
Cohesion: 0.03
Nodes (92): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+84 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (105): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, applyInitAutoTestChange(), askForAppName(), askForWebDir() (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (95): app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch() (+87 more)
...
Cohesion: 0.03
Nodes (54): createAuthenticatedSupabaseClient(), describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, pool (+46 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (76): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), resolveAppSetIconPath(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions (+68 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (80): ALLOWED_ATTRIBUTE_KEYS, app, createBodySchema, requireManageSsoPermission(), updateBodySchema, uuidSchema, app, bodySchema (+72 more)
...
Cohesion: 0.05
Nodes (56): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, createHashedKeySDK() (+48 more)
...
Cohesion: 0.04
Nodes (68): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, insertDelta(), productionChannel() (+60 more)
...
Cohesion: 0.09
Nodes (75): getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+67 more)
...
Cohesion: 0.07
Nodes (59): AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, displayBundles(), getActiveAppVersions(), getChannelsVersion(), displayApps() (+51 more)
...
Cohesion: 0.04
Nodes (53): id, RBAC_ORG_ID, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id (+45 more)
...
Cohesion: 0.05
Nodes (41): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled (+33 more)
...
Cohesion: 0.09
Nodes (39): addMonthsUtc(), Cycle, daysInMonthUtc(), oracleCompletedCycle(), pad2(), parseUtcDateOnly(), sqlPortCompletedCycle(), utcDateOnly() (+31 more)
...
Cohesion: 0.08
Nodes (42): getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails (+34 more)
...
Cohesion: 0.06
Nodes (39): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES, ChurnReason (+31 more)

### Community 84 - "Community 84"
Cohesion: 0.10
Nodes (33): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), AppOnboardingProgressPatch, checkAppExists(), completePendingOnboardingApp(), getAppIconStoragePath() (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (35): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, UploadCompatibilityResult, UploadCompatibilitySummary, displayCompatibilityTable(), assertIntegerInRange(), assertOptionalConfidence() (+27 more)
...
Cohesion: 0.08
Nodes (35): aggregateInstallTimingsByVersion(), app, buildBundleInstallResponse(), buildInstallTimingQuery(), buildInstallTimingsFromEvents(), buildSuccessRateQuery(), BundleInstallPeriodDays, BundleInstallStatsItem (+27 more)
...
Cohesion: 0.10
Nodes (30): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget() (+22 more)
...
Cohesion: 0.10
Nodes (24): cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), tryResumeOnboarding(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+16 more)
...
Cohesion: 0.13
Nodes (21): IncompatibleBundleError, capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS, getCommanderCode(), getCommandPath(), getErrorStatus() (+13 more)
...
Cohesion: 0.12
Nodes (19): buildFrontendOnboardingDailySeries(), buildFrontendOnboardingFunnelStages(), buildFrontendOnboardingFunnelSummaries(), buildFrontendOnboardingGraphMetrics(), createFrontendOnboardingAnalyticsLoader(), formatFrontendOnboardingDuration(), FrontendOnboardingAnalytics, FrontendOnboardingAnalyticsLoaderCallbacks (+11 more)
...
Cohesion: 0.22
Nodes (10): buildBillingBentoTagUpdates(), didCancel(), getBillingBentoEmails(), getBillingPlans(), getStripeCustomerBillingEmail(), lookupOrgCreatorEmail(), syncBillingBentoTags(), syncBillingBentoTagsFromStoredStripeInfo() (+2 more)
...
## Knowledge Gaps
- **5395 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5390 more)
...
- **Why does `Database` connect `Community 15` to `Community 386`, `Community 3`, `Community 5`, `Community 8`, `Community 12`, `Community 14`, `Community 19`, `Community 24`, `Community 27`, `Community 30`, `Community 32`, `Community 160`, `Community 34`, `Community 35`, `Community 294`, `Community 47`, `Community 48`, `Community 189`, `Community 61`, `Community 65`, `Community 193`, `Community 70`, `Community 71`, `Community 203`, `Community 84`, `Community 85`, `Community 91`, `Community 480`, `Community 102`?**
  _High betweenness centrality (0.193) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 6`, `Community 135`, `Community 8`, `Community 264`, `Community 10`, `Community 266`, `Community 269`, `Community 141`, `Community 271`, `Community 144`, `Community 17`, `Community 142`, `Community 16`, `Community 21`, `Community 23`, `Community 151`, `Community 153`, `Community 282`, `Community 157`, `Community 33`, `Community 38`, `Community 295`, `Community 554`, `Community 555`, `Community 42`, `Community 429`, `Community 557`, `Community 174`, `Community 175`, `Community 563`, `Community 51`, `Community 179`, `Community 185`, `Community 186`, `Community 59`, `Community 60`, `Community 62`, `Community 68`, `Community 201`, `Community 74`, `Community 204`, `Community 83`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 94`, `Community 96`, `Community 99`, `Community 104`, `Community 109`, `Community 110`, `Community 495`, `Community 496`, `Community 497`, `Community 114`, `Community 243`, `Community 499`, `Community 500`, `Community 373`, `Community 120`, `Community 508`, `Community 126`, `Community 127`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023719354195734503 - nodes in this community are weakly interconnected._