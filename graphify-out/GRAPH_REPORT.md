# Graph Report - capgo.app  (2026-08-17)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2381 files · ~4,835,090 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15394 nodes · 27975 edges · 999 communities (833 shown, 166 thin omitted)
...
## Communities (999 total, 166 thin omitted)
...
Cohesion: 0.02
Nodes (140): appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials (+132 more)
...
Cohesion: 0.03
Nodes (126): syncSubscriptionAndEventsWithRetry(), autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel(), loadCompatibilityBundle() (+118 more)
...
Cohesion: 0.04
Nodes (120): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, BuilderCtaAction, BuilderCtaChoice (+112 more)
...
Cohesion: 0.03
Nodes (91): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (99): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), completePendingOnboardingApp(), getAppIconStoragePath(), hostOptionsFromSupabase(), reportAppOnboardingProgress(), resolveAppSetIconPath() (+91 more)
...
Cohesion: 0.03
Nodes (110): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+102 more)
...
Cohesion: 0.06
Nodes (70): getInvocationSource(), checkAppExists(), AlertsReporter, checkAlerts(), VersionCheckResult, CapgoHttpOptions, DeleteSpecificVersionOptions, displayBundles() (+62 more)
...
Cohesion: 0.04
Nodes (73): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+65 more)
...
Cohesion: 0.04
Nodes (71): setConfigWriteTarget(), cleanupStepsDone(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), tryResumeOnboarding(), ConfirmOptions, intro(), PromptResult (+63 more)
...
Cohesion: 0.05
Nodes (64): AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId(), getScopedCreditSteps() (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (63): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+55 more)
...
Cohesion: 0.05
Nodes (46): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig, ChannelChecksum, channelUpdatePackageCliError() (+38 more)

### Community 42 - "Community 42"
Cohesion: 0.11
Nodes (59): addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath(), askForReplacementAppId() (+51 more)
...
Cohesion: 0.06
Nodes (49): buildCliRequestHeaders(), setCurrentCliCommand(), cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level (+41 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (45): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+37 more)
...
Cohesion: 0.05
Nodes (45): CLIActivityPayload, displayStore, mainStore, router, { t }, triggerFakeReplicationToast(), activeCount, canaryColor (+37 more)
...
Cohesion: 0.06
Nodes (41): decryptChecksum(), decryptChecksumV3(), decryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision (+33 more)
...
Cohesion: 0.09
Nodes (38): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+30 more)
...
Cohesion: 0.07
Nodes (39): app, bodySchema, CreateDeviceBody, app, DataUpload, app, CliReplayBody, readOptionalString() (+31 more)
...
Cohesion: 0.06
Nodes (31): findAppInOrganization(), resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), getResumedOnboardingAccessError(), resolveInitDirectoryPath(), resolveInitTargetPath() (+23 more)
...
Cohesion: 0.09
Nodes (32): AxisConfig, colorChannelToLinear(), createChartColorWithOpacity(), createChartScales(), createLegendConfig(), createStackedChartScales(), createXAxisConfig(), createYAxisConfig() (+24 more)
...
Cohesion: 0.10
Nodes (28): DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), getUpdaterInstallState(), PackageInstallState, PackageJsonDependencies, readInstalledPackageVersion() (+20 more)
...
Cohesion: 0.09
Nodes (26): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg() (+18 more)
...
Cohesion: 0.09
Nodes (18): id, testOrgId, id, semverApiKey, buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp() (+10 more)
...
Cohesion: 0.15
Nodes (17): apikeyHasOrgRight(), bodySchema, deleteWebhook(), bodySchema, get(), apiKeyHasAppScopedBinding(), app, appGlobal (+9 more)
...
- **Why does `Database` connect `Community 83` to `Community 3`, `Community 7`, `Community 10`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 30`, `Community 35`, `Community 296`, `Community 41`, `Community 171`, `Community 46`, `Community 47`, `Community 48`, `Community 57`, `Community 58`, `Community 64`, `Community 193`, `Community 67`, `Community 199`, `Community 73`, `Community 86`, `Community 127`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 129`, `Community 132`, `Community 5`, `Community 8`, `Community 267`, `Community 139`, `Community 13`, `Community 268`, `Community 270`, `Community 16`, `Community 271`, `Community 146`, `Community 147`, `Community 148`, `Community 150`, `Community 23`, `Community 25`, `Community 156`, `Community 29`, `Community 159`, `Community 32`, `Community 164`, `Community 38`, `Community 553`, `Community 554`, `Community 297`, `Community 556`, `Community 429`, `Community 45`, `Community 299`, `Community 177`, `Community 562`, `Community 178`, `Community 52`, `Community 182`, `Community 11`, `Community 59`, `Community 61`, `Community 189`, `Community 190`, `Community 68`, `Community 69`, `Community 198`, `Community 71`, `Community 74`, `Community 202`, `Community 208`, `Community 84`, `Community 85`, `Community 91`, `Community 95`, `Community 96`, `Community 104`, `Community 105`, `Community 123`, `Community 107`, `Community 109`, `Community 497`, `Community 114`, `Community 498`, `Community 499`, `Community 242`, `Community 501`, `Community 502`, `Community 379`, `Community 508`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023652913427679223 - nodes in this community are weakly interconnected._