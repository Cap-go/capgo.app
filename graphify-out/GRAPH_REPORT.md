# Graph Report - capgo.app  (2026-08-05)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2055 files · ~4,411,582 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13646 nodes · 24958 edges · 922 communities (776 shown, 146 thin omitted)
...
## Communities (922 total, 146 thin omitted)
...
Cohesion: 0.03
Nodes (137): syncSubscriptionAndEventsWithRetry(), aggregateDailyBuildStats(), calculateRevenue(), getBuildStats(), getTrialExtensionStats(), isMissingBuildMetricColumnError(), readGlobalStatsPastDueSnapshot(), runBuildsGlobalStatsShard() (+129 more)
...
Cohesion: 0.03
Nodes (96): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps (+88 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (98): check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), Channel, checkVersionNotUsedInChannel(), CheckVersionOptions (+90 more)
...
Cohesion: 0.03
Nodes (96): ExistingOrganizationApp, findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), setConfigWriteTarget(), applyInitAutoTestChange() (+88 more)
...
Cohesion: 0.03
Nodes (84): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, testOrgId, id (+76 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (57): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+49 more)
...
Cohesion: 0.04
Nodes (63): CompatibilityResult, configWriteTargetStore, loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), Compatibility (+55 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (69): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+61 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (65): CheckDomainResponse, spoof(), fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser() (+57 more)
...
Cohesion: 0.05
Nodes (64): promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), ConfirmOptions, log, PromptResult, SelectOption, SelectOptions, SpinnerController (+56 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (40): useAppPage(), UseAppPageOptions, adminStore, deliveryLatencyDays, devicesTrendSeries, displayStore, externalUpdatesSeries, isLoading (+32 more)
...
Cohesion: 0.04
Nodes (61): app, DataDevice, devicesBodySchema, orderItemSchema, platformSchema, app, createUtcDate(), DataStats (+53 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (59): getConsumedDeferredPreviewLink(), handleDeepLink(), installDeepLinkHandler(), isCapgoConsoleHost(), routeDeferredPreviewLink(), routePreviewLink(), routeWebLink(), setConsumedDeferredPreviewLink() (+51 more)
...
Cohesion: 0.04
Nodes (49): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, clearVersionAudits() (+41 more)
...
Cohesion: 0.10
Nodes (60): checkAppIdsExist(), completePendingOnboardingApp(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+52 more)
...
Cohesion: 0.05
Nodes (28): getRecentEmailOtpVerification(), isRecentEmailOtpVerification(), App, Bundle, Channel, Device, useAppDetailStore, CreditMetric (+20 more)
...
Cohesion: 0.08
Nodes (31): buildInitReplayBody(), buildTerminalImageDataUrl(), chunkToString(), CliStream, createTerminal(), createTerminalInteractionEvents(), createTerminalSnapshot(), createTerminalSnapshotNode() (+23 more)
...
Cohesion: 0.15
Nodes (30): ensureNativePlatformForBuild(), exitCanceledInitOnboarding(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+22 more)
...
Cohesion: 0.16
Nodes (21): buildOnPremResponse(), extractAppIdFromBodyBytes(), extractAppIdFromRequest(), fetch(), getCacheTtlSeconds(), getCircuitBreakerCacheKey(), getEndpointName(), getOnPremCache() (+13 more)
...
Cohesion: 0.12
Nodes (25): areGlobalStatsNumbersDifferent(), buildRecentGlobalStatsRepairDateIds(), dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows() (+17 more)
...
Cohesion: 0.16
Nodes (21): countDemoSeededApps(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getRegistersToday(), runLogsnagInsightsShard(), runLtvGlobalStatsShard() (+13 more)
...
Cohesion: 0.19
Nodes (14): useGitHubProfileDialog(), getGitHubProfile(), GitHubProfile, GitHubProfileError, normalizeGitHubUsername(), getAffonsoReferral(), getCookieValue(), getDatafastAttribution() (+6 more)
...
Cohesion: 0.15
Nodes (14): calculateChurnRevenue(), calculateNrr(), getCompletedAppBuildOnboardingWindow(), getCompletedDayWindow(), getCurrentDayWindow(), getDailyWindow(), getDateId(), getPaidProductActivityStats() (+6 more)

### Community 278 - "Community 278"
Cohesion: 0.15
Nodes (14): calculateConversionRate(), countRegisteredUsersForSnapshot(), getAppBuildOnboardingMetrics(), getCoreSnapshotCounts(), getGithubStars(), getPaidPlanTotal(), getPlanConversionRates(), getTrailing12mStart() (+6 more)
...
## Knowledge Gaps
- **4587 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4582 more)
...
- **Why does `Database` connect `Community 62` to `Community 2`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 140`, `Community 13`, `Community 14`, `Community 17`, `Community 19`, `Community 275`, `Community 23`, `Community 24`, `Community 30`, `Community 175`, `Community 53`, `Community 181`, `Community 58`, `Community 64`, `Community 68`, `Community 196`, `Community 77`, `Community 79`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 128`, `Community 515`, `Community 516`, `Community 132`, `Community 6`, `Community 518`, `Community 4`, `Community 137`, `Community 10`, `Community 395`, `Community 524`, `Community 139`, `Community 15`, `Community 146`, `Community 276`, `Community 280`, `Community 25`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 160`, `Community 161`, `Community 34`, `Community 39`, `Community 40`, `Community 171`, `Community 172`, `Community 47`, `Community 50`, `Community 180`, `Community 61`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 456`, `Community 457`, `Community 458`, `Community 74`, `Community 460`, `Community 461`, `Community 78`, `Community 80`, `Community 468`, `Community 85`, `Community 86`, `Community 348`, `Community 93`, `Community 223`, `Community 96`, `Community 98`, `Community 122`, `Community 104`, `Community 105`, `Community 239`, `Community 112`, `Community 241`, `Community 118`, `Community 248`, `Community 250`, `Community 123`, `Community 252`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4590 weakly-connected nodes found - possible documentation gaps or missing edges._
