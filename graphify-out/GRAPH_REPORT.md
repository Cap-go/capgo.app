...
## Corpus Check
- Large corpus: 2453 files · ~4,931,714 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15802 nodes · 28754 edges · 1022 communities (861 shown, 161 thin omitted)
...
## Communities (1022 total, 161 thin omitted)
...
Cohesion: 0.03
Nodes (134): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+126 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (97): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+89 more)
...
Cohesion: 0.03
Nodes (127): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+119 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (111): buildCliRequestHeaders(), withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), completePendingOnboardingApp(), getAppIconStoragePath() (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (118): syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus(), calculatePlanStatusFresh() (+110 more)
...
Cohesion: 0.03
Nodes (50): describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+42 more)
...
Cohesion: 0.05
Nodes (73): delay(), promoteEncryptionSummaryToEnabled(), runBuildAndSyncLoop(), runNativeResetCommand(), streamCommandInInitPanel(), uploadStep(), ConfirmOptions, intro() (+65 more)
...
Cohesion: 0.05
Nodes (73): getConfigWriteTarget(), resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), InitOnboardingStepDefinition (+65 more)
...
Cohesion: 0.06
Nodes (57): flushDeferredCommandInvocation(), AlertsReporter, checkAlerts(), VersionCheckResult, SaveKeyOptions, BrowserLoginDependencies, BrowserLoginEvent, BrowserLoginOptions (+49 more)
...
Cohesion: 0.05
Nodes (61): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+53 more)
...
Cohesion: 0.10
Nodes (58): findAppInOrganization(), cancelCommand(), sendCliEvent(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+50 more)
...
Cohesion: 0.06
Nodes (43): app, canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup() (+35 more)
...
Cohesion: 0.05
Nodes (33): TEST_ORG_ID, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createGroupOrgBinding(), createUserOrgBinding(), fixtureId, getOrgRoleId() (+25 more)
...
Cohesion: 0.06
Nodes (37): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest(), limitPathsForAi() (+29 more)
...
Cohesion: 0.06
Nodes (37): apiFetch(), fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers, id (+29 more)
...
Cohesion: 0.06
Nodes (37): appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+29 more)
...
Cohesion: 0.06
Nodes (36): firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl(), ManifestEntry, rewriteLocalEdgeRuntimeUrl(), AppInfos, AppStats, BaseHeaders (+28 more)
...
Cohesion: 0.06
Nodes (31): describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData, LogSpec, Order (+23 more)
...
Cohesion: 0.07
Nodes (28): getCurrentCliCommand(), setCurrentCliCommand(), author, bin, capgo, bugs, url, description (+20 more)
...
Cohesion: 0.10
Nodes (29): DeliveryMessage, allowLocalWebhookUrls(), AuditLogData, base64Encode(), bytesToArrayBuffer(), decodeSerializedWebhookSecret(), deliverWebhook(), disableWebhook() (+21 more)
...
Cohesion: 0.14
Nodes (9): UploadResponse, createAuthenticatedClient(), isRetryableRpcTransportError(), requestActorUserId(), SUPABASE_ANON_KEY, SUPABASE_SERVICE_KEY, SUPABASE_URL, APIKEY_TEST_APP_UPLOADER (+1 more)
...
Cohesion: 0.35
Nodes (9): buildWebhookDeliveryPayload(), buildWebhookPayload(), createDeliveryRecord(), createTestPayload(), getWebhookPublicUrlValidationError(), normalizeWebhookDeliveryVersion(), updateDeliveryResult(), bodySchema (+1 more)
...
## Knowledge Gaps
- **5592 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5587 more)
...
- **Why does `Database` connect `Community 101` to `Community 3`, `Community 5`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 23`, `Community 33`, `Community 34`, `Community 36`, `Community 292`, `Community 41`, `Community 170`, `Community 305`, `Community 178`, `Community 307`, `Community 57`, `Community 63`, `Community 72`, `Community 73`, `Community 202`, `Community 77`, `Community 78`, `Community 499`, `Community 126`?**
  _High betweenness centrality (0.203) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 18` to `Community 130`, `Community 515`, `Community 516`, `Community 517`, `Community 6`, `Community 519`, `Community 520`, `Community 394`, `Community 11`, `Community 12`, `Community 10`, `Community 143`, `Community 527`, `Community 273`, `Community 274`, `Community 147`, `Community 276`, `Community 277`, `Community 149`, `Community 145`, `Community 24`, `Community 153`, `Community 30`, `Community 32`, `Community 162`, `Community 165`, `Community 38`, `Community 37`, `Community 47`, `Community 176`, `Community 48`, `Community 309`, `Community 184`, `Community 185`, `Community 56`, `Community 573`, `Community 574`, `Community 447`, `Community 576`, `Community 67`, `Community 582`, `Community 71`, `Community 201`, `Community 76`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 471`, `Community 216`, `Community 89`, `Community 87`, `Community 92`, `Community 221`, `Community 97`, `Community 98`, `Community 99`, `Community 104`, `Community 107`, `Community 113`, `Community 114`, `Community 247`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5595 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.024168530409061396 - nodes in this community are weakly interconnected._