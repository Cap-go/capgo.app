...
## Corpus Check
- Large corpus: 2452 files · ~4,930,698 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15795 nodes · 28742 edges · 1010 communities (850 shown, 160 thin omitted)
...
## Communities (1010 total, 160 thin omitted)
...
Cohesion: 0.03
Nodes (141): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+133 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (111): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), resolveOrgStripeContext(), app (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (117): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (133): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), setConfigWriteTarget(), shouldStartInitBrowserLogin(), addCodeStep() (+125 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (114): withSupabaseSource(), flushDeferredCommandInvocation(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase() (+106 more)
...
Cohesion: 0.04
Nodes (120): BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), buildOnboardingIntentBentoEventData(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange, calculatePlanStatus() (+112 more)
...
Cohesion: 0.05
Nodes (75): getConfigWriteTarget(), resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep() (+67 more)
...
Cohesion: 0.04
Nodes (56): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, toIdString(), TrackEventBody (+48 more)
...
Cohesion: 0.04
Nodes (45): createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+37 more)
...
Cohesion: 0.08
Nodes (77): findAppInOrganization(), cancelCommand(), sendCliEvent(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep() (+69 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (64): promoteEncryptionSummaryToEnabled(), ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+56 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (66): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, describeBackend, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission() (+58 more)
...
Cohesion: 0.04
Nodes (50): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+42 more)
...
Cohesion: 0.04
Nodes (54): getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+46 more)
...
Cohesion: 0.06
Nodes (52): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), assertIntegerInRange(), assertOptionalConfidence(), assertOptionalIntegerInRange(), disableAutoUpdatesPossibleOptions, displayCompatibilityTable(), setChannel() (+44 more)
...
Cohesion: 0.04
Nodes (51): AlertsReporter, VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies() (+43 more)
...
Cohesion: 0.06
Nodes (40): buildServerInstructions(), installMcpStdoutGuard(), mcpAddAppInputSchema, mcpAddChannelInputSchema, mcpAddOrganizationInputSchema, mcpCheckCompatibilityInputSchema, mcpCleanupBundlesInputSchema, mcpDeleteAppInputSchema (+32 more)
...
Cohesion: 0.05
Nodes (39): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+31 more)
...
Cohesion: 0.07
Nodes (41): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema (+33 more)
...
Cohesion: 0.07
Nodes (37): id, testOrgId, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers (+29 more)
...
Cohesion: 0.09
Nodes (35): createRSA(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, isTypeScriptCompiler(), loadConfig(), loadConfigForWrite() (+27 more)
...
Cohesion: 0.11
Nodes (33): buildCliRequestHeaders(), setCurrentCliCommand(), getInvocationSource(), completePendingOnboardingApp(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppCreateSource (+25 more)
...
Cohesion: 0.11
Nodes (31): numberLikeSchema, apikeyHasOrgRight(), isWebhookEventType(), parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, deleteWebhook() (+23 more)
...
Cohesion: 0.13
Nodes (9): Digester, noopDigester(), sha256Digester(), isR2ChecksumError(), isR2Error(), isR2MultipartDoesNotExistError(), UploadHandler, Part (+1 more)

### Community 135 - "Community 135"
Cohesion: 0.15
Nodes (29): ensureNativePlatformForBuild(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets() (+21 more)
...
Cohesion: 0.12
Nodes (24): app, DataSetManifest, onManifestCreateTestUtils, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount() (+16 more)
...
Cohesion: 0.09
Nodes (30): aggregateDailyBuildStats(), countDemoSeededApps(), countNotificationEvent(), getBuildStats(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getNativeNotificationGlobalStats() (+22 more)
...
Cohesion: 0.12
Nodes (23): isTelemetryDisabled(), IncompatibleBundleError, trimTrailingSlashes(), capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS, getCommanderCode() (+15 more)
...
Cohesion: 0.15
Nodes (16): debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogSpec, Order (+8 more)
...
Cohesion: 0.15
Nodes (15): applySubscriptionRevenue(), calculateRevenue(), getEmptyPlanRevenue(), getEmptySubscriptionAccessSnapshotCounts(), getMetricWindowFromDailyWindow(), getSubscriptionAccessSnapshotCounts(), getTrailing12mStart(), getTrialExtensionStats() (+7 more)
...
## Knowledge Gaps
- **5588 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5583 more)
...
- **Why does `Database` connect `Community 76` to `Community 3`, `Community 5`, `Community 7`, `Community 264`, `Community 9`, `Community 12`, `Community 15`, `Community 16`, `Community 19`, `Community 23`, `Community 27`, `Community 29`, `Community 31`, `Community 160`, `Community 33`, `Community 165`, `Community 40`, `Community 44`, `Community 307`, `Community 52`, `Community 60`, `Community 62`, `Community 65`, `Community 194`, `Community 197`, `Community 71`, `Community 212`, `Community 218`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 512`, `Community 513`, `Community 130`, `Community 515`, `Community 516`, `Community 6`, `Community 7`, `Community 137`, `Community 395`, `Community 523`, `Community 141`, `Community 142`, `Community 11`, `Community 17`, `Community 147`, `Community 278`, `Community 279`, `Community 281`, `Community 282`, `Community 28`, `Community 30`, `Community 159`, `Community 35`, `Community 164`, `Community 37`, `Community 39`, `Community 47`, `Community 48`, `Community 180`, `Community 565`, `Community 566`, `Community 309`, `Community 568`, `Community 181`, `Community 182`, `Community 310`, `Community 57`, `Community 448`, `Community 192`, `Community 196`, `Community 68`, `Community 73`, `Community 75`, `Community 77`, `Community 83`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 92`, `Community 94`, `Community 97`, `Community 100`, `Community 101`, `Community 103`, `Community 104`, `Community 108`, `Community 109`, `Community 112`, `Community 115`, `Community 118`, `Community 250`, `Community 127`, `Community 511`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5591 weakly-connected nodes found - possible documentation gaps or missing edges._
