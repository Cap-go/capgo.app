...
## Corpus Check
- Large corpus: 2767 files · ~5,240,351 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17231 nodes · 31825 edges · 1105 communities (935 shown, 170 thin omitted)
...
Cohesion: 0.02
Nodes (155): UpdateProbeResult, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+147 more)
...
Cohesion: 0.03
Nodes (127): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), resolveAppSetIconPath(), CapgoHttpOptions, Channel, ChannelLinkedVersion (+119 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (119): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+111 more)
...
Cohesion: 0.02
Nodes (92): TEST_ORG_ID, fixtureId, orgId, createAuthenticatedSupabaseClient(), describeBackend, orgId, scopeId, pgPool (+84 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (129): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+121 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (125): app, bodySchema, CreateDeviceBody, syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), buildOnboardingIntentBentoEventData(), applyCreditsForMetric() (+117 more)
...
Cohesion: 0.03
Nodes (126): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+118 more)
...
Cohesion: 0.05
Nodes (61): flushDeferredCommandInvocation(), AlertsReporter, checkAlerts(), VersionCheckResult, SaveKeyOptions, BrowserLoginDependencies, BrowserLoginEvent, BrowserLoginOptions (+53 more)
...
Cohesion: 0.03
Nodes (85): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+77 more)
...
Cohesion: 0.04
Nodes (67): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+59 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (59): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+51 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (78): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, setSetting() (+70 more)
...
Cohesion: 0.04
Nodes (72): waitForCommandResult(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, initOnboardingSteps, ConfirmOptions (+64 more)
...
Cohesion: 0.05
Nodes (69): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+61 more)
...
Cohesion: 0.04
Nodes (53): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+45 more)
...
Cohesion: 0.05
Nodes (58): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+50 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (52): TEST_ORG_ID, getUniqueBaseData(), AutoTopUpSettings, originalSettings, CreditStep, headers, id, TEST_ORG_ID (+44 more)
...
Cohesion: 0.06
Nodes (61): resolveInitTargetPath(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult (+53 more)
...
Cohesion: 0.05
Nodes (55): adminStore, displayStore, isLoading, loadDashboard(), loadError, mainStore, router, { t } (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (58): app, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+50 more)
...
Cohesion: 0.05
Nodes (41): isTelemetryDisabled(), assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, IncompatibleBundleError, CliUserError, trimTrailingSlashes() (+33 more)
...
Cohesion: 0.08
Nodes (52): getAppListPath(), checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError() (+44 more)
...
Cohesion: 0.07
Nodes (54): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), getSpawnOutputText() (+46 more)
...
Cohesion: 0.07
Nodes (47): bindAppReader(), DEVICE_STORE, DEVICE_TF, refreshUntil(), serviceRoleSupabase, unbindAppReader(), APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES (+39 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (41): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+33 more)
...
Cohesion: 0.07
Nodes (47): nativeObserveActions, app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView() (+39 more)
...
Cohesion: 0.08
Nodes (41): deleteOwnedApiKeyByIdentifier(), isNumericApiKeyId(), selectOwnedApiKeyByIdentifier(), bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau() (+33 more)
...
Cohesion: 0.07
Nodes (39): app, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload (+31 more)
...
Cohesion: 0.10
Nodes (37): persistAppOnboarding(), getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, appendAppOnboardingStepHistory(), appendStepHistory(), applyAppOnboardingPatch() (+29 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (35): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+27 more)
...
Cohesion: 0.11
Nodes (22): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), app (+14 more)
...
Cohesion: 0.09
Nodes (24): AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders(), getAppListRow() (+16 more)
...
Cohesion: 0.08
Nodes (22): id, testOrgId, id, semverApiKey, buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp() (+14 more)
...
Cohesion: 0.10
Nodes (23): ensureUpdaterReadyBeforeSync(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallBlocker(), getUpdaterVersionToInstall(), handleBuildAndSyncFailure(), normalizeConcreteVersion(), runBuildAndSyncLoop(), waitForVerifiedUpdaterInstall() (+15 more)
...
Cohesion: 0.12
Nodes (18): isOptionalString(), isOptionalStringMaxLength(), isStatsRequestBody(), isValidStatsMetadata(), ALLOWED_STATS_ACTIONS_SET, firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl() (+10 more)
...
Cohesion: 0.18
Nodes (7): App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload, mocks
...
## Knowledge Gaps
- **6003 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5998 more)
...
- **Why does `Database` connect `Community 5` to `Community 3`, `Community 6`, `Community 8`, `Community 9`, `Community 144`, `Community 16`, `Community 18`, `Community 19`, `Community 278`, `Community 22`, `Community 539`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 422`, `Community 168`, `Community 425`, `Community 45`, `Community 176`, `Community 51`, `Community 52`, `Community 54`, `Community 185`, `Community 58`, `Community 321`, `Community 67`, `Community 68`, `Community 86`, `Community 93`, `Community 376`, `Community 124`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 21` to `Community 128`, `Community 6`, `Community 7`, `Community 264`, `Community 136`, `Community 10`, `Community 13`, `Community 142`, `Community 148`, `Community 150`, `Community 155`, `Community 156`, `Community 287`, `Community 160`, `Community 33`, `Community 420`, `Community 294`, `Community 295`, `Community 38`, `Community 297`, `Community 298`, `Community 555`, `Community 556`, `Community 557`, `Community 559`, `Community 175`, `Community 561`, `Community 178`, `Community 50`, `Community 49`, `Community 48`, `Community 568`, `Community 441`, `Community 57`, `Community 59`, `Community 196`, `Community 197`, `Community 326`, `Community 201`, `Community 74`, `Community 76`, `Community 79`, `Community 80`, `Community 81`, `Community 209`, `Community 83`, `Community 82`, `Community 213`, `Community 214`, `Community 85`, `Community 94`, `Community 97`, `Community 482`, `Community 226`, `Community 102`, `Community 233`, `Community 618`, `Community 619`, `Community 108`, `Community 621`, `Community 105`, `Community 106`, `Community 111`, `Community 109`, `Community 114`, `Community 627`, `Community 115`, `Community 119`, `Community 123`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _6006 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021603747588867458 - nodes in this community are weakly interconnected._