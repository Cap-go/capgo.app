# Graph Report - capgo.app  (2026-09-16)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2756 files · ~5,216,821 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17197 nodes · 31766 edges · 1102 communities (927 shown, 175 thin omitted)
...
## Communities (1102 total, 175 thin omitted)
...
Cohesion: 0.02
Nodes (156): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, buildCacheKeyOptionSchema (+148 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (182): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+174 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (132): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+124 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (122): get(), getAll(), app, appGlobal, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle() (+114 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (107): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+99 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (130): calcKeyId(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest() (+122 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (131): syncSubscriptionAndEventsWithRetry(), autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel(), loadCompatibilityBundle() (+123 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (109): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+101 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (127): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+119 more)
...
Cohesion: 0.03
Nodes (77): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+69 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (111): mockContext, mockContext, mockContext, mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate (+103 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (106): app, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+98 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (78): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, fixtureId, orgId (+70 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (79): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+71 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (78): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (93): flushDeferredCommandInvocation(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+85 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (93): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+85 more)
...
Cohesion: 0.03
Nodes (83): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+75 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (61): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+53 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (66): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId, AuditLog (+58 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (71): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, Awaitable, ChannelInfo, ChannelsListResponse (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (70): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo (+62 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (80): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+72 more)
...
Cohesion: 0.05
Nodes (59): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (65): streamCommandInInitPanel(), ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+57 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (58): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+50 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (76): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+68 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (71): activeChannelVersionJoin(), AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow (+63 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (48): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+40 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (56): addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags(), trackBentoEvent(), unsubscribeBento(), subscriberUpdate (+48 more)
...
Cohesion: 0.05
Nodes (57): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+49 more)
...
Cohesion: 0.05
Nodes (50): getInvocationSource(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, ensureOptions(), isAppInTargetOrganization() (+42 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (52): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), encryptChecksum(), encryptChecksumV3(), encryptSource() (+44 more)
...
Cohesion: 0.09
Nodes (21): addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers() (+13 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (47): useGitHubProfileDialog(), CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod() (+39 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (47): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat() (+39 more)
...
Cohesion: 0.06
Nodes (43): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+35 more)
...
Cohesion: 0.06
Nodes (42): IncompatibleBundleError, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS, sleep(), throwTwoFactorComplianceRpcError(), TwoFactorComplianceNetworkError (+34 more)
...
Cohesion: 0.06
Nodes (50): aggregateNativeObserveSamples(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, buildVersionStatsQuery(), bumpMetricBucket(), createNativeObserveAggregateState(), createSeries(), durationExpression (+42 more)
...
Cohesion: 0.06
Nodes (41): adminStore, displayStore, isLoading, loadDashboard(), loadError, mainStore, router, { t } (+33 more)
...
Cohesion: 0.06
Nodes (38): canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema, appIdParamSchema (+30 more)
...
Cohesion: 0.08
Nodes (42): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+34 more)
...
Cohesion: 0.09
Nodes (39): computeBuggyWeeklyInstallStats(), addDaysToDateOnly(), billingPeriodMetricsRange(), billingPeriodStatsTestUtils, formatBytes(), formatNumber(), getOrgIdForApp(), handleBillingPeriodStats() (+31 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (39): persistAppOnboarding(), getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, appendAppOnboardingStepHistory() (+31 more)
...
Cohesion: 0.06
Nodes (37): AcceptInvitation, acquireRbacOrgLockWithRetry(), app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensureOrgMembership(), ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError() (+29 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (39): app, bodySchema, CreateDeviceBody, app, app, CliReplayBody, readOptionalString(), readProperties() (+31 more)
...
Cohesion: 0.05
Nodes (44): bento_tag, label, bento_tag, label, A, B, C, D (+36 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (32): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+24 more)
...
Cohesion: 0.08
Nodes (38): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult (+30 more)
...
Cohesion: 0.09
Nodes (40): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), countDevicesCF() (+32 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (30): { checklistCoverageMock, cloudlogErrMock, queryPosthogHogqlMock }, buildAdminChannelAnimationHogql(), sqlString(), assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingDailyTabSwitches(), buildFrontendOnboardingHogql(), buildFrontendOnboardingTabSwitchHogql(), buildFrontendOnboardingWelcomeHogql() (+22 more)
...
Cohesion: 0.09
Nodes (37): aesKeyFromSecret(), buildNotificationBadgeStateQuery(), decryptNotificationToken(), decryptProviderSecretWithSecretKey(), decryptWithSecretKey(), deriveNativeNotificationIdentity(), encryptNotificationToken(), encryptProviderSecret() (+29 more)
...
Cohesion: 0.09
Nodes (36): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), log, getRunDeviceCommandForPlatform(), assertHelperFileWritable(), getConfigAppId(), notificationPackages (+28 more)
...
Cohesion: 0.09
Nodes (33): ensureSplashScreenForDirectUpdate(), ensureUpdaterReadyBeforeSync(), formatInitFilePath(), formatPackageReadyMessage(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getPackageInstallCommand(), getSplashScreenVersionToInstall() (+25 more)
...
Cohesion: 0.09
Nodes (34): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnelStages(), buildInteractionGraph(), buildLegacyFunnel(), buildSetupCliOutcomes() (+26 more)
...
Cohesion: 0.10
Nodes (29): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), emptyPlansAnalyticsResponse(), exactTrackingStartedAt(), explicitTransitionKind() (+21 more)
...
Cohesion: 0.13
Nodes (28): isChannelSelfRequestBody(), isDevicePlatform(), isOptionalString(), isOptionalStringMaxLength(), isUpdateRequestBody(), DevicePlatform, fieldIssue(), getAllowedStatsActionsList() (+20 more)
...
Cohesion: 0.11
Nodes (26): animationRow, { closeClientMock, getPgClientMock, posthogQueryMock, queryMock }, ADMIN_CHANNEL_ANIMATION_COHORTS, ADMIN_CHANNEL_ANIMATION_STAGES, AdminABTestChannelCreation, AdminChannelAnimationPosthogRow, AdminChannelAnimationRetentionPoint, AdminChannelAnimationRetentionProgress (+18 more)
...
Cohesion: 0.14
Nodes (23): updateDeliveryStatsTestUtils, lintFailures, liveFailures, ANALYTICS_ENGINE_SQL_LINT_RULES, AnalyticsEngineSqlLintIssue, AnalyticsEngineSqlLintRule, AnalyticsEngineSqlLiveValidationFailure, AnalyticsEngineSqlLiveValidationResult (+15 more)
...
Cohesion: 0.12
Nodes (19): { closeClientMock, getPgClientMock, queryMock }, { closeClientMock, getPgClientMock, queryMock }, config, ADMIN_AB_TEST_DEVELOPMENT_ENVIRONMENT_OUTCOMES, AdminABTestDevelopmentEnvironment, AdminABTestDevelopmentEnvironmentOutcomeName, AdminABTestDevelopmentEnvironmentRow, buildAdminABTestDevelopmentEnvironment() (+11 more)
...
Cohesion: 0.12
Nodes (19): AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason(), formatStoredChurnReason() (+11 more)
...
Cohesion: 0.17
Nodes (18): numberLikeSchema, apikeyHasOrgRight(), bodySchema, deleteWebhook(), getDeliveries(), bodySchema, get(), apiKeyHasAppScopedBinding() (+10 more)
...
Cohesion: 0.20
Nodes (17): addConfiguredHost(), getAllowedConfirmationHosts(), hasControlCharacters(), isAllowedConfirmationUrl(), normalizeRedirectPath(), validateRedirectPath(), escapeHtmlForSsr(), HTML_ALLOWED_ATTR (+9 more)
...
Cohesion: 0.14
Nodes (14): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), app, config, getChunkReloadTimestamp(), guestPath (+6 more)
...
Cohesion: 0.19
Nodes (15): app, AdminCliUsageStats, AdminCliUsageUser, aggregateTopUsersByEmail(), CliUsageEvent, emptyAdminCliUsageStats(), getAdminCliUsage(), getAdminCliUsageFromAE() (+7 more)
...
Cohesion: 0.19
Nodes (14): attributeCheckoutStarts(), AttributedCheckout, buildLogicalPlansOpenings(), buildPlansChartData(), CheckoutCompletionOutcome, classifyCheckoutCompletion(), incrementCategory(), LogicalPlansOpening (+6 more)
...
Cohesion: 0.18
Nodes (15): getRedirect(), allowOnboardingDashboardExploration(), canExploreOnboardingDashboard(), DashboardExploration, getOnboardingExploreBannerAppId(), getOnboardingResumeAppId(), matchesAppPath(), matchingDashboardExploration() (+7 more)
...
Cohesion: 0.17
Nodes (11): id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, createAppVersions(), createVersionWithoutR2Path() (+3 more)
...
Cohesion: 0.12
Nodes (15): api_domain, development, local, preprod, prod, captcha_key, development, local (+7 more)
...
Cohesion: 0.16
Nodes (14): AdminOnboardingActivationCohort, AdminOnboardingActivationMetrics, getAdminOnboardingActivationMetrics(), isWithinActivationWindow(), toValidDate(), AdminOnboardingFunnel, buildAdminOnboardingInstallSourceQuery(), addOrgToDateSet() (+6 more)
...
Cohesion: 0.25
Nodes (11): AnimationTrigger, useOnboardingChannelAnimation(), UseOnboardingChannelAnimationOptions, createTracker(), AnimationProgressSource, createOnboardingChannelAnimationTracker(), CreateOnboardingChannelAnimationTrackerOptions, OnboardingChannelAnimationStage (+3 more)
...
Cohesion: 0.26
Nodes (12): fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort(), parsePositiveInt() (+4 more)
...
Cohesion: 0.38
Nodes (9): CreateApp, post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), applyAppOnboardingPatch() (+1 more)
...
Cohesion: 0.21
Nodes (9): attemptedDestination, clearOtpSendCooldownTimer(), otpSendDisabled, rawReturnToQuery, resetOtpCaptcha(), returnTo, sendOtpCode(), startOtpSendCooldown() (+1 more)
...
Cohesion: 0.27
Nodes (10): refreshUntil(), asTimestamp(), getAppOnboardingFeature(), isRecord(), parseAppOnboardingFeature(), parseAppOnboardingLedger(), setupOutcome(), shouldSkipOnboardingResume() (+2 more)
...
Cohesion: 0.43
Nodes (6): AppOnboardingStepId, AppChecklistRow, buildFrontendOnboardingCliChecklistCoverage(), FrontendOnboardingCliChecklistCoverage, getFrontendOnboardingCliChecklistCoverage(), uniqueAppIds()
...
## Knowledge Gaps
- **5991 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5986 more)
...
- **Why does `Database` connect `Community 5` to `Community 3`, `Community 6`, `Community 8`, `Community 13`, `Community 16`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 535`, `Community 286`, `Community 160`, `Community 418`, `Community 34`, `Community 37`, `Community 47`, `Community 562`, `Community 51`, `Community 52`, `Community 58`, `Community 61`, `Community 708`, `Community 70`, `Community 326`, `Community 78`, `Community 85`, `Community 95`, `Community 225`, `Community 118`, `Community 375`, `Community 378`, `Community 124`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 6`, `Community 135`, `Community 7`, `Community 264`, `Community 137`, `Community 9`, `Community 10`, `Community 141`, `Community 14`, `Community 146`, `Community 147`, `Community 20`, `Community 149`, `Community 21`, `Community 151`, `Community 27`, `Community 288`, `Community 417`, `Community 289`, `Community 164`, `Community 38`, `Community 296`, `Community 553`, `Community 554`, `Community 555`, `Community 297`, `Community 557`, `Community 169`, `Community 559`, `Community 300`, `Community 49`, `Community 302`, `Community 46`, `Community 310`, `Community 566`, `Community 57`, `Community 188`, `Community 189`, `Community 316`, `Community 199`, `Community 72`, `Community 73`, `Community 74`, `Community 330`, `Community 77`, `Community 205`, `Community 79`, `Community 208`, `Community 80`, `Community 86`, `Community 87`, `Community 216`, `Community 88`, `Community 93`, `Community 479`, `Community 99`, `Community 100`, `Community 103`, `Community 616`, `Community 617`, `Community 104`, `Community 619`, `Community 364`, `Community 106`, `Community 110`, `Community 114`, `Community 117`, `Community 127`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021487783595113438 - nodes in this community are weakly interconnected._