# Graph Report - capgo.app  (2026-09-19)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2882 files · ~5,466,055 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17622 nodes · 32696 edges · 1109 communities (937 shown, 172 thin omitted)
...
## Communities (1109 total, 172 thin omitted)
...
Cohesion: 0.03
Nodes (175): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+167 more)
...
Cohesion: 0.01
Nodes (185): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+177 more)
...
Cohesion: 0.03
Nodes (139): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+131 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (134): app, bodySchema, CreateDeviceBody, hasAppliedBundle(), syncSubscriptionAndEventsWithRetry(), BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp() (+126 more)
...
Cohesion: 0.03
Nodes (99): get(), getAll(), app, appGlobal, CreateApp, ALLOWED_STORE_HOSTS, AppleLookupResult, assertAllowedStoreUrl() (+91 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+110 more)
...
Cohesion: 0.03
Nodes (87): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (83): getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch() (+75 more)
...
Cohesion: 0.04
Nodes (72): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (60): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+52 more)
...
Cohesion: 0.03
Nodes (62): fixtureId, orgId, createAuthenticatedSupabaseClient(), orgId, scopeId, pgPool, fixtureId, orgId (+54 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (83): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getScopedCreditSteps() (+75 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (71): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+63 more)
...
Cohesion: 0.07
Nodes (92): cancelCommand(), sendCliEvent(), waitLog(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep() (+84 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (69): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir() (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (64): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+56 more)
...
Cohesion: 0.05
Nodes (73): resolveCapacitorConfigTargetPath(), withConfigWriteTarget(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS (+65 more)
...
Cohesion: 0.06
Nodes (67): asyncPool(), createStripeClient(), createSupabaseServiceClient(), getArgValue(), getRequiredEnv(), getSupabaseServiceRoleKey(), isActionableStripeCustomerId(), loadEnv() (+59 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (63): ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone, TextOptions (+55 more)
...
Cohesion: 0.04
Nodes (51): sizeClasses, AnimationTrigger, useOnboardingChannelAnimation(), UseOnboardingChannelAnimationOptions, app, channelEvents, events, organization (+43 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (51): fetchAllIds(), generateInsertQuery(), ids, main(), chunkArray(), getArgValue(), loadEnv(), loadInput() (+43 more)
...
Cohesion: 0.05
Nodes (50): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), isTelemetryDisabled(), recordSupabaseCall() (+42 more)
...
Cohesion: 0.05
Nodes (50): TableColumn, useGitHubProfileDialog(), ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, ApiKeyLoadScope, clearApiKeyScopeFilters(), confirmApiKeyDeletion() (+42 more)
...
Cohesion: 0.06
Nodes (55): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser(), AppUsageByApp, AppUsageGlobal (+47 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (61): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+53 more)
...
Cohesion: 0.06
Nodes (55): developmentEnvironmentOptions, OnboardingDevelopmentEnvironmentOption, abTestsConfig, onboardingFor(), onboardingWithNewChannel(), getABTestBranch(), hasNewChannelTreatment(), hasWebNativeDevelopmentEnvironmentTreatment() (+47 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (41): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+33 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (47): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), CheckDomainResponse, buildDemoUpdateDeliveryStats(), UpdateDeliveryScope (+39 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (51): backgroundTaskMock, baseBuild, emitBuildTransition(), fakeContext(), maybeSingleMock, sendDiscordAlertMock, sendEventToTrackingMock, app (+43 more)
...
Cohesion: 0.04
Nodes (50): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+42 more)
...
Cohesion: 0.06
Nodes (55): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), getSpawnOutputText() (+47 more)
...
Cohesion: 0.05
Nodes (33): install(), PUBLIC_ROUTES, SsoEnforcementResponse, AppContext, UserModule, AuthGuardTestContext, contextStorage, createTestContext() (+25 more)
...
Cohesion: 0.07
Nodes (41): CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod(), isPostgresUniqueViolation() (+33 more)
...
Cohesion: 0.06
Nodes (42): accumulateNumbers(), AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildDailyPlatformActiveTotals(), buildNativeVersionCounts(), bundleUsageSchema, bundleUsageTestUtils (+34 more)
...
Cohesion: 0.07
Nodes (38): periodForDays(), app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getStatsInsightsPeriod() (+30 more)
...
Cohesion: 0.08
Nodes (41): buildExportRows(), buildNeverPaidCustomerSummaries(), chunkItems(), ExportRow, fetchActionableOrgs(), fetchOrgMemberEmailsByOrgId(), fetchRoleBindingRows(), fetchUserEmails() (+33 more)
...
Cohesion: 0.09
Nodes (40): app, DeliveryMessage, app, allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload() (+32 more)

### Community 91 - "Community 91"
Cohesion: 0.10
Nodes (37): ProgressResponse, useAppOnboardingCliProgress(), admin, getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, APP_ONBOARDING_V3_STEP_IDS (+29 more)
...
Cohesion: 0.07
Nodes (33): state, supabase, widgets, classes, globals, rootClasses(), availableLocales, ensureLanguageLoaded() (+25 more)
...
Cohesion: 0.08
Nodes (34): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+26 more)
...
Cohesion: 0.09
Nodes (34): buildDeletedFileMarkerRequest(), buildFileReadCacheRequestsForPath(), buildWorkersFileCacheKey(), buildWorkersFileCacheRequests(), CacheLike, FILE_READ_CACHE_ORIGINS, FILE_READ_PATH_PREFIXES, FILE_READ_TRACKING_QUERY_PARAMS (+26 more)
...
Cohesion: 0.11
Nodes (28): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult() (+20 more)
...
Cohesion: 0.07
Nodes (27): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels(), getUniqueBaseData(), id (+19 more)
...
Cohesion: 0.09
Nodes (26): captchaKey, completeInviteSuccess(), emailDialogDescription, emailDialogTitle, handleEmailSubmit(), handleFullDetailsSubmit(), isEmailDialogOpen, isFullDetailsDialogOpen (+18 more)
...
Cohesion: 0.09
Nodes (28): firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl(), ManifestEntry, rewriteLocalEdgeRuntimeUrl(), canUseSupabaseFallback(), createStatsBandwidth(), createStatsDevices() (+20 more)
...
Cohesion: 0.12
Nodes (25): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), APIKEY_MANAGER_DENIED_ASSIGNABLE_ROLES (+17 more)

### Community 146 - "Community 146"
Cohesion: 0.11
Nodes (19): AppSettings, persistAppOnboarding(), UpdateApp, app, AuthenticatedClient, bodySchema, Observations, persistObservedProgress() (+11 more)
...
Cohesion: 0.14
Nodes (26): app, processAppFameBatch(), APP_FAME_TIERS, AppFameCandidate, AppFameDecision, AppFameTier, buildFameSystemPrompt(), buildFameUserPrompt() (+18 more)
...
Cohesion: 0.17
Nodes (24): post(), put(), body, context, mocks, isAppOnboardingOutcome(), isAppOnboardingSource(), parseAppOnboardingPatch() (+16 more)
...
Cohesion: 0.14
Nodes (18): app, buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString(), optionalTagString(), ResolvedTrackingId (+10 more)
...
Cohesion: 0.12
Nodes (23): executeStatsQueryWithRetry(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), app, getManifestSizeWithRetry() (+15 more)
...
Cohesion: 0.18
Nodes (26): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown() (+18 more)
...
Cohesion: 0.11
Nodes (14): Tab, TableAction, TableRow, TableSort, accountTabs, adminTabs, appSettingsTabs, appTabs (+6 more)
...
Cohesion: 0.14
Nodes (14): CompatibilitySummary, DeploymentHistoryEntry, DeploymentPair, didPlatformChecksumMetadataChange(), getIncompatibilityReasons(), hasPlatformChecksum(), hasPlatformChecksumMetadataDrift(), IncompatibilityReason (+6 more)
...
Cohesion: 0.19
Nodes (17): apikeyHasOrgRight(), bodySchema, deleteWebhook(), getDeliveries(), get(), apiKeyHasAppScopedBinding(), app, appGlobal (+9 more)
...
Cohesion: 0.18
Nodes (15): emptyPlansAnalyticsResponse(), attributeCheckoutStarts(), AttributedCheckout, buildLogicalPlansOpenings(), buildPlansChartData(), CheckoutCompletionOutcome, classifyCheckoutCompletion(), incrementCategory() (+7 more)
...
Cohesion: 0.15
Nodes (15): describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData, LogSpec, Order (+7 more)
...
Cohesion: 0.17
Nodes (14): DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState(), PackageInstallState, PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson() (+6 more)
...
Cohesion: 0.28
Nodes (13): app, AUTH_EMAIL_EVENTS, AuthEmailBentoDetails, authEmailDeliveriesFromGoTrueEvent(), AuthEmailDelivery, AuthEmailPayload, buildAuthConfirmationUrl(), buildAuthEmailBentoDetails() (+5 more)
...
Cohesion: 0.25
Nodes (13): aiBumpLevel, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), extractAppsArray(), findAppsArrayInEnvelope() (+5 more)
...
Cohesion: 0.19
Nodes (10): appKeyBody(), id, orgKeyBody(), apiKeyIds, ApiKeyResponse, createAppApiKey(), id, seedOptions (+2 more)
...
Cohesion: 0.17
Nodes (11): allDone, coloredOutput, completedCheck, countdown, finishEarly, fixture, options, output (+3 more)
...
## Knowledge Gaps
- **6133 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6128 more)
...
- **Why does `Database` connect `Community 2` to `Community 4`, `Community 6`, `Community 10`, `Community 268`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 153`, `Community 29`, `Community 672`, `Community 546`, `Community 40`, `Community 43`, `Community 172`, `Community 49`, `Community 50`, `Community 55`, `Community 184`, `Community 58`, `Community 572`, `Community 63`, `Community 71`, `Community 714`, `Community 75`, `Community 332`, `Community 92`, `Community 226`, `Community 111`, `Community 125`?**
  _High betweenness centrality (0.170) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 34` to `Community 128`, `Community 133`, `Community 7`, `Community 8`, `Community 10`, `Community 140`, `Community 13`, `Community 141`, `Community 12`, `Community 16`, `Community 145`, `Community 146`, `Community 20`, `Community 157`, `Community 30`, `Community 158`, `Community 159`, `Community 161`, `Community 164`, `Community 37`, `Community 174`, `Community 304`, `Community 432`, `Community 307`, `Community 52`, `Community 565`, `Community 181`, `Community 182`, `Community 312`, `Community 568`, `Community 60`, `Community 191`, `Community 65`, `Community 578`, `Community 68`, `Community 69`, `Community 72`, `Community 76`, `Community 336`, `Community 209`, `Community 210`, `Community 84`, `Community 341`, `Community 86`, `Community 88`, `Community 221`, `Community 95`, `Community 96`, `Community 98`, `Community 104`, `Community 490`, `Community 109`, `Community 110`, `Community 240`, `Community 113`, `Community 114`, `Community 112`, `Community 245`, `Community 117`, `Community 119`, `Community 124`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _6136 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02917818437102365 - nodes in this community are weakly interconnected._
