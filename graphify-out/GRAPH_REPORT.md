...
## Corpus Check
- Large corpus: 2988 files · ~5,560,448 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 18043 nodes · 33509 edges · 1119 communities (949 shown, 170 thin omitted)
...
## Communities (1119 total, 170 thin omitted)
...
Cohesion: 0.03
Nodes (165): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (168): CLI_PROJECT_MODES, fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort() (+160 more)
...
Cohesion: 0.03
Nodes (120): get(), getAll(), app, appGlobal, CreateApp, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists() (+112 more)
...
Cohesion: 0.03
Nodes (131): BillingPlanBentoState, buildBillingPlanBentoTags(), isDemoApp(), isDemoAppRow(), getActivePlanNameOrg(), hasFeature(), isActivePlanStatus(), requireEnterprisePlan() (+123 more)
...
Cohesion: 0.03
Nodes (115): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady() (+107 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (99): isTelemetryDisabled(), getActiveUploadReporter(), IncompatibleBundleError, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS, sleep() (+91 more)
...
Cohesion: 0.03
Nodes (120): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForWebDir(), buildCodeDiffLines() (+112 more)
...
Cohesion: 0.03
Nodes (71): TEST_ORG_ID, TEST_ORG_ID, appRolesOf(), createApp(), createdAppIds, createdKeyIds, createKey(), ORG_ID (+63 more)
...
Cohesion: 0.05
Nodes (63): STRIPE_EMULATOR_HEADERS, StripePriceResponse, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id (+55 more)
...
Cohesion: 0.04
Nodes (67): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+59 more)
...
Cohesion: 0.07
Nodes (90): findAppInOrganization(), cancelCommand(), sendCliEvent(), promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep() (+82 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (74): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+66 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (74): resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep() (+66 more)
...
Cohesion: 0.05
Nodes (67): CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel(), formatCreditTierAmount() (+59 more)
...
Cohesion: 0.04
Nodes (61): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels(), getUniqueBaseData(), id (+53 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (65): checkVersionStatus(), buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatDoctorInstallHint() (+57 more)
...
Cohesion: 0.05
Nodes (66): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit() (+58 more)
...
Cohesion: 0.06
Nodes (55): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+47 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (30): sizeClasses, refreshOnboarding(), doneCount, steps, applyOnboardingABTestAssignments(), isRecord(), closeChannelFlow(), app (+22 more)
...
Cohesion: 0.06
Nodes (53): CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod(), isPostgresUniqueViolation() (+45 more)
...
Cohesion: 0.06
Nodes (49): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema (+41 more)
...
Cohesion: 0.06
Nodes (55): AdditiveSchemaSyncOptions, AdditiveSchemaSyncPlan, AdditiveSchemaSyncResult, assertCatalogObject(), assertSchemaCatalog(), assertSchemaColumn(), assertSchemaCompositeAttribute(), assertSchemaConstraint() (+47 more)
...
Cohesion: 0.10
Nodes (17): displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers(), DisplayOptions, listMembers(), listMembersInternal(), MemberInfo (+9 more)
...
Cohesion: 0.06
Nodes (42): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+34 more)
...
Cohesion: 0.07
Nodes (40): ensureUpdaterReadyBeforeSync(), handleBuildAndSyncFailure(), runBuildAndSyncLoop(), waitForVerifiedUpdaterInstall(), DependencySection, getDeclaredDependency(), getPackageInstallState(), getSplashScreenInstallState() (+32 more)
...
Cohesion: 0.11
Nodes (39): post(), body, context, mocks, addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord() (+31 more)
...
Cohesion: 0.08
Nodes (28): app, AuthenticatedClient, bodySchema, hasAppliedBundle(), Observations, persistObservedProgress(), auth, dialect (+20 more)
...
Cohesion: 0.09
Nodes (26): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+18 more)
...
Cohesion: 0.07
Nodes (18): APP_UUID, createConfirmedAuthUser(), ORG_ID, TEST_ID, createAuthenticatedClient(), isRetryableRpcTransportError(), requestActorEmail(), requestActorUserId() (+10 more)

### Community 126 - "Community 126"
Cohesion: 0.09
Nodes (26): AuthGuardTestContext, contextStorage, createTestContext(), getGuard(), MockFetchResponse, withTestContext(), getRedirect(), hasSupportedOtaTodoList() (+18 more)
...
Cohesion: 0.07
Nodes (24): id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp(), seedReadyBundle() (+16 more)
...
Cohesion: 0.12
Nodes (21): event(), mocks, profilePreparedEvent(), startSetupEvent(), AppOnboardingBuilderStepId, AppOnboardingBuilderStepState, persistAuthorizedOnboardingMutation(), applyBuilderChecklistUpdate() (+13 more)
...
Cohesion: 0.27
Nodes (9): channelLookupId(), createFixture(), CreateRoleBindingBody, createRoleBindingFixture(), createRoleBindingTestRequest(), createUserOrgBinding(), findExistingRoleBinding(), resolveChannelRbacId() (+1 more)
...
## Knowledge Gaps
- **6285 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6280 more)
...
- **Why does `Database` connect `Community 2` to `Community 3`, `Community 4`, `Community 7`, `Community 11`, `Community 12`, `Community 19`, `Community 20`, `Community 149`, `Community 22`, `Community 28`, `Community 158`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 550`, `Community 678`, `Community 172`, `Community 48`, `Community 435`, `Community 54`, `Community 578`, `Community 71`, `Community 75`, `Community 333`, `Community 719`, `Community 87`, `Community 88`, `Community 223`, `Community 102`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.175) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 18` to `Community 128`, `Community 130`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 15`, `Community 144`, `Community 274`, `Community 21`, `Community 25`, `Community 153`, `Community 159`, `Community 160`, `Community 161`, `Community 164`, `Community 294`, `Community 39`, `Community 42`, `Community 170`, `Community 45`, `Community 46`, `Community 47`, `Community 304`, `Community 177`, `Community 305`, `Community 434`, `Community 308`, `Community 181`, `Community 309`, `Community 56`, `Community 185`, `Community 568`, `Community 569`, `Community 570`, `Community 61`, `Community 572`, `Community 60`, `Community 574`, `Community 64`, `Community 195`, `Community 583`, `Community 202`, `Community 203`, `Community 80`, `Community 81`, `Community 210`, `Community 83`, `Community 212`, `Community 339`, `Community 86`, `Community 85`, `Community 343`, `Community 91`, `Community 222`, `Community 97`, `Community 101`, `Community 103`, `Community 105`, `Community 109`, `Community 111`, `Community 496`, `Community 114`, `Community 627`, `Community 628`, `Community 630`, `Community 121`, `Community 122`, `Community 636`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020206243032329988 - nodes in this community are weakly interconnected._