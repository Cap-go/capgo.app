...
## Corpus Check
- Large corpus: 2464 files · ~4,938,413 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15852 nodes · 28834 edges · 1043 communities (879 shown, 164 thin omitted)
...
## Communities (1043 total, 164 thin omitted)
...
Cohesion: 0.02
Nodes (145): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+137 more)
...
Cohesion: 0.04
Nodes (130): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+122 more)
...
Cohesion: 0.03
Nodes (103): get(), getAll(), app, appGlobal, FetchStoreMetadataBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (107): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+99 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (103): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName(), askForWebDir() (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (92): computeBuggyWeeklyInstallStats(), addDaysToDateOnly(), billingPeriodMetricsRange(), billingPeriodStatsTestUtils, formatBytes(), formatNumber(), getOrgIdForApp(), handleBillingPeriodStats() (+84 more)
...
Cohesion: 0.03
Nodes (55): describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+47 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (79): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (71): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+63 more)
...
Cohesion: 0.04
Nodes (59): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert (+51 more)
...
Cohesion: 0.09
Nodes (75): addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath(), askForReplacementAppId() (+67 more)
...
Cohesion: 0.05
Nodes (60): createRSA(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig() (+52 more)
...
Cohesion: 0.04
Nodes (48): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, clearVersionAudits() (+40 more)
...
Cohesion: 0.05
Nodes (54): getActiveUploadReporter(), isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl(), CanOpenExternalUrlOptions, CapgoCliInvokeOptions (+46 more)
...
Cohesion: 0.07
Nodes (44): getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), handleCheckoutSessionCompleted(), syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout() (+36 more)
...
Cohesion: 0.06
Nodes (37): id, testOrgId, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema (+29 more)
...
Cohesion: 0.08
Nodes (38): apiKeyBindingsAllowOrgCreate(), assertApiKeyCanKeepOrgCreateGrant(), parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), validateApiKeyGlobalPermissionsForBindings(), ApiKeyRow, app, assertCanManageApiKeysForOrgsPg() (+30 more)
...
Cohesion: 0.08
Nodes (25): findAppInOrganization(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath(), markStepDone() (+17 more)
...
Cohesion: 0.14
Nodes (28): CreateApp, post(), cleanStoredImageMetadata(), concatUint8Arrays(), isSameBytes(), JPEG_SIGNATURE, mimeFromFileBytes(), mimeFromFilePath() (+20 more)
...
Cohesion: 0.11
Nodes (21): cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData, LogSpec (+13 more)
...
Cohesion: 0.16
Nodes (15): AlertsReporter, checkVersionStatus(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies() (+7 more)
...
## Knowledge Gaps
- **5613 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5608 more)
...
- **Why does `Database` connect `Community 148` to `Community 3`, `Community 5`, `Community 9`, `Community 13`, `Community 141`, `Community 15`, `Community 19`, `Community 21`, `Community 536`, `Community 163`, `Community 36`, `Community 37`, `Community 39`, `Community 42`, `Community 172`, `Community 45`, `Community 55`, `Community 313`, `Community 62`, `Community 64`, `Community 194`, `Community 198`, `Community 71`, `Community 74`, `Community 93`, `Community 365`, `Community 118`, `Community 511`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 18` to `Community 6`, `Community 8`, `Community 138`, `Community 139`, `Community 12`, `Community 141`, `Community 11`, `Community 143`, `Community 528`, `Community 529`, `Community 530`, `Community 271`, `Community 532`, `Community 149`, `Community 533`, `Community 16`, `Community 280`, `Community 281`, `Community 154`, `Community 409`, `Community 284`, `Community 157`, `Community 542`, `Community 286`, `Community 32`, `Community 28`, `Community 38`, `Community 170`, `Community 43`, `Community 51`, `Community 179`, `Community 180`, `Community 181`, `Community 52`, `Community 60`, `Community 316`, `Community 317`, `Community 191`, `Community 192`, `Community 63`, `Community 66`, `Community 320`, `Community 68`, `Community 197`, `Community 70`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 590`, `Community 465`, `Community 591`, `Community 593`, `Community 80`, `Community 85`, `Community 86`, `Community 599`, `Community 89`, `Community 90`, `Community 96`, `Community 99`, `Community 102`, `Community 105`, `Community 109`, `Community 112`, `Community 117`, `Community 119`, `Community 122`, `Community 253`, `Community 126`?**
