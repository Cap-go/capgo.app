...
## Corpus Check
- Large corpus: 2631 files · ~5,098,226 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16663 nodes · 30831 edges · 1059 communities (884 shown, 175 thin omitted)
...
## Communities (1059 total, 175 thin omitted)
...
Cohesion: 0.02
Nodes (173): UpdateProbeResult, withConfigWriteTarget(), SuperOptions, fetchObserve(), ObserveCliOptions, observeCommand(), ObserveFinding, parseObserveDays() (+165 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (168): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase(), PendingOnboardingApp (+160 more)
...
Cohesion: 0.02
Nodes (116): isTelemetryDisabled(), getActiveUploadReporter(), IncompatibleBundleError, Release, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (119): app, bodySchema, app, bodySchema, getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), getRegistrationMetadata() (+111 more)
...
Cohesion: 0.03
Nodes (112): trackMcpServerStarted(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath() (+104 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (85): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, isVersionDeleted() (+77 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (76): TEST_ORG_ID, TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID (+68 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (69): buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds(), getBuildCount(), getBuildTotalSeconds() (+61 more)
...
Cohesion: 0.03
Nodes (57): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, execFileAsync, fixtureId (+49 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (84): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+76 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (59): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+51 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (70): createRSA(), derivePublicKeyFromPrivate(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig() (+62 more)
...
Cohesion: 0.04
Nodes (77): defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, respondEvents(), respondSampleView(), sampleActionsForView(), isDemoApp() (+69 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (68): getInvocationSource(), reportAppOnboardingProgress(), AlertsReporter, checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal() (+60 more)
...
Cohesion: 0.05
Nodes (56): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), describeFetchFailure() (+48 more)
...
Cohesion: 0.05
Nodes (57): bodySchema, get(), memberSchema, allowedInviteRoles, allowedInviteRoleSet, inviteBodySchema, inviteRoleAliases, inviteTypeSchema (+49 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (46): useGitHubProfileDialog(), setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+38 more)
...
Cohesion: 0.05
Nodes (56): createTracker(), {
  getLocalConfigMock,
  sendEventMock,
}, trackerIdentity, steps, trackerIdentity, AnalyticsPrimitive, AnalyticsProperties, CaptureEvent (+48 more)
...
Cohesion: 0.06
Nodes (53): executeStatsQueryWithRetry(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit(), buildStorageHourlyRows(), calculateStorageHourlyRows() (+45 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (51): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels(), getUniqueBaseData(), id (+43 more)
...
Cohesion: 0.08
Nodes (15): async, Any, ASCSession, Bool, FlowStep, Int, Never, NSImage (+7 more)
...
Cohesion: 0.08
Nodes (37): CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod(), isPostgresUniqueViolation() (+29 more)
...
Cohesion: 0.07
Nodes (31): Digester, noopDigester(), sha256Digester(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env (+23 more)
...
Cohesion: 0.08
Nodes (31): aggregateDeliverySamples(), app, assertPlatformAdmin(), buildDeliveriesFromEvents(), buildEmptyUpdateDeliveryResponse(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse() (+23 more)
...
Cohesion: 0.12
Nodes (20): Any, Bool, String, Decodable, Equatable, Identifiable, ASCSession, ASCTeam (+12 more)
...
Cohesion: 0.13
Nodes (24): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, readUpdateDeliveryTimingEventsCFChunked(), buildNativeObservePluginTotalDevicesCFQuery() (+16 more)
...
## Knowledge Gaps
- **5816 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5811 more)
...
- **Why does `Database` connect `Community 78` to `Community 3`, `Community 4`, `Community 133`, `Community 7`, `Community 9`, `Community 14`, `Community 399`, `Community 16`, `Community 20`, `Community 22`, `Community 151`, `Community 24`, `Community 29`, `Community 160`, `Community 35`, `Community 39`, `Community 42`, `Community 43`, `Community 46`, `Community 49`, `Community 51`, `Community 309`, `Community 67`, `Community 70`, `Community 75`, `Community 360`, `Community 108`, `Community 117`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 8`, `Community 136`, `Community 137`, `Community 138`, `Community 140`, `Community 265`, `Community 526`, `Community 527`, `Community 16`, `Community 528`, `Community 142`, `Community 275`, `Community 530`, `Community 532`, `Community 398`, `Community 279`, `Community 21`, `Community 280`, `Community 538`, `Community 26`, `Community 31`, `Community 159`, `Community 291`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 168`, `Community 169`, `Community 296`, `Community 47`, `Community 48`, `Community 175`, `Community 50`, `Community 10`, `Community 180`, `Community 181`, `Community 182`, `Community 55`, `Community 314`, `Community 266`, `Community 192`, `Community 193`, `Community 194`, `Community 454`, `Community 74`, `Community 203`, `Community 77`, `Community 590`, `Community 591`, `Community 209`, `Community 593`, `Community 81`, `Community 212`, `Community 85`, `Community 86`, `Community 87`, `Community 599`, `Community 84`, `Community 92`, `Community 97`, `Community 100`, `Community 107`, `Community 110`, `Community 113`, `Community 119`, `Community 126`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.021715785705763036 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020209059233449476 - nodes in this community are weakly interconnected._