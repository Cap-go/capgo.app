# Graph Report - capgo.app  (2026-09-23)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2943 files · ~5,522,073 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17790 nodes · 33032 edges · 1139 communities (967 shown, 172 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 137 edges (avg confidence: 0.8)
...
## Communities (1139 total, 172 thin omitted)
...
Cohesion: 0.02
Nodes (160): UpdateProbeResult, CLI_PROJECT_MODES, AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema (+152 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (172): getCreditTopUpProductId(), app, bodySchema, mockContext, mockContext, mockContext, getFreePort(), { mockedSupabaseAdmin } (+164 more)
...
Cohesion: 0.01
Nodes (193): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+185 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (143): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+135 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (124): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), recordSupabaseCall(), AppOnboardingProgressPatch (+116 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (94): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds() (+86 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (103): DeleteOrganizationParams, app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app (+95 more)
...
Cohesion: 0.04
Nodes (122): calcKeyId(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, shouldBlockIncompatibleUpload(), CompatibilityResult, summarizeUploadCompatibility() (+114 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (84): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, getPublicKeyFingerprint(), testEncryption() (+76 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (95): getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId(), createTimedFetch() (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (110): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+102 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (73): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+65 more)
...
Cohesion: 0.04
Nodes (73): decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys (+65 more)
...
Cohesion: 0.03
Nodes (83): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (83): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+75 more)
...
Cohesion: 0.04
Nodes (71): useAppPage(), UseAppPageOptions, CheckDomainResponse, CreditMetricType, creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue() (+63 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (73): setConfigWriteTarget(), cleanupStepsDone(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), tryResumeOnboarding(), CANCEL, ConfirmOptions, intro() (+65 more)
...
Cohesion: 0.05
Nodes (65): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+57 more)
...
Cohesion: 0.04
Nodes (66): resolveAppSetIconPath(), isAppListedInOrganization(), cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level (+58 more)
...
Cohesion: 0.05
Nodes (66): createRSA(), derivePublicKeyFromPrivate(), AlertsReporter, checkAlerts(), VersionCheckResult, setSetting(), setSettingInternal(), writeConfigUpdater() (+58 more)
...
Cohesion: 0.04
Nodes (57): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+49 more)
...
Cohesion: 0.04
Nodes (55): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), getUniqueBaseData(), id, insertDelta() (+47 more)
...
Cohesion: 0.06
Nodes (50): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+42 more)
...
Cohesion: 0.10
Nodes (64): findAppInOrganization(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+56 more)
...
Cohesion: 0.04
Nodes (55): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+47 more)
...
Cohesion: 0.07
Nodes (56): normalizeTargetLimit(), resolveTargetPlan(), analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), buildNotificationBadgeStateQuery() (+48 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (52): CapgoApiInvokeOptions, defaultRetriesForMethod(), getCapgoApiErrorCode(), invokeCapgoApi(), invokeWithRetry(), isCapgoManagedSupabaseHost(), isIdempotentMethod(), isPostgresUniqueViolation() (+44 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (60): NativeNotificationProviderConfig, aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody(), canRetry() (+52 more)
...
Cohesion: 0.07
Nodes (56): onManifestCreateTestUtils, onVersionUpdateTestUtils, archive_queue_messages(), chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), DISCORD_IGNORED_ERROR_CODES (+48 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (45): buildCordovaModeUploadExample(), buildMissingCapacitorConfigUploadMessage(), enhanceMissingCapacitorConfigUploadError(), configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget() (+37 more)
...
Cohesion: 0.07
Nodes (45): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema (+37 more)
...
Cohesion: 0.09
Nodes (43): ProgressResponse, useAppOnboardingCliProgress(), admin, getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), APP_ONBOARDING_OTA_V1_STEP_IDS, APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS (+35 more)
...
Cohesion: 0.08
Nodes (38): ensureUpdaterReadyBeforeSync(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallBlocker(), getUpdaterVersionToInstall(), handleBuildAndSyncFailure(), normalizeConcreteVersion(), waitForVerifiedUpdaterInstall(), DependencySection (+30 more)
...
Cohesion: 0.11
Nodes (29): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), AppRow, assertAppAllowsPreview(), buildPreviewQrUrl(), BundleRow, ChannelRow, getAppPreviewState() (+21 more)
...
Cohesion: 0.10
Nodes (24): AuthGuardTestContext, contextStorage, createTestContext(), getGuard(), MockFetchResponse, withTestContext(), getRedirect(), allowOnboardingDashboardExploration() (+16 more)
...
Cohesion: 0.14
Nodes (27): processAppFameBatch(), APP_FAME_TIERS, AppFameCandidate, AppFameDecision, AppFameTier, buildFameSystemPrompt(), buildFameUserPrompt(), clampScore() (+19 more)
...
Cohesion: 0.12
Nodes (29): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), countInstallSourcesCF(), countUpdatesFromLogsCF(), countUpdatesFromLogsExternalCF() (+21 more)
...
Cohesion: 0.08
Nodes (21): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey() (+13 more)
...
Cohesion: 0.12
Nodes (17): pending, AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), onboardingRefreshBody, OnboardingSignals, refreshAppOnboardingBatch(), getTodoEvidenceNeeds(), loadTodoEvidenceCandidates() (+9 more)
...
Cohesion: 0.09
Nodes (22): normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), browserInvocationIndex, browserLoginIndex, builderAuthCallback, builderSource, indexSource (+14 more)
...
Cohesion: 0.14
Nodes (22): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), getErrorCode() (+14 more)
...
Cohesion: 0.19
Nodes (23): formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets() (+15 more)
...
Cohesion: 0.22
Nodes (11): convertDataToJsTypes(), getAdminOrgMetrics(), getAdminPlatformOverview(), normalizeAnalyticsLimit(), readLastMonthDevicesByPlatformCF(), readStatsCF(), runQueryToCFA(), buildNativeObservePluginTotalDevicesCFQuery() (+3 more)
...
Cohesion: 0.22
Nodes (11): aesKeyFromSecret(), decryptNotificationToken(), decryptProviderSecretWithSecretKey(), decryptWithSecretKey(), encryptNotificationToken(), encryptProviderSecret(), encryptWithSecretKey(), fromBase64Url() (+3 more)
...
Cohesion: 0.33
Nodes (6): buildReadDevicesCFVersionNameCondition(), countDevicesCF(), buildReadDevicesCFPlatformCondition(), buildVersionNameSqlCondition(), normalizeVersionNameFilter(), platformOsToCFDouble()
...
Cohesion: 0.60
Nodes (5): buildBreakdownMetrics(), getPublicLiveUpdateMetricsCF(), roundPublicPercent(), rateFromOutcomes(), rateFromParts()
...
## Knowledge Gaps
- **6193 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6188 more)
...
- **Why does `Database` connect `Community 27` to `Community 2`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 18`, `Community 21`, `Community 22`, `Community 26`, `Community 28`, `Community 29`, `Community 34`, `Community 36`, `Community 39`, `Community 296`, `Community 168`, `Community 167`, `Community 48`, `Community 51`, `Community 55`, `Community 60`, `Community 446`, `Community 62`, `Community 64`, `Community 72`, `Community 341`, `Community 223`, `Community 105`, `Community 368`, `Community 113`, `Community 124`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 15` to `Community 128`, `Community 129`, `Community 3`, `Community 6`, `Community 648`, `Community 9`, `Community 649`, `Community 651`, `Community 137`, `Community 16`, `Community 19`, `Community 148`, `Community 282`, `Community 28`, `Community 156`, `Community 158`, `Community 159`, `Community 161`, `Community 35`, `Community 45`, `Community 46`, `Community 304`, `Community 177`, `Community 53`, `Community 184`, `Community 312`, `Community 313`, `Community 56`, `Community 315`, `Community 445`, `Community 316`, `Community 318`, `Community 579`, `Community 580`, `Community 581`, `Community 70`, `Community 583`, `Community 68`, `Community 585`, `Community 74`, `Community 202`, `Community 81`, `Community 595`, `Community 84`, `Community 215`, `Community 345`, `Community 90`, `Community 91`, `Community 92`, `Community 221`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 103`, `Community 235`, `Community 108`, `Community 109`, `Community 107`, `Community 116`, `Community 504`, `Community 123`, `Community 126`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02156927478815891 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020199004975124377 - nodes in this community are weakly interconnected._