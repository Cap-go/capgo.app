# Graph Report - capgo.app  (2026-09-17)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2807 files · ~5,285,229 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17443 nodes · 32271 edges · 1137 communities (963 shown, 174 thin omitted)
...
## Communities (1137 total, 174 thin omitted)
...
Cohesion: 0.02
Nodes (281): checkAppIdsExist(), findAppInOrganization(), listPendingOnboardingApps(), checkVersionStatus(), cancelCommand(), sendCliEvent(), waitLog(), promptDoctorUpdateChoice() (+273 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (168): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), hostOptionsFromSupabase() (+160 more)
...
Cohesion: 0.01
Nodes (184): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+176 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (157): calcKeyId(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, AiBumpDecision, diffManifests(), fetchRemoteManifest() (+149 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (100): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+92 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (124): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+116 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (108): get(), getAll(), app, appGlobal, CreateApp, FetchStoreMetadataBody, AiBumpLevelBody, AppWithOrg (+100 more)
...
Cohesion: 0.03
Nodes (96): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+88 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (63): fixtureId, orgId, describeBackend, orgId, scopeId, pgPool, fixtureId, orgId (+55 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (73): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, collectErrorMessages(), getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps (+65 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (61): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+53 more)
...
Cohesion: 0.04
Nodes (88): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, adminOnboardingConversionRate(), AdminOnboardingFunnel (+80 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (74): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, APP_UUID, createConfirmedAuthUser(), ORG_ID (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (49): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+41 more)
...
Cohesion: 0.04
Nodes (69): getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl() (+61 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (77): OrganizationUpdatePayload, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+69 more)
...
Cohesion: 0.03
Nodes (57): bindAppReader(), DEVICE_STORE, DEVICE_TF, serviceRoleSupabase, unbindAppReader(), createUserOrgBinding(), destinationOrgId, AuditLog (+49 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (60): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (71): trackMcpServerStarted(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath() (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (59): checkIndexPosition(), searchInDirectory(), searchInFile(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle(), zipBundleInternal() (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (57): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+49 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (70): activeChannelVersionJoin(), AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOnboardingFunnel (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (50): TEST_ORG_ID, TEST_ORG_ID, id, orgKeyBody(), execFileAsync, AutoTopUpSettings, originalSettings, CreditStep (+42 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (59): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), clearInitLogs(), clearPrompt(), ConfirmPrompt, emit(), INIT_CANCEL (+51 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (53): isTelemetryDisabled(), IncompatibleBundleError, isCliTelemetryDisabled(), createInitTelemetry(), InitProgressTelemetry, InitTelemetryOptions, ResumeCandidate, TelemetryProperties (+45 more)
...
Cohesion: 0.06
Nodes (56): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser(), AppUsageByApp, AppUsageGlobal (+48 more)
...
Cohesion: 0.06
Nodes (46): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), lookupChannelUpdateStrategy(), lookupVersionMinUpdate(), optionalNonEmptyTagString() (+38 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (52): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+44 more)
...
Cohesion: 0.08
Nodes (50): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), encryptChecksum(), encryptChecksumV3(), encryptSource() (+42 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (48): buildDemoBundleInstallStats(), BundleInstallStatsItem, BundleInstallStatsResponse, utcEndOfDay(), utcStartOfDay(), CheckDomainResponse, buildDemoUpdateDeliveryStats(), UpdateDeliveryScope (+40 more)
...
Cohesion: 0.06
Nodes (55): executeStatsQueryWithRetry(), isRetryableStatsError(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit(), buildStorageHourlyRows() (+47 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (52): headers, testRunId, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint(), fetchGetChannels() (+44 more)
...
Cohesion: 0.06
Nodes (33): withConfigWriteTarget(), Channel, AccountIdOptions, AddAppOptions, AddChannelOptions, AddOrganizationOptions, AppInfo, BundleCompatibilityOptions (+25 more)
...
Cohesion: 0.06
Nodes (52): nativeObserveActions, app, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, periodForDays(), respondEvents() (+44 more)
...
Cohesion: 0.05
Nodes (45): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+37 more)
...
Cohesion: 0.06
Nodes (44): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+36 more)
...
Cohesion: 0.04
Nodes (30): LogData, STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, App, Bundle, Channel, Device (+22 more)
...
Cohesion: 0.06
Nodes (34): conversion(), count(), formatOnboardingPaymentCohortMonth(), formatOnboardingPaymentCohortTimestamp(), getOnboardingPaymentCohortPeriod(), invalidReport(), OnboardingPaymentCohortReport, OnboardingPaymentCohortRow (+26 more)
...
Cohesion: 0.07
Nodes (49): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes() (+41 more)
...
Cohesion: 0.06
Nodes (19): Channel, ParsedSecurityError, ObserveOptions, StarAllRepositoriesOptions, StatsOrder, StarAllRepositoryResult, BundleCompatibilityEntry, CompatibilityReport (+11 more)
...
Cohesion: 0.07
Nodes (33): isRetryableDurableObjectFetchError(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env, normalizeContentType(), StoredR2Part (+25 more)

### Community 75 - "Community 75"
Cohesion: 0.10
Nodes (42): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, Platform (+34 more)
...
Cohesion: 0.08
Nodes (40): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+32 more)
...
Cohesion: 0.09
Nodes (42): refreshUntil(), APP_ONBOARDING_FEATURES, APP_ONBOARDING_STAGES, AppOnboardingFeature, AppOnboardingFeatureKey, AppOnboardingLedger, AppOnboardingStage, asTimestamp() (+34 more)
...
Cohesion: 0.05
Nodes (39): accountIdOptionsSchema, addAppOptionsSchema, addChannelOptionsSchema, addOrganizationOptionsSchema, appInfoSchema, bundleCompatibilityOptionsSchema, bundleInfoSchema, cleanupOptionsSchema (+31 more)
...
Cohesion: 0.08
Nodes (37): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+29 more)
...
Cohesion: 0.11
Nodes (34): computeBuggyWeeklyInstallStats(), addDaysToDateOnly(), billingPeriodMetricsRange(), billingPeriodStatsTestUtils, formatBytes(), formatNumber(), getOrgIdForApp(), handleBillingPeriodStats() (+26 more)

### Community 90 - "Community 90"
Cohesion: 0.10
Nodes (32): period, cutoff, { dataMock, posthogMock }, org(), period, run(), user(), buildOnboardingPaymentInvoiceHogql() (+24 more)
...
Cohesion: 0.09
Nodes (34): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, lintFailures (+26 more)
...
Cohesion: 0.11
Nodes (35): getAppOnboardingLoginSource(), markAppOnboardingLoginFromTracking(), APP_ONBOARDING_V1_STEP_IDS, APP_ONBOARDING_V2_STEP_IDS, appendAppOnboardingStepHistory(), appendStepHistory(), applyAppOnboardingPatch(), AppOnboardingOutcome (+27 more)
...
Cohesion: 0.10
Nodes (31): backgroundTaskMock, baseBuild, emitBuildTransition(), fakeContext(), maybeSingleMock, sendDiscordAlertMock, sendEventToTrackingMock, BuilderStatusResponse (+23 more)
...
Cohesion: 0.09
Nodes (23): appGlobal, app, app, app, AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION (+15 more)
...
Cohesion: 0.10
Nodes (28): buildServerInstructions(), installMcpStdoutGuard(), mcpAddAppInputSchema, mcpAddChannelInputSchema, mcpAddOrganizationInputSchema, mcpCheckCompatibilityInputSchema, mcpCleanupBundlesInputSchema, mcpDeleteAppInputSchema (+20 more)
...
Cohesion: 0.10
Nodes (11): assertDayWindow(), daySpan(), expectedDaySpan(), isUsageWindow(), VisualDiffRoute, visualDiffRoutes, visualDiffViewport, LoadedVisualDiffConfig (+3 more)
...
Cohesion: 0.09
Nodes (28): app, DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getValidatedStatsRequestBody(), insightPeriodDays (+20 more)
...
Cohesion: 0.12
Nodes (24): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), exactTrackingStartedAt(), explicitTransitionKind(), failedResult() (+16 more)
...
Cohesion: 0.11
Nodes (28): buildInitReplayBody(), buildTerminalImageDataUrl(), CliStream, createTerminalInteractionEvents(), createTerminalSnapshot(), createTerminalSnapshotNode(), defaultReplayTransport(), escapeHtml() (+20 more)
...
Cohesion: 0.13
Nodes (24): addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags(), trackBentoEvent(), unsubscribeBento(), subscriberUpdate (+16 more)

### Community 147 - "Community 147"
Cohesion: 0.15
Nodes (30): adminOnboardingConversionRate(), buildPlanValidationExpression(), closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend() (+22 more)
...
Cohesion: 0.15
Nodes (26): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), DoctorInfoOptions, DoctorRecoveryResult, DoctorUpdateChoice, formatSpawnOutput(), getInfo() (+18 more)
...
Cohesion: 0.14
Nodes (8): Digester, noopDigester(), sha256Digester(), isR2ChecksumError(), isR2Error(), isR2MultipartDoesNotExistError(), UploadHandler, buildFileHttpMetadata()
...
Cohesion: 0.09
Nodes (24): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg() (+16 more)
...
Cohesion: 0.13
Nodes (22): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+14 more)
...
Cohesion: 0.08
Nodes (24): AppInfos, AppStats, BaseHeaders, Customer, DeviceRes, DeviceWithoutCreatedAt, NativeVersionUsage, Order (+16 more)
...
Cohesion: 0.09
Nodes (22): formatDoctorInstallHint(), shellQuotePath(), allOutdated, declaredByPath, empty, extraLatestKeys, fresh, grouped (+14 more)
...
Cohesion: 0.11
Nodes (20): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+12 more)

### Community 215 - "Community 215"
Cohesion: 0.14
Nodes (20): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+12 more)
...
Cohesion: 0.16
Nodes (15): isAppListedInOrganization(), AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders() (+7 more)
...
Cohesion: 0.21
Nodes (17): buildPluginCompatibilityTrendSeries(), getLatestNonEmptyPluginTrendPoint(), PluginCompatibilityChartSeries, PluginCompatibilityTrendPoint, getAdminPluginBreakdown(), getLatestNonEmptyPluginTrendRowDate(), parseBreakdownJson(), parsePluginVersionLadderJson() (+9 more)
...
Cohesion: 0.18
Nodes (13): NotifyAppReadyProject, compilerOptions(), hasCall(), importDeclaration(), scanNotifyAppReadySource(), updaterImport(), app(), fixture() (+5 more)
...
Cohesion: 0.11
Nodes (17): browserInvocationIndex, browserLoginIndex, indexSource, initActionSource, initActionStart, initCommandSource, initInvocationIndex, initSavedKeyFallbackIndex (+9 more)
...
Cohesion: 0.15
Nodes (14): describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogSpec, Order, QueryStats (+6 more)
...
Cohesion: 0.14
Nodes (14): assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema, ValidationIssue, validateOptions() (+6 more)
...
Cohesion: 0.14
Nodes (13): deleteUserAs(), withAuthClient(), createOrgWithMember(), orgIds, protectedOrgId, transferOrgId, withAuthenticatedUser(), CatalogIndex (+5 more)
...
Cohesion: 0.20
Nodes (10): resolveChannelAddDuplicateOutcome(), isChannelAlreadyExistsError(), ChannelSelectionPrompts, OnboardingChannel, selectOnboardingChannel(), duplicateError, functionsHttpError, supabase (+2 more)
...
Cohesion: 0.21
Nodes (12): BundleUploadRecoveryChoice, getBundleUploadFailureRecoveryOptions(), joinUniqueUploadPaths(), mergeMonorepoRootUploadPaths(), resolveUploadPaths(), withMonorepoUploadRetryHint(), app, command (+4 more)
...
Cohesion: 0.24
Nodes (9): { closeClientMock, getPgClientMock, queryMock }, config, AdminABTestDistribution, AdminABTestDistributionBranch, AdminABTestDistributionRow, buildAdminABTestDistribution(), getAdminABTestDistribution(), readCount() (+1 more)
...
Cohesion: 0.18
Nodes (10): mainStore, mockFilter, mockFrom, mockReadEq, mockReadMaybeSingle, mockReadSelect, mockUpdate, mockUpdateEq (+2 more)
...
Cohesion: 0.49
Nodes (7): post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), isAppOnboardingSource()
...
Cohesion: 0.36
Nodes (8): Part, context, now, { queryMock, closeMock, clientMock }, buildRegistrationComparisonWindows(), buildRegistrationMonthlyComparisonQuery(), getAdminRegistrationMonthlyComparison(), registrationCount()
...
Cohesion: 0.22
Nodes (8): bytes, bytes, bytes, inputs, outputs, dist/index.js, dist/notify-app-ready-worker.js, dist/src/sdk.js
...
Cohesion: 0.22
Nodes (8): liveUpdateExplainInputSchema, LiveUpdateNextStepInput, liveUpdateNextStepSchema, LiveUpdateStartInput, liveUpdateStartSchema, mainFileSchema, packageJsonSchema, capacitorConfigOptionSchema
...
Cohesion: 0.29
Nodes (6): c, { getPgMock, closeMock, queryMock, releaseMock, connectMock }, grant, org, period, user
...
Cohesion: 0.53
Nodes (4): AppOnboardingStepPosthogInput, buildAppOnboardingStepPosthogEvent(), AppOnboardingState, AppOnboardingStepHistoryChange
...
## Knowledge Gaps
- **6064 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+6059 more)
...
- **Why does `Database` connect `Community 62` to `Community 3`, `Community 6`, `Community 12`, `Community 15`, `Community 272`, `Community 17`, `Community 18`, `Community 20`, `Community 148`, `Community 23`, `Community 26`, `Community 157`, `Community 29`, `Community 35`, `Community 39`, `Community 41`, `Community 169`, `Community 45`, `Community 48`, `Community 306`, `Community 179`, `Community 308`, `Community 54`, `Community 66`, `Community 67`, `Community 72`, `Community 340`, `Community 223`, `Community 231`, `Community 116`?**
  _High betweenness centrality (0.181) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 512`, `Community 134`, `Community 7`, `Community 136`, `Community 9`, `Community 649`, `Community 650`, `Community 652`, `Community 11`, `Community 8`, `Community 658`, `Community 405`, `Community 280`, `Community 155`, `Community 156`, `Community 159`, `Community 32`, `Community 161`, `Community 34`, `Community 164`, `Community 427`, `Community 44`, `Community 46`, `Community 302`, `Community 50`, `Community 178`, `Community 308`, `Community 181`, `Community 53`, `Community 55`, `Community 312`, `Community 313`, `Community 315`, `Community 316`, `Community 191`, `Community 451`, `Community 195`, `Community 325`, `Community 68`, `Community 71`, `Community 584`, `Community 73`, `Community 585`, `Community 586`, `Community 588`, `Community 201`, `Community 78`, `Community 590`, `Community 202`, `Community 77`, `Community 82`, `Community 211`, `Community 596`, `Community 85`, `Community 207`, `Community 88`, `Community 218`, `Community 347`, `Community 222`, `Community 96`, `Community 97`, `Community 100`, `Community 101`, `Community 103`, `Community 104`, `Community 107`, `Community 110`, `Community 238`, `Community 115`, `Community 119`, `Community 330`, `Community 126`, `Community 76`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.021804855703160788 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.031846536278786176 - nodes in this community are weakly interconnected._