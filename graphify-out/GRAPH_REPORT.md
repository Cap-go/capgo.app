# Graph Report - capgo-admin-animation-cohorts  (2026-09-16)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2756 files · ~5,216,877 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17198 nodes · 31767 edges · 1100 communities (929 shown, 171 thin omitted)
...
## Communities (1100 total, 171 thin omitted)
...
Cohesion: 0.02
Nodes (155): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, buildCacheKeyOptionSchema (+147 more)
...
Cohesion: 0.04
Nodes (117): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (149): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+141 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (134): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+126 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (106): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, bodySchema (+98 more)
...
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, shouldStartInitBrowserLogin(), addCodeStep(), applyInitAutoTestChange() (+110 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (98): get(), getAll(), app, appGlobal, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle() (+90 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (108): app, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+100 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (75): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+67 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (83): getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps, InvocationSource, setInvocationSource(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId() (+75 more)
...
Cohesion: 0.04
Nodes (63): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+55 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (76): app, canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (86): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+78 more)
...
Cohesion: 0.03
Nodes (73): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, getActiveUploadReporter(), addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl() (+65 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (58): id, testOrgId, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId (+50 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (57): fixtureId, orgId, orgId, scopeId, pgPool, fixtureId, orgId, QueryFn (+49 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (79): CreateApp, post(), persistAppOnboarding(), put(), UpdateApp, addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId() (+71 more)
...
Cohesion: 0.05
Nodes (72): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+64 more)
...
Cohesion: 0.08
Nodes (86): promptDoctorUpdateChoice(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath() (+78 more)
...
Cohesion: 0.04
Nodes (71): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+63 more)
...
Cohesion: 0.05
Nodes (67): waitForCommandResult(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), ConfirmOptions, intro(), log, PromptResult, SelectOption (+59 more)
...
Cohesion: 0.04
Nodes (60): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), fetchEndpoint() (+52 more)
...
Cohesion: 0.05
Nodes (44): classes, globals, rootClasses(), availableLocales, ensureLanguageLoaded(), FALLBACK_LOCALE, fetchRemoteMessages(), getNavigatorLanguage() (+36 more)
...
Cohesion: 0.06
Nodes (50): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), completePendingOnboardingApp() (+42 more)
...
Cohesion: 0.05
Nodes (47): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+39 more)
...
Cohesion: 0.07
Nodes (52): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), getSpawnOutputText() (+44 more)
...
Cohesion: 0.07
Nodes (41): buildOutdatedInstallCommand(), buildOutdatedInstallCommandsForDoctor(), computeDoctorAnalyticsTags(), formatDoctorInstallHint(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), getPMAndCommandForDir() (+33 more)
...
Cohesion: 0.08
Nodes (45): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes() (+37 more)
...
Cohesion: 0.08
Nodes (34): SaveKeyOptions, BrowserLoginDependencies, BrowserLoginEvent, BrowserLoginOptions, defaults, listOrganizationIds(), loginInitInBrowser(), promptForKey() (+26 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (33): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+25 more)
...
Cohesion: 0.07
Nodes (19): adminStore, displayStore, getCountryFlag(), getCountryLabel(), isLoading, { locale, t }, mainStore, normalizeCountryCode() (+11 more)
...
Cohesion: 0.09
Nodes (26): isAppListedInOrganization(), AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders() (+18 more)
...
Cohesion: 0.10
Nodes (29): animationRow, { closeClientMock, getPgClientMock, posthogQueryMock, queryMock }, ADMIN_CHANNEL_ANIMATION_COHORTS, ADMIN_CHANNEL_ANIMATION_STAGES, AdminABTestChannelCreation, AdminChannelAnimationPosthogRow, AdminChannelAnimationRetentionPoint, AdminChannelAnimationRetentionProgress (+21 more)
...
Cohesion: 0.12
Nodes (20): setConfigWriteTarget(), cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), tryResumeOnboarding(), getActiveCliReplaySessionId(), isCliTelemetryDisabled() (+12 more)
...
Cohesion: 0.48
Nodes (7): detectProjectFrameworkFromConfig(), detectProjectFrameworkFromDependencies(), detectProjectTypeInDir(), findProjectType(), getAllPackagesDependencies(), getProjectTypeWithLanguage(), logFoundProject()
...
- **Why does `Database` connect `Community 70` to `Community 3`, `Community 5`, `Community 7`, `Community 11`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 153`, `Community 26`, `Community 31`, `Community 35`, `Community 37`, `Community 167`, `Community 424`, `Community 43`, `Community 48`, `Community 49`, `Community 177`, `Community 54`, `Community 56`, `Community 71`, `Community 327`, `Community 103`, `Community 119`, `Community 122`, `Community 381`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 131`, `Community 6`, `Community 8`, `Community 138`, `Community 11`, `Community 269`, `Community 141`, `Community 144`, `Community 18`, `Community 150`, `Community 23`, `Community 151`, `Community 25`, `Community 152`, `Community 156`, `Community 161`, `Community 422`, `Community 39`, `Community 552`, `Community 41`, `Community 553`, `Community 171`, `Community 554`, `Community 298`, `Community 46`, `Community 556`, `Community 558`, `Community 176`, `Community 300`, `Community 301`, `Community 50`, `Community 565`, `Community 182`, `Community 47`, `Community 312`, `Community 305`, `Community 64`, `Community 196`, `Community 197`, `Community 73`, `Community 40`, `Community 332`, `Community 77`, `Community 78`, `Community 79`, `Community 208`, `Community 80`, `Community 212`, `Community 87`, `Community 90`, `Community 218`, `Community 93`, `Community 480`, `Community 97`, `Community 100`, `Community 101`, `Community 614`, `Community 615`, `Community 617`, `Community 107`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 117`, `Community 118`, `Community 125`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021658859189859464 - nodes in this community are weakly interconnected._