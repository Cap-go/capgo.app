...
## Corpus Check
- Large corpus: 2722 files · ~5,186,364 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 17027 nodes · 31447 edges · 1086 communities (911 shown, 175 thin omitted)
...
## Communities (1086 total, 175 thin omitted)
...
Cohesion: 0.02
Nodes (295): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, promptDoctorUpdateChoice(), setConfigWriteTarget(), buildAppIdConflictSuggestions() (+287 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (174): SuperOptions, fetchObserve(), observeCommand(), ObserveFinding, parseObserveDays(), parseObserveLimit(), parseObserveSort(), parsePositiveInt() (+166 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (178): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), findAppInOrganization(), getAppIconStoragePath(), hostOptionsFromSupabase() (+170 more)
...
Cohesion: 0.03
Nodes (136): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions (+128 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (122): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+114 more)
...
Cohesion: 0.04
Nodes (114): isVersionDeleted(), app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getDeletedVersionAction() (+106 more)
...
Cohesion: 0.03
Nodes (96): assertMinCliVersion(), formatMinCliVersionMessage(), isCliVersionBelowMin(), MinCliVersionConfig, getActiveUploadReporter(), OrganizationUpdatePayload, OrganizationUpdateResponse, resolveConfiguredOrganizationUpdateApiHost (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (67): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+59 more)
...
Cohesion: 0.04
Nodes (84): flushDeferredCommandInvocation(), trackMcpServerStarted(), normalized(), resolveInitCommandInput(), resolveLoginCommandApiKey(), clearSavedKey(), ensureGitignored(), getLoginState() (+76 more)
...
Cohesion: 0.03
Nodes (66): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+58 more)
...
Cohesion: 0.07
Nodes (58): checkIndexPosition(), searchInDirectory(), searchInFile(), checkNotifyAppReady(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (54): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), isCliLoginPath(), isNativeAppStoreContext(), isSsoProvider() (+46 more)
...
Cohesion: 0.05
Nodes (53): getInvocationSource(), reportAppOnboardingProgress(), addApp(), addAppInternal(), AppAddDuplicateOutcome, AppCreateSource, AppListRow, createAppViaApi() (+45 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (51): configWriteTargetStore, defaultCapacitorConfigFiles, dynamicImport, findDefaultCapacitorConfigFile(), getConfigWriteTarget(), isTypeScriptCompiler(), loadCliTypeScript(), loadConfig() (+43 more)
...
Cohesion: 0.05
Nodes (46): isTelemetryDisabled(), IncompatibleBundleError, getActiveCliReplaySessionId(), isCliTelemetryDisabled(), createInitTelemetry(), InitProgressTelemetry, InitTelemetryOptions, parseInitProgressTelemetry() (+38 more)
...
Cohesion: 0.07
Nodes (58): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_DEVELOPMENT_ENVIRONMENTS, ORG_ONBOARDING_INTENTS (+50 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (51): nativeObserveActions, defaultMetricActions, deviceTimelineNext(), loadSamples(), observeBodySchema, periodForDays(), respondEvents(), respondSampleView() (+43 more)
...
Cohesion: 0.06
Nodes (52): aggregateNativeObserveSamples(), buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, buildVersionStatsQuery(), bumpMetricBucket(), createNativeObserveAggregateState(), createSeries() (+44 more)
...
Cohesion: 0.05
Nodes (52): activeChannelVersionJoin(), AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOnboardingFunnel (+44 more)

### Community 58 - "Community 58"
Cohesion: 0.09
Nodes (47): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), generateSessionKey(), RSAKeys, AlertsReporter (+39 more)
...
Cohesion: 0.07
Nodes (35): canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, addGroupMemberBodyHook, addGroupMemberBodySchema, appIdParamSchema (+27 more)
...
Cohesion: 0.07
Nodes (34): clearPrompt(), ConfirmPrompt, emit(), INIT_CANCEL, InitCodeDiff, InitCodeDiffLine, InitEncryptionPhase, InitEncryptionSummary (+26 more)
...
Cohesion: 0.08
Nodes (41): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+33 more)
...
Cohesion: 0.11
Nodes (34): persistAppOnboarding(), put(), UpdateApp, APP_ONBOARDING_STEP_IDS, appendAppOnboardingStepHistory(), appendStepHistory(), applyAppOnboardingPatch(), AppOnboardingOutcome (+26 more)
...
Cohesion: 0.11
Nodes (30): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), handlePut() (+22 more)
...
Cohesion: 0.12
Nodes (15): updateUser(), base64ToArrayBuffer(), blobToData(), getPhotoErrorMessage(), isPhotoSelectionCancelledError(), pickPhoto(), supabase, takePhoto() (+7 more)
...
Cohesion: 0.13
Nodes (17): adminStore, displayStore, isLoading, loadDistribution(), loadError, mainStore, router, { t } (+9 more)
...
Cohesion: 0.20
Nodes (14): fixSupabaseHost(), getCachedReplicaLag(), getDatabaseURL(), getFreshReplicationLagMemoryEntry(), getLocalReadOnlyDatabaseURL(), getReadOnlyDatabaseURL(), getReplicationLagCacheKey(), isLocalWorkerEnv() (+6 more)
...
Cohesion: 0.38
Nodes (9): post(), addAppCreatorToOnboarding(), buildAppCreatorEventDetails(), getAppCreatorUserId(), isRecord(), resolveAppCreatorEmail(), isAppOnboardingSource(), getStorageAllowedOrigins() (+1 more)
...
## Knowledge Gaps
- **5933 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5928 more)
...
- **Why does `Database` connect `Community 65` to `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 13`, `Community 14`, `Community 15`, `Community 20`, `Community 21`, `Community 25`, `Community 410`, `Community 26`, `Community 283`, `Community 157`, `Community 30`, `Community 32`, `Community 34`, `Community 36`, `Community 39`, `Community 169`, `Community 43`, `Community 54`, `Community 59`, `Community 321`, `Community 74`, `Community 88`, `Community 225`, `Community 371`, `Community 117`, `Community 124`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 19` to `Community 131`, `Community 262`, `Community 135`, `Community 8`, `Community 9`, `Community 138`, `Community 10`, `Community 12`, `Community 147`, `Community 148`, `Community 149`, `Community 151`, `Community 409`, `Community 539`, `Community 540`, `Community 541`, `Community 285`, `Community 543`, `Community 31`, `Community 545`, `Community 28`, `Community 293`, `Community 294`, `Community 168`, `Community 297`, `Community 552`, `Community 299`, `Community 428`, `Community 45`, `Community 46`, `Community 47`, `Community 176`, `Community 42`, `Community 306`, `Community 48`, `Community 53`, `Community 55`, `Community 188`, `Community 189`, `Community 193`, `Community 69`, `Community 326`, `Community 72`, `Community 73`, `Community 201`, `Community 203`, `Community 78`, `Community 207`, `Community 468`, `Community 86`, `Community 87`, `Community 89`, `Community 602`, `Community 603`, `Community 220`, `Community 605`, `Community 93`, `Community 95`, `Community 91`, `Community 97`, `Community 98`, `Community 99`, `Community 356`, `Community 103`, `Community 104`, `Community 107`, `Community 110`, `Community 112`, `Community 116`, `Community 118`, `Community 121`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.020281968835023496 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02011125374411639 - nodes in this community are weakly interconnected._