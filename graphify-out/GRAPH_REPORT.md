...
## Corpus Check
- Large corpus: 2594 files · ~5,063,320 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16448 nodes · 30347 edges · 1050 communities (883 shown, 167 thin omitted)
...
## Communities (1050 total, 167 thin omitted)
...
Cohesion: 0.05
Nodes (109): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath(), CapgoHttpOptions (+101 more)
...
Cohesion: 0.03
Nodes (107): checkAppIdsExist(), ExistingOrganizationApp, findAppInOrganization(), listPendingOnboardingApps(), PendingOnboardingApp, setConfigWriteTarget(), shouldStartInitBrowserLogin(), applyInitAutoTestChange() (+99 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (96): baseDecision, getOrgIdForApp(), handleMonthlyCreateStats(), handleWeeklyInstallStats(), buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart() (+88 more)
...
Cohesion: 0.04
Nodes (82): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (81): getActiveUploadReporter(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), throwCapacitorConfigPathError() (+73 more)
...
Cohesion: 0.07
Nodes (60): createRSA(), decryptChecksum(), decryptChecksumV3(), decryptSource(), derivePublicKeyFromPrivate(), encryptSource(), generateSessionKey(), RSAKeys (+52 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (59): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), base64ToArrayBuffer(), blobToData() (+51 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (61): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+53 more)
...
Cohesion: 0.04
Nodes (48): isTelemetryDisabled(), IncompatibleBundleError, isTransientNetworkError(), trimTrailingSlashes(), callTwoFactorComplianceRpcWithRetry(), PREFLIGHT_RETRY_DELAYS_MS, sleep(), throwTwoFactorComplianceRpcError() (+40 more)
...
Cohesion: 0.07
Nodes (55): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildGlobalNotificationStatsQuery(), buildNotificationBadgeStateQuery() (+47 more)
...
Cohesion: 0.07
Nodes (58): createNotificationDeliveryEventProofFromSecret(), NativeNotificationProviderConfig, aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody() (+50 more)
...
Cohesion: 0.07
Nodes (52): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncSubscriptionAndEventsWithRetry(), maybeAutoTopUpCredits(), buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS (+44 more)
...
Cohesion: 0.06
Nodes (39): getNativeExternalPurchaseRedirect(), isNativeAppStoreContext(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), JsonPrimitive, posthogLoader(), PostHogProperties (+31 more)

### Community 73 - "Community 73"
Cohesion: 0.08
Nodes (42): getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), chargeOffSessionCredits(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal() (+34 more)
...
Cohesion: 0.09
Nodes (36): handleBundleUploadCommand(), formatFunctionInvokeError(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, AppRow (+28 more)
...
Cohesion: 0.10
Nodes (34): computeBuggyWeeklyInstallStats(), addDaysToDateOnly(), billingPeriodMetricsRange(), billingPeriodStatsTestUtils, formatBytes(), formatNumber(), handleBillingPeriodStats(), handleDailyFailRatio() (+26 more)
...
Cohesion: 0.08
Nodes (31): resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition (+23 more)
...
Cohesion: 0.09
Nodes (30): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+22 more)
...
Cohesion: 0.23
Nodes (16): baseResult(), decideAdvance(), decideAtStep(), decideStart(), drive(), explainLiveUpdateOnboarding(), gatherFacts(), mergeProgress() (+8 more)
...
## Knowledge Gaps
- **5768 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5763 more)
...
- **Why does `Database` connect `Community 53` to `Community 2`, `Community 5`, `Community 6`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 30`, `Community 31`, `Community 33`, `Community 162`, `Community 173`, `Community 45`, `Community 51`, `Community 54`, `Community 57`, `Community 315`, `Community 62`, `Community 67`, `Community 202`, `Community 76`, `Community 80`, `Community 208`, `Community 81`, `Community 87`, `Community 112`, `Community 122`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 9` to `Community 131`, `Community 8`, `Community 136`, `Community 11`, `Community 140`, `Community 13`, `Community 14`, `Community 274`, `Community 532`, `Community 533`, `Community 534`, `Community 404`, `Community 536`, `Community 537`, `Community 282`, `Community 154`, `Community 28`, `Community 283`, `Community 157`, `Community 285`, `Community 543`, `Community 286`, `Community 34`, `Community 36`, `Community 168`, `Community 297`, `Community 42`, `Community 43`, `Community 44`, `Community 172`, `Community 50`, `Community 52`, `Community 56`, `Community 186`, `Community 187`, `Community 188`, `Community 319`, `Community 323`, `Community 198`, `Community 199`, `Community 585`, `Community 586`, `Community 73`, `Community 588`, `Community 77`, `Community 78`, `Community 207`, `Community 464`, `Community 594`, `Community 83`, `Community 211`, `Community 84`, `Community 89`, `Community 93`, `Community 95`, `Community 99`, `Community 20`, `Community 102`, `Community 104`, `Community 105`, `Community 108`, `Community 110`, `Community 150`, `Community 151`, `Community 121`, `Community 124`, `Community 255`?**
