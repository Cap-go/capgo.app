...
## Corpus Check
- Large corpus: 2460 files · ~4,936,913 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15836 nodes · 28798 edges · 1031 communities (865 shown, 166 thin omitted)
...
## Communities (1031 total, 166 thin omitted)
...
Cohesion: 0.03
Nodes (131): filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter(), publicDevice, syncSubscriptionAndEventsWithRetry() (+123 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (127): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+119 more)
...
Cohesion: 0.02
Nodes (101): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+93 more)
...
Cohesion: 0.05
Nodes (103): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (98): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+90 more)
...
Cohesion: 0.03
Nodes (101): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+93 more)
...
Cohesion: 0.03
Nodes (54): createAuthenticatedSupabaseClient(), describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId (+46 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (61): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, createHashedKeySDK() (+53 more)
...
Cohesion: 0.04
Nodes (69): app, canManageGroupRank(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId(), withLockedGroup() (+61 more)
...
Cohesion: 0.04
Nodes (70): getActiveUploadReporter(), optionsUploadSchema, CapacitorConfig, ExtConfigPairs, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult (+62 more)
...
Cohesion: 0.05
Nodes (61): buildCliRequestHeaders(), setCurrentCliCommand(), getInvocationSource(), completePendingOnboardingApp(), reportAppOnboardingProgress(), AlertsReporter, VersionCheckResult, addApp() (+53 more)
...
Cohesion: 0.09
Nodes (72): findAppInOrganization(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+64 more)
...
Cohesion: 0.07
Nodes (51): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildGlobalNotificationStatsQuery(), buildNotificationBadgeStateQuery() (+43 more)
...
Cohesion: 0.06
Nodes (39): configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget() (+31 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (47): assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody, CAMPAIGN_KINDS, CAMPAIGN_STATUSES (+39 more)
...
Cohesion: 0.06
Nodes (38): createRSA(), checkAlerts(), setSetting(), setSettingInternal(), writeConfigUpdater(), syncPendingAppIdToCapacitorConfig(), CommandOption, CommandWithInternals (+30 more)
...
Cohesion: 0.09
Nodes (42): handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary (+34 more)
...
Cohesion: 0.09
Nodes (25): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), checkIndexPosition(), searchInDirectory() (+17 more)
...
Cohesion: 0.10
Nodes (29): app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString(), readSnapshotBytes(), ValidatedReplayPayload, validateReplayBody() (+21 more)
...
Cohesion: 0.09
Nodes (26): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility(), UploadCompatibilityResult, UploadCompatibilitySummary, getReleaseType(), printReleaseType() (+18 more)
...
Cohesion: 0.11
Nodes (21): cleanupStepsDone(), getResumedOnboardingAccessError(), getTmpObjectPath(), markStepDone(), readTmpObj(), tryResumeOnboarding(), validateResumedOnboardingAccess(), reportInitOnboardingStep() (+13 more)
...
Cohesion: 0.29
Nodes (8): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), sqlStr(), timestampMs()
...
- **Why does `Database` connect `Community 84` to `Community 259`, `Community 3`, `Community 133`, `Community 6`, `Community 10`, `Community 141`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 23`, `Community 29`, `Community 31`, `Community 35`, `Community 164`, `Community 40`, `Community 43`, `Community 51`, `Community 308`, `Community 53`, `Community 58`, `Community 62`, `Community 194`, `Community 66`, `Community 196`, `Community 203`, `Community 217`, `Community 97`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 130`, `Community 515`, `Community 516`, `Community 5`, `Community 517`, `Community 7`, `Community 519`, `Community 520`, `Community 8`, `Community 11`, `Community 268`, `Community 140`, `Community 143`, `Community 400`, `Community 17`, `Community 529`, `Community 147`, `Community 148`, `Community 277`, `Community 22`, `Community 278`, `Community 280`, `Community 144`, `Community 282`, `Community 159`, `Community 34`, `Community 36`, `Community 294`, `Community 39`, `Community 45`, `Community 46`, `Community 47`, `Community 180`, `Community 181`, `Community 182`, `Community 311`, `Community 314`, `Community 60`, `Community 192`, `Community 65`, `Community 450`, `Community 579`, `Community 580`, `Community 193`, `Community 582`, `Community 71`, `Community 73`, `Community 202`, `Community 588`, `Community 79`, `Community 80`, `Community 81`, `Community 210`, `Community 85`, `Community 87`, `Community 90`, `Community 93`, `Community 94`, `Community 99`, `Community 102`, `Community 109`, `Community 114`, `Community 115`, `Community 246`, `Community 119`, `Community 127`?**
