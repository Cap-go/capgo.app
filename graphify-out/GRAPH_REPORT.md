# Graph Report - capgo.app  (2026-09-02)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2594 files · ~5,063,943 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 16456 nodes · 30363 edges · 1064 communities (891 shown, 173 thin omitted)
...
## Communities (1064 total, 173 thin omitted)
...
Cohesion: 0.02
Nodes (113): GetLatest, getLinkedChannelVersionIds(), assertPreviewChannelDeletePermission(), deletePreviewChannelAndBundle(), getEffectiveApikey(), loadPreviewAppForUpdate(), loadPreviewChannelForUpdate(), loadPreviewChannelOwner() (+105 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (122): AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), CapgoHttpOptions, Channel (+114 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (128): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, BuilderCtaAction, BuilderCtaChoice, BuilderCtaContext, BuilderCtaSurface (+120 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (127): syncSubscriptionAndEventsWithRetry(), getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel(), getRegistrationMetadata(), didCancel(), invoiceUpcoming(), BillingPlanBentoState (+119 more)
...
Cohesion: 0.03
Nodes (122): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+114 more)
...
Cohesion: 0.03
Nodes (68): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, id, testOrgId, appCreationApiKey, id, createAppForTest() (+60 more)
...
Cohesion: 0.03
Nodes (78): getActiveUploadReporter(), optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema (+70 more)
...
Cohesion: 0.04
Nodes (75): get(), getAll(), app, appGlobal, CreateApp, ALLOWED_STORE_HOSTS, AppleLookupResult, assertAllowedStoreUrl() (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (74): resolveChannelAddDuplicateOutcome(), resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets() (+66 more)
...
Cohesion: 0.05
Nodes (66): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), useCurrentOrgBillingCycleChart() (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (77): flushDeferredCommandInvocation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+69 more)
...
Cohesion: 0.05
Nodes (71): AUTH_HEADER_NAMES, buildCliRequestHeaders(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue(), getInvocationSource() (+63 more)
...
Cohesion: 0.05
Nodes (59): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getGitHubProfile(), GitHubProfile, GitHubProfileError, normalizeGitHubUsername() (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (44): TEST_ORG_ID, TEST_ORG_ID, execFileAsync, AutoTopUpSettings, originalSettings, CreditStep, callLogAs(), seedStaleCreatedByOrg() (+36 more)
...
Cohesion: 0.06
Nodes (63): normalizeTargetLimit(), resolveTargetPlan(), analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret() (+55 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (68): findAppInOrganization(), waitLog(), setConfigWriteTarget(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep() (+60 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (58): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+50 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (48): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), hideLoader(), showLoader(), isNativeAppStoreContext() (+40 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (53): captchaKey, completeInviteSuccess(), emailDialogDescription, emailDialogTitle, handleEmailSubmit(), handleFullDetailsSubmit(), isEmailDialogOpen, isFullDetailsDialogOpen (+45 more)
...
Cohesion: 0.09
Nodes (24): AlertsReporter, VersionCheckResult, addOrganization(), addOrganizationInternal(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations() (+16 more)
...
Cohesion: 0.07
Nodes (59): createNotificationDeliveryEventProofFromSecret(), aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody(), canRetry() (+51 more)
...
Cohesion: 0.09
Nodes (50): getAppListPath(), checkIndexPosition(), searchInDirectory(), searchInFile(), emitCliUserJsonError(), emitJson(), emitJsonError(), zipBundle() (+42 more)
...
Cohesion: 0.06
Nodes (46): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+38 more)
...
Cohesion: 0.06
Nodes (48): assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody, CAMPAIGN_KINDS, CAMPAIGN_STATUSES (+40 more)
...
Cohesion: 0.08
Nodes (43): createRSA(), derivePublicKeyFromPrivate(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler() (+35 more)
...
Cohesion: 0.05
Nodes (36): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, UploadResponse, headers, id (+28 more)
...
Cohesion: 0.06
Nodes (35): updateUser(), createSignedImageUrl(), getImmediateImageUrl(), resolveImagePath(), signedUrlCache, getLocalConfig(), stripeEnabled, clearWebsiteCookie() (+27 more)
...
Cohesion: 0.09
Nodes (22): Digester, noopDigester(), sha256Digester(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, isR2ChecksumError() (+14 more)
...
Cohesion: 0.08
Nodes (39): deleteOwnedApiKeyByIdentifier(), isNumericApiKeyId(), selectOwnedApiKeyByIdentifier(), bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau() (+31 more)
...
Cohesion: 0.09
Nodes (36): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), hasProcessedCreditTopUp() (+28 more)
...
Cohesion: 0.10
Nodes (33): buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution, ensureCustomerMetadata() (+25 more)
...
Cohesion: 0.11
Nodes (24): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), app (+16 more)

### Community 128 - "Community 128"
Cohesion: 0.10
Nodes (29): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, updateDeliveryStatsTestUtils, buildNativeObservePluginTotalDevicesCFQuery() (+21 more)
...
Cohesion: 0.12
Nodes (21): deleteOverride(), DeviceLink, filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter() (+13 more)
...
Cohesion: 0.13
Nodes (23): app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch() (+15 more)
...
Cohesion: 0.13
Nodes (22): appGlobal, buildBundleInfoRequest(), buildPreviewAuthRequest(), buildPreviewDownloadPayload(), buildPreviewPayloadResponseHeaders(), buildPreviewResponseHeaders(), BundleInfoCache, getBundleInfo() (+14 more)
...
Cohesion: 0.18
Nodes (26): promptDoctorUpdateChoice(), ensureNativePlatformForBuild(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+18 more)
...
Cohesion: 0.10
Nodes (21): getTmpObjectPath(), markStepDone(), readTmpObj(), reportInitOnboarding(), reportInitOnboardingStep(), INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId (+13 more)
...
Cohesion: 0.14
Nodes (19): lintFailures, liveFailures, ANALYTICS_ENGINE_SQL_LINT_RULES, AnalyticsEngineSqlLintIssue, AnalyticsEngineSqlLintRule, AnalyticsEngineSqlLiveValidationFailure, AnalyticsEngineSqlLiveValidationResult, assertAnalyticsEngineSqlValid() (+11 more)
...
Cohesion: 0.18
Nodes (14): AppListOptions, AppRow, displayApps(), formatAppListText(), formatAppsCsv(), getActiveApps(), getAppListHeaders(), getAppListRow() (+6 more)
...
Cohesion: 0.14
Nodes (16): AdminOnboardingActivationCohort, AdminOnboardingActivationMetrics, getAdminOnboardingActivationMetrics(), isWithinActivationWindow(), toValidDate(), adminOnboardingConversionRate(), AdminOnboardingFunnel, getAdminOnboardingFunnel() (+8 more)
...
Cohesion: 0.17
Nodes (11): apps, builtCli, cliSource, csv, formulaCsv, help, keyFixture, originalCwd (+3 more)
...
## Knowledge Gaps
- **5769 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5764 more)
...
- **Why does `Database` connect `Community 6` to `Community 3`, `Community 7`, `Community 520`, `Community 648`, `Community 13`, `Community 14`, `Community 272`, `Community 17`, `Community 18`, `Community 21`, `Community 153`, `Community 28`, `Community 29`, `Community 30`, `Community 544`, `Community 160`, `Community 37`, `Community 38`, `Community 174`, `Community 50`, `Community 179`, `Community 311`, `Community 313`, `Community 63`, `Community 64`, `Community 66`, `Community 70`, `Community 79`, `Community 81`, `Community 210`, `Community 86`, `Community 234`, `Community 362`, `Community 118`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 257`, `Community 5`, `Community 134`, `Community 8`, `Community 137`, `Community 10`, `Community 143`, `Community 19`, `Community 149`, `Community 150`, `Community 407`, `Community 536`, `Community 153`, `Community 537`, `Community 155`, `Community 538`, `Community 285`, `Community 540`, `Community 541`, `Community 287`, `Community 33`, `Community 288`, `Community 289`, `Community 36`, `Community 549`, `Community 166`, `Community 31`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 187`, `Community 188`, `Community 317`, `Community 321`, `Community 67`, `Community 72`, `Community 73`, `Community 202`, `Community 203`, `Community 77`, `Community 78`, `Community 209`, `Community 83`, `Community 467`, `Community 595`, `Community 596`, `Community 598`, `Community 85`, `Community 213`, `Community 89`, `Community 92`, `Community 221`, `Community 93`, `Community 604`, `Community 96`, `Community 100`, `Community 101`, `Community 109`, `Community 111`, `Community 114`, `Community 117`, `Community 119`, `Community 151`, `Community 122`, `Community 279`, `Community 152`, `Community 126`, `Community 127`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02309961709873831 - nodes in this community are weakly interconnected._