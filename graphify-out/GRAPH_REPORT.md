...
## Corpus Check
- Large corpus: 2047 files · ~4,407,809 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13619 nodes · 24905 edges · 931 communities (779 shown, 152 thin omitted)
...
## Communities (931 total, 152 thin omitted)
...
Cohesion: 0.02
Nodes (148): GateProbe, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+140 more)
...
Cohesion: 0.03
Nodes (131): app, bodySchema, CreateDeviceBody, DataUpload, DataUpload, syncSubscriptionAndEventsWithRetry(), getPreviousDefaultChannel(), BillingPlanBentoState (+123 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (120): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath(), Channel (+112 more)
...
Cohesion: 0.03
Nodes (56): ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, GLOBAL_STATS_TREND_DATES, NOW, ONBOARDING_LATE_SUBSCRIPTION_ORG_ID, ONBOARDING_NO_BUNDLE_ORG_ID (+48 more)
...
Cohesion: 0.04
Nodes (61): findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, CapgoConfig, CapgoFilesConfig (+53 more)
...
Cohesion: 0.06
Nodes (54): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+46 more)
...
Cohesion: 0.05
Nodes (61): get(), getAll(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization() (+53 more)
...
Cohesion: 0.05
Nodes (39): useAppPage(), UseAppPageOptions, adminStore, deliveryLatencyDays, devicesTrendSeries, displayStore, externalUpdatesSeries, isLoading (+31 more)
...
Cohesion: 0.05
Nodes (57): createRSA(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget() (+49 more)
...
Cohesion: 0.06
Nodes (52): addMonthsUtc(), Cycle, daysInMonthUtc(), oracleCompletedCycle(), pad2(), parseUtcDateOnly(), sqlPortCompletedCycle(), utcDateOnly() (+44 more)
...
Cohesion: 0.07
Nodes (58): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildNotificationBadgeStateQuery(), buildNotificationRegistryLookupQuery() (+50 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (50): getInvocationSource(), checkAppExists(), checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal(), AppCreateSource (+42 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (59): getAllNotificationBuckets(), NativeNotificationProviderConfig, aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody() (+51 more)
...
Cohesion: 0.04
Nodes (38): TEST_ORG_ID, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createGroupOrgBinding(), createUserOrgBinding(), fixtureId, getOrgRoleId() (+30 more)
...
Cohesion: 0.05
Nodes (52): app, appGlobal, assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody (+44 more)
...
Cohesion: 0.05
Nodes (36): Binding, CGFloat, Bool, Color, Int, GuidedFlowModel, String, GuidedFlowModel (+28 more)
...
Cohesion: 0.05
Nodes (29): LogData, getRecentEmailOtpVerification(), isRecentEmailOtpVerification(), App, Bundle, Channel, Device, useAppDetailStore (+21 more)
...
Cohesion: 0.08
Nodes (44): app, bodySchema, handleCheckoutSessionCompleted(), syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal() (+36 more)
...
Cohesion: 0.06
Nodes (36): UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled, ComponentCustomProperties, GlobalComponents, BreadcrumbItem, ExtendedOrganizationMember, ExtendedOrganizationMembers (+28 more)
...
Cohesion: 0.06
Nodes (38): getUniqueBaseData(), headers, id, TEST_ORG_ID, expectNoPrimaryDownloadStatsRows(), id, postStats(), StatsAction (+30 more)
...
Cohesion: 0.06
Nodes (35): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, globalId, ORG_ID (+27 more)
...
Cohesion: 0.10
Nodes (22): accumulateNumbers(), AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, bundleUsageSchema, checkOrganizationAccess(), fetchAppMetricsRows(), formatNativePlatform() (+14 more)
...
Cohesion: 0.14
Nodes (23): assertSubkeyHasPlaintextSecret(), checkKeyByIdPg(), checkKeyPg(), FindApikeyByValueResult, foundAPIKey(), foundJWT(), getSubkeyId(), hasLimitedRbacSubkeyScope() (+15 more)
...
Cohesion: 0.11
Nodes (13): CommandOption, CommandWithInternals, formatFrontmatterString(), generateDocs(), getCommandEmoji(), MappedCommand, ANSI_PATTERN, FormatTableOptions (+5 more)
...
Cohesion: 0.39
Nodes (8): buildNativeVersionCounts(), createDatasetsByName(), generateDateLabels(), getActiveVersionsByName(), getBundleUsage(), getLatestDayVersionShare(), getNativeVersionUsage(), convertCountsToPercentagesByName()
...
## Knowledge Gaps
- **4581 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4576 more)
...
- **Why does `Database` connect `Community 54` to `Community 258`, `Community 2`, `Community 4`, `Community 7`, `Community 11`, `Community 15`, `Community 21`, `Community 22`, `Community 277`, `Community 24`, `Community 23`, `Community 32`, `Community 166`, `Community 172`, `Community 52`, `Community 55`, `Community 59`, `Community 62`, `Community 73`, `Community 74`, `Community 108`, `Community 125`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 17` to `Community 128`, `Community 130`, `Community 134`, `Community 6`, `Community 9`, `Community 521`, `Community 522`, `Community 524`, `Community 266`, `Community 13`, `Community 400`, `Community 18`, `Community 19`, `Community 148`, `Community 530`, `Community 278`, `Community 146`, `Community 280`, `Community 154`, `Community 27`, `Community 155`, `Community 28`, `Community 29`, `Community 31`, `Community 34`, `Community 163`, `Community 164`, `Community 40`, `Community 43`, `Community 45`, `Community 175`, `Community 48`, `Community 56`, `Community 57`, `Community 58`, `Community 65`, `Community 67`, `Community 75`, `Community 461`, `Community 462`, `Community 463`, `Community 78`, `Community 465`, `Community 466`, `Community 83`, `Community 88`, `Community 473`, `Community 92`, `Community 223`, `Community 352`, `Community 97`, `Community 98`, `Community 102`, `Community 105`, `Community 239`, `Community 112`, `Community 113`, `Community 114`, `Community 246`, `Community 247`, `Community 118`, `Community 253`, `Community 250`, `Community 123`, `Community 125`, `Community 126`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.025456207587637565 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.022412131875497465 - nodes in this community are weakly interconnected._
