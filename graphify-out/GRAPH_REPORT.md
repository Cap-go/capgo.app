...
## Corpus Check
- Large corpus: 2415 files · ~4,881,012 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15591 nodes · 28351 edges · 1009 communities (848 shown, 161 thin omitted)
...
## Communities (1009 total, 161 thin omitted)
...
Cohesion: 0.03
Nodes (121): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+113 more)
...
Cohesion: 0.04
Nodes (120): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+112 more)
...
Cohesion: 0.05
Nodes (104): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions (+96 more)
...
Cohesion: 0.03
Nodes (103): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, resolveCapacitorConfigTargetPath(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+95 more)
...
Cohesion: 0.02
Nodes (62): describeBackend, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), id, pgPool, fixtureId (+54 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (90): computeBuggyWeeklyInstallStats(), addDaysToDateOnly(), billingPeriodMetricsRange(), billingPeriodStatsTestUtils, formatBytes(), formatNumber(), getOrgIdForApp(), handleBillingPeriodStats() (+82 more)
...
Cohesion: 0.05
Nodes (60): STRIPE_EMULATOR_HEADERS, STRIPE_EMULATOR_HEADERS, StripePriceResponse, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id (+52 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (76): filterDeviceKeys(), get(), GetDevice, parseCustomIdFilter(), parseDevicesOrder(), parseUpdatedAtFilter(), publicDevice, DeviceRow (+68 more)
...
Cohesion: 0.04
Nodes (71): setConfigWriteTarget(), cleanupStepsDone(), streamCommandInInitPanel(), tryResumeOnboarding(), ConfirmOptions, intro(), PromptResult, SelectOption (+63 more)
...
Cohesion: 0.04
Nodes (56): CompatibilityResult, getActiveUploadReporter(), Compatibility, addProjectTypeCandidateDir(), ArrayElement, CapgoCliInvokeOptions, CapgoConfig, CapgoFilesConfig (+48 more)
...
Cohesion: 0.04
Nodes (51): TEST_ORG_ID, apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg() (+43 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (47): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, testOrgId, appCreationApiKey (+39 more)
...
Cohesion: 0.07
Nodes (46): buildCliRequestHeaders(), getCurrentCliCommand(), setCurrentCliCommand(), getInvocationSource(), AppOnboardingProgressPatch, checkAppExists(), completePendingOnboardingApp(), getAppIconStoragePath() (+38 more)
...
Cohesion: 0.06
Nodes (38): resolveAppSetIconPath(), cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+30 more)
...
Cohesion: 0.07
Nodes (37): decryptChecksum(), decryptChecksumV3(), decryptSource(), AlertsReporter, checkVersionStatus(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions (+29 more)
...
Cohesion: 0.06
Nodes (38): getStatsInsightsPeriod(), aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample (+30 more)
...
Cohesion: 0.09
Nodes (42): normalizeTargetLimit(), resolveTargetPlan(), aesKeyFromSecret(), buildNotificationBadgeStateQuery(), buildNotificationRegistryLookupQuery(), decryptNotificationToken(), deriveNativeNotificationIdentity(), deriveRecipientKey() (+34 more)
...
Cohesion: 0.10
Nodes (35): createRSA(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite() (+27 more)
...
Cohesion: 0.08
Nodes (27): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), buildFrontendOnboardingWelcomeHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), mapWelcomeAttempts(), ONBOARDING_INTERACTION_EVENTS (+19 more)
...
Cohesion: 0.10
Nodes (32): CURRENT_START_MS, buildDailyAttempts(), buildDailyConversion(), buildFrontendOnboardingAnalytics(), buildFunnel(), buildInteractionGraph(), buildSetupCliOutcomes(), comparePeriods() (+24 more)
...
Cohesion: 0.10
Nodes (23): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+15 more)
...
Cohesion: 0.08
Nodes (21): app, bodySchema, bumpRateLimit(), hashRateLimitKey(), isEmailPreferencesRateLimited(), preferenceValueSchema, PublicEmailPreferenceKey, record (+13 more)

### Community 140 - "Community 140"
Cohesion: 0.13
Nodes (24): app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch() (+16 more)
...
Cohesion: 0.12
Nodes (21): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), createNotificationDeliveryEventProof(), createNotificationDeliveryEventProofFromSecret(), createNotificationEventProof() (+13 more)
...
Cohesion: 0.16
Nodes (16): numberLikeSchema, getDeliveryById(), getWebhookById(), getWebhookLogUrlMetadata(), queueWebhookDelivery(), bodySchema, deleteWebhook(), getDeliveries() (+8 more)
...
Cohesion: 0.15
Nodes (17): addFirstSeenByApp(), appLogDimensionBlobs(), batchAdminOnboardingTelemetryWindows(), buildAdminOnboardingProductionDeviceQuery(), buildAdminOnboardingUpdateDownloadQuery(), emptyAdminOnboardingTelemetry(), getAdminOnboardingTelemetry(), getAdminOnboardingTelemetryWindowFilter() (+9 more)
...
## Knowledge Gaps
- **5524 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5519 more)
...
- **Why does `Database` connect `Community 60` to `Community 3`, `Community 262`, `Community 9`, `Community 11`, `Community 13`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 27`, `Community 28`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 297`, `Community 43`, `Community 171`, `Community 49`, `Community 59`, `Community 62`, `Community 70`, `Community 198`, `Community 80`, `Community 487`, `Community 235`, `Community 509`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 514`, `Community 5`, `Community 6`, `Community 134`, `Community 10`, `Community 139`, `Community 140`, `Community 269`, `Community 270`, `Community 15`, `Community 272`, `Community 145`, `Community 141`, `Community 273`, `Community 20`, `Community 142`, `Community 17`, `Community 278`, `Community 155`, `Community 285`, `Community 30`, `Community 29`, `Community 33`, `Community 38`, `Community 167`, `Community 41`, `Community 300`, `Community 559`, `Community 560`, `Community 48`, `Community 562`, `Community 178`, `Community 436`, `Community 179`, `Community 568`, `Community 61`, `Community 191`, `Community 64`, `Community 192`, `Community 68`, `Community 197`, `Community 73`, `Community 461`, `Community 81`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 93`, `Community 95`, `Community 121`, `Community 98`, `Community 99`, `Community 101`, `Community 105`, `Community 112`, `Community 241`, `Community 506`, `Community 116`, `Community 501`, `Community 502`, `Community 503`, `Community 505`, `Community 122`, `Community 124`, `Community 382`?**
