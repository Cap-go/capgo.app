# Graph Report - capgo.app  (2026-08-24)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2481 files · ~4,947,149 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15892 nodes · 28908 edges · 1050 communities (881 shown, 169 thin omitted)
...
7. `findSavedKey()` - 76 edges
8. `checkPermission()` - 76 edges
9. `executeSQL()` - 71 edges
10. `initApp()` - 67 edges
...
## Communities (1050 total, 169 thin omitted)
...
Cohesion: 0.02
Nodes (143): appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials (+135 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (164): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+156 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (135): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+127 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (112): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, DEFAULT_SCOPES (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (129): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+121 more)
...
Cohesion: 0.03
Nodes (121): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), shouldStartInitBrowserLogin(), applyInitAutoTestChange(), askForAppName() (+113 more)
...
Cohesion: 0.06
Nodes (96): withSupabaseSource(), AppOnboardingProgressPatch, check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), hostOptionsFromSupabase(), resolveAppSetIconPath() (+88 more)
...
Cohesion: 0.04
Nodes (85): AUTH_HEADER_NAMES, buildCliRequestHeaders(), getCurrentCliCommand(), invalidAuthHeaderMessage(), isByteStringSafe(), missingAuthHeaderMessage(), setCurrentCliCommand(), validateCliRequestHeaderValue() (+77 more)
...
Cohesion: 0.03
Nodes (58): createAuthenticatedSupabaseClient(), describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId (+50 more)
...
Cohesion: 0.04
Nodes (70): enableSupabaseInstrumentation(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+62 more)
...
Cohesion: 0.05
Nodes (67): promoteEncryptionSummaryToEnabled(), initOnboardingSteps, ConfirmOptions, intro(), log, PromptResult, SelectOption, SelectOptions (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (68): resolveCapacitorConfigTargetPath(), getInitUpdaterPluginConfig(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP (+60 more)
...
Cohesion: 0.04
Nodes (68): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+60 more)
...
Cohesion: 0.04
Nodes (62): getActiveUploadReporter(), findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, canOpenExternalUrl() (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (66): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+58 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (51): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+43 more)
...
Cohesion: 0.05
Nodes (54): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+46 more)
...
Cohesion: 0.11
Nodes (62): findAppInOrganization(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (42): app, buildAppTooLargeTrackedBentoEvent(), buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString() (+34 more)
...
Cohesion: 0.05
Nodes (50): firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl(), ManifestEntry, rewriteLocalEdgeRuntimeUrl(), canUseSupabaseFallback(), createStatsBandwidth(), createStatsDevices() (+42 more)
...
Cohesion: 0.05
Nodes (39): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+31 more)
...
Cohesion: 0.08
Nodes (39): createRSA(), cancelCommand(), sendCliEvent(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), isTypeScriptCompiler() (+31 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (37): describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData, LogSpec, Order (+29 more)
...
Cohesion: 0.06
Nodes (37): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, testRunId, headers, id, orgId (+29 more)
...
Cohesion: 0.08
Nodes (36): aiBumpLevel, AiBumpLevelBody, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), app (+28 more)
...
Cohesion: 0.06
Nodes (29): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+21 more)
...
Cohesion: 0.11
Nodes (29): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), handlePut() (+21 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (29): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, checkCompatibility(), CompatibilityResult, summarizeUploadCompatibility(), UploadCompatibilityResult (+21 more)
...
Cohesion: 0.11
Nodes (27): INIT_ONBOARDING_STEP_IDS, InitOnboardingStepDefinition, InitOnboardingStepId, APP_ONBOARDING_STEP_IDS, AppOnboardingOutcome, AppOnboardingPatch, AppOnboardingSource, AppOnboardingState (+19 more)

### Community 118 - "Community 118"
Cohesion: 0.09
Nodes (28): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+20 more)
...
Cohesion: 0.10
Nodes (32): countDemoSeededApps(), countNotificationEvent(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getEmptySubscriptionAccessSnapshotCounts(), getLtvStats(), getMetricWindowFromDailyWindow(), getNativeNotificationGlobalStats() (+24 more)

### Community 125 - "Community 125"
Cohesion: 0.10
Nodes (24): IncompatibleBundleError, trimTrailingSlashes(), capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, EXPECTED_USER_ERROR_MARKERS, getCommanderCode(), getCommandPath() (+16 more)
...
Cohesion: 0.11
Nodes (24): app, buildQueueHealthCriteria(), buildQueueIntervalMap(), cronTaskIntervalSeconds(), evaluateQueueHealth(), fetchQueueMetrics(), isSafeQueueName(), loadQueueIntervals() (+16 more)
...
Cohesion: 0.17
Nodes (27): ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+19 more)
...
Cohesion: 0.15
Nodes (21): assertSubkeyHasPlaintextSecret(), checkKeyByIdPg(), checkKeyPg(), FindApikeyByValueResult, foundAPIKey(), foundJWT(), getSubkeyId(), hasLimitedRbacSubkeyScope() (+13 more)
...
Cohesion: 0.11
Nodes (13): AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, post(), PostResult, shouldRecordStatsAction() (+5 more)
...
Cohesion: 0.14
Nodes (19): buildMappedUserBentoEvent(), copyMappedFields(), deliverEveryUserBentoEvent(), DetailField, isJsonObject(), MappedUserBentoEvent, mappingForBentoEvent(), RecordUserBentoEventInput (+11 more)
...
Cohesion: 0.14
Nodes (18): calculateConversionRate(), countAppsWithPreview(), countRegisteredUsersForSnapshot(), getAppBuildOnboardingMetrics(), getBillingSnapshotCounts(), getCoreSnapshotCounts(), getEmptyBillingSnapshotCounts(), getGithubStars() (+10 more)
...
Cohesion: 0.18
Nodes (10): resetSupportUploadCacheForTests(), buildHelpMenuOptions(), HelpMenuOption, offerSupportUploadBeforeAi(), OfferSupportUploadDeps, supportUploadConfirmation(), SupportUploadOutcome, t() (+2 more)
...
Cohesion: 0.20
Nodes (14): AB_TESTS_CONFIG, ABTestAssignment, ABTestAudience, ABTestBranch, ABTestsConfig, AssignmentUser, createABTestAssignments(), invalidConfig() (+6 more)
...
Cohesion: 0.14
Nodes (15): buildRecentGlobalStatsRepairDateIds(), calculateChurnRevenue(), calculateNrr(), getCompletedAppBuildOnboardingWindow(), getCompletedDayWindow(), getCurrentDayWindow(), getDailyWindow(), getDateId() (+7 more)
...
Cohesion: 0.35
Nodes (12): addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags(), trackBentoEvent(), unsubscribeBento(), acceptedBentoBatchResult() (+4 more)
...
Cohesion: 0.29
Nodes (8): confirmMessage(), contactSupport(), ContactSupportDeps, ContactSupportResult, fitBodyPrefix(), runContactSupport(), buildMailtoUrl(), MailtoParams
...
Cohesion: 0.47
Nodes (9): appendUserBentoObservation(), deliverPendingUserBentoEvents(), getPendingUserBentoEvents(), logUserBentoError(), parseUserBentoEvents(), persistUserBentoObservation(), recordUserBentoEvent(), rollbackReleaseError() (+1 more)
...
Cohesion: 0.31
Nodes (3): buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError()
...
Cohesion: 0.25
Nodes (5): ABTestsConfig, ABTestsModule, {
  closeClientMock,
  getPgClientMock,
  pgConnectMock,
  pgQueryMock,
...
Cohesion: 0.33
Nodes (6): aggregateDailyBuildStats(), getBuildStats(), isMissingAppsWithPreviewColumnError(), isMissingBuildMetricColumnError(), isMissingSchemaColumnError(), runBuildsGlobalStatsShard()

### Community 563 - "Community 563"
Cohesion: 0.33
Nodes (6): applySubscriptionRevenue(), calculateRevenue(), getEmptyPlanRevenue(), resolvePlanBillingInterval(), resolvePlanMrrDollars(), roundRevenueMoney()
...
## Knowledge Gaps
- **5630 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5625 more)
...
- **Why does `Database` connect `Community 68` to `Community 514`, `Community 3`, `Community 5`, `Community 133`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `Community 18`, `Community 25`, `Community 27`, `Community 29`, `Community 30`, `Community 165`, `Community 39`, `Community 169`, `Community 45`, `Community 176`, `Community 49`, `Community 50`, `Community 309`, `Community 57`, `Community 61`, `Community 197`, `Community 72`, `Community 202`, `Community 76`, `Community 216`, `Community 361`, `Community 636`?**
  _High betweenness centrality (0.227) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 13` to `Community 6`, `Community 7`, `Community 137`, `Community 10`, `Community 268`, `Community 142`, `Community 15`, `Community 143`, `Community 530`, `Community 147`, `Community 531`, `Community 21`, `Community 532`, `Community 278`, `Community 148`, `Community 279`, `Community 534`, `Community 535`, `Community 28`, `Community 406`, `Community 282`, `Community 543`, `Community 32`, `Community 160`, `Community 33`, `Community 34`, `Community 294`, `Community 42`, `Community 44`, `Community 173`, `Community 51`, `Community 53`, `Community 54`, `Community 182`, `Community 183`, `Community 184`, `Community 313`, `Community 316`, `Community 195`, `Community 69`, `Community 71`, `Community 201`, `Community 77`, `Community 78`, `Community 462`, `Community 592`, `Community 209`, `Community 593`, `Community 595`, `Community 79`, `Community 81`, `Community 214`, `Community 85`, `Community 88`, `Community 89`, `Community 96`, `Community 98`, `Community 102`, `Community 489`, `Community 107`, `Community 112`, `Community 116`, `Community 248`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _5633 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02317668207498716 - nodes in this community are weakly interconnected._