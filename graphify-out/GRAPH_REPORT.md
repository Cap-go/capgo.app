# Graph Report - capgo.app  (2026-08-04)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2040 files · ~4,406,695 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13603 nodes · 24884 edges · 912 communities (768 shown, 144 thin omitted)
...
## Communities (912 total, 144 thin omitted)
...
Cohesion: 0.03
Nodes (127): app, DataSetManifest, syncSubscriptionAndEventsWithRetry(), DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount() (+119 more)
...
Cohesion: 0.02
Nodes (90): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+82 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (92): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath(), Channel (+84 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (99): checkAppIdsExist(), setConfigWriteTarget(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), buildCodeDiffLines(), BuildProjectStepOutcome, CancelablePromptValue (+91 more)
...
Cohesion: 0.04
Nodes (83): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, AppContext (+75 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (65): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps (+57 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (69): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInstalledDependencies(), getLatestDependencies(), findMonorepoRoot, findNXMonorepoRoot, addProjectTypeCandidateDir() (+61 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (77): mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata() (+69 more)
...
Cohesion: 0.05
Nodes (60): fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getFirstTierCreditUnitPricing(), sortCreditPricingSteps(), getErrorMessage(), logAsUser() (+52 more)
...
Cohesion: 0.06
Nodes (54): analyticsOptOutCommands, applyCommandAnalyticsOptOut(), applyRawCommandAnalyticsOptOut(), buildInitReplayBody(), buildTerminalImageDataUrl(), CliStream, createTerminalInteractionEvents(), createTerminalSnapshot() (+46 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (49): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), assertIntegerInRange(), assertOptionalConfidence(), assertOptionalIntegerInRange(), disableAutoUpdatesPossibleOptions, displayCompatibilityTable(), setChannel() (+41 more)
...
Cohesion: 0.05
Nodes (37): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), CheckDomainResponse, UpdateDeliveryScope, UpdateDeliveryStatsResponse, DATE_RANGE_DURATIONS_MS, DATE_RANGE_PRESET_GROUPS (+29 more)
...
Cohesion: 0.12
Nodes (52): completePendingOnboardingApp(), markSnag(), waitLog(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep() (+44 more)
...
Cohesion: 0.05
Nodes (48): adminStore, ago(), buildAverageSecondsTrendSeries, builderActivityTrendSeries, buildPeriodSubtitle(), buildsLastMonthTrendSeries, buildsSeries, buildsTrendSeries (+40 more)
...
Cohesion: 0.06
Nodes (33): findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitDirectoryPath(), resolveInitTargetPath() (+25 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (38): checkAlerts(), checkVersionStatus(), VersionCheckResult, cancelCommand(), formatTimeOnly(), Level, LogData, LogSpec (+30 more)
...
Cohesion: 0.08
Nodes (41): describeFetchFailure(), getStats(), getInfoInternal(), addUpdaterStep(), ensureUpdaterReadyBeforeSync(), formatInheritedCommandFailure(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage() (+33 more)
...
Cohesion: 0.10
Nodes (36): additionalDefaultStarRepositories, checkIfStarred(), parseNumber(), StarAllCommandOptions, starRepositoryCommand(), createAbortedError(), createStartRateLimiter(), dedupeRepositories() (+28 more)
...
Cohesion: 0.13
Nodes (34): createCapacitorRunTargetListError(), ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getCapacitorRunTargetListWithStatus(), getInitRecoveryCommands(), getNativePlatformAvailability() (+26 more)

### Community 98 - "Community 98"
Cohesion: 0.10
Nodes (31): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerForTargetList(), runPackageRunnerSync(), log, assertHelperFileWritable(), getConfigAppId(), notificationPackages (+23 more)
...
Cohesion: 0.15
Nodes (13): optionsUploadSchema, assertSyncResult(), parseSchema(), safeParseSchema(), SafeParseSchemaResult, SchemaError, StandardSchema, ValidationIssue (+5 more)
...
## Knowledge Gaps
- **4579 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4574 more)
...
- **Why does `Database` connect `Community 67` to `Community 2`, `Community 5`, `Community 8`, `Community 11`, `Community 12`, `Community 15`, `Community 17`, `Community 21`, `Community 277`, `Community 23`, `Community 25`, `Community 27`, `Community 30`, `Community 33`, `Community 44`, `Community 176`, `Community 179`, `Community 60`, `Community 62`, `Community 65`, `Community 81`, `Community 84`, `Community 225`?**
  _High betweenness centrality (0.225) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 10` to `Community 128`, `Community 4`, `Community 5`, `Community 133`, `Community 7`, `Community 517`, `Community 265`, `Community 137`, `Community 140`, `Community 396`, `Community 13`, `Community 143`, `Community 144`, `Community 16`, `Community 18`, `Community 141`, `Community 278`, `Community 281`, `Community 26`, `Community 28`, `Community 29`, `Community 162`, `Community 163`, `Community 36`, `Community 37`, `Community 173`, `Community 174`, `Community 47`, `Community 52`, `Community 64`, `Community 451`, `Community 452`, `Community 453`, `Community 70`, `Community 455`, `Community 72`, `Community 456`, `Community 75`, `Community 76`, `Community 77`, `Community 464`, `Community 82`, `Community 86`, `Community 88`, `Community 92`, `Community 95`, `Community 224`, `Community 353`, `Community 100`, `Community 103`, `Community 106`, `Community 127`, `Community 111`, `Community 239`, `Community 241`, `Community 125`, `Community 118`, `Community 248`, `Community 253`, `Community 251`, `Community 508`, `Community 509`, `Community 511`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4582 weakly-connected nodes found - possible documentation gaps or missing edges._
