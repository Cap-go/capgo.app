# Graph Report - capgo.app  (2026-08-21)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 2430 files · ~4,893,488 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 15634 nodes · 28453 edges · 1020 communities (857 shown, 163 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.8)
...
1. `scripts` - 198 edges
2. `supabaseAdmin()` - 170 edges
3. `scripts` - 161 edges
4. `getSupabaseClient()` - 140 edges
5. `Database` - 125 edges
6. `formatError()` - 93 edges
7. `checkPermission()` - 76 edges
8. `findSavedKey()` - 72 edges
9. `initApp()` - 67 edges
10. `executeSQL()` - 66 edges
...
## Communities (1020 total, 163 thin omitted)
...
Cohesion: 0.02
Nodes (141): setSetting(), setSettingInternal(), withConfigWriteTarget(), AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (161): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+153 more)
...
Cohesion: 0.03
Nodes (99): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+91 more)
...
Cohesion: 0.03
Nodes (116): checkAppIdsExist(), ExistingOrganizationApp, listPendingOnboardingApps(), PendingOnboardingApp, checkVersionStatus(), shouldStartInitBrowserLogin(), addCodeStep(), applyInitAutoTestChange() (+108 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (110): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, maybePromptBuilderCta(), shouldBlockIncompatibleUpload(), checkCompatibility(), checkCompatibilityInternal() (+102 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (93): AiBumpLevelBody, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+85 more)
...
Cohesion: 0.04
Nodes (70): useAppPage(), UseAppPageOptions, buildPeriodSubtitle(), formatNumberValue(), formatPercent(), formatSeconds(), formatTotalSeconds(), getBuildAverageSeconds() (+62 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (89): loadDeployVersionAdoption(), autoResolveCompatibilityEvents(), ChannelPlatformScope, ChannelRow, getCurrentChannel(), getCurrentPublicWinner(), getPreviousDefaultChannel(), loadCompatibilityBundle() (+81 more)
...
Cohesion: 0.06
Nodes (78): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), CapgoHttpOptions, Channel, ChannelLinkedVersion, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+70 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (83): ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOnboardingTelemetry (+75 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (73): flushDeferredCommandInvocation(), AlertsReporter, checkAlerts(), VersionCheckResult, displayApps(), getActiveApps(), listApp(), listAppInternal() (+65 more)
...
Cohesion: 0.03
Nodes (48): describeBackend, pgPool, fixtureId, orgId, QueryFn, pool, alreadyHasBillingId, appOnlyBackfillId (+40 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (67): buildCliRequestHeaders(), setCurrentCliCommand(), getInvocationSource(), AppOnboardingProgressPatch, checkAppExists(), completePendingOnboardingApp(), getAppIconStoragePath(), hostOptionsFromSupabase() (+59 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (66): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), base64ToArrayBuffer() (+58 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (51): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+43 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (69): resolveCapacitorConfigTargetPath(), resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), reportInitOnboarding(), reportInitOnboardingStep(), InitOnboardingStepDefinition, InitOnboardingStepId (+61 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (67): waitForCommandResult(), promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), ConfirmOptions, intro(), PromptResult, SelectOption, SelectOptions (+59 more)
...
Cohesion: 0.05
Nodes (59): useGitHubProfileDialog(), ApiKeyListFilterOptions, ApiKeyListFilterResult, ApiKeyListRow, clearApiKeyScopeFilters(), confirmApiKeyDeletion(), confirmApiKeyRegeneration(), createAiApiKey() (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (76): addAppStep(), addChannelStep(), addCodeChangeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId(), askForExistingDirectoryPath(), askForReplacementAppId() (+68 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (59): CheckDomainResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser(), AppUsageByApp (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (54): createUserOrgBinding(), destinationOrgId, AuditLog, auditLogSchema, auditLogsResponseSchema, countAppUpdates(), countOrgUpdates(), globalId (+46 more)
...
Cohesion: 0.06
Nodes (51): AdminDailyConversionPoint, buildAdminDailyConversionChartData(), buildAdminDailyConversionChartOptions(), BuildCardProps, useBuildCardStats(), useCurrentOrgBillingCycleChart(), useDashboardDailyChartCycle(), useOrgBillingCycleChart() (+43 more)
...
Cohesion: 0.05
Nodes (58): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow (+50 more)
...
Cohesion: 0.07
Nodes (57): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildGlobalNotificationStatsQuery(), buildNotificationBadgeStateQuery() (+49 more)
...
Cohesion: 0.05
Nodes (37): TEST_ORG_ID, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createUserOrgBinding(), expectCreatedOrganizationPlan(), globalId, globalIdRbac (+29 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (47): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+39 more)
...
Cohesion: 0.06
Nodes (50): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+42 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (54): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, buildOnboardingIntentBentoEventData(), buildOnboardingIntentBentoTags(), lookupUserEmail(), ORG_ONBOARDING_INTENTS, OrgOnboardingIntent, orgOnboardingIntentTestUtils (+46 more)
...
Cohesion: 0.06
Nodes (49): app, appGlobal, assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody (+41 more)
...
Cohesion: 0.05
Nodes (38): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+30 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (46): aggregateNativeObserveSamples(), app, buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, bumpMetricBucket(), createNativeObserveAggregateState(), createSeries() (+38 more)
...
Cohesion: 0.06
Nodes (39): AdminDashboardMinimize, createAdminDashboardChartPreferenceKey(), hasAdminDashboardMinimize(), isJsonObject(), preserveAdminDashboardMinimize(), readAdminDashboardMinimize(), slugify(), stableHash() (+31 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (40): cancelCommand(), debugApp(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, listenForWaitLogContinue(), LogData (+32 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (41): BuildChartConfigProps, useBuildChartConfig(), AnnotationOptions, inlineAnnotationPlugin, AxisConfig, colorChannelToLinear(), createChartColorWithOpacity(), createChartScales() (+33 more)
...
Cohesion: 0.06
Nodes (41): accumulateNumbers(), app, appGlobal, AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildNativeVersionCounts(), bundleUsageSchema (+33 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (40): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg() (+32 more)
...
Cohesion: 0.08
Nodes (43): getFreePort(), { mockedSupabaseAdmin }, startStripeEmulatorWithRetry(), handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal() (+35 more)
...
Cohesion: 0.05
Nodes (43): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOrganizationInsightRow, AdminOrganizationInsightsFilters (+35 more)
...
Cohesion: 0.08
Nodes (44): getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handlePhysicalIosRunTargets(), handleSimulatorIosRunTargets() (+36 more)
...
Cohesion: 0.08
Nodes (40): apiKeyBindingsAllowOrgCreate(), assertApiKeyCanKeepOrgCreateGrant(), parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), validateApiKeyGlobalPermissionsForBindings(), app, appGlobal, ApiKeyRow (+32 more)
...
Cohesion: 0.06
Nodes (37): id, testOrgId, fetchRest(), getAnonHeaders(), getApiKeyHeaders(), headers, id, orgId (+29 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (31): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingAttemptTotal(), buildFrontendOnboardingHogql(), buildFrontendOnboardingWelcomeHogql(), getAdminFrontendOnboardingAnalytics(), mapAttempts(), mapWelcomeAttempts(), FRONTEND_ONBOARDING_PRODUCTION_HOST (+23 more)
...
Cohesion: 0.08
Nodes (43): buildReadDevicesCFCursorCondition(), buildReadDevicesCFCustomIdsCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFQuery(), buildReadDevicesCFUpdatedAtGtCondition(), buildReadDevicesCFVersionNameCondition(), buildStatsInsightsActionFilter(), convertDataToJsTypes() (+35 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (35): getCurrentCliCommand(), AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels (+27 more)
...
Cohesion: 0.08
Nodes (35): aiBumpLevel, BUMP_LEVELS, bumpLevelSchema(), capPaths(), ManifestDiffBody, parseBumpDecision(), app, buildBatches() (+27 more)
...
Cohesion: 0.05
Nodes (26): App, Bundle, Channel, Device, useAppDetailStore, ApiKeyInvokePayload, mocks, CreditMetric (+18 more)

### Community 90 - "Community 90"
Cohesion: 0.10
Nodes (36): DeliveryMessage, AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer(), createDeliveryRecord(), createTestPayload() (+28 more)
...
Cohesion: 0.10
Nodes (33): createRSA(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), setConfigWriteTarget(), writeConfig() (+25 more)
...
Cohesion: 0.08
Nodes (20): Digester, noopDigester(), sha256Digester(), DEFAULT_RETRY_PARAMS, isR2ChecksumError(), isR2Error(), isR2MultipartDoesNotExistError(), retry() (+12 more)
...
Cohesion: 0.09
Nodes (29): buildFrontendOnboardingDailySeries(), buildFrontendOnboardingDailySetupCliSeries(), buildFrontendOnboardingDailyWelcomeOutcomeSeries(), buildFrontendOnboardingFunnelStages(), buildFrontendOnboardingFunnelSummaries(), buildFrontendOnboardingGraphMetrics(), createFrontendOnboardingAnalyticsLoader(), DAILY_SETUP_CLI_OUTCOME_COLORS (+21 more)
...
Cohesion: 0.11
Nodes (28): context, startMs, buildBillingTransitionsQuery(), buildExactTrackingStartQuery(), buildPlansBehaviorQuery(), emptyPlansAnalyticsResponse(), exactTrackingStartedAt(), explicitTransitionKind() (+20 more)
...
Cohesion: 0.10
Nodes (27): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), ApiKeyGlobalPermissionBinding, attachApiKeyGlobalPermissions() (+19 more)
...
Cohesion: 0.09
Nodes (29): aggregateDeliverySamples(), app, buildDeliveriesFromEvents(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), DeliverySample, durationExpression (+21 more)
...
Cohesion: 0.09
Nodes (26): AssignablePrincipal, canManageRoleBindingScope(), CreateBindingOptions, CreateBindingResult, createRoleBindingForPrincipal(), DrizzleClient, DrizzleExecutor, getCallerMaxPriorityRank() (+18 more)
...
Cohesion: 0.12
Nodes (27): isRetryableStatsError(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), getErrorCode(), getRetryableStatus(), isMissingOrgError(), isRetryableCronSyncError(), OrgToGet (+19 more)
...
Cohesion: 0.10
Nodes (21): mockContext, mockContext, mockContext, plans, mockContext, stripeEventTestUtils, honoFactory, MiddlewareKeyVariablesStripe (+13 more)
...
Cohesion: 0.09
Nodes (27): DataStats, defaultInsightActions, EXPORT_FORMATS, ExportBody, exportSchema, getValidatedStatsRequestBody(), insightPeriodDays, normalizeRangeDate() (+19 more)
...
Cohesion: 0.13
Nodes (31): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown() (+23 more)
...
Cohesion: 0.11
Nodes (29): aggregateDailyBuildStats(), countDemoSeededApps(), countNotificationEvent(), getBuildStats(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow() (+21 more)
...
Cohesion: 0.14
Nodes (19): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+11 more)

### Community 160 - "Community 160"
Cohesion: 0.10
Nodes (19): isRetryableDurableObjectFetchError(), AppScopedAttachmentPath, AsyncLock, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, FinalPart, getAttachmentReadCandidateKeys() (+11 more)

### Community 161 - "Community 161"
Cohesion: 0.16
Nodes (5): UploadMetadata, normalizeContentType(), UploadHandler, readIntFromHeader(), toBase64()
...
Cohesion: 0.14
Nodes (21): apikeyHasOrgRight(), apikeyHasOrgRightWithPolicy(), checkApikeyMeetsOrgPolicy(), bodySchema, deleteWebhook(), getDeliveries(), bodySchema, get() (+13 more)
...
Cohesion: 0.15
Nodes (20): app, DataSetManifest, DeletedVersionAction, deleteIt(), deleteManifest(), ensureVersionManifest(), getManifestEntryCount(), getMetadataBranch() (+12 more)

### Community 174 - "Community 174"
Cohesion: 0.13
Nodes (19): aggregateCliKeyPolicy(), candidatePolicyAllows(), canonicalizeCliBindings(), CliApiKeyMetadata, CliKeyBinding, CliKeyPolicy, CliLoginKeyDependencies, CliLoginKeyPreparation (+11 more)
...
Cohesion: 0.12
Nodes (14): Tab, TableAction, TableColumn, TableRow, TableSort, accountTabs, adminTabs, appSettingsTabs (+6 more)
...
Cohesion: 0.10
Nodes (21): steps, trackerIdentity, AnalyticsPrimitive, AnalyticsProperties, CaptureEvent, createOnboardingDetailsFieldDebouncer(), createOnboardingProgressTracker(), CreateOnboardingProgressTrackerOptions (+13 more)
...
Cohesion: 0.12
Nodes (13): creditPricingDisclaimer, dismissUpdateBillingModal(), ensureUpdateBillingAccess(), formatMetricAmount(), handleBuyCredits(), handleCreditCheckoutReturn(), metricLabel(), onEscapeDismiss() (+5 more)
...
Cohesion: 0.15
Nodes (15): { cloudlogErrMock, queryPosthogHogqlMock }, assertFrontendOnboardingDailySetupCliEventTotal(), buildFrontendOnboardingDailySetupCliHogql(), EVENT_KINDS, getFrontendOnboardingDailySetupCliEvents(), mapEvent(), sqlStr(), timestampMs() (+7 more)
...
Cohesion: 0.13
Nodes (19): cleanupStepsDone(), getTmpObjectPath(), markStepDone(), readTmpObj(), tryResumeOnboarding(), getActiveCliReplaySessionId(), isCliTelemetryDisabled(), setInitCodeDiff() (+11 more)
...
Cohesion: 0.12
Nodes (20): calculateConversionRate(), countAppsWithPreview(), countRegisteredUsersForSnapshot(), getAppBuildOnboardingMetrics(), getBillingSnapshotCounts(), getCoreSnapshotCounts(), getEmptyBillingSnapshotCounts(), getGithubStars() (+12 more)
...
Cohesion: 0.16
Nodes (17): DataDevice, devicesBodySchema, devicesBodyShape, EXPORT_FORMATS, exportSchema, firstVersionName(), orderItemSchema, parseAuthorizedDevicesBody() (+9 more)
...
Cohesion: 0.12
Nodes (17): dependencies, happy-dom, ink, ink-spinner, @inkjs/ui, jsonwebtoken, node-forge, qrcode (+9 more)
...
Cohesion: 0.24
Nodes (17): adminOnboardingConversionRate(), closeClient(), createAdminTrialPlanTrendDay(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend() (+9 more)
...
Cohesion: 0.21
Nodes (12): attributeCheckoutStarts(), AttributedCheckout, buildLogicalPlansOpenings(), buildPlansChartData(), incrementCategory(), LogicalPlansOpening, PlansBehaviorEvent, PlansBillingCategory (+4 more)
...
Cohesion: 0.18
Nodes (9): id, insertDelta(), productionChannel(), createChannel(), seedOptions, versionCache, getCanonicalAppVersionR2Path(), isCanonicalAppVersionR2Path() (+1 more)
...
Cohesion: 0.21
Nodes (11): app, app, checkPermissionMock, countDevicesMock, expectInvalidBody(), expectRejectedDevicesBody(), expectRejectedStatsBody(), postJson() (+3 more)
...
Cohesion: 0.21
Nodes (6): findAppInOrganization(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), isChannelAlreadyExistsError(), getResumedOnboardingAccessError(), validateResumedOnboardingAccess()
...
Cohesion: 0.47
Nodes (9): addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags(), trackBentoEvent(), unsubscribeBento(), acceptedBentoBatchResult() (+1 more)
...
Cohesion: 0.38
Nodes (7): normalizeTargetLimit(), resolveTargetPlan(), buildNotificationRegistryLookupQuery(), getAllNotificationBuckets(), getNotificationBucket(), normalizeNotificationTag(), resolveNotificationBuckets()
...
Cohesion: 0.33
Nodes (3): organizationMainTabs, organizationPlanSubTabs, organizationTeamSubTabs
...
Cohesion: 0.40
Nodes (4): fetchMock, jsonResponse(), queueAcknowledgement(), subscriberUpdates
...
Cohesion: 0.40
Nodes (4): auth, messages, organizationStore, pagePath
...
Cohesion: 0.50
Nodes (3): sanitizeFilename(), stripControlChars(), toCsv()
...
## Knowledge Gaps
- **5527 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+5522 more)
...
- **Why does `Database` connect `Community 89` to `Community 3`, `Community 261`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 26`, `Community 28`, `Community 29`, `Community 36`, `Community 293`, `Community 44`, `Community 174`, `Community 50`, `Community 307`, `Community 57`, `Community 60`, `Community 63`, `Community 198`, `Community 202`, `Community 75`, `Community 213`, `Community 91`, `Community 97`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 14` to `Community 512`, `Community 513`, `Community 130`, `Community 129`, `Community 52`, `Community 6`, `Community 520`, `Community 10`, `Community 139`, `Community 395`, `Community 13`, `Community 144`, `Community 145`, `Community 16`, `Community 146`, `Community 277`, `Community 279`, `Community 280`, `Community 158`, `Community 30`, `Community 33`, `Community 34`, `Community 291`, `Community 164`, `Community 166`, `Community 38`, `Community 295`, `Community 296`, `Community 173`, `Community 46`, `Community 47`, `Community 176`, `Community 564`, `Community 53`, `Community 565`, `Community 567`, `Community 182`, `Community 183`, `Community 184`, `Community 310`, `Community 444`, `Community 573`, `Community 65`, `Community 195`, `Community 67`, `Community 69`, `Community 72`, `Community 201`, `Community 74`, `Community 73`, `Community 79`, `Community 81`, `Community 84`, `Community 85`, `Community 87`, `Community 95`, `Community 248`, `Community 100`, `Community 101`, `Community 105`, `Community 113`, `Community 115`, `Community 118`, `Community 120`, `Community 122`, `Community 508`, `Community 509`, `Community 510`?**
